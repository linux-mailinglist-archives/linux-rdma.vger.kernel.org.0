Return-Path: <linux-rdma+bounces-17996-lists+linux-rdma=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-rdma@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id gNuZMo+ssWmzEQAAu9opvQ
	(envelope-from <linux-rdma+bounces-17996-lists+linux-rdma=lfdr.de@vger.kernel.org>)
	for <lists+linux-rdma@lfdr.de>; Wed, 11 Mar 2026 18:55:27 +0100
X-Original-To: lists+linux-rdma@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [172.234.253.10])
	by mail.lfdr.de (Postfix) with ESMTPS id 711262684F8
	for <lists+linux-rdma@lfdr.de>; Wed, 11 Mar 2026 18:55:26 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id CB05F30BA37D
	for <lists+linux-rdma@lfdr.de>; Wed, 11 Mar 2026 17:54:57 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id BD7EB3E63A1;
	Wed, 11 Mar 2026 17:54:56 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=cornelisnetworks.com header.i=@cornelisnetworks.com header.b="MDcTbCBi"
...
Received: from SJ2PR03CU001.outbound.protection.outlook.com (mail-westusazon11022131.outbound.protection.outlook.com [52.101.43.131])
	...
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id F27C03E6394
	for <linux-rdma@vger.kernel.org>; Wed, 11 Mar 2026 17:54:48 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=52.101.43.131
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1773251696; cv=fail; b=oOxoPWRbHOh+bNoATr30izeTU13De2YxbnfzEqhLIS2SFkvfor760JwmXAFjan+go91I4iUW4qVJn7DJh5iH7cHCh5sxCs4VTeil4RvQg21aWBxEqCWkIRtb8/Z5PE0JEy7no7ky9HCdvUGMCFjG+No9+q9msEcV36YJ2deDjCE=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1773251696; c=relaxed/simple;
	bh=h5CJtxzaUxkSUdUlurFmRVyVJqNNHZClhf75xVmNVfo=;
	h=Subject:From:To:Cc:Date:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=JpKYzX2Ozfcvi0eZXBLIwRylzi/oUlV7TQP9n/2a3FNF0ZBJi2IZSNQPQFWhiEDXODgcq24KYSMMdF3Ndb0UjBoVRUH7tRunk3Rchtg2dMWf32uIYzerFRAcPerYNv3I+Pz66FN43ee4bIkSuQHwXQ7dotbvuemKluMTzlmobjk=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=cornelisnetworks.com; spf=pass smtp.mailfrom=cornelisnetworks.com; dkim=pass (2048-bit key) header.d=cornelisnetworks.com header.i=@cornelisnetworks.com header.b=MDcTbCBi; arc=fail smtp.client-ip=52.101.43.131
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=cornelisnetworks.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=cornelisnetworks.com
ARC-Seal: i=1; a=rsa-sha256; s=arcselector10001; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com;
 s=arcselector10001;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-AntiSpam-MessageData-ChunkCount:X-MS-Exchange-AntiSpam-MessageData-0:X-MS-Exchange-AntiSpam-MessageData-1;
 bh=tWBHIHIKQjjpUFi2TOzP0WsnMfvGgqv+yfX/faVPMPM=;
 b=
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=cornelisnetworks.com;
 ...
 bh=tWBHIHIKQjjpUFi2TOzP0WsnMfvGgqv+yfX/faVPMPM=;
 b=
Received: from BN0PR03CA0032.namprd03.prod.outlook.com (2603:10b6:408:e7::7)
 by BN0PR01MB7165.prod.exchangelabs.com (2603:10b6:408:154::13) with Microsoft
 SMTP Server (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.20.9700.12; Wed, 11 Mar 2026 17:54:42 +0000
Received: from BN2PEPF000044A6.namprd04.prod.outlook.com
 (2603:10b6:408:e7:cafe::5) by BN0PR03CA0032.outlook.office365.com
...
Received: from cn-mailer-00.localdomain (50.148.235.34) by
 ...
 via Frontend Transport; Wed, 11 Mar 2026 17:54:46 +0000
Received: from awdrv-04.localdomain (awdrv-04.cornelisnetworks.com [10.228.212.218])
	by cn-mailer-00.localdomain (Postfix) with ESMTPS id 0A0F814D817;
	Wed, 11 Mar 2026 13:54:46 -0400 (EDT)
Received: from awdrv-04.cornelisnetworks.com (localhost [IPv6:::1])
	by awdrv-04.localdomain (Postfix) with ESMTP id 05F7E1810D6C5;
	Wed, 11 Mar 2026 13:54:46 -0400 (EDT)
Subject: [PATCH for-next resend 12/24] RDMA/hfi2: Implement MAD handling
From: Dennis Dalessandro <dennis.dalessandro@cornelisnetworks.com>
To: jgg@ziepe.ca, leon@kernel.org
Cc: Dean Luick <dean.luick@cornelisnetworks.com>,
 Douglas Miller <doug.miller@cornelisnetworks.com>, linux-rdma@vger.kernel.org
Date: Wed, 11 Mar 2026 13:54:46 -0400
Message-ID:
 <177325168598.57064.3856918704644788598.stgit@awdrv-04.cornelisnetworks.com>
In-Reply-To:
...
X-MS-TrafficTypeDiagnostic: BN2PEPF000044A6:EE_|BN0PR01MB7165:EE_
X-MS-Office365-Filtering-Correlation-Id: 76a965c8-2909-4c01-5799-08de7f974853
X-MS-Exchange-AtpMessageProperties: SA
X-MS-Exchange-SenderADCheck: 1
X-MS-Exchange-AntiSpam-Relay: 0
X-Microsoft-Antispam:
	BCL:0;ARA:13230040|36860700016|34020700016|1800799024|376014|82310400026|55112099003|18002099003|22082099003|56012099003;
X-Microsoft-Antispam-Message-Info:
	
X-Forefront-Antispam-Report:
	CIP:50.148.235.34;CTRY:US;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:cn-mailer-00.localdomain;PTR:c-50-148-235-34.hsd1.mn.comcast.net;CAT:NONE;SFS:(13230040)(36860700016)(34020700016)(1800799024)(376014)(82310400026)(55112099003)(18002099003)(22082099003)(56012099003);DIR:OUT;SFP:1102;
X-MS-Exchange-AntiSpam-MessageData-ChunkCount: 1
X-MS-Exchange-AntiSpam-MessageData-0:
	
X-OriginatorOrg: cornelisnetworks.com
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 11 Mar 2026 17:54:46.2521
 (UTC)
X-MS-Exchange-CrossTenant-Network-Message-Id: 76a965c8-2909-4c01-5799-08de7f974853
...
X-Spamd-Result: default: False [-0.16 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	TAGGED_FROM(0.00)[bounces-17996-lists,linux-rdma=lfdr.de];
	RCVD_TLS_LAST(0.00)[];
...
---
 ...
 1 file changed, 6531 insertions(+)
...
index 000000000000..df77cb9bf630
--- /dev/null
...
+MODULE_PARM_DESC(cport_mad_to, "Timeout for MADs to CPORT, seconds, default 1 (-1 = infinite)");
+
...
+}
+
+static void print_mad(struct hfi2_devdata *dd, u32 port, const struct ib_mad *in_mad,
...
+	ni->system_image_guid = ib_hfi2_sys_image_guid;
+#ifdef CPORT_MAD_TRACE
+	ppd_dev_info(ppd, "NODEINFO %04x:%02x%02x%02x type=%d nport=%d/%d guid sys=%016llx node=%016llx port=%016llx\n",
...
+		}
+		rc = hfi2_lookup_pkey_idx(&ppd->ibport_data, pkey); /* should never fail */
