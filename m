...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 4DE281DAB79
	for <lists+linux-rdma@lfdr.de>; Wed, 20 May 2020 09:06:40 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726993AbgETHEj (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Wed, 20 May 2020 03:04:39 -0400
Received: from mga12.intel.com ([192.55.52.136]:50903 "EHLO mga12.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726905AbgETHEh (ORCPT <rfc822;linux-rdma@vger.kernel.org>);
        Wed, 20 May 2020 03:04:37 -0400
IronPort-SDR: +gXK//EAqaOGfWQvaCpqapFGUxCtZwMwp+ej6QCORR4Gr5ZdNfLtsNGaHfPpQlAv2hca+h0zPu
 6mhA34KQ8sBA==
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga003.jf.intel.com ([10.7.209.27])
  by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 20 May 2020 00:04:18 -0700
IronPort-SDR: K56+RzwHW5lV4ZzwqfMqiSFtHuJKheGRxP+1UOrp7Hk38DsQa1AEERICFaktoqT38Kh3abksaH
 CrMFAMesyTzQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.73,413,1583222400"; 
   d="scan'208";a="264581232"
...
Subject: [RDMA RFC v6 07/16] RDMA/irdma: Add connection manager
Date:   Wed, 20 May 2020 00:04:06 -0700
Message-Id: <20200520070415.3392210-8-jeffrey.t.kirsher@intel.com>
...
index 000000000000..a40f26655e87
--- /dev/null
...
+
+		if (iwqp->flush_issued || iwqp->destroy_pending) {
+			spin_unlock_irqrestore(&iwqp->lock, flags);
+			return;
+		}
+
...
+
+	spin_unlock_irqrestore(&iwqp->lock, flags);
+	if (issue_flush && !iwqp->destroy_pending) {
...
new file mode 100644
index 000000000000..59a0b673c418
--- /dev/null
...
+#define IRDMA_CM_DEFAULT_RCV_WND_SCALED	0x3ffc
