...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id D0A84DE3E
	for <lists+linux-rdma@lfdr.de>; Mon, 29 Apr 2019 10:47:03 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727654AbfD2IrC (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Mon, 29 Apr 2019 04:47:02 -0400
Received: from mail.kernel.org ([198.145.29.99]:54466 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1727480AbfD2IrC (ORCPT <rfc822;linux-rdma@vger.kernel.org>);
        Mon, 29 Apr 2019 04:47:02 -0400
Received: from localhost (unknown [77.138.135.184])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id CCC692063F;
        Mon, 29 Apr 2019 08:46:59 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1556527620;
        bh=QOOL1B3//pnurCaj8JzA9JmKIF2WIFkvQqdkpRKYvDE=;
        h=From:To:Cc:Subject:Date:From;
        b=vmfXhtlTuoSeleio/14qudIWaYExkaFqrBtsTFh1PbXEwycIp+Tys3A3FbRSnUjgA
         AyK/eA6IIz3GbUW3LCiywRUeIn8GLmfKxnOKg+X6rRR1e4rGqdl3YP1HTWzSMEiI2j
         +B6Qd4zWY4mr4Bb1Lqik6JYPOya/C+JIwRlAmTXc=
From:   Leon Romanovsky <leon@kernel.org>
To:     Doug Ledford <dledford@redhat.com>,
        Jason Gunthorpe <jgg@mellanox.com>
Cc:     RDMA mailing list <linux-rdma@vger.kernel.org>,
        Leon Romanovsky <leonro@mellanox.com>
Subject: [PATCH rdma-next] RDMA/umem: Move page_shift from ib_umem to ib_odp_umem
Date:   Mon, 29 Apr 2019 11:46:53 +0300
Message-Id: <20190429084653.31087-1-leon@kernel.org>
...
@@ -583,7 +577,6 @@ int ib_umem_odp_map_dma_pages(struct ib_umem_odp *umem_odp, u64 user_virt,
...
@@ -595,15 +588,15 @@ int ib_umem_odp_map_dma_pages(struct ib_umem_odp *umem_odp, u64 user_virt,
 	if (access_mask == 0)
 		return -EINVAL;
...
-	unsigned long page_shift = umem->page_shift;
 	...
 	if (umem->is_odp) {
+		unsigned long page_shift = to_ib_umem_odp(umem)->page_shift;
+
