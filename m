A==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.09,234,1716274800"; 
   d="scan'208";a="52425987"
...
Subject: [RFC PATCH 01/25] iidc/ice/irdma: Update IDC to support multiple consumers
Date: Wed, 24 Jul 2024 18:38:53 -0500
Message-Id: <20240724233917.704-2-tatyana.e.nikolova@intel.com>
...
@@ -325,13 +333,13 @@ static int irdma_probe(struct auxiliary_device *aux_dev, const struct auxiliary_
...
index c4b6965..0eb84a0 100644
--- a/drivers/net/ethernet/intel/ice/devlink/devlink.c
+++ b/drivers/net/ethernet/intel/ice/devlink/devlink.c
@@ -1286,8 +1286,14 @@ static int ice_devlink_reinit_up(struct ice_pf *pf)
...
@@ -1320,11 +1331,16 @@ static int ice_devlink_enable_roce_set(struct devlink *devlink, u32 id,
 				 struct netlink_ext_ack *extack)
 {
 	struct ice_pf *pf = devlink_priv(devlink);
+	struct idc_rdma_core_dev_info *cdev;
...
@@ -1338,7 +1354,8 @@ static int ice_devlink_enable_roce_set(struct devlink *devlink, u32 id,
 {
 	struct ice_pf *pf = devlink_priv(devlink);
...
@@ -1375,7 +1396,7 @@ static int ice_devlink_enable_iw_set(struct devlink *devlink, u32 id,
 	if (!test_bit(ICE_FLAG_RDMA_ENA, pf->flags))
 		return -EOPNOTSUPP;
...
@@ -944,6 +950,36 @@ void ice_update_dcb_stats(struct ice_pf *pf)
 }
...
index 62c8205..4dd7a69 100644
--- a/drivers/net/ethernet/intel/ice/ice_ethtool.c
+++ b/drivers/net/ethernet/intel/ice/ice_ethtool.c
@@ -3643,11 +3643,11 @@ static int ice_set_channels(struct net_device *dev, struct ethtool_channels *ch)
 		return -EINVAL;
 	}
...
+		if (pf->cdev_info->adev->dev.driver) {
 			...
 			ret = -EBUSY;
 			goto adev_unlock;
@@ -3666,7 +3666,7 @@ static int ice_set_channels(struct net_device *dev, struct ethtool_channels *ch)
...
@@ -234,22 +214,26 @@ void ice_get_qos_params(struct ice_pf *pf, struct iidc_qos_params *qos)
  */
...
+	pf->cdev_info->adev = NULL;
 	...
 	if (adev) {
@@ -362,12 +369,38 @@ void ice_unplug_aux_dev(struct ice_pf *pf)
 }
...
@@ -9216,6 +9216,7 @@ static int ice_setup_tc_mqprio_qdisc(struct net_device *netdev, void *type_data)
 {
...
@@ -9231,11 +9232,12 @@ static int ice_setup_tc_mqprio_qdisc(struct net_device *netdev, void *type_data)
 			return -EOPNOTSUPP;
 		}
...
+			if (cdev->adev->dev.driver) {
 				...
 				err = -EBUSY;
 				goto adev_unlock;
@@ -9249,7 +9251,7 @@ static int ice_setup_tc_mqprio_qdisc(struct net_device *netdev, void *type_data)
