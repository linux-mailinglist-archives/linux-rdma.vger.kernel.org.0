...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 5F93F1B5AB4
	for <lists+linux-rdma@lfdr.de>; Thu, 23 Apr 2020 13:45:57 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727930AbgDWLp4 (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Thu, 23 Apr 2020 07:45:56 -0400
Received: from szxga06-in.huawei.com ([45.249.212.32]:35238 "EHLO huawei.com"
        rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org with ESMTP
        id S1727088AbgDWLp4 (ORCPT <rfc822;linux-rdma@vger.kernel.org>);
        Thu, 23 Apr 2020 07:45:56 -0400
Received: from DGGEMS410-HUB.china.huawei.com (unknown [172.30.72.58])
        by Forcepoint Email with ESMTP id 65AFDFD9C439F383C8BE;
        Thu, 23 Apr 2020 19:45:53 +0800 (CST)
Received: from [127.0.0.1] (10.40.168.149) by DGGEMS410-HUB.china.huawei.com
 (10.3.19.210) with Microsoft SMTP Server id 14.3.487.0; Thu, 23 Apr 2020
 19:45:46 +0800
Subject: Re: [PATCH for-next 3/5] RDMA/hns: Optimize WQE buffer size
 calculating process
...
References: <1587640550-16777-1-git-send-email-liweihang@huawei.com>
 <1587640550-16777-4-git-send-email-liweihang@huawei.com>
Message-ID: <2c2c5be0-ad53-3977-7d3e-c078ff0ddab3@huawei.com>
Date:   Thu, 23 Apr 2020 19:45:46 +0800
User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:68.0) Gecko/20100101
 Thunderbird/68.6.0
MIME-Version: 1.0
In-Reply-To: <1587640550-16777-4-git-send-email-liweihang@huawei.com>
...
On 2020/4/23 19:16, Weihang Li wrote:
...
> @@ -1089,6 +1091,38 @@ static inline u32 to_hr_hw_page_shift(u32 page_shift)
...
Sorry, I didn't notice that Leon has a comment on the similar function
in rdma-core today. The judgment of count is meaningless, will send v2 later.
