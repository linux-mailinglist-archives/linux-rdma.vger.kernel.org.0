...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 281BD301456
	for <lists+linux-rdma@lfdr.de>; Sat, 23 Jan 2021 10:47:11 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726779AbhAWJqx (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Sat, 23 Jan 2021 04:46:53 -0500
Received: from szxga04-in.huawei.com ([45.249.212.190]:11140 "EHLO
        szxga04-in.huawei.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726032AbhAWJqw (ORCPT
        <rfc822;linux-rdma@vger.kernel.org>); Sat, 23 Jan 2021 04:46:52 -0500
Received: from DGGEMS411-HUB.china.huawei.com (unknown [172.30.72.59])
        by szxga04-in.huawei.com (SkyGuard) with ESMTP id 4DNB6S1kjVz15wjk;
        Sat, 23 Jan 2021 17:44:16 +0800 (CST)
Received: from localhost.localdomain (10.67.165.24) by
 DGGEMS411-HUB.china.huawei.com (10.3.19.211) with Microsoft SMTP Server id
 14.3.498.0; Sat, 23 Jan 2021 17:45:22 +0800
From:   Weihang Li <liweihang@huawei.com>
To:     <dledford@redhat.com>, <jgg@nvidia.com>
CC:     <leon@kernel.org>, <linux-rdma@vger.kernel.org>,
        <linuxarm@openeuler.org>
Subject: [PATCH v2 RFC 4/7] RDMA/hns: Add method for attaching WQE buffer
Date:   Sat, 23 Jan 2021 17:43:11 +0800
Message-ID: <1611394994-50363-5-git-send-email-liweihang@huawei.com>
...
index 0dca8bbb..611e594 100644
--- a/drivers/infiniband/hw/hns/hns_roce_device.h
+++ b/drivers/infiniband/hw/hns/hns_roce_device.h
@@ -368,7 +368,17 @@ struct hns_roce_mtr {
 };
...
+	u32 rq_offset;
 ...
 struct hns_roce_mw {
@@ -943,6 +953,9 @@ struct hns_roce_hw {
...
index fecb782..8536c09 100644
--- a/include/uapi/rdma/hns-abi.h
+++ b/include/uapi/rdma/hns-abi.h
@@ -109,6 +109,7 @@ enum hns_ib_dca_mem_methods {
...
@@ -129,4 +130,14 @@ enum hns_ib_dca_mem_shrink_attrs {
