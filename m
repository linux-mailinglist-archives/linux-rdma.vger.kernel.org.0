mid,cornelisnetworks.com:dkim,cornelisnetworks.com:email,cornelisnetworks.com:from_mime,sea.lore.kernel.org:rdns,sea.lore.kernel.org:helo,wc.sl:url];
...
---
  Changes since v1:
    - Address Arnd Bergmann's feedback (Re: hfi2 v1, Mar 23 2026):
      update cport_get_dev_fw_str() to use the CPORT_FW_VER_*()
      accessor macros after union cport_fw_ver was replaced with a
      plain u64 in cport.h.
---
 ...
 drivers/infiniband/hw/hfi2/verbs.c       | 2030 ++++++++++++++++++++++++++++++
 drivers/infiniband/hw/hfi2/verbs.h       |    6 
 drivers/infiniband/hw/hfi2/verbs_txreq.c |  101 +
 8 files changed, 5705 insertions(+), 6 deletions(-)
...
index 000000000000..f24d28e404b8
--- /dev/null
...
+		.request = hfi2_tid_rdma_conn_req,
+		.response = hfi2_tid_rdma_conn_resp,
+		.reply = hfi2_tid_rdma_conn_reply,
+		.error = hfi2_tid_rdma_conn_error,
+	},
+};
+
...
+		if (qp->pmtu == hfi2_enum_to_mtu(OPA_MTU_4096) ||
+		    qp->pmtu == hfi2_enum_to_mtu(OPA_MTU_8192)) {
+			hfi2_tid_rdma_opfn_init(qp, local);
+			/*
...
new file mode 100644
index 000000000000..3bcf5c9a9e88
--- /dev/null
...
+		if (ret)
+			hfi2_iowait_clear_flag(&priv->s_iowait, IOWAIT_PENDING_IB);
+	}
+	if (hfi2_iowait_flag_set(&priv->s_iowait, IOWAIT_PENDING_TID)) {
+		ret = hfi2_schedule_tid_send(qp);
+		if (ret)
+			hfi2_iowait_clear_flag(&priv->s_iowait, IOWAIT_PENDING_TID);
+	}
+}
+
...
new file mode 100644
index 000000000000..7d20a2a5c0db
--- /dev/null
...
+		if (qp->s_ahgidx < 0)
+			qp->s_ahgidx = hfi2_sdma_ahg_alloc(priv->s_sde);
+		if (qp->s_ahgidx >= 0) {
+			qp->s_ahgpsn = npsn;
...
+	switch (qp->ibqp.qp_type) {
+	case IB_QPT_RC:
+		if (!hfi2_loopback && ((rdma_ah_get_dlid(&qp->remote_ah_attr) &
+				   ~((1 << ps.ppd->lmc) - 1)) ==
+				  ps.ppd->lid)) {
...
new file mode 100644
index 000000000000..20e465ca1b20
--- /dev/null
...
+
+/**
+ * ud_loopback - handle send on hfi2_loopback QPs
+ * @sqp: the sending QP
...
+
+		/*
+		 * For hfi2_loopback packets with extended LIDs, the
+		 * sgid_index in the GRH is 0 and the dgid is
+		 * OPA GID of the sender. While creating a response
+		 * to the hfi2_loopback packet, IB core creates the new
...
+				   ((1 << ppd->lmc) - 1))) & U16_MAX;
+	/* Check for hfi2_loopback when the port lid is not set */
...
+			 * a completion for the hfi2_loopback packet since
...
+	u32 nwords;
+
+	/* should only be called for WFR, creat_pbc ignores hfi2_loopback param */
...
+					     PBC_L2_16B, dlid,
+					     ctxt->hw_context);
+		pbuf = hfi2_sc_buffer_alloc(ctxt, plen, NULL, NULL);
...
new file mode 100644
index 000000000000..8b34b2799c57
--- /dev/null
...
index 5b61a951e1d6..18ec034de681 100644
--- a/drivers/infiniband/hw/hfi2/verbs.h
...
new file mode 100644
index 000000000000..73cd0ced63a0
--- /dev/null
