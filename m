...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id B27041DF784
	for <lists+linux-rdma@lfdr.de>; Sat, 23 May 2020 15:23:09 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2387862AbgEWNXI (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Sat, 23 May 2020 09:23:08 -0400
Received: from mail.kernel.org ([198.145.29.99]:56814 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S2387763AbgEWNXI (ORCPT <rfc822;linux-rdma@vger.kernel.org>);
        Sat, 23 May 2020 09:23:08 -0400
Received: from localhost (unknown [213.57.247.131])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id 3AE8E2072C;
        Sat, 23 May 2020 13:23:07 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1590240187;
        bh=h4HSec9r9jIRrHaT3+L7DwMJ4HYqkTI0niImwzI31vA=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=TkimG882tWtmuMwK0FnkLlsSgMfpZDyKdJaAUi8tKQD2Y8Y8E0L6RD8wrqXlRC6jO
         xqjzCWlxHdrlUzTuDIYwu7VQRB2FbnydzeWWw0JovTxTUIy2H7YY7efCEcH5SV1OiB
         yneAHcw9rz6EoimFKtfepyNxRSg3FZHfmCVnM45w=
From:   Leon Romanovsky <leon@kernel.org>
To:     Doug Ledford <dledford@redhat.com>,
        Jason Gunthorpe <jgg@mellanox.com>
Cc:     Leon Romanovsky <leonro@mellanox.com>, linux-rdma@vger.kernel.org,
        Mark Zhang <markz@mellanox.com>
Subject: [PATCH rdma-next v1 5/9] RDMA/mlx5: Remove manually crafted QP context the query call
Date:   Sat, 23 May 2020 16:22:39 +0300
Message-Id: <20200523132243.817936-6-leon@kernel.org>
...
index 7cbf83b423f5..163f7723cff0 100644
--- a/drivers/infiniband/hw/mlx5/qp.c
+++ b/drivers/infiniband/hw/mlx5/qp.c
@@ -4329,48 +4329,34 @@ static inline enum ib_mig_state to_ib_mig_state(int mlx5_mig_state)
 	}
 }
...
@@ -4492,10 +4478,9 @@ static int query_qp_attr(struct mlx5_ib_dev *dev, struct mlx5_ib_qp *qp,
...
+	int err;
 	...
 	if (!outb)
@@ -4505,47 +4490,46 @@ static int query_qp_attr(struct mlx5_ib_dev *dev, struct mlx5_ib_qp *qp,
 	if (err)
 		goto out;
