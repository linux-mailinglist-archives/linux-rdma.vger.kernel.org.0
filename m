...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id A38172D5BAC
	for <lists+linux-rdma@lfdr.de>; Thu, 10 Dec 2020 14:25:49 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1731917AbgLJNZi (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Thu, 10 Dec 2020 08:25:38 -0500
Received: from szxga04-in.huawei.com ([45.249.212.190]:9153 "EHLO
        szxga04-in.huawei.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S2389230AbgLJNZi (ORCPT
        <rfc822;linux-rdma@vger.kernel.org>); Thu, 10 Dec 2020 08:25:38 -0500
Received: from DGGEMS413-HUB.china.huawei.com (unknown [172.30.72.59])
        by szxga04-in.huawei.com (SkyGuard) with ESMTP id 4CsF4d1nglz15bCX;
...
CC:     <leon@kernel.org>, <linux-rdma@vger.kernel.org>,
        <linuxarm@huawei.com>
Subject: [PATCH v3 for-next 10/11] RDMA/hns: Fix inaccurate prints
Date:   Thu, 10 Dec 2020 21:22:51 +0800
Message-ID: <1607606572-11968-11-git-send-email-liweihang@huawei.com>
...
@@ -680,7 +680,8 @@ static int hns_roce_v2_post_send(struct ib_qp *ibqp,
...
+				  "num_sge = %d > qp->sq.max_gs = %u\n",
 			...
 			ret = -EINVAL;
 			*bad_wr = wr;
@@ -765,7 +766,7 @@ static int hns_roce_v2_post_recv(struct ib_qp *ibqp,
...
+			ibdev_err(ibdev, "num_sge = %d >= max_sge = %u.\n",
 			...
 			ret = -EINVAL;
 			*bad_wr = wr;
@@ -1950,8 +1951,8 @@ static void calc_pg_sz(u32 obj_num, u32 obj_size, u32 hop_num, u32 ctx_bt_num,
...
@@ -3683,7 +3684,7 @@ static int get_op_for_set_hem(struct hns_roce_dev *hr_dev, u32 type,
 		break;
 	default:
 		dev_warn(hr_dev->dev,
...
@@ -3819,7 +3820,7 @@ static int hns_roce_v2_clear_hem(struct hns_roce_dev *hr_dev,
 	case HEM_TYPE_GMV:
 		return 0;
 	default:
...
@@ -4411,7 +4412,7 @@ static int modify_qp_rtr_to_rts(struct ib_qp *ibqp,
...
@@ -4902,7 +4903,7 @@ static int hns_roce_v2_modify_qp(struct ib_qp *ibqp,
...
@@ -4995,7 +4996,7 @@ static int hns_roce_v2_query_qp(struct ib_qp *ibqp, struct ib_qp_attr *qp_attr,
...
@@ -5118,7 +5119,7 @@ static int hns_roce_v2_destroy_qp_common(struct hns_roce_dev *hr_dev,
...
@@ -5157,7 +5158,7 @@ static int hns_roce_v2_destroy_qp(struct ib_qp *ibqp, struct ib_udata *udata)
...
@@ -5180,7 +5181,7 @@ static int hns_roce_v2_qp_flow_control_init(struct hns_roce_dev *hr_dev,
...
@@ -5190,7 +5191,7 @@ static int hns_roce_v2_qp_flow_control_init(struct hns_roce_dev *hr_dev,
...
@@ -5439,7 +5440,7 @@ static int hns_roce_v2_modify_cq(struct ib_cq *cq, u16 cq_count, u16 cq_period)
 	hns_roce_free_cmd_mailbox(hr_dev, mailbox);
 	if (ret)
 		ibdev_err(&hr_dev->ib_dev,
