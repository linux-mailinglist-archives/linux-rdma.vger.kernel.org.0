...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 3EAD51B5BE6
	for <lists+linux-rdma@lfdr.de>; Thu, 23 Apr 2020 14:56:25 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728534AbgDWM4V (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Thu, 23 Apr 2020 08:56:21 -0400
Received: from mail-il-dmz.mellanox.com ([193.47.165.129]:57497 "EHLO
        mellanox.co.il" rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org
        with ESMTP id S1728530AbgDWM4J (ORCPT
        <rfc822;linux-rdma@vger.kernel.org>); Thu, 23 Apr 2020 08:56:09 -0400
Received: from Internal Mail-Server by MTLPINE1 (envelope-from maorg@mellanox.com)
        with ESMTPS (AES256-SHA encrypted); 23 Apr 2020 15:56:00 +0300
Received: from dev-l-vrt-201.mtl.labs.mlnx (dev-l-vrt-201.mtl.labs.mlnx [10.134.201.1])
        by labmailer.mlnx (8.13.8/8.13.8) with ESMTP id 03NCtw26003234;
...
Subject: [PATCH V5 mlx5-next 16/16] RDMA/mlx5: Set lag tx affinity according to slave
Date:   Thu, 23 Apr 2020 15:55:55 +0300
Message-Id: <20200423125555.21759-17-maorg@mellanox.com>
...
index b3a3df51c44a..d73968786ee0 100644
...
index a041a1357a13..bdc36395db4a 100644
...
index a45499809903..7fd1d4f81862 100644
...
@@ -3458,10 +3463,18 @@ static unsigned int get_tx_affinity(struct ib_qp *qp, u8 init,
...
+		return 0;
 	...
 	if (ucontext)
@@ -3547,7 +3560,7 @@ static int __mlx5_ib_modify_qp(struct ib_qp *ibqp,
...
+	enum mlx5_qp_optpar optpar = 0;
 	...
 	int mlx5_st;
 	int err;
@@ -3582,10 +3595,15 @@ static int __mlx5_ib_modify_qp(struct ib_qp *ibqp,
 		}
 	}
...
@@ -3722,7 +3740,7 @@ static int __mlx5_ib_modify_qp(struct ib_qp *ibqp,
 	}
