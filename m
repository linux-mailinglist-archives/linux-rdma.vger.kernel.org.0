...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 821AB394286
	for <lists+linux-rdma@lfdr.de>; Fri, 28 May 2021 14:30:50 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234333AbhE1McX (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Fri, 28 May 2021 08:32:23 -0400
Received: from szxga08-in.huawei.com ([45.249.212.255]:2339 "EHLO
        szxga08-in.huawei.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230056AbhE1McW (ORCPT
        <rfc822;linux-rdma@vger.kernel.org>); Fri, 28 May 2021 08:32:22 -0400
Received: from dggemv703-chm.china.huawei.com (unknown [172.30.72.57])
        by szxga08-in.huawei.com (SkyGuard) with ESMTP id 4Fs3nW3Fbqz19Tdd;
        Fri, 28 May 2021 20:26:07 +0800 (CST)
Received: from dggema769-chm.china.huawei.com (10.1.198.211) by
 dggemv703-chm.china.huawei.com (10.3.19.46) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256) id
 15.1.2176.2; Fri, 28 May 2021 20:30:43 +0800
Received: from localhost (10.174.179.215) by dggema769-chm.china.huawei.com
 (10.1.198.211) with Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256_P256) id 15.1.2176.2; Fri, 28
 May 2021 20:30:43 +0800
From:   YueHaibing <yuehaibing@huawei.com>
To:     <bvanassche@acm.org>, <dledford@redhat.com>, <jgg@ziepe.ca>
CC:     <linux-rdma@vger.kernel.org>, <linux-kernel@vger.kernel.org>,
        YueHaibing <yuehaibing@huawei.com>
Subject: [PATCH v2 -next] RDMA/srp: use DEVICE_ATTR_*() macro
Date:   Fri, 28 May 2021 20:30:39 +0800
Message-ID: <20210528123039.10668-1-yuehaibing@huawei.com>
...
index 31f8aa2c40ed..1c18b607b575 100644
...
@@ -3870,19 +3870,19 @@ static ssize_t srp_create_target(struct device *dev,
 	goto out;
 }
...
+static ssize_t port_show(struct device *dev, struct device_attribute *attr,
 ...
 {
 	struct srp_host *host = container_of(dev, struct srp_host, dev);
@@ -3890,7 +3890,7 @@ static ssize_t show_port(struct device *dev, struct device_attribute *attr,
 	return sysfs_emit(buf, "%d\n", host->port);
 }
