...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id F19B629766F
	for <lists+linux-rdma@lfdr.de>; Fri, 23 Oct 2020 20:10:43 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1754276AbgJWSJn (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Fri, 23 Oct 2020 14:09:43 -0400
Received: from mga07.intel.com ([134.134.136.100]:64208 "EHLO mga07.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1754275AbgJWSJm (ORCPT <rfc822;linux-rdma@vger.kernel.org>);
        Fri, 23 Oct 2020 14:09:42 -0400
IronPort-SDR: lg/5IC1gq81cIgeWYx9+SuJhQNsnDTmggyRAOZGLXKGTJp7IwDfPIGdL6bwukohMdbC20fPe3O
 04GZHlC19bew==
X-IronPort-AV: E=McAfee;i="6000,8403,9783"; a="231904964"
X-IronPort-AV: E=Sophos;i="5.77,409,1596524400"; 
   d="scan'208";a="231904964"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
  by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 23 Oct 2020 11:09:41 -0700
IronPort-SDR: Y2JifhIOwsMBU/Uto3bC7wawK+LnUoceM+93l0GlQH5OU2VZnrmZwuwwm1SLLscNnEHiH6NDlC
 xg8t9UYzQebA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.77,409,1596524400"; 
   d="scan'208";a="524757922"
...
Received: from MW3PR11MB4555.namprd11.prod.outlook.com (2603:10b6:303:2e::24)
 by MWHPR1101MB2190.namprd11.prod.outlook.com (2603:10b6:301:5b::13) with
...
X-MS-Exchange-CrossTenant-originalarrivaltime: 23 Oct 2020 18:09:37.5758
 (UTC)
...
> > +		len =3D min(len, length);
> > +		if (len) {
> > +			sg_dma_address(new_sg) =3D addr;
> > +			sg_dma_len(new_sg) =3D len;
...
> > +		return PTR_ERR(sgt);
> > +
> > +	err =3D ib_umem_dmabuf_sgt_slice(sgt, umem_dmabuf->umem.address,
...
> > +	}
> > +
> > +	umem_dmabuf->umem.nmap =3D umem_dmabuf->umem.sg_head.nents;
...
> > +	if (device->dma_device->dma_ops =3D=3D &dma_virt_ops)
> > +		return ERR_PTR(-EINVAL);
> > +#endif
>=20
> Maybe I'm confused, but should we have this check in dma_buf_attach, or a=
t least in dma_buf_dynamic_attach? The p2pdma functions use
> that too, and I can't imagine how zerocopy should work (which is like the=
 entire point of
...
This is also checked by dma_buf_dynamic_attach(), not in the common code, b=
ut
in the exporter's attach() method. For example, the attach method of 'amdgp=
u' calls p2pdma_distance_many and would disable p2p if dma_virt_ops is dete=
cted.

Here we could instead check the peer2peer flag from the returned 'attach' s=
tructure.
=20
> > +
