...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 57D22D46DA
	for <lists+linux-rdma@lfdr.de>; Fri, 11 Oct 2019 19:45:57 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728416AbfJKRp4 (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Fri, 11 Oct 2019 13:45:56 -0400
Received: from userp2120.oracle.com ([156.151.31.85]:60222 "EHLO
        userp2120.oracle.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1728374AbfJKRp4 (ORCPT
        <rfc822;linux-rdma@vger.kernel.org>); Fri, 11 Oct 2019 13:45:56 -0400
Received: from pps.filterd (userp2120.oracle.com [127.0.0.1])
        by userp2120.oracle.com (8.16.0.27/8.16.0.27) with SMTP id x9BHichm005289;
        Fri, 11 Oct 2019 17:44:39 GMT
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=oracle.com; h=content-type :
 mime-version : subject : from : in-reply-to : date : cc :
 content-transfer-encoding : message-id : references : to;
 s=corp-2019-08-05; bh=oTkc4XJukkRSvp8KrS5v4fS2CL4dAAL1pe6gWTAf5Fk=;
 b= ZA== 
Received: from aserp3030.oracle.com (aserp3030.oracle.com [141.146.126.71])
        by userp2120.oracle.com with ESMTP id 2vekts2wc5-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=OK);
        Fri, 11 Oct 2019 17:44:38 +0000
Received: from pps.filterd (aserp3030.oracle.com [127.0.0.1])
        by aserp3030.oracle.com (8.16.0.27/8.16.0.27) with SMTP id x9BHhZeb040969;
        Fri, 11 Oct 2019 17:44:14 GMT
Received: from userv0122.oracle.com (userv0122.oracle.com [156.151.31.75])
        by aserp3030.oracle.com with ESMTP id 2vjdymeby9-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=OK);
        Fri, 11 Oct 2019 17:44:14 +0000
Received: from abhmp0004.oracle.com (abhmp0004.oracle.com [141.146.116.10])
        by userv0122.oracle.com (8.14.4/8.14.4) with ESMTP id x9BHiDbx003359;
        Fri, 11 Oct 2019 17:44:13 GMT
Received: from anon-dhcp-153.1015granger.net (/68.61.232.219)
        by default (Oracle Beehive Gateway v4.0)
        with ESMTP ; Fri, 11 Oct 2019 10:44:12 -0700
...
Message-Id: <AFA11C46-9CA3-4B34-921C-1E11EECA4743@oracle.com>
...
X-Proofpoint-Spam-Details: rule=notspam policy=default score=0 suspectscore=2 malwarescore=0
 ...
 engine=8.0.1-1908290000 definitions=main-1910110151
X-Proofpoint-Virus-Version: vendor=nai engine=6000 definitions=9407 signatures=668684
X-Proofpoint-Spam-Details: rule=notspam policy=default score=0 priorityscore=1501 malwarescore=0
 suspectscore=2 phishscore=0 bulkscore=0 spamscore=0 clxscore=1015
 lowpriorityscore=0 mlxscore=0 impostorscore=0 mlxlogscore=999 adultscore=0
 classifier=spam adjust=0 reason=mlx scancount=1 engine=8.0.1-1908290000
 definitions=main-1910110151
...
> On Oct 11, 2019, at 1:38 PM, Chuck Lever <chuck.lever@oracle.com> =
wrote:
>=20
>=20
>=20
...
>>>=20
>>> 	return completed;
>>> @@ -131,8 +136,10 @@ static int ib_poll_handler(struct irq_poll =
*iop, int
>>> budget)
...
>>> }
>>>=20
>>> @@ -239,6 +248,7 @@ struct ib_cq *__ib_alloc_cq_user(struct =
ib_device *dev,
>>> void *private,
>>> 		goto out_destroy_cq;
>>> 	}
...
>>> +	ktime_t timestamp;
>>> +	bool interrupt;
>> Its unclear when to update timestamp and interrupt. Comment will =
help.
>=20
