Date:   Sun, 10 Apr 2022 21:12:54 +0800
Message-ID: <CAHj4cs_v-T-sioz234iNS4OLDWqO-kA1ss3NWzjuauS=kgwPjA@mail.gmail.com>
...
>
>
> =E5=9C=A8 2022/4/9 22:00, Yanjun Zhu =E5=86=99=E9=81=93:
> >
> > =E5=9C=A8 2022/4/9 20:13, Yanjun Zhu =E5=86=99=E9=81=93:
> >> =E5=9C=A8 2022/4/9 13:33, Yi Zhang =E5=86=99=E9=81=93:
> >>> Hi Yanjun
> >>>
...
> +               return 0;
> +       }
>          if (mr->type =3D=3D IB_MR_TYPE_DMA) {
>                  u8 *src, *dest;
>
...
> >>
> >> -       err =3D xa_alloc_cyclic(&pool->xa, &elem->index, elem, pool->l=
imit,
> >> -                             &pool->next, GFP_KERNEL);
> >> +       xa_lock_irqsave(&pool->xa, flags);
> >> +       err =3D __xa_alloc_cyclic(&pool->xa, &elem->index, elem,
> >> pool->limit,
> >> +                               &pool->next, GFP_KERNEL);
...
> >>  int __rxe_add_to_pool(struct rxe_pool *pool, struct rxe_pool_elem *el=
em)
> >>  {
> >>         int err;
> >> +       unsigned long flags;
...
> >>  {
> >>         struct rxe_pool_elem *elem =3D container_of(kref, typeof(*elem=
),
> >> ref_cnt);
...
> >>> [  155.724090] scsi_debug:sdebug_driver_probe: host protection DIF3 D=
IX3
> >>> [  155.724098] scsi host15: scsi_debug: version 0191 [20210520]
> >>>                   dev_size_mb=3D32, opts=3D0x0, submit_queues=3D1,
> >>> statistics=3D0
...
> >>> [  155.736235] sd 15:0:0:0: [sdb] 65536 512-byte logical blocks: (33.=
6
> >>> MB/32.0 MiB)
...
> >>> 4294967288
> >>> [  156.996061] ib_srpt:srpt_add_one: ib_srpt device =3D 00000000b38bf=
f2d
...
> >>> id_ext=3Df2d4e2fffee6e1e0,ioc_guid=3Df2d4e2fffee6e1e0,pkey=3Dffff,ser=
vice_id=3Df2d4e2fffee6e1e0
> >>>
> >>> [  156.996450] ib_srpt:srpt_add_one: ib_srpt added eno1_rxe.
> >>> [  156.996460] ib_srpt:srpt_add_one: ib_srpt device =3D 000000000c435=
da2
...
> >>> [  157.001659] ib_srpt:srpt_add_one: ib_srpt device =3D 00000000a6176=
9b4
...
> >>> [  157.006823] ib_srpt:srpt_add_one: ib_srpt device =3D 000000008f723=
49b
...
> >>> 10.16.221.116:5555
> >>> [  160.489971] ib_srp:add_target_store: ib_srp: max_sectors =3D 1024;
> >>> max_pages_per_mr =3D 512; mr_page_size =3D 4096; max_sectors_per_mr =
=3D
> >>> 4096; mr_per_cmd =3D 2
> >>> [  160.489978] ib_srp:srp_max_it_iu_len: ib_srp: max_iu_len =3D 8260
> >>> [  160.499158] ------------[ cut here ]------------
...
> >>> iTCO_vendor_support mgag200 skx_edac i2c_algo_bit x86_pkg_temp_therma=
l
...
> >>> c0 75 9d <0f> 0b eb 99 e8 00 79 3b 00 eb 9a 48 89 ef e8 86 0a 16 00 e=
b
> >>> a3 48
...
> >>> 00 0f 05 <48> 3d 00 f0 ff ff 77 58 c3 0f 1f 80 00 00 00 00 41 54 49 8=
9
> >>> d4 55
...
> >>>
> >>> [  161.058297] =3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=
...
> >>> [  161.278009]
> >>>                 stack backtrace:
> >>> [  161.282368] CPU: 25 PID: 163 Comm: ksoftirqd/25 Tainted: G S      =
W
...
> >>>
> >>>
> >>> On Sat, Apr 9, 2022 at 11:27 AM Yanjun Zhu <yanjun.zhu@linux.dev> wro=
te:
> >>>>
> >>>> =E5=9C=A8 2022/4/8 17:10, Yi Zhang =E5=86=99=E9=81=93:
...
> >>>>>>
> >>>>>> The link is
> >>>>>> https://patchwork.kernel.org/project/linux-rdma/patch/202202151944=
48.44369-1-rpearsonhpe@gmail.com/
> >>>>>>
> >>>>>>
> >>>>> Hi Yanjun
...
> >>>>                   *** DEADLOCK ***
> >>>>
> >>>> I disable softirq in the function __rxe_add_to_pool. Please make tes=
ts
> >>>> with the following.
...
> >>>>
> >>>> +       local_bh_disable();
> >>>>           err =3D xa_alloc_cyclic(&pool->xa, &elem->index, elem,
> >>>> pool->limit,
> >>>>                                 &pool->next, GFP_KERNEL);
> >>>> -       if (err)
> >>>> +       if (err) {
...
> >>>>>>> Hello
> >>>>>>>
> >>>>>>> Below WARNING triggered during blktests srp/ tests with 5.18.0-rc=
1
...
> >>>>>>> 0.3.0 loaded
> >>>>>>> [  291.262990] device-mapper: table: 253:3: multipath: error gett=
ing
> >>>>>>> device (-EBUSY)
...
> >>>>>>>                     dev_size_mb=3D32, opts=3D0x0, submit_queues=
=3D1,
> >>>>>>> statistics=3D0
...
> >>>>>>> [  291.846049] sd 15:0:0:0: [sdb] Write cache: enabled, read cach=
e:
> >>>>>>> enabled, supports DPO and FUA
> >>>>>>> [  291.846254] sd 15:0:0:0: [sdb] Optimal transfer size 524288 by=
tes
...
> >>>>>>> to 4294967288
> >>>>>>> [  293.102261] ib_srpt:srpt_add_one: ib_srpt device =3D
> >>>>>>> 0000000047a39f45
> >>>>>>> [  293.102363] ib_srpt:srpt_use_srq: ib_srpt srpt_use_srq(eno1_rx=
e):
> >>>>>>> use_srq =3D 0; ret =3D 0
> >>>>>>> [  293.102369] ib_srpt:srpt_add_one: ib_srpt Target login info:
> >>>>>>> id_ext=3Df2d4e2fffee6e1e0,ioc_guid=3Df2d4e2fffee6e1e0,pkey=3Dffff=
,service_id=3Df2d4e2fffee6e1e0
> >>>>>>>
> >>>>>>> [  293.102680] ib_srpt:srpt_add_one: ib_srpt added eno1_rxe.
> >>>>>>> [  293.102692] ib_srpt:srpt_add_one: ib_srpt device =3D
> >>>>>>> 00000000b2dfcbe9
> >>>>>>> [  293.102725] ib_srpt:srpt_use_srq: ib_srpt srpt_use_srq(eno2_rx=
e):
> >>>>>>> use_srq =3D 0; ret =3D 0
...
> >>>>>>> [  293.107893] ib_srpt:srpt_add_one: ib_srpt device =3D
> >>>>>>> 0000000061e03247
> >>>>>>> [  293.107922] ib_srpt:srpt_use_srq: ib_srpt srpt_use_srq(eno3_rx=
e):
> >>>>>>> use_srq =3D 0; ret =3D 0
...
> >>>>>>> [  293.113046] ib_srpt:srpt_add_one: ib_srpt device =3D
> >>>>>>> 00000000c0e3d43d
> >>>>>>> [  293.113081] ib_srpt:srpt_use_srq: ib_srpt srpt_use_srq(eno4_rx=
e):
> >>>>>>> use_srq =3D 0; ret =3D 0
...
> >>>>>>> 18446744073709551615 / 4096 =3D 4503599627370495 <> 512
> >>>>>>> [  296.450783] ib_srp:srp_add_one: ib_srp: eno1_rxe: mr_page_shif=
t =3D
> >>>>>>> 12, device->max_mr_size =3D 0xffffffffffffffff,
> >>>>>>> device->max_fast_reg_page_list_len =3D 512, max_pages_per_mr =3D =
512,
> >>>>>>> mr_max_size =3D 0x200000
> >>>>>>> [  296.451222] ib_srp:srp_add_one: ib_srp: srp_add_one:
> >>>>>>> 18446744073709551615 / 4096 =3D 4503599627370495 <> 512
> >>>>>>> [  296.451229] ib_srp:srp_add_one: ib_srp: eno2_rxe: mr_page_shif=
t =3D
> >>>>>>> 12, device->max_mr_size =3D 0xffffffffffffffff,
> >>>>>>> device->max_fast_reg_page_list_len =3D 512, max_pages_per_mr =3D =
512,
...
> >>>>>>> 18446744073709551615 / 4096 =3D 4503599627370495 <> 512
> >>>>>>> [  296.451523] ib_srp:srp_add_one: ib_srp: eno3_rxe: mr_page_shif=
t =3D
> >>>>>>> 12, device->max_mr_size =3D 0xffffffffffffffff,
> >>>>>>> device->max_fast_reg_page_list_len =3D 512, max_pages_per_mr =3D =
512,
...
> >>>>>>> 18446744073709551615 / 4096 =3D 4503599627370495 <> 512
> >>>>>>> [  296.451774] ib_srp:srp_add_one: ib_srp: eno4_rxe: mr_page_shif=
t =3D
> >>>>>>> 12, device->max_mr_size =3D 0xffffffffffffffff,
> >>>>>>> device->max_fast_reg_page_list_len =3D 512, max_pages_per_mr =3D =
512,
...
> >>>>>>> 10.16.221.116:5555
> >>>>>>> [  296.606014] ib_srp:add_target_store: ib_srp: max_sectors =3D 1=
024;
> >>>>>>> max_pages_per_mr =3D 512; mr_page_size =3D 4096; max_sectors_per_=
mr =3D
> >>>>>>> 4096; mr_per_cmd =3D 2
> >>>>>>> [  296.606021] ib_srp:srp_max_it_iu_len: ib_srp: max_iu_len =3D 8=
260
> >>>>>>>
> >>>>>>> [  296.616660] =3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=
=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D
> >>>>>>> [  296.620931] WARNING: inconsistent lock state
> >>>>>>> [  296.625207] 5.18.0-rc1 #1 Tainted: G S        I
> >>>>>>> [  296.630259] --------------------------------
> >>>>>>> [  296.634531] inconsistent {SOFTIRQ-ON-W} -> {IN-SOFTIRQ-W} usag=
e.
...
> >>>>>>> [  296.835686] CPU: 30 PID: 188 Comm: ksoftirqd/30 Tainted: G S
> >>>>>>> I       5.18.0-rc1 #1
> >>>>>>> [  296.843859] Hardware name: Dell Inc. PowerEdge R640/06NR82, BI=
OS
> >>>>>>> 2.11.2 004/21/2021
> >>>>>>> [  296.851509] Call Trace:
> >>>>>>> [  296.853964]  <TASK>
