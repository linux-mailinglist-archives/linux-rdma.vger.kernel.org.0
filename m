Return-Path: <linux-rdma+bounces-22525-lists+linux-rdma=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-rdma@lfdr.de
Received: from mail.lfdr.de
	by mail.lfdr.de with LMTP
	id G3/WAbL5P2qhawkAu9opvQ
	(envelope-from <linux-rdma+bounces-22525-lists+linux-rdma=lfdr.de@vger.kernel.org>)
	for <lists+linux-rdma@lfdr.de>; Sat, 27 Jun 2026 18:26:26 +0200
X-Original-To: lists+linux-rdma@lfdr.de
Received: from sin.lore.kernel.org (sin.lore.kernel.org [IPv6:2600:3c15:e001:75::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id 98C956D2426
	for <lists+linux-rdma@lfdr.de>; Sat, 27 Jun 2026 18:26:24 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=pass header.d=cornelisnetworks.com header.s=selector1 header.b="N8M/qrkv";
	spf=pass (mail.lfdr.de: domain of "linux-rdma+bounces-22525-lists+linux-rdma=lfdr.de@vger.kernel.org" designates 2600:3c15:e001:75::12fc:5321 as permitted sender) smtp.mailfrom="linux-rdma+bounces-22525-lists+linux-rdma=lfdr.de@vger.kernel.org";
	dmarc=pass (policy=none) header.from=cornelisnetworks.com;
	arc=reject ("cv is fail on i=2")
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sin.lore.kernel.org (Postfix) with ESMTP id 50EEC30074E3
	for <lists+linux-rdma@lfdr.de>; Sat, 27 Jun 2026 16:26:21 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 13DB82EEE7E;
	Sat, 27 Jun 2026 16:26:18 +0000 (UTC)
...
Received: from BL2PR02CU003.outbound.protection.outlook.com (mail-eastusazon11021090.outbound.protection.outlook.com [52.101.52.90])
	...
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 3A9AF23AB87
	for <linux-rdma@vger.kernel.org>; Sat, 27 Jun 2026 16:26:12 +0000 (UTC)
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1782577577; cv=fail; b=B9e1cy1v5hA4QN1s7AndgHVxkJw9MsP8DSF7Xxh2GhWGfExNI/x/Tjb7Sa3fKPXmRtdSoVzRnLyefCyV+6CANaNrmtNa+yXbeiFLdSIq7qYFwNLeNviCxLVkY03UA6EYOV+RvPY1iNM06KMZJzHzYfvb1RZe8ks+suzfkk6ngg0=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1782577577; c=relaxed/simple;
	bh=++UwbC/jCMn1Hb2nAVsq9K1IzmBHVdRB2E0Z+/SDQV8=;
	h=Subject:From:To:Cc:Date:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=Eq8OcbdhoLD2x/ThpfiaPKyraHgxwguZCIDLJgXhipzBVtJO/pHtnqbUyTOEdg5PrVaLrgVVemZq5gev/DQ9w2F5IqMSAeizmK9k33ERo+JjqLNCBbDlu9n+uHWQz0L2RPX4o1D1AWQhzfoqNT8bKVFITywbMUSVdJaYygeoQvk=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=cornelisnetworks.com; spf=pass smtp.mailfrom=cornelisnetworks.com; dkim=pass (2048-bit key) header.d=cornelisnetworks.com header.i=@cornelisnetworks.com header.b=N8M/qrkv; arc=fail smtp.client-ip=52.101.52.90
ARC-Seal: i=1; a=rsa-sha256; s=arcselector10001; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com;
 s=arcselector10001;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-AntiSpam-MessageData-ChunkCount:X-MS-Exchange-AntiSpam-MessageData-0:X-MS-Exchange-AntiSpam-MessageData-1;
 bh=Eta+m16g4Rb1xlzRlWTNB6ZujrQsMDWb5GCYKlhl99U=;
 b=
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=cornelisnetworks.com;
 ...
 bh=Eta+m16g4Rb1xlzRlWTNB6ZujrQsMDWb5GCYKlhl99U=;
 b=
Received: from IA4P220CA0006.NAMP220.PROD.OUTLOOK.COM (2603:10b6:208:558::7)
 by SA6PR01MB8974.prod.exchangelabs.com (2603:10b6:806:42e::18) with Microsoft
 SMTP Server (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.21.159.18; Sat, 27 Jun 2026 16:26:06 +0000
Received: from BL6PEPF00022574.namprd02.prod.outlook.com
 (2603:10b6:208:558:cafe::6a) by IA4P220CA0006.outlook.office365.com
...
Received: from cn-mailer-00.localdomain (208.255.156.42) by
 ...
 via Frontend Transport; Sat, 27 Jun 2026 16:26:05 +0000
Received: from awdrv-04.localdomain (unknown [10.228.212.218])
	by cn-mailer-00.localdomain (Postfix) with ESMTPS id 454CA146565;
	Sat, 27 Jun 2026 12:26:05 -0400 (EDT)
Received: from [10.228.212.218] (localhost [IPv6:::1])
	by awdrv-04.localdomain (Postfix) with ESMTP id 402371810D6C7;
	Sat, 27 Jun 2026 12:26:05 -0400 (EDT)
Subject: [PATCH v2 for-next 14/24] RDMA/hfi2: Add PIO send infrastructure
From: Dennis Dalessandro <dennis.dalessandro@cornelisnetworks.com>
To: jgg@ziepe.ca, leon@kernel.org
Cc: Dean Luick <dean.luick@cornelisnetworks.com>,
 Breandan Cunningham <brendan.cunningham@cornelisnetworks.com>,
 Douglas Miller <doug.miller@cornelisnetworks.com>, linux-rdma@vger.kernel.org
Date: Sat, 27 Jun 2026 12:26:05 -0400
Message-ID: <178257756522.371918.11124299025806049918.stgit@awdrv-04>
...
X-MS-TrafficTypeDiagnostic: BL6PEPF00022574:EE_|SA6PR01MB8974:EE_
X-MS-Office365-Filtering-Correlation-Id: cf7b7aac-3fb4-4ef3-77a6-08ded468c97d
X-MS-Exchange-AtpMessageProperties: SA
X-MS-Exchange-SenderADCheck: 1
X-MS-Exchange-AntiSpam-Relay: 0
X-Microsoft-Antispam:
	BCL:0;ARA:13230040|1800799024|82310400026|36860700016|23010399003|376014|18002099003|22082099003|20052099010|55112099003|5023799004|56012099006|6133799003|3023799007;
X-Microsoft-Antispam-Message-Info:
	
X-Forefront-Antispam-Report:
	CIP:208.255.156.42;CTRY:US;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:cn-mailer-00.localdomain;PTR:InfoDomainNonexistent;CAT:NONE;SFS:(13230040)(1800799024)(82310400026)(36860700016)(23010399003)(376014)(18002099003)(22082099003)(20052099010)(55112099003)(5023799004)(56012099006)(6133799003)(3023799007);DIR:OUT;SFP:1102;
X-MS-Exchange-AntiSpam-MessageData-ChunkCount: 1
X-MS-Exchange-AntiSpam-MessageData-0:
	
X-OriginatorOrg: cornelisnetworks.com
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 27 Jun 2026 16:26:05.4598
 (UTC)
X-MS-Exchange-CrossTenant-Network-Message-Id: cf7b7aac-3fb4-4ef3-77a6-08ded468c97d
...
X-MS-Exchange-Transport-CrossTenantHeadersStamped: SA6PR01MB8974
...
X-Spamd-Result: default: False [0.34 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	TO_DN_SOME(0.00)[];
	TAGGED_FROM(0.00)[bounces-22525-lists,linux-rdma=lfdr.de];
	RCVD_TLS_LAST(0.00)[];
	MIME_TRACE(0.00)[0:+];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[cornelisnetworks.com:dkim,cornelisnetworks.com:email,cornelisnetworks.com:from_mime,awdrv-04:mid,vger.kernel.org:from_smtp,sin.lore.kernel.org:rdns,sin.lore.kernel.org:helo];
...
---
  Changes since v1:
    - Address Arnd Bergmann's feedback (Re: hfi2 v1, Mar 23 2026):
      pio_copy() and the seg_pio_copy_*() helpers now use
      writeq_relaxed() in their tight MMIO loops instead of writeq().
      writeq() emits a full barrier on every call (especially costly
      on arm64), which is unnecessary for the inner loop. A single
      trailing wmb() in pio_copy() and seg_pio_copy_end() provides
      the required ordering before the device is allowed to consume
      the buffer.
    - Address Leon's feedback (Re: v1 patch 07, Mar 17 2026): replace
      the references to node_affinity.num_possible_nodes in
      init_credit_return() and free_credit_return() with the kernel
      helper num_possible_nodes(); the affinity-policy state struct
      is no longer maintained by the driver.
---
...
index 000000000000..29fd8b86362e
--- /dev/null
...
+ */
+void hfi2_wfr_set_pio_integrity(struct hfi2_devdata *dd, u32 pidx, u32 hw_context,
...
+			(u64)-1);
+
+	hfi2_priv_reg_op(dd, ppd->hw_pidx, hw_context, type, SC_CHK_ALLOC_OP, reg);
+
...
+		thresh = hfi2_sc_percent_to_threshold(sc,
+						 hfi2_user_credit_return_threshold);
+	} else { /* kernel */
+		thresh =
+			min(hfi2_sc_percent_to_threshold(sc, 50),
+			    hfi2_sc_mtu_to_threshold(sc, hfi2_max_mtu, hdrqentsize));
+	}
...
+				(u32)reg);
+			hfi2_priv_reg_op(dd, ppd->hw_pidx, 0, 0, LINK_BOUNCE_OP, 0);
+			break;
+		}
+		loop++;
+		mdelay(1);
...
+
+	ret = hfi2_priv_reg_op(dd, 0, sc->hw_context, sc->type, SC_ENABLE_OP, 0);
+	if (ret)
+		goto unlock;
+
+	sc->flags |= SCF_ENABLED;
...
+
+	/* build new map */
+	newmap = kzalloc(struct_size(newmap, map, roundup_pow_of_two(hfi2_num_vls)),
+			 GFP_KERNEL);
+	if (!newmap)
+		goto bail;
...
+}
+
+void hfi2_seqfile_dump_sci(struct seq_file *s, u32 i, struct send_context_info *sci)
+{
...
new file mode 100644
index 000000000000..41797fc3136e
--- /dev/null
