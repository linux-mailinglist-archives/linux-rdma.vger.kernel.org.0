...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 0598A2AA90
	for <lists+linux-rdma@lfdr.de>; Sun, 26 May 2019 18:03:14 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726875AbfEZQDN convert rfc822-to-8bit (ORCPT
        <rfc822;lists+linux-rdma@lfdr.de>); Sun, 26 May 2019 12:03:13 -0400
Received: from mx0a-001b2d01.pphosted.com ([148.163.156.1]:58086 "EHLO
        mx0a-001b2d01.pphosted.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1726759AbfEZQDN (ORCPT
        <rfc822;linux-rdma@vger.kernel.org>);
        Sun, 26 May 2019 12:03:13 -0400
Received: from pps.filterd (m0098396.ppops.net [127.0.0.1])
        by mx0a-001b2d01.pphosted.com (8.16.0.27/8.16.0.27) with SMTP id x4QG217w057211
        for <linux-rdma@vger.kernel.org>; Sun, 26 May 2019 12:03:11 -0400
Received: from smtp.notes.na.collabserv.com (smtp.notes.na.collabserv.com [192.155.248.73])
        by mx0a-001b2d01.pphosted.com with ESMTP id 2sqk7c7ep2-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT)
        for <linux-rdma@vger.kernel.org>; Sun, 26 May 2019 12:03:11 -0400
Received: from localhost
        by smtp.notes.na.collabserv.com with smtp.notes.na.collabserv.com ESMTP
        for <linux-rdma@vger.kernel.org> from <BMT@zurich.ibm.com>;
        Sun, 26 May 2019 16:03:11 -0000
Received: from us1a3-smtp01.a3.dal06.isc4sb.com (10.106.154.95)
        ...
        Sun, 26 May 2019 16:03:07 -0000
Received: from us1a3-mail162.a3.dal06.isc4sb.com ([10.146.71.4])
          by us1a3-smtp01.a3.dal06.isc4sb.com
          with ESMTP id 2019052616030704-373639 ;
          Sun, 26 May 2019 16:03:07 +0000 
...
Date:   Sun, 26 May 2019 16:03:07 +0000
MIME-Version: 1.0
Sensitivity: 
Importance: Normal
X-Priority: 3 (Normal)
...
x-cbid: 19052616-3107-0000-0000-00000B6437B1
X-IBM-SpamModules-Scores: BY=0; FL=0; FP=0; FZ=0; HX=0; KW=0; PH=0;
 SC=0.40962; ST=0; TS=0; UL=0; ISC=; MB=0.041724
X-IBM-SpamModules-Versions: BY=3.00011167; HX=3.00000242; KW=3.00000007;
 PH=3.00000004; SC=3.00000286; SDB=6.01208920; UDB=6.00635018; IPR=6.00989924;
 ...
 UTC=2019-05-26 16:03:10
X-IBM-AV-DETECTION: SAVI=unsuspicious REMOTE=unsuspicious XFE=unused
X-IBM-AV-VERSION: SAVI=2019-05-26 13:23:17 - 6.00009971
x-cbparentid: 19052616-3108-0000-0000-00006C223978
Message-Id: <OFBA1429B1.5C6C5E72-ON00258406.00582D3D-00258406.00582D43@notes.na.collabserv.com>
...
Sorry, somewhat did put an 'EXTERNAL' blah into the
subject of your comment. Awesome. 

I'll try to avoid that subject changes in the future.
Sorry about that.

So, yes, SOFT-IWARP is the name of the thing
and bmt is reachable at zurich.ibm.com 
