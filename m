...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 298061179C5
	for <lists+linux-rdma@lfdr.de>; Mon,  9 Dec 2019 23:50:34 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727223AbfLIWuD (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Mon, 9 Dec 2019 17:50:03 -0500
Received: from mga12.intel.com ([192.55.52.136]:33717 "EHLO mga12.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1727183AbfLIWt6 (ORCPT <rfc822;linux-rdma@vger.kernel.org>);
        Mon, 9 Dec 2019 17:49:58 -0500
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
  by fmsmga106.fm.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384; 09 Dec 2019 14:49:46 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.69,296,1571727600"; 
   d="scan'208";a="237912360"
Received: from jtkirshe-desk1.jf.intel.com ([134.134.177.74])
  by fmsmga004.fm.intel.com with ESMTP; 09 Dec 2019 14:49:46 -0800
...
Subject: [PATCH v3 16/20] RDMA/irdma: Add miscellaneous utility definitions
Date:   Mon,  9 Dec 2019 14:49:31 -0800
Message-Id: <20191209224935.1780117-17-jeffrey.t.kirsher@intel.com>
...
---
 ...
 4 files changed, 2673 insertions(+)
...
index 000000000000..c02e33f2fa03
--- /dev/null
...
new file mode 100644
index 000000000000..c9e5ef758acc
--- /dev/null
...
new file mode 100644
index 000000000000..c755680f1b98
--- /dev/null
...
+		goto error;
+
+	dev_info(rfdev_to_dev(dev), "PRINT CONTXT QP [%d]\n", info->qp_id);
+	{
+		u32 i, j;
+
