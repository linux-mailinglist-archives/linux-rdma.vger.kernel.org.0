Return-Path: <linux-rdma+bounces-20657-lists+linux-rdma=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-rdma@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id UCblNTxsBWo+WwIAu9opvQ
	(envelope-from <linux-rdma+bounces-20657-lists+linux-rdma=lfdr.de@vger.kernel.org>)
	for <lists+linux-rdma@lfdr.de>; Thu, 14 May 2026 08:31:24 +0200
X-Original-To: lists+linux-rdma@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [IPv6:2600:3c0a:e001:db::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id 65E5053E569
	for <lists+linux-rdma@lfdr.de>; Thu, 14 May 2026 08:31:23 +0200 (CEST)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id 1A028308DBA5
	for <lists+linux-rdma@lfdr.de>; Thu, 14 May 2026 06:27:06 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 638F33CAE83;
	Thu, 14 May 2026 06:27:03 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=marvell.com header.i=@marvell.com header.b="hysBkBFd"
X-Original-To: linux-rdma@vger.kernel.org
Received: from mx0a-0016f401.pphosted.com (mx0a-0016f401.pphosted.com [67.231.148.174])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 979173C5523;
	Thu, 14 May 2026 06:27:00 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=67.231.148.174
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1778740022; cv=none; b=u9tIZ3gkvy+/wP7lTbEGm8c0DENTfBnVF5YL/FgfucOgLMqIfIgNDj+yvi9V1B1k7TdVpBL2vG3zSVawRyLk9Xi35sGESpDjKQozcxpz8Loumc9/BPezeD9hSIgCcTcMSv5QA1yQL3ku0wVgQT5xnjoPJ8++Zo4zKi0gLy/OB9w=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1778740022; c=relaxed/simple;
	bh=WbI4K4khY0OIbAGch017QFE87aAlex4Qx2ZH6EBPVRU=;
	h=From:To:CC:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=JCOAUbpUAmnAr69D+WqLvsbm+MZs8+wXG/w2kbBlEv2VuKhGJqMU7Sla02VCZ9labKpZXsSNmritcd11sggyCQ5LlOPwNAfsXbp24b/sMXpG7ZjRqx4d1QpJvkn+XNutbpvS4FQKTuA9vn5bUGCiYyqPaRqwacYeYj9ue1ErLIk=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=marvell.com; spf=pass smtp.mailfrom=marvell.com; dkim=pass (2048-bit key) header.d=marvell.com header.i=@marvell.com header.b=hysBkBFd; arc=none smtp.client-ip=67.231.148.174
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=marvell.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=marvell.com
Received: from pps.filterd (m0431384.ppops.net [127.0.0.1])
	by mx0a-0016f401.pphosted.com (8.18.1.11/8.18.1.11) with ESMTP id 64E21t2u2549028;
	Wed, 13 May 2026 23:26:40 -0700
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=marvell.com; h=
	cc:content-transfer-encoding:content-type:date:from:in-reply-to
	:message-id:mime-version:references:subject:to; s=pfpt0220; bh=A
	CrAc+pcgw/6gencDbDwvuENHRu2u+5PxBW9xYVTCRI=; b=hysBkBFdhIB3bnh73
	
Received: from dc5-exch05.marvell.com ([199.233.59.128])
	by mx0a-0016f401.pphosted.com (PPS) with ESMTPS id 4e45ybe4ae-1
	(version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
	Wed, 13 May 2026 23:26:40 -0700 (PDT)
Received: from DC5-EXCH05.marvell.com (10.69.176.209) by
 DC5-EXCH05.marvell.com (10.69.176.209) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.2.1544.25; Wed, 13 May 2026 23:26:39 -0700
Received: from maili.marvell.com (10.69.176.80) by DC5-EXCH05.marvell.com
 (10.69.176.209) with Microsoft SMTP Server id 15.2.1544.25 via Frontend
 Transport; Wed, 13 May 2026 23:26:39 -0700
Received: from rkannoth-OptiPlex-7090.. (unknown [10.28.36.165])
	by maili.marvell.com (Postfix) with ESMTP id 559D55B6942;
	Wed, 13 May 2026 23:26:31 -0700 (PDT)
...
Subject: [PATCH v14 net-next 5/9] octeontx2-af: npc: cn20k: add subbank search order control
Date: Thu, 14 May 2026 11:55:33 +0530
Message-ID: <20260514062537.3813802-6-rkannoth@marvell.com>
...
X-Proofpoint-GUID: YYQXDNFmgN42eJhC5NmjcNMpOz1Ns3pN
X-Proofpoint-ORIG-GUID: YYQXDNFmgN42eJhC5NmjcNMpOz1Ns3pN
X-Proofpoint-Spam-Details-Enc: AW1haW4tMjYwNTE0MDA2MCBTYWx0ZWRfX+A3Fk8HP3E4w
 
X-Authority-Analysis: v=2.4 cv=ZtTd7d7G c=1 sm=1 tr=0 ts=6a056b20 cx=c_pps
 a=rEv8fa4AjpPjGxpoe8rlIQ==:117 a=rEv8fa4AjpPjGxpoe8rlIQ==:17
 a=NGcC8JguVDcA:10 a=VkNPw1HP01LnGYTKEx00:22 a=l0iWHRpgs5sLHlkKQ1IR:22
 a=TtqV-g6YmW1Jfm2GSLaY:22 a=M5GUcnROAAAA:8 a=xtqk7LRRSWtFqS1o7J8A:9
 a=OBjm3rFKGHvpk9ecZwUJ:22
X-Proofpoint-Virus-Version: vendor=baseguard
 engine=ICAP:2.0.293,Aquarius:18.0.1143,Hydra:6.1.51,FMLib:17.12.100.49
 definitions=2026-05-14_01,2026-05-13_01,2025-10-01_01
X-Rspamd-Queue-Id: 65E5053E569
...
X-Spamd-Result: default: False [0.84 / 15.00];
	...
	MIME_TRACE(0.00)[0:+];
	TAGGED_FROM(0.00)[bounces-20657-lists,linux-rdma=lfdr.de];
...
---
 .../ethernet/marvell/octeontx2/af/cn20k/npc.c | 66 ++++++++++++-
...
index e9aad0ad3fa6..7504d6f1ce16 100644
...
+	subbank_srch_order = kcalloc(cnt, sizeof(u32),
 	...
 	if (!subbank_srch_order)
 		return -ENOMEM;
@@ -3906,6 +3906,68 @@ static void npc_unlock_all_subbank(void)
