...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 74AAB2B7279
	for <lists+linux-rdma@lfdr.de>; Wed, 18 Nov 2020 00:32:57 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1725814AbgKQXcU (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Tue, 17 Nov 2020 18:32:20 -0500
Received: from mga14.intel.com ([192.55.52.115]:3220 "EHLO mga14.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1725779AbgKQXcU (ORCPT <rfc822;linux-rdma@vger.kernel.org>);
        Tue, 17 Nov 2020 18:32:20 -0500
IronPort-SDR: ulbUjKJbs6721KE1QvJQXKiHg2JZp/Aao10xJQzqKYoQn47EDW8ZD2V+FI44HFJiYe+GRiiSRy
 nI+mTg7VhwGw==
X-IronPort-AV: E=McAfee;i="6000,8403,9808"; a="170251499"
X-IronPort-AV: E=Sophos;i="5.77,486,1596524400"; 
   d="scan'208";a="170251499"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga001.jf.intel.com ([10.7.209.18])
  by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 17 Nov 2020 15:32:19 -0800
IronPort-SDR: ONO0xNYf6065LPygVZUgAqDBFefpuvDOmFDhMavNvr3FtjSFGdaCnJLMzTWiqgD1k0OAEiv79j
 fyWq+kypKAWA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.77,486,1596524400"; 
   d="scan'208";a="400919821"
Received: from sedona.ch.intel.com ([10.2.136.157])
  by orsmga001.jf.intel.com with ESMTP; 17 Nov 2020 15:32:18 -0800
Received: from awfm-01.aw.intel.com (awfm-01.aw.intel.com [10.228.212.213])
        by sedona.ch.intel.com (8.14.3/8.14.3/Standard MailSET/Hub) with ESMTP id 0AHNWGlF041764;
        Tue, 17 Nov 2020 16:32:17 -0700
Received: from awfm-01.aw.intel.com (localhost [127.0.0.1])
        by awfm-01.aw.intel.com (8.14.7/8.14.7) with ESMTP id 0AHNWDtu010581;
        Tue, 17 Nov 2020 18:32:14 -0500
Subject: [PATCH for-rc v3] IB/hfi1: Move cached value of mm into handler
...
Date:   Tue, 17 Nov 2020 18:32:13 -0500
Message-ID: <20201117233213.10558.47108.stgit@awfm-01.aw.intel.com>
...
---
 ...
 drivers/infiniband/hw/hfi1/mmu_rb.c       |   39 ++++++++++++++++-------------
...
+	ret = mmu_notifier_register(&handlr->mn, current->mm);
 	if (ret) {
 		kfree(handlr);
 		return ret;
@@ -133,8 +121,11 @@ void hfi1_mmu_rb_unregister(struct mmu_rb_handler *handler)
 	unsigned long flags;
 	struct list_head del_list;
...
@@ -166,6 +157,10 @@ int hfi1_mmu_rb_insert(struct mmu_rb_handler *handler,
 	int ret = 0;
...
+
 	...
 	if (node) {
@@ -180,6 +175,7 @@ int hfi1_mmu_rb_insert(struct mmu_rb_handler *handler,
...
+	mnode->handler = handler;
 unlock:
 	...
 	return ret;
@@ -217,6 +213,9 @@ bool hfi1_mmu_rb_remove_unless_exact(struct mmu_rb_handler *handler,
 	unsigned long flags;
 	bool ret = false;
...
+
 	...
 	if (node) {
@@ -239,6 +238,9 @@ void hfi1_mmu_rb_evict(struct mmu_rb_handler *handler, void *evict_arg)
 	unsigned long flags;
 	bool stop = false;
...
+
 	...
 	spin_lock_irqsave(&handler->lock, flags);
@@ -272,6 +274,9 @@ void hfi1_mmu_rb_remove(struct mmu_rb_handler *handler,
 {
 	unsigned long flags;
