...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id A1B0C6080B8
	for <lists+linux-rdma@lfdr.de>; Fri, 21 Oct 2022 23:23:20 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229514AbiJUVXT (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Fri, 21 Oct 2022 17:23:19 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:56632 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229476AbiJUVXS (ORCPT
        <rfc822;linux-rdma@vger.kernel.org>); Fri, 21 Oct 2022 17:23:18 -0400
Received: from mga06.intel.com (mga06b.intel.com [134.134.136.31])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 7F28217E17
        for <linux-rdma@vger.kernel.org>; Fri, 21 Oct 2022 14:23:14 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1666387394; x=1697923394;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=HF9mHtMmq1LhRpR7FPWJCC2cM05fKSvpfagpJ+8xe6E=;
  b=Dr10gRkzo7mFFF2TbHk4WyF3VEHDMIpYQ7SuAnu+m0077hnjttaVzULe
   vOtzS+ZolT5o0OibQxqghRqOn28nzCo4uogDLwf6eSUnVH/XU4nNt/kof
   bn8udk1MgJooQ2UFGy+0gMeYv3kJNG/bLR5kxQM6MPUIg6He734FG1O42
   Z6uIsCJNkfrAQOdMaWsr0JZCDpJIAJ5oerv7M0LZXWsa3WyUkTE15xlcR
   MeNOpJC8+xeqfPexXHQ/ELa+U/qzj3QBUj5G5fxWYwSBztavEExGWM2dx
   A1ZrBK2RmNx3dxjTjX19YK8DplZ282UHUD9gNlb077HbFp6T1valD4KtH
   Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10507"; a="369172299"
X-IronPort-AV: E=Sophos;i="5.95,203,1661842800"; 
   d="scan'208";a="369172299"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
  by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 21 Oct 2022 14:23:13 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10507"; a="581752420"
X-IronPort-AV: E=Sophos;i="5.95,203,1661842800"; 
   d="scan'208";a="581752420"
Received: from lkp-server02.sh.intel.com (HELO b6d29c1a0365) ([10.239.97.151])
  by orsmga003.jf.intel.com with ESMTP; 21 Oct 2022 14:23:09 -0700
Received: from kbuild by b6d29c1a0365 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1olzTx-0002yp-0O;
        Fri, 21 Oct 2022 21:23:09 +0000
Date:   Sat, 22 Oct 2022 05:22:10 +0800
From:   kernel test robot <lkp@intel.com>
To:     Bob Pearson <rpearsonhpe@gmail.com>, jgg@nvidia.com,
        zyjzyj2000@gmail.com, leon@kernel.org, jhack@hpe.com,
...
Subject: Re: [PATCH for-next v2 10/18] RDMA/rxe: Handle qp error in rxe_resp.c
Message-ID: <202210220559.f7taTL8S-lkp@intel.com>
References: <20221021200118.2163-11-rpearsonhpe@gmail.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="fJc4QYK/Zt1oiAYj"
Content-Disposition: inline
In-Reply-To: <20221021200118.2163-11-rpearsonhpe@gmail.com>
...
[auto build test WARNING on 9abf2313adc1ca1b6180c508c25f22f9395cc780]

url:    https://github.com/intel-lab-lkp/linux/commits/Bob-Pearson/Implement-work-queues-for-rdma_rxe/20221022-040425
base:   9abf2313adc1ca1b6180c508c25f22f9395cc780
patch link:    https://lore.kernel.org/r/20221021200118.2163-11-rpearsonhpe%40gmail.com
patch subject: [PATCH for-next v2 10/18] RDMA/rxe: Handle qp error in rxe_resp.c
config: parisc-allyesconfig
compiler: hppa-linux-gcc (GCC) 12.1.0
reproduce (this is a W=1 build):
        wget https://raw.githubusercontent.com/intel/lkp-tests/master/sbin/make.cross -O ~/bin/make.cross
        chmod +x ~/bin/make.cross
        # https://github.com/intel-lab-lkp/linux/commit/89164294e45c7434c93b957bc31354f8057ed6b5
        git remote add linux-review https://github.com/intel-lab-lkp/linux
        git fetch --no-tags linux-review Bob-Pearson/Implement-work-queues-for-rdma_rxe/20221022-040425
        git checkout 89164294e45c7434c93b957bc31354f8057ed6b5
        # save the config file
        mkdir build_dir && cp config build_dir/.config
        COMPILER_INSTALL_PATH=$HOME/0day COMPILER=gcc-12.1.0 make.cross W=1 O=build_dir ARCH=parisc SHELL=/bin/bash drivers/infiniband/sw/rxe/
...
>> drivers/infiniband/sw/rxe/rxe_resp.c:1253:5: warning: no previous prototype for 'complete_flush' [-Wmissing-prototypes]
    1253 | int complete_flush(struct rxe_qp *qp, struct rxe_recv_wqe *wqe)
         |     ^~~~~~~~~~~~~~


vim +/complete_flush +1253 drivers/infiniband/sw/rxe/rxe_resp.c

  1252	
> 1253	int complete_flush(struct rxe_qp *qp, struct rxe_recv_wqe *wqe)
  1254	{
  1255		struct rxe_cqe cqe;
  1256		struct ib_wc *wc = &cqe.ibwc;
  1257		struct ib_uverbs_wc *uwc = &cqe.uibwc;
  1258	
  1259		memset(&cqe, 0, sizeof(cqe));
  1260	
  1261		if (qp->rcq->is_user) {
  1262			uwc->status		= IB_WC_WR_FLUSH_ERR;
  1263			uwc->qp_num		= qp->ibqp.qp_num;
  1264			uwc->wr_id		= wqe->wr_id;
  1265		} else {
  1266			wc->status		= IB_WC_WR_FLUSH_ERR;
  1267			wc->qp			= &qp->ibqp;
  1268			wc->wr_id		= wqe->wr_id;
  1269		}
  1270	
  1271		if (rxe_cq_post(qp->rcq, &cqe, 0))
  1272			return -ENOMEM;
  1273	
  1274		return 0;
  1275	}
