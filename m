...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 244191EB360
	for <lists+linux-rdma@lfdr.de>; Tue,  2 Jun 2020 04:34:42 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1725850AbgFBCed (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Mon, 1 Jun 2020 22:34:33 -0400
Received: from mga11.intel.com ([192.55.52.93]:33186 "EHLO mga11.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726380AbgFBCec (ORCPT <rfc822;linux-rdma@vger.kernel.org>);
        Mon, 1 Jun 2020 22:34:32 -0400
IronPort-SDR: VaWU2ekvetmvCEuTOtaOePlICoesMuMUTCEvKPAvC8tPSoUAKYTKJxpNrXrxgDvBM1Es167V7f
 Zfb5/YTDBdCQ==
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga007.jf.intel.com ([10.7.209.58])
  by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 01 Jun 2020 19:34:30 -0700
IronPort-SDR: H3DesGUOn7aE4g0iCGKSNyFXMawno6eZ8S+VuIWb3QHSzEq7DSrnoxogjm2DgknL1q8py5iif4
 VB4t6rp41wLw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.73,462,1583222400"; 
   d="scan'208";a="257460728"
Received: from lkp-server02.sh.intel.com (HELO c8e1d689ed63) ([10.239.97.151])
  by orsmga007.jf.intel.com with ESMTP; 01 Jun 2020 19:34:29 -0700
Received: from kbuild by c8e1d689ed63 with local (Exim 4.92)
        (envelope-from <lkp@intel.com>)
        id 1jfwl2-00008y-BM; Tue, 02 Jun 2020 02:34:28 +0000
Date:   Tue, 02 Jun 2020 10:34:21 +0800
From:   kbuild test robot <lkp@intel.com>
To:     Jason Gunthorpe <jgg@mellanox.com>
Cc:     linux-rdma@vger.kernel.org, Doug Ledford <dledford@redhat.com>
Subject: [rdma:for-next] BUILD SUCCESS
 70ae395550333607bda245db5270211b6ef8ab00
Message-ID: <5ed5baad.r6u9sYWg0389dnNP%lkp@intel.com>
...
branch HEAD: 70ae395550333607bda245db5270211b6ef8ab00  RDMA/hns: Uninitialized variable in modify_qp_init_to_rtr()
...
drivers/infiniband/core/cm.c:2063:12: sparse: sparse: context imbalance in 'cm_req_handler' - different lock contexts for basic block
...
drivers/infiniband/core/cm.c:2582:12: sparse: sparse: context imbalance in 'cm_rtu_handler' - different lock contexts for basic block
...
drivers/infiniband/core/cm.c:3380:12: sparse: sparse: context imbalance in 'cm_apr_handler' - different lock contexts for basic block
...
drivers/infiniband/core/cm.c:3425:12: sparse: sparse: context imbalance in 'cm_timewait_handler' - different lock contexts for basic block

Warning ids grouped by kconfigs:

recent_errors
|-- microblaze-randconfig-s032-20200601
...
`-- powerpc64-randconfig-s032-20200602
    |-- drivers-infiniband-core-cm.c:sparse:sparse:context-imbalance-in-cm_apr_handler-different-lock-contexts-for-basic-block
    |-- drivers-infiniband-core-cm.c:sparse:sparse:context-imbalance-in-cm_req_handler-different-lock-contexts-for-basic-block
    |-- drivers-infiniband-core-cm.c:sparse:sparse:context-imbalance-in-cm_rtu_handler-different-lock-contexts-for-basic-block
    `-- drivers-infiniband-core-cm.c:sparse:sparse:context-imbalance-in-cm_timewait_handler-different-lock-contexts-for-basic-block
...
| DELTA |               SYMBOL               |                                  COMMIT                                   |
+-------+------------------------------------+---------------------------------------------------------------------------+
|  +455 | TOTAL                              | 8f3d9f354286..70ae39555033 (ALL COMMITS)                                  |
