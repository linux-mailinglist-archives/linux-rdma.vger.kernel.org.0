...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 8D113621289
	for <lists+linux-rdma@lfdr.de>; Tue,  8 Nov 2022 14:39:57 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233988AbiKHNjy (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Tue, 8 Nov 2022 08:39:54 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:38240 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233936AbiKHNjw (ORCPT
        <rfc822;linux-rdma@vger.kernel.org>); Tue, 8 Nov 2022 08:39:52 -0500
Received: from szxga02-in.huawei.com (szxga02-in.huawei.com [45.249.212.188])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id EED1F9586;
        Tue,  8 Nov 2022 05:39:50 -0800 (PST)
Received: from dggemv711-chm.china.huawei.com (unknown [172.30.72.56])
        by szxga02-in.huawei.com (SkyGuard) with ESMTP id 4N68Mx2pL7zHvdV;
        Tue,  8 Nov 2022 21:39:25 +0800 (CST)
Received: from kwepemm600013.china.huawei.com (7.193.23.68) by
 dggemv711-chm.china.huawei.com (10.1.198.66) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2375.31; Tue, 8 Nov 2022 21:39:49 +0800
...
Subject: [PATCH v3 for-rc 2/2] RDMA/hns: Fix the problem of sge nums
Date:   Tue, 8 Nov 2022 21:38:47 +0800
Message-ID: <20221108133847.2304539-3-xuhaoyue1@hisilicon.com>
...
2) When the sge space is enough to accommodate inline data, the upper limit
of inline data can be increased so that users can send larger inline data

Currently case one is not implemented. When the inline data is larger than
the sge space, an error of insufficient sge space occurs.
This part of the code needs to be reimplemented according to the expected
rules. The calculation method of sge num is modified to take the maximum
value of max_send_sge and the sge for max_inline_data to solve this problem.
