Return-Path: <linux-rdma+bounces-22984-lists+linux-rdma=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-rdma@lfdr.de
Received: from mail.lfdr.de
	by mail.lfdr.de with LMTP
	id ctZaNUZoUGqAyQIAu9opvQ
	(envelope-from <linux-rdma+bounces-22984-lists+linux-rdma=lfdr.de@vger.kernel.org>)
	for <lists+linux-rdma@lfdr.de>; Fri, 10 Jul 2026 05:34:30 +0200
X-Original-To: lists+linux-rdma@lfdr.de
Received: from tor.lore.kernel.org (tor.lore.kernel.org [IPv6:2600:3c04:e001:36c::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id 6309E737011
	for <lists+linux-rdma@lfdr.de>; Fri, 10 Jul 2026 05:34:30 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=pass header.d=linux.alibaba.com header.s=default header.b="IuA/y8GB";
	dmarc=pass (policy=none) header.from=linux.alibaba.com;
	spf=pass (mail.lfdr.de: domain of "linux-rdma+bounces-22984-lists+linux-rdma=lfdr.de@vger.kernel.org" designates 2600:3c04:e001:36c::12fc:5321 as permitted sender) smtp.mailfrom="linux-rdma+bounces-22984-lists+linux-rdma=lfdr.de@vger.kernel.org";
	arc=pass ("subspace.kernel.org:s=arc-20240116:i=1")
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by tor.lore.kernel.org (Postfix) with ESMTP id 3FB6E3027302
	for <lists+linux-rdma@lfdr.de>; Fri, 10 Jul 2026 03:34:11 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id C88093624D7;
	Fri, 10 Jul 2026 03:34:10 +0000 (UTC)
X-Original-To: linux-rdma@vger.kernel.org
Received: from out30-111.freemail.mail.aliyun.com (out30-111.freemail.mail.aliyun.com [115.124.30.111])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 313B234F48F;
	Fri, 10 Jul 2026 03:34:05 +0000 (UTC)
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1783654450; cv=none; b=mBJ9S4IrNd1SNNl4eUkEGiwHis+NLGPoC7hP1BNV2z+nEGPBjC5K6FN0FsQ1/D9F4I4VVmgWtAi4IoMyP8+dmX2po25KfNla59C1ioFeEcb+yaAkBbqsYYGLFk1T+scyAPAAt5ifBEDAvWhol6n+WlCD3iJFRoCbL60luTZW91I=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1783654450; c=relaxed/simple;
	bh=7fzEYynA6SsSwHHtMHP22mE2G5ZIwFjAinr6zYvcVPY=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=UHtvI+868J6HooXaci5rRjXX2WLzIg5jP5V+5Ln+nzOKQfHBxOmQsOxL+WeJsZVbE/E8ymt2bfc3F3T8zWTsEdOUEvQvM2fAu2pASP6Azp/Vtlso72fgwmQIY9hVmidM/jsEwZWtqvYeL7gB2OkmWVIzNvN0mtboLE2I+Lxsbdc=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linux.alibaba.com; spf=pass smtp.mailfrom=linux.alibaba.com; dkim=pass (1024-bit key) header.d=linux.alibaba.com header.i=@linux.alibaba.com header.b=IuA/y8GB; arc=none smtp.client-ip=115.124.30.111
DKIM-Signature:v=1; a=rsa-sha256; c=relaxed/relaxed;
	d=linux.alibaba.com; s=default;
	t=1783654443; h=From:To:Subject:Date:Message-ID:MIME-Version;
	bh=aZNDqyVK6/NTwEac+kEL1t1V6agZUS8T01T7Hk452Hg=;
	b=IuA/y8GBDtRiWM3TxGXpF/vu76iaIAmAAEIfXW4LNOPQhoLexsc5COMdBjsZ8zOEVjxVcG93OAUjIJPOEKPpmFuNYItEufJgBtoz4SuWkrWLt2VpvPVs508VtHPosBmsYiM/L7K3JLb5w170r+HhBJyINX89b3XcGb77FaeuDhQ=
X-Alimail-AntiSpam:AC=PASS;BC=-1|-1;BR=01201311R861e4;CH=green;DM=||false|;DS=||;FP=0|-1|-1|-1|0|-1|-1|-1;HT=maildocker-contentspam033037009110;MF=alibuda@linux.alibaba.com;NM=1;PH=DS;RN=15;SR=0;TI=SMTPD_---0X6mSWfM_1783654442;
Received: from j66a10360.sqa.eu95.tbsite.net(mailfrom:alibuda@linux.alibaba.com fp:SMTPD_---0X6mSWfM_1783654442 cluster:ay36)
...
Cc: kuba@kernel.org,
	...
	jaka@linux.ibm.com
Subject: [PATCH net-next v3 2/3] net/smc: transition to RDMA core CQ pooling
Date: Fri, 10 Jul 2026 11:33:55 +0800
Message-ID: <20260710033356.16460-3-alibuda@linux.alibaba.com>
...
X-Spamd-Result: default: False [-10.66 / 15.00];
	...
	RCVD_TLS_LAST(0.00)[];
	TAGGED_FROM(0.00)[bounces-22984-lists,linux-rdma=lfdr.de];
...
---
 ...
 net/smc/smc_ib.h   |   7 -
 net/smc/smc_tx.c   |   1 -
 net/smc/smc_wr.c   | 376 +++++++++++++++++++++------------------------
 net/smc/smc_wr.h   |  48 ++----
 7 files changed, 255 insertions(+), 334 deletions(-)
...
index 5c18f08a4c8a..9645105ac7ed 100644
...
index 9bb495707445..0077b06dc13a 100644
--- a/net/smc/smc_ib.c
+++ b/net/smc/smc_ib.c
...
+
 	...
 	if (rc)
 		goto out;
@@ -657,38 +645,61 @@ void smc_ib_destroy_queue_pair(struct smc_link *lnk)
 	if (lnk->roce_qp)
...
@@ -838,62 +849,6 @@ void smc_ib_buf_unmap_sg(struct smc_link *lnk,
...
@@ -952,7 +907,6 @@ static int smc_ib_add_dev(struct ib_device *ibdev)
...
@@ -1001,7 +955,6 @@ static void smc_ib_remove_dev(struct ib_device *ibdev, void *client_data)
...
index 6b5add922993..675bfe633e39 100644
--- a/net/smc/smc_wr.c
+++ b/net/smc/smc_wr.c
@@ -31,14 +31,11 @@
 #include "smc.h"
...
@@ -431,95 +369,107 @@ static inline void smc_wr_rx_demultiplex(struct ib_wc *wc)
 {
...
@@ -826,18 +769,6 @@ int smc_wr_alloc_link_mem(struct smc_link *link)
 	return -ENOMEM;
 }
...
+	percpu_ref_exit(&lnk->wr_reg_refs);
 cancel_ref:
 	percpu_ref_exit(&lnk->wr_tx_refs);
 dma_unmap:
@@ -931,3 +872,42 @@ int smc_wr_create_link(struct smc_link *lnk)
 out:
 	return rc;
 }
+
...
index aa4533af9122..fc8cd93394cc 100644
--- a/net/smc/smc_wr.h
+++ b/net/smc/smc_wr.h
