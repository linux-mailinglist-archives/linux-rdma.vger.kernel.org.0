...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 495AA1179D1
	for <lists+linux-rdma@lfdr.de>; Mon,  9 Dec 2019 23:50:42 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727187AbfLIWt4 (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Mon, 9 Dec 2019 17:49:56 -0500
Received: from mga12.intel.com ([192.55.52.136]:33714 "EHLO mga12.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1727145AbfLIWtx (ORCPT <rfc822;linux-rdma@vger.kernel.org>);
        Mon, 9 Dec 2019 17:49:53 -0500
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
  by fmsmga106.fm.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384; 09 Dec 2019 14:49:45 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.69,296,1571727600"; 
   d="scan'208";a="237912340"
Received: from jtkirshe-desk1.jf.intel.com ([134.134.177.74])
  by fmsmga004.fm.intel.com with ESMTP; 09 Dec 2019 14:49:44 -0800
...
Subject: [PATCH v3 13/20] RDMA/irdma: Implement device supported verb APIs
Date:   Mon,  9 Dec 2019 14:49:28 -0800
Message-Id: <20191209224935.1780117-14-jeffrey.t.kirsher@intel.com>
...
---
 ...
 3 files changed, 4558 insertions(+)
 create mode 100644 drivers/infiniband/hw/irdma/verbs.c
 create mode 100644 drivers/infiniband/hw/irdma/verbs.h

diff --git a/drivers/infiniband/hw/irdma/verbs.c b/drivers/infiniband/hw/irdma/verbs.c
new file mode 100644
index 000000000000..76ea44e69560
--- /dev/null
...
+	if (ucontext->iwdev->rf->ldev.ftype) {
...
+						  >> PAGE_SHIFT),
+				 PAGE_SIZE, vma->vm_page_prot, NULL);
+}
+
+/**
...
+		return ERR_PTR(-EINVAL);
+
+	region = ib_umem_get(udata, start, len, acc);
+	if (IS_ERR(region))
...
new file mode 100644
index 000000000000..1b98ddedbc55
--- /dev/null
...
index 9019b2d906ea..53b2b505fbb5 100644
--- a/include/uapi/rdma/ib_user_ioctl_verbs.h
+++ b/include/uapi/rdma/ib_user_ioctl_verbs.h
@@ -184,6 +184,7 @@ enum rdma_driver_id {
 	RDMA_DRIVER_OCRDMA,
 	RDMA_DRIVER_NES,
 	RDMA_DRIVER_I40IW,
