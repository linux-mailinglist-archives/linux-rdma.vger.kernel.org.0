...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 57C1F453545
	for <lists+linux-rdma@lfdr.de>; Tue, 16 Nov 2021 16:07:14 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S238072AbhKPPJz (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Tue, 16 Nov 2021 10:09:55 -0500
Received: from szxga02-in.huawei.com ([45.249.212.188]:26319 "EHLO
        szxga02-in.huawei.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S238101AbhKPPJM (ORCPT
        <rfc822;linux-rdma@vger.kernel.org>); Tue, 16 Nov 2021 10:09:12 -0500
Received: from dggemv711-chm.china.huawei.com (unknown [172.30.72.55])
        by szxga02-in.huawei.com (SkyGuard) with ESMTP id 4Htq572MNMzbhy6;
        Tue, 16 Nov 2021 23:01:15 +0800 (CST)
...
Subject: [PATCH v3 for-next 1/1] RDMA/hns: Support direct wqe of userspace
Date:   Tue, 16 Nov 2021 23:04:00 +0800
Message-ID: <20211116150400.23459-2-liangwenpeng@huawei.com>
X-Mailer: git-send-email 2.33.0
In-Reply-To: <20211116150400.23459-1-liangwenpeng@huawei.com>
References: <20211116150400.23459-1-liangwenpeng@huawei.com>
MIME-Version: 1.0
...
index 43e17d61cb63..3c1e1685c15a 100644
...
index 4194b626f3c6..1b40a9c60126 100644
--- a/drivers/infiniband/hw/hns/hns_roce_main.c
+++ b/drivers/infiniband/hw/hns/hns_roce_main.c
@@ -307,9 +307,25 @@ hns_roce_user_mmap_entry_insert(struct ib_ucontext *ucontext, u64 address,
...
+
 	if (ret) {
 		kfree(entry);
 		return NULL;
@@ -436,10 +452,20 @@ static int hns_roce_mmap(struct ib_ucontext *uctx, struct vm_area_struct *vma)
...
index 9af4509894e6..dcd0499db3ef 100644
...
@@ -903,16 +941,23 @@ static int alloc_qp_db(struct hns_roce_dev *hr_dev, struct hns_roce_qp *hr_qp,
...
+			goto err_remove_qp;
 		...
 		if (ret)
@@ -920,6 +965,12 @@ static int alloc_qp_db(struct hns_roce_dev *hr_dev, struct hns_roce_qp *hr_qp,
 	}
...
@@ -933,6 +984,8 @@ static void free_qp_db(struct hns_roce_dev *hr_dev, struct hns_roce_qp *hr_qp,
