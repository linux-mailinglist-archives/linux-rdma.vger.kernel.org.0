...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 322614FA533
	for <lists+linux-rdma@lfdr.de>; Sat,  9 Apr 2022 07:37:46 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235614AbiDIFgT (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Sat, 9 Apr 2022 01:36:19 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:41216 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235570AbiDIFgS (ORCPT
        <rfc822;linux-rdma@vger.kernel.org>); Sat, 9 Apr 2022 01:36:18 -0400
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
        by lindbergh.monkeyblade.net (Postfix) with ESMTP id 9BED31D4
        for <linux-rdma@vger.kernel.org>; Fri,  8 Apr 2022 22:34:08 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        s=mimecast20190719; t=1649482448;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=plNPYHtrzxNDX9MnbRFTM1BuAXi6N9H7xEjCHslydkc=;
        b=Y5GFvGJrNYWbjnHSWDhHgvwi+wIpPzgIg2QH1TDJmFIw8KWm/U9Luk2cfb9OacRrGzdRW2
        kVB2IEUYmvbDGU0maocwSzad1m6DTEZggcwKKdHWJq4m0u3zzBOCi81SwXeW9TWkKyLTQC
        cIWtyfWU0vWeFxI5cOYnIohZKYEwz4c=
Received: from mail-pj1-f72.google.com (mail-pj1-f72.google.com
 [209.85.216.72]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 us-mta-396-c3okWWL6NPOlbjE_0m_YNA-1; Sat, 09 Apr 2022 01:34:06 -0400
X-MC-Unique: c3okWWL6NPOlbjE_0m_YNA-1
Received: by mail-pj1-f72.google.com with SMTP id mm2-20020a17090b358200b001bf529127dfso6576423pjb.6
        for <linux-rdma@vger.kernel.org>; Fri, 08 Apr 2022 22:34:06 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20210112;
        h=x-gm-message-state:mime-version:references:in-reply-to:from:date
         :message-id:subject:to:cc:content-transfer-encoding;
        bh=plNPYHtrzxNDX9MnbRFTM1BuAXi6N9H7xEjCHslydkc=;
        b=
X-Gm-Message-State: AOAM532kczBjldAwRoPMzR46z4u8wUmsEoqoBofMrCRz+FLe9OEsxnJ9
        p4YguBaXKr1chUPrIHPuQLTSSZhSW9wU+BEyMAHQUdpGBuDiE/G2yZs3tFnelq1VLa+wMcA47R8
        khjRbxJrSOS09d6+I8eXn+kpulxgW6zjkFdJ24w==
X-Received: by 2002:a17:902:ce82:b0:156:bb3c:3297 with SMTP id f2-20020a170902ce8200b00156bb3c3297mr22046397plg.159.1649482445034;
        Fri, 08 Apr 2022 22:34:05 -0700 (PDT)
X-Google-Smtp-Source: ABdhPJxkrsmjn1FT89wx+OMNtBC/3nH89ssdA0/dKZfVb4uVbouitvPpQSVCgqUb9NVBLh7ffrHCMzdSw8/04xaKas8=
X-Received: by 2002:a17:902:ce82:b0:156:bb3c:3297 with SMTP id
 f2-20020a170902ce8200b00156bb3c3297mr22046371plg.159.1649482444513; Fri, 08
 Apr 2022 22:34:04 -0700 (PDT)
MIME-Version: 1.0
...
In-Reply-To: <e677d777-8646-81d4-3299-e4e390587074@linux.dev>
From:   Yi Zhang <yi.zhang@redhat.com>
Date:   Sat, 9 Apr 2022 13:33:52 +0800
Message-ID: <CAHj4cs8EcLsMWCan=YStQX+DtEqACPUeMqjqN=Deg=grUfp-gw@mail.gmail.com>
...
[  156.927509] Rounding down aligned max_sectors from 4294967295 to 4294967=
288
[  156.996061] ib_srpt:srpt_add_one: ib_srpt device =3D 00000000b38bff2d
...
id_ext=3Df2d4e2fffee6e1e0,ioc_guid=3Df2d4e2fffee6e1e0,pkey=3Dffff,service_i=
d=3Df2d4e2fffee6e1e0
[  156.996450] ib_srpt:srpt_add_one: ib_srpt added eno1_rxe.
[  156.996460] ib_srpt:srpt_add_one: ib_srpt device =3D 000000000c435da2
...
[  157.001659] ib_srpt:srpt_add_one: ib_srpt device =3D 00000000a61769b4
...
[  157.006823] ib_srpt:srpt_add_one: ib_srpt device =3D 000000008f72349b
...
[  157.616022] Rounding down aligned max_sectors from 4294967295 to 4294967=
288
[  160.335819] ib_srp:srp_add_one: ib_srp: srp_add_one:
18446744073709551615 / 4096 =3D 4503599627370495 <> 512
[  160.335830] ib_srp:srp_add_one: ib_srp: eno1_rxe: mr_page_shift =3D
...
18446744073709551615 / 4096 =3D 4503599627370495 <> 512
[  160.336235] ib_srp:srp_add_one: ib_srp: eno2_rxe: mr_page_shift =3D
12, device->max_mr_size =3D 0xffffffffffffffff,
device->max_fast_reg_page_list_len =3D 512, max_pages_per_mr =3D 512,
mr_max_size =3D 0x200000
[  160.336757] ib_srp:srp_add_one: ib_srp: srp_add_one:
18446744073709551615 / 4096 =3D 4503599627370495 <> 512
[  160.336763] ib_srp:srp_add_one: ib_srp: eno3_rxe: mr_page_shift =3D
12, device->max_mr_size =3D 0xffffffffffffffff,
device->max_fast_reg_page_list_len =3D 512, max_pages_per_mr =3D 512,
mr_max_size =3D 0x200000
[  160.337006] ib_srp:srp_add_one: ib_srp: srp_add_one:
18446744073709551615 / 4096 =3D 4503599627370495 <> 512
[  160.337011] ib_srp:srp_add_one: ib_srp: eno4_rxe: mr_page_shift =3D
12, device->max_mr_size =3D 0xffffffffffffffff,
device->max_fast_reg_page_list_len =3D 512, max_pages_per_mr =3D 512,
mr_max_size =3D 0x200000
[  160.489879] ib_srp:srp_parse_in: ib_srp: 10.16.221.116 -> 10.16.221.116:=
0
...
[  160.651978] RAX: 0000000000000000 RBX: 0000000000000200 RCX: 00000000000=
00000
[  160.659110] RDX: 0000000000000000 RSI: 0000000000000200 RDI: ffffffffa22=
8d58c
[  160.666243] RBP: ffffffffc241cd72 R08: ffffed103a3de28b R09: ffffed103a3=
de28b
[  160.673375] R10: ffff8881d1ef1453 R11: ffffed103a3de28a R12: ffff8881d1e=
f1450
[  160.680508] R13: ffff8881d1ef143c R14: ffff8882a4823850 R15: ffff8881d1e=
f14b0
[  160.687638] FS:  00007fbae6b89740(0000) GS:ffff888e2fc00000(0000)
knlGS:0000000000000000
[  160.695725] CS:  0010 DS: 0000 ES: 0000 CR0: 0000000080050033
[  160.701470] CR2: 00005558050bac08 CR3: 00000001e1a5a002 CR4: 00000000007=
706e0
[  160.708602] DR0: 0000000000000000 DR1: 0000000000000000 DR2: 00000000000=
00000
[  160.715734] DR3: 0000000000000000 DR6: 00000000fffe0ff0 DR7: 00000000000=
00400
...
0000000000000001
[  160.972996] RAX: ffffffffffffffda RBX: 0000000000000081 RCX: 00007fbae5d=
205c8
[  160.980130] RDX: 0000000000000081 RSI: 000055580502ca20 RDI: 00000000000=
00001
[  160.987262] RBP: 000055580502ca20 R08: 000000000000000a R09: 00007fbae5d=
80820
[  160.994395] R10: 000000000000000a R11: 0000000000000246 R12: 00007fbae5f=
c06e0
[  161.001525] R13: 0000000000000081 R14: 00007fbae5fbb880 R15: 00000000000=
00081
[  161.008685]  </TASK>
...
[  161.058297] =3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=
...
> >> Hi, all
> >>
> >> In 5.18-rc1, this commit "[PATCH for-next] RDMA/rxe: Revert changes fr=
om
> >> irqsave to bh locks" does not exist.
> >>
> >> The link is
> >> https://patchwork.kernel.org/project/linux-rdma/patch/20220215194448.4=
4369-1-rpearsonhpe@gmail.com/
> >>
> > Hi Yanjun
...
>
> +       local_bh_disable();
>          err =3D xa_alloc_cyclic(&pool->xa, &elem->index, elem, pool->lim=
it,
...
> >>> [  291.260285] device-mapper: multipath service-time: version 0.3.0 l=
oaded
...
> >>> poll_queues to 0. poll_q/nr_hw =3D (0/1)
> >>> [  291.834505] scsi_debug:sdebug_driver_probe: host protection DIF3 D=
IX3
> >>> [  291.834513] scsi host15: scsi_debug: version 0191 [20210520]
> >>>                    dev_size_mb=3D32, opts=3D0x0, submit_queues=3D1, s=
tatistics=3D0
...
> >>> [  291.845878] sd 15:0:0:0: [sdb] 65536 512-byte logical blocks: (33.=
6
> >>> MB/32.0 MiB)
...
> >>> [  291.859380] sd 15:0:0:0: [sdb] Enabling DIX T10-DIF-TYPE3-CRC prot=
ection
...
> >>> [  293.033291] Rounding down aligned max_sectors from 4294967295 to 4=
294967288
> >>> [  293.102261] ib_srpt:srpt_add_one: ib_srpt device =3D 0000000047a39=
f45
...
> >>> [  293.102692] ib_srpt:srpt_add_one: ib_srpt device =3D 00000000b2dfc=
be9
...
> >>> [  293.107893] ib_srpt:srpt_add_one: ib_srpt device =3D 0000000061e03=
247
...
> >>> [  293.113046] ib_srpt:srpt_add_one: ib_srpt device =3D 00000000c0e3d=
43d
...
> >>> [  293.724363] Rounding down aligned max_sectors from 4294967295 to 4=
294967288
...
> >>> device->max_fast_reg_page_list_len =3D 512, max_pages_per_mr =3D 512,
> >>> mr_max_size =3D 0x200000
> >>> [  296.605925] ib_srp:srp_parse_in: ib_srp: 10.16.221.116 -> 10.16.22=
1.116:0
