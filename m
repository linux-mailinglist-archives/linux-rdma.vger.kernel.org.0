...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id D72732C1229
	for <lists+linux-rdma@lfdr.de>; Mon, 23 Nov 2020 18:40:12 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2388258AbgKWRiZ (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Mon, 23 Nov 2020 12:38:25 -0500
Received: from mga05.intel.com ([192.55.52.43]:24099 "EHLO mga05.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S2390278AbgKWRiZ (ORCPT <rfc822;linux-rdma@vger.kernel.org>);
        Mon, 23 Nov 2020 12:38:25 -0500
IronPort-SDR: fXvlhmVktVz/dL2Ip5CiX2d+64WR3/NDVxOaLMqWepr3KSie6pES4z6vRcnVmmU9VY40mt1Oa0
 po9zvN+iHNkQ==
X-IronPort-AV: E=McAfee;i="6000,8403,9814"; a="256518424"
X-IronPort-AV: E=Sophos;i="5.78,364,1599548400"; 
   d="scan'208";a="256518424"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
  by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 23 Nov 2020 09:38:23 -0800
IronPort-SDR: ElJuDiOW1bKaJRy+1y3276IFFa93UVIto37/GnaZso57oOBhqp8fGYJXtLfTUwsaGlfQtAFrRh
 tRCOf4moyu5w==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.78,364,1599548400"; 
   d="scan'208";a="364717887"
Received: from cst-dev.jf.intel.com ([10.23.221.69])
  by fmsmga002.fm.intel.com with ESMTP; 23 Nov 2020 09:38:23 -0800
...
Subject: [PATCH v11 4/4] RDMA/mlx5: Support dma-buf based userspace memory region
Date:   Mon, 23 Nov 2020 09:51:59 -0800
Message-Id: <1606153919-104513-5-git-send-email-jianxin.xiong@intel.com>
...
+
 static struct mlx5_ib_mr *alloc_mr_from_cache(struct ib_pd *pd,
 					      ...
 					      int access_flags)
@@ -966,7 +979,10 @@ static struct mlx5_ib_mr *alloc_mr_from_cache(struct ib_pd *pd,
...
@@ -1212,8 +1228,10 @@ int mlx5_ib_update_xlt(struct mlx5_ib_mr *mr, u64 idx, int npages,
...
@@ -1255,6 +1273,10 @@ static int mlx5_ib_update_mr_pas(struct mlx5_ib_mr *mr, unsigned int flags)
 		cur_mtt->ptag =
...
@@ -1291,8 +1313,11 @@ static struct mlx5_ib_mr *reg_create(struct ib_mr *ibmr, struct ib_pd *pd,
 	int err;
...
@@ -1581,6 +1606,96 @@ struct ib_mr *mlx5_ib_reg_user_mr(struct ib_pd *pd, u64 start, u64 length,
 	return ERR_PTR(err);
 }
...
+
  ...
  * @mr: The MR to fence
@@ -1649,7 +1764,7 @@ int mlx5_ib_rereg_user_mr(struct ib_mr *ib_mr, int flags, u64 start,
 	if (!mr->umem)
 		return -EINVAL;
...
@@ -1812,6 +1927,8 @@ static void dereg_mr(struct mlx5_ib_dev *dev, struct mlx5_ib_mr *mr)
 	/* Stop all DMA */
 	if (is_odp)
