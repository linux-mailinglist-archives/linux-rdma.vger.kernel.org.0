...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 91BF44D7AF7
	for <lists+linux-rdma@lfdr.de>; Mon, 14 Mar 2022 07:48:05 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S236472AbiCNGtL (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Mon, 14 Mar 2022 02:49:11 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:47098 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S236476AbiCNGtI (ORCPT
        <rfc822;linux-rdma@vger.kernel.org>); Mon, 14 Mar 2022 02:49:08 -0400
Received: from out30-42.freemail.mail.aliyun.com (out30-42.freemail.mail.aliyun.com [115.124.30.42])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id A781ABC30
        for <linux-rdma@vger.kernel.org>; Sun, 13 Mar 2022 23:47:54 -0700 (PDT)
X-Alimail-AntiSpam: AC=PASS;BC=-1|-1;BR=01201311R151e4;CH=green;DM=||false|;DS=||;FP=0|-1|-1|-1|0|-1|-1|-1;HT=e01e04357;MF=chengyou@linux.alibaba.com;NM=1;PH=DS;RN=8;SR=0;TI=SMTPD_---0V75.E3Q_1647240471;
Received: from localhost(mailfrom:chengyou@linux.alibaba.com fp:SMTPD_---0V75.E3Q_1647240471)
          by smtp.aliyun-inc.com(127.0.0.1);
          Mon, 14 Mar 2022 14:47:51 +0800
From:   Cheng Xu <chengyou@linux.alibaba.com>
To:     jgg@ziepe.ca, dledford@redhat.com
Cc:     leon@kernel.org, linux-rdma@vger.kernel.org,
        KaiShen@linux.alibaba.com, chengyou@linux.alibaba.com,
        tonylu@linux.alibaba.com, BMT@zurich.ibm.com
Subject: [PATCH for-next v4 09/12] RDMA/erdma: Add connection management (CM) support
Date:   Mon, 14 Mar 2022 14:47:36 +0800
Message-Id: <20220314064739.81647-10-chengyou@linux.alibaba.com>
...
index 000000000000..e835a7d1d3c1
--- /dev/null
...
+}
+
+static void __mpa_ext_set_cc(u32 *bits, u32 cc)
+{
...
+	if (__mpa_ext_cc(cep->mpa.ext_data.bits) != qp->attrs.cc_method)
+		qp->attrs.cc_method = COMPROMISE_CC;
+
...
+	cep->mpa.ext_data.cookie = cep->qp->attrs.cookie;
+	__mpa_ext_set_cc(&cep->mpa.ext_data.bits, cep->qp->attrs.cc_method);
+
...
+
+	if (qp->attrs.cc_method != __mpa_ext_cc(cep->mpa.ext_data.bits))
+		qp->attrs.cc_method = COMPROMISE_CC;
+
+	/* move to rts */
+	ret = erdma_modify_qp_internal(qp, &qp_attrs,
...
+	__mpa_ext_set_cc(&cep->mpa.ext_data.bits, qp->attrs.cc_method);
+	cep->mpa.ext_data.cookie = cep->qp->attrs.cookie;
+
...
new file mode 100644
index 000000000000..1206bc538bc4
--- /dev/null
