 <a4b877ca-acbd-4c7a-9d32-00ee56ea6cf0@linux.dev> <CA+-1TMMBVoVcnsg9dV-bpBTzTTx0r=bas9w6tNcVh4_KfB6BEw@mail.gmail.com>
 <814d34c6-9bdc-4b84-be46-49d6be6dc5b0@linux.dev>
In-Reply-To: <814d34c6-9bdc-4b84-be46-49d6be6dc5b0@linux.dev>
From: Yiyi Hu <yiyihu@gmail.com>
Date: Tue, 18 Mar 2025 18:42:57 +0800
X-Gm-Features: AQ5f1JqM0pVXqMo0oruerlujZKYESnPJulMJuprjARnVpqSTw-95xfZDmGVJZCY
Message-ID: <CA+-1TMNuNsEQT2H18cBk8y5pfKp+inbXH6q1mLxx+kfA+cboQA@mail.gmail.com>
...
On Sun, Mar 16, 2025 at 2:45=E2=80=AFPM Zhu Yanjun <yanjun.zhu@linux.dev> w=
rote:
>
>
> =E5=9C=A8 2025/3/16 2:02, Yiyi Hu =E5=86=99=E9=81=93:
...
> >   veth-port-a  <--> br-with-vlan-filtering[veth-port-ap, other-phy-port=
s]
...
> >
> > On Thu, Dec 26, 2024 at 7:50=E2=80=AFAM Zhu Yanjun <yanjun.zhu@linux.de=
v> wrote:
> >> =E5=9C=A8 2024/12/25 21:04, Yiyi Hu =E5=86=99=E9=81=93:
> >>> Hi, I'm using 6.6.x kernel, after I upgraded to kernel 6.12.x for my
> >>> home server, I got the following error. Which causes soft rdma doesn'=
t
> >>> work for 6.12.x with my setup.
> >> I read this bug descriptions for several times. To be honest, I am als=
o
...
> >> can not work.
> >>
> >> So maybe "git bisect" is a good tool to find the commit that causes th=
is
> >> problems.
> >>
> >> Zhu Yanjun
...
> >>> nvme_fabrics nvme ixgbe crct10dif_pclmul mdio crc32_pclmul mdio_devre=
s
...
> >>> # [  134.041342] Code: 00 f0 0f c1 87 80 00 00 00 83 f8 01 74 39 85 c=
0
> >>> 7f 96 5b 5d be 03 00 00 00 48 89 d7 41 5c e9 7b 43 39 e0 41 f6 04 24
> >>> 01 75 26 <0f> 0b 5b 5d 41 5c c3 ff c8 83 f8 0f 77 a4 49 8d bc 24 d8 0=
3
> >>> 00 00
...
> >>> # [  134.041488] Code: de 01 00 00 e8 d2 9c 5f ff e8 dd f2 ff ff 49 8=
9
> >>> c5 0f 1f 44 00 00 31 ff e8 9e bd 5e ff 45 84 ff 0f 85 b0 01 00 00 fb
> >>> 45 85 f6 <0f> 88 88 01 00 00 48 8b 04 24 49 63 ce 4c 89 ea 48 6b f1 6=
8
> >>> 48 29
...
> >>> I created a software bridge named br-fp and bridge 2 ports on this ad=
apter,
> >>> I also created a veth pair (venfp <-> venfpbr), venfpbr is connected
> >>> to bridge br-fp.
> >>> then I do 'rdma link add rxe_venfp type rxe netdev venfp', If I try t=
o
