...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 615402A995A
	for <lists+linux-rdma@lfdr.de>; Fri,  6 Nov 2020 17:20:41 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726320AbgKFQUk (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Fri, 6 Nov 2020 11:20:40 -0500
Received: from mga06.intel.com ([134.134.136.31]:37950 "EHLO mga06.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726010AbgKFQUk (ORCPT <rfc822;linux-rdma@vger.kernel.org>);
        Fri, 6 Nov 2020 11:20:40 -0500
IronPort-SDR: 1dyl8or48JC/jeV1Oms+n0wleTw0ejjG5qGeVOOLMJ0pGi3KD3PU6dTSWlfwx7e/YFuFEyhCza
 oWtlCTZK+vWw==
X-IronPort-AV: E=McAfee;i="6000,8403,9797"; a="231192183"
X-IronPort-AV: E=Sophos;i="5.77,457,1596524400"; 
   d="scan'208";a="231192183"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga002.jf.intel.com ([10.7.209.21])
  by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 06 Nov 2020 08:20:39 -0800
IronPort-SDR: ZEEgBQ4CnZvJxY0YAND64xjO6IB0L1ixXjrEjvL3oLi44836K2qVHXYQtz93RZGl9HqLmKlR0a
 5Y4YuJnRLaXQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.77,457,1596524400"; 
   d="scan'208";a="337617213"
...
X-MS-Exchange-CrossTenant-originalarrivaltime: 06 Nov 2020 16:20:34.7300
 (UTC)
...
> Subject: Re: [PATCH v8 3/5] RDMA/uverbs: Add uverbs command for dma-buf b=
...
> > +		return ret;
>=20
> This should also reject unsupportable flags like ACCESS_ON_DEMAND and HUG=
ETLB
...
>=20
> I trie to keep these sorted, but I see it has become unsorted. You can re=
-sort it in this patch
