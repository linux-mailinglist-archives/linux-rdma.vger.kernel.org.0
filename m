...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id E07F2164B6
	for <lists+linux-rdma@lfdr.de>; Tue,  7 May 2019 15:38:49 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726608AbfEGNis (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Tue, 7 May 2019 09:38:48 -0400
Received: from mail-il-dmz.mellanox.com ([193.47.165.129]:40311 "EHLO
        mellanox.co.il" rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org
        with ESMTP id S1726509AbfEGNis (ORCPT
...
Received: from r-vnc08.mtr.labs.mlnx (r-vnc08.mtr.labs.mlnx [10.208.0.121])
        by labmailer.mlnx (8.13.8/8.13.8) with ESMTP id x47DcdF7021865;
...
Subject: [PATCH 07/25] RDMA/mlx5: Add attr for max number page list length for PI operation
Date:   Tue,  7 May 2019 16:38:21 +0300
Message-Id: <1557236319-9986-8-git-send-email-maxg@mellanox.com>
...
index 175f315fc43f..b8884cefea78 100644
--- a/drivers/infiniband/hw/mlx5/main.c
+++ b/drivers/infiniband/hw/mlx5/main.c
@@ -1006,6 +1006,8 @@ static int mlx5_ib_query_device(struct ib_device *ibdev,
...
index 05c9996915d5..ee18ff26dc1a 100644
--- a/include/rdma/ib_verbs.h
+++ b/include/rdma/ib_verbs.h
@@ -367,6 +367,7 @@ struct ib_device_attr {
 	int			max_srq_wr;
 	int			max_srq_sge;
