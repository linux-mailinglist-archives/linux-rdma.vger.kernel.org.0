...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id C484820FCB2
	for <lists+linux-rdma@lfdr.de>; Tue, 30 Jun 2020 21:23:38 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726283AbgF3TXh (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Tue, 30 Jun 2020 15:23:37 -0400
Received: from mga17.intel.com ([192.55.52.151]:17426 "EHLO mga17.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726065AbgF3TXg (ORCPT <rfc822;linux-rdma@vger.kernel.org>);
        Tue, 30 Jun 2020 15:23:36 -0400
IronPort-SDR: sxBC7RWaI6qFz+rLmUxcyMij2rUdxh+AqQAkZtnnbYCkV6k6ScJfLB8r5soDIRsdndiluu/Guh
 qSXG1+esbP5A==
X-IronPort-AV: E=McAfee;i="6000,8403,9668"; a="126460765"
X-IronPort-AV: E=Sophos;i="5.75,298,1589266800"; 
   d="scan'208";a="126460765"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
  by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 30 Jun 2020 12:04:46 -0700
IronPort-SDR: CI0vdBSruiXESlN5CV9VCJbhDpnr0fDCdcwrYLHwGa2emMViK9NjOfXxJI5AzzyP1FCg4m9m8t
 wWAnwGaEVxqA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.75,298,1589266800"; 
   d="scan'208";a="481300748"
...
Received: from NAM12-MW2-obe.outbound.protection.outlook.com (104.47.66.44) by
 ...
 14.3.439.0; Tue, 30 Jun 2020 12:04:45 -0700
...
x-forefront-antispam-report: CIP:255.255.255.255;CTRY:;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:MW3PR11MB4555.namprd11.prod.outlook.com;PTR:;CAT:NONE;SFTY:;SFS:(4636009)(366004)(346002)(136003)(376002)(396003)(39860400002)(9686003)(2906002)(55016002)(5660300002)(71200400001)(8676002)(83380400001)(6916009)(8936002)(4326008)(86362001)(316002)(478600001)(26005)(76116006)(33656002)(7696005)(66556008)(66476007)(52536014)(66946007)(64756008)(186003)(66446008)(6506007)(53546011)(54906003)(30864003)(559001)(579004);DIR:OUT;SFP:1102;
...
X-MS-Exchange-CrossTenant-originalarrivaltime: 30 Jun 2020 19:04:41.2193
 (UTC)
...
> Subject: [RFC PATCH v2 2/3] RDMA/core: Expand the driver method 'reg_user=
_mr' to support dma-buf
>=20
...
>  	}
>=20
>  	mr =3D pd->device->ops.reg_user_mr(pd, cmd.start, cmd.length, cmd.hca_v=
a,
> -					 cmd.access_flags,
> +					 -1, cmd.access_flags,
>  					 &attrs->driver_udata);
...
>  	}
>=20
>  	mr =3D pd->device->ops.reg_user_mr(pd, start, length, virt_addr,
> -					 access_flags, NULL);
> +					 -1, access_flags, NULL);
>=20
>  	if (IS_ERR(mr))
...
> @@ -3695,7 +3695,7 @@ static int fill_umem_pbl_tbl(struct ib_umem *umem, =
u64 *pbl_tbl_orig,
>=20
>  /* uverbs */
>  struct ib_mr *bnxt_re_reg_user_mr(struct ib_pd *ib_pd, u64 start, u64 le=
ngth,
> -				  u64 virt_addr, int mr_access_flags,
> +				  u64 virt_addr, int fd, int mr_access_flags,
>  				  struct ib_udata *udata)
>  {
>  	struct bnxt_re_pd *pd =3D container_of(ib_pd, struct bnxt_re_pd, ib_pd)=
;
> @@ -3728,6 +3728,11 @@ struct ib_mr *bnxt_re_reg_user_mr(struct ib_pd *ib=
_pd, u64 start, u64 length,
...
> @@ -203,7 +203,7 @@ struct ib_mw *bnxt_re_alloc_mw(struct ib_pd *ib_pd, e=
num ib_mw_type type,
>  			       struct ib_udata *udata);
>  int bnxt_re_dealloc_mw(struct ib_mw *mw);
>  struct ib_mr *bnxt_re_reg_user_mr(struct ib_pd *pd, u64 start, u64 lengt=
h,
> -				  u64 virt_addr, int mr_access_flags,
> +				  u64 virt_addr, int fd, int mr_access_flags,
>  				  struct ib_udata *udata);
>  int bnxt_re_alloc_ucontext(struct ib_ucontext *ctx, struct ib_udata *uda=
ta);
...
> @@ -988,7 +988,8 @@ int c4iw_map_mr_sg(struct ib_mr *ibmr, struct scatter=
list *sg, int sg_nents,
...
> diff --git a/drivers/infiniband/hw/cxgb4/mem.c b/drivers/infiniband/hw/cx=
gb4/mem.c
> index 962dc97..b0b912a 100644
> --- a/drivers/infiniband/hw/cxgb4/mem.c
> +++ b/drivers/infiniband/hw/cxgb4/mem.c
> @@ -506,7 +506,8 @@ struct ib_mr *c4iw_get_dma_mr(struct ib_pd *pd, int a=
cc)
>  }
>=20
...
>  	__be64 *pages;
>  	int shift, n, i;
> @@ -543,6 +544,11 @@ struct ib_mr *c4iw_reg_user_mr(struct ib_pd *pd, u64=
 start, u64 length,
>=20
>  	mhp->rhp =3D rhp;
>=20
...
> +	}
> +
>  	mhp->umem =3D ib_umem_get(pd->device, start, length, acc);
>  	if (IS_ERR(mhp->umem))
>  		goto err_free_skb;
> diff --git a/drivers/infiniband/hw/efa/efa.h b/drivers/infiniband/hw/efa/=
efa.h
...
> @@ -1386,6 +1386,11 @@ struct ib_mr *efa_reg_mr(struct ib_pd *ibpd, u64 s=
tart, u64 length,
>  		goto err_out;
>  	}
>=20
...
> +	}
> +
>  	mr->umem =3D ib_umem_get(ibpd->device, start, length, access_flags);
>  	if (IS_ERR(mr->umem)) {
>  		err =3D PTR_ERR(mr->umem);
> diff --git a/drivers/infiniband/hw/hns/hns_roce_device.h b/drivers/infini=
band/hw/hns/hns_roce_device.h
> index d7dcf6e..c2b94c6 100644
> --- a/drivers/infiniband/hw/hns/hns_roce_device.h
> +++ b/drivers/infiniband/hw/hns/hns_roce_device.h
> @@ -1185,7 +1185,7 @@ int hns_roce_create_ah(struct ib_ah *ah, struct rdm=
a_ah_attr *ah_attr,
>=20
>  struct ib_mr *hns_roce_get_dma_mr(struct ib_pd *pd, int acc);
>  struct ib_mr *hns_roce_reg_user_mr(struct ib_pd *pd, u64 start, u64 leng=
th,
> -				   u64 virt_addr, int access_flags,
> +				   u64 virt_addr, int fd, int access_flags,
>  				   struct ib_udata *udata);
>  int hns_roce_rereg_user_mr(struct ib_mr *mr, int flags, u64 start, u64 l=
ength,
>  			   u64 virt_addr, int mr_access_flags, struct ib_pd *pd,
> diff --git a/drivers/infiniband/hw/hns/hns_roce_mr.c b/drivers/infiniband=
/hw/hns/hns_roce_mr.c
> index b9898e7..24dd79a 100644
> --- a/drivers/infiniband/hw/hns/hns_roce_mr.c
> +++ b/drivers/infiniband/hw/hns/hns_roce_mr.c
> @@ -1130,7 +1130,7 @@ static int hns_roce_ib_umem_write_mr(struct hns_roc=
e_dev *hr_dev,
>  }
>=20
>  struct ib_mr *hns_roce_reg_user_mr(struct ib_pd *pd, u64 start, u64 leng=
...
>  				   struct ib_udata *udata)
>  {
>  	struct hns_roce_dev *hr_dev =3D to_hr_dev(pd->device);
> @@ -1145,6 +1145,11 @@ struct ib_mr *hns_roce_reg_user_mr(struct ib_pd *p=
d, u64 start, u64 length,
>  	if (!mr)
>  		return ERR_PTR(-ENOMEM);
>=20
> +	if (fd >=3D 0) {
> +		ret =3D ERR_PTR(-EOPNOTSUPP);
> +		goto err_free;
> +	}
> +
>  	mr->umem =3D ib_umem_get(pd->device, start, length, access_flags);
>  	if (IS_ERR(mr->umem)) {
>  		ret =3D PTR_ERR(mr->umem);
...
> @@ -1727,6 +1727,7 @@ static int i40iw_hwreg_mr(struct i40iw_device *iwde=
v,
...
>   * @udata: user data
>   */
> @@ -1734,6 +1735,7 @@ static struct ib_mr *i40iw_reg_user_mr(struct ib_pd=
 *pd,
>  				       u64 start,
>  				       u64 length,
>  				       u64 virt,
...
>  				       struct ib_udata *udata)
>  {
> @@ -1764,6 +1766,10 @@ static struct ib_mr *i40iw_reg_user_mr(struct ib_p=
d *pd,
>=20
...
> +
>  	region =3D ib_umem_get(pd->device, start, length, acc);
>  	if (IS_ERR(region))
>  		return (struct ib_mr *)region;
> diff --git a/drivers/infiniband/hw/mlx4/mlx4_ib.h b/drivers/infiniband/hw=
/mlx4/mlx4_ib.h
> index d188573..d9db34b 100644
> --- a/drivers/infiniband/hw/mlx4/mlx4_ib.h
> +++ b/drivers/infiniband/hw/mlx4/mlx4_ib.h
> @@ -732,7 +732,7 @@ int mlx4_ib_db_map_user(struct ib_udata *udata, unsig=
ned long virt,
>  int mlx4_ib_umem_write_mtt(struct mlx4_ib_dev *dev, struct mlx4_mtt *mtt=
,
>  			   struct ib_umem *umem);
>  struct ib_mr *mlx4_ib_reg_user_mr(struct ib_pd *pd, u64 start, u64 lengt=
h,
> -				  u64 virt_addr, int access_flags,
> +				  u64 virt_addr, int fd, int access_flags,
>  				  struct ib_udata *udata);
...
> @@ -402,7 +402,7 @@ static struct ib_umem *mlx4_get_umem_mr(struct ib_dev=
...
>  				  struct ib_udata *udata)
>  {
>  	struct mlx4_ib_dev *dev =3D to_mdev(pd->device);
> @@ -415,6 +415,11 @@ struct ib_mr *mlx4_ib_reg_user_mr(struct ib_pd *pd, =
...
> +	}
> +
>  	mr->umem =3D mlx4_get_umem_mr(pd->device, start, length, access_flags);
>  	if (IS_ERR(mr->umem)) {
>  		err =3D PTR_ERR(mr->umem);
...
> @@ -1189,7 +1189,7 @@ int mlx5_ib_create_cq(struct ib_cq *ibcq, const str=
uct ib_cq_init_attr *attr,
>  int mlx5_ib_resize_cq(struct ib_cq *ibcq, int entries, struct ib_udata *=
udata);
>  struct ib_mr *mlx5_ib_get_dma_mr(struct ib_pd *pd, int acc);
>  struct ib_mr *mlx5_ib_reg_user_mr(struct ib_pd *pd, u64 start, u64 lengt=
h,
> -				  u64 virt_addr, int access_flags,
> +				  u64 virt_addr, int fd, int access_flags,
>  				  struct ib_udata *udata);
...
> @@ -797,6 +797,39 @@ static int mr_umem_get(struct mlx5_ib_dev *dev, u64 =
start, u64 length,
>  	return 0;
>  }
>=20
> +static int mr_umem_dmabuf_get(struct mlx5_ib_dev *dev, u64 start, u64 le=
ngth,
...
> +	*umem =3D NULL;
> +
> +	u =3D ib_umem_dmabuf_get(&dev->ib_dev, start, length, dmabuf_fd,
> +			       access_flags);
> +	if (IS_ERR(u)) {
...
>  {
>  	struct mlx5_ib_umr_context *context =3D
> @@ -1228,7 +1261,7 @@ struct ib_mr *mlx5_ib_reg_dm_mr(struct ib_pd *pd, s=
truct ib_dm *dm,
>  }
>=20
>  struct ib_mr *mlx5_ib_reg_user_mr(struct ib_pd *pd, u64 start, u64 lengt=
...
> @@ -1261,9 +1294,13 @@ struct ib_mr *mlx5_ib_reg_user_mr(struct ib_pd *pd=
, u64 start, u64 length,
>  		return &mr->ibmr;
>  	}
>=20
> -	err =3D mr_umem_get(dev, start, length, access_flags, &umem,
...
> +				  &npages, &page_shift, &ncont, &order);
> +	else
> +		err =3D mr_umem_dmabuf_get(dev, start, length, fd, access_flags,
...
> @@ -852,7 +852,8 @@ static struct ib_mr *mthca_get_dma_mr(struct ib_pd *p=
d, int acc)
>  }
>=20
>  static struct ib_mr *mthca_reg_user_mr(struct ib_pd *pd, u64 start, u64 =
length,
> -				       u64 virt, int acc, struct ib_udata *udata)
> +				       u64 virt, int fd, int acc,
> +				       struct ib_udata *udata)
...
> @@ -880,6 +881,11 @@ static struct ib_mr *mthca_reg_user_mr(struct ib_pd =
...
> +	}
> +
>  	mr->umem =3D ib_umem_get(pd->device, start, length, acc);
>  	if (IS_ERR(mr->umem)) {
>  		err =3D PTR_ERR(mr->umem);
> diff --git a/drivers/infiniband/hw/ocrdma/ocrdma_verbs.c b/drivers/infini=
band/hw/ocrdma/ocrdma_verbs.c
> index 10e3438..2c25244 100644
> --- a/drivers/infiniband/hw/ocrdma/ocrdma_verbs.c
> +++ b/drivers/infiniband/hw/ocrdma/ocrdma_verbs.c
> @@ -853,7 +853,8 @@ static void build_user_pbes(struct ocrdma_dev *dev, s=
truct ocrdma_mr *mr,
>  }
>=20
...
> @@ -869,6 +870,12 @@ struct ib_mr *ocrdma_reg_user_mr(struct ib_pd *ibpd,=
 u64 start, u64 len,
...
> +	}
> +
>  	mr->umem =3D ib_umem_get(ibpd->device, start, len, acc);
>  	if (IS_ERR(mr->umem)) {
>  		status =3D -EFAULT;
> diff --git a/drivers/infiniband/hw/ocrdma/ocrdma_verbs.h b/drivers/infini=
band/hw/ocrdma/ocrdma_verbs.h
> index 3a50108..bc3660e 100644
> --- a/drivers/infiniband/hw/ocrdma/ocrdma_verbs.h
> +++ b/drivers/infiniband/hw/ocrdma/ocrdma_verbs.h
> @@ -99,7 +99,8 @@ int ocrdma_post_srq_recv(struct ib_srq *, const struct =
ib_recv_wr *,
...
>  int ocrdma_map_mr_sg(struct ib_mr *ibmr, struct scatterlist *sg, int sg_=
nents,
...
> @@ -2828,7 +2828,8 @@ static int init_mr_info(struct qedr_dev *dev, struc=
t mr_info *info,
>  }
>=20
...
> +			       struct ib_udata *udata)
>  {
>  	struct qedr_dev *dev =3D get_qedr_dev(ibpd->device);
>  	struct qedr_mr *mr;
> @@ -2849,6 +2850,11 @@ struct ib_mr *qedr_reg_user_mr(struct ib_pd *ibpd,=
 u64 start, u64 len,
>=20
>  	mr->type =3D QEDR_MR_USER;
>=20
> +	if (fd >=3D 0) {
> +		rc =3D -EOPNOTSUPP;
> +		goto err0;
...
>  	if (IS_ERR(mr->umem)) {
>  		rc =3D -EFAULT;
> diff --git a/drivers/infiniband/hw/qedr/verbs.h b/drivers/infiniband/hw/q=
edr/verbs.h
> index 1802784..78effd1 100644
> --- a/drivers/infiniband/hw/qedr/verbs.h
> +++ b/drivers/infiniband/hw/qedr/verbs.h
> @@ -78,7 +78,8 @@ int qedr_create_ah(struct ib_ah *ibah, struct rdma_ah_a=
ttr *attr, u32 flags,
...
> diff --git a/drivers/infiniband/hw/usnic/usnic_ib_verbs.c b/drivers/infin=
iband/hw/usnic/usnic_ib_verbs.c
> index 71f8233..58ed9d1 100644
> --- a/drivers/infiniband/hw/usnic/usnic_ib_verbs.c
> +++ b/drivers/infiniband/hw/usnic/usnic_ib_verbs.c
> @@ -603,7 +603,8 @@ void usnic_ib_destroy_cq(struct ib_cq *cq, struct ib_=
udata *udata)
>  }
>=20
...
> @@ -616,6 +617,11 @@ struct ib_mr *usnic_ib_reg_mr(struct ib_pd *pd, u64 =
start, u64 length,
>  	if (!mr)
>  		return ERR_PTR(-ENOMEM);
>=20
...
> +	}
> +
>  	mr->umem =3D usnic_uiom_reg_get(to_upd(pd)->umem_pd, start, length,
>  					access_flags, 0);
>  	if (IS_ERR_OR_NULL(mr->umem)) {
> diff --git a/drivers/infiniband/hw/usnic/usnic_ib_verbs.h b/drivers/infin=
iband/hw/usnic/usnic_ib_verbs.h
> index 2aedf78..42ba8b7 100644
> --- a/drivers/infiniband/hw/usnic/usnic_ib_verbs.h
> +++ b/drivers/infiniband/hw/usnic/usnic_ib_verbs.h
> @@ -62,7 +62,7 @@ int usnic_ib_create_cq(struct ib_cq *ibcq, const struct=
...
>  int usnic_ib_alloc_ucontext(struct ib_ucontext *uctx, struct ib_udata *u=
data);
> diff --git a/drivers/infiniband/hw/vmw_pvrdma/pvrdma_mr.c b/drivers/infin=
iband/hw/vmw_pvrdma/pvrdma_mr.c
> index b039f1f..8b8b10c 100644
> --- a/drivers/infiniband/hw/vmw_pvrdma/pvrdma_mr.c
> +++ b/drivers/infiniband/hw/vmw_pvrdma/pvrdma_mr.c
> @@ -103,13 +103,14 @@ struct ib_mr *pvrdma_get_dma_mr(struct ib_pd *pd, i=
nt acc)
...
> @@ -126,6 +127,9 @@ struct ib_mr *pvrdma_reg_user_mr(struct ib_pd *pd, u6=
4 start, u64 length,
>  		return ERR_PTR(-EINVAL);
>  	}
>=20
...
> +		return ERR_PTR(-EOPNOTSUPP);
> +
>  	umem =3D ib_umem_get(pd->device, start, length, access_flags);
>  	if (IS_ERR(umem)) {
...
> @@ -402,7 +402,7 @@ int pvrdma_modify_port(struct ib_device *ibdev, u8 po=
rt,
...
> diff --git a/drivers/infiniband/sw/rdmavt/mr.c b/drivers/infiniband/sw/rd=
mavt/mr.c
> index 72f6534..cbd54de 100644
> --- a/drivers/infiniband/sw/rdmavt/mr.c
> +++ b/drivers/infiniband/sw/rdmavt/mr.c
> @@ -372,13 +372,14 @@ struct ib_mr *rvt_get_dma_mr(struct ib_pd *pd, int =
acc)
...
>  {
>  	struct rvt_mr *mr;
> @@ -390,6 +391,9 @@ struct ib_mr *rvt_reg_user_mr(struct ib_pd *pd, u64 s=
tart, u64 length,
>  	if (length =3D=3D 0)
>  		return ERR_PTR(-EINVAL);
>=20
...
> +		return ERR_PTR(-EOPNOTSUPP);
> +
>  	umem =3D ib_umem_get(pd->device, start, length, mr_access_flags);
>  	if (IS_ERR(umem))
>  		return (void *)umem;
> diff --git a/drivers/infiniband/sw/rdmavt/mr.h b/drivers/infiniband/sw/rd=
mavt/mr.h
...
> @@ -930,6 +930,7 @@ static struct ib_mr *rxe_reg_user_mr(struct ib_pd *ib=
pd,
>  				     u64 start,
>  				     u64 length,
>  				     u64 iova,
...
>  {
>  	int err;
> @@ -947,6 +948,11 @@ static struct ib_mr *rxe_reg_user_mr(struct ib_pd *i=
bpd,
>=20
>  	rxe_add_ref(pd);
>=20
...
> +	}
> +
>  	err =3D rxe_mem_init_user(pd, start, length, iova,
>  				access, udata, mr);
>  	if (err)
...
> @@ -1275,11 +1275,13 @@ int siw_dereg_mr(struct ib_mr *base_mr, struct ib=
_udata *udata)
...
> +			      struct ib_udata *udata)
>  {
>  	struct siw_mr *mr =3D NULL;
>  	struct siw_umem *umem =3D NULL;
> @@ -1315,6 +1317,10 @@ struct ib_mr *siw_reg_user_mr(struct ib_pd *pd, u6=
4 start, u64 len,
>  			goto err_out;
>  		}
>  	}
...
>  	if (IS_ERR(umem)) {
>  		rv =3D PTR_ERR(umem);
> diff --git a/drivers/infiniband/sw/siw/siw_verbs.h b/drivers/infiniband/s=
w/siw/siw_verbs.h
> index 1a73198..e08bf51 100644
> --- a/drivers/infiniband/sw/siw/siw_verbs.h
> +++ b/drivers/infiniband/sw/siw/siw_verbs.h
> @@ -67,7 +67,8 @@ int siw_post_receive(struct ib_qp *base_qp, const struc=
t ib_recv_wr *wr,
>  int siw_poll_cq(struct ib_cq *base_cq, int num_entries, struct ib_wc *wc=
);
>  int siw_req_notify_cq(struct ib_cq *base_cq, enum ib_cq_notify_flags fla=
gs);
>  struct ib_mr *siw_reg_user_mr(struct ib_pd *base_pd, u64 start, u64 len,
> -			      u64 rnic_va, int rights, struct ib_udata *udata);
> +			      u64 rnic_va, int fd, int rights,
> +			      struct ib_udata *udata);
>  struct ib_mr *siw_alloc_mr(struct ib_pd *base_pd, enum ib_mr_type mr_typ=
e,
