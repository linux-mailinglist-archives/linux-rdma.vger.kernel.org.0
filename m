...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 16DF368B558
	for <lists+linux-rdma@lfdr.de>; Mon,  6 Feb 2023 06:47:25 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229550AbjBFFrU (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Mon, 6 Feb 2023 00:47:20 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:49230 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229619AbjBFFrR (ORCPT
        <rfc822;linux-rdma@vger.kernel.org>); Mon, 6 Feb 2023 00:47:17 -0500
Received: from mx0b-0016f401.pphosted.com (mx0b-0016f401.pphosted.com [67.231.156.173])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 442B8199EB;
        Sun,  5 Feb 2023 21:47:14 -0800 (PST)
Received: from pps.filterd (m0045851.ppops.net [127.0.0.1])
        by mx0b-0016f401.pphosted.com (8.17.1.19/8.17.1.19) with ESMTP id 3165M9wF013612;
        Sun, 5 Feb 2023 21:47:03 -0800
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=marvell.com; h=from : to : cc :
 subject : date : message-id : in-reply-to : references : mime-version :
 content-type; s=pfpt0220; bh=X2ftRgTELnps4cMbiI9qOO2rgo/s7OQzstTy9f7qFDg=;
 b= Wg== 
Received: from dc5-exch02.marvell.com ([199.233.59.182])
        by mx0b-0016f401.pphosted.com (PPS) with ESMTPS id 3nhqrt8m91-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-SHA384 bits=256 verify=NOT);
        Sun, 05 Feb 2023 21:47:02 -0800
Received: from DC5-EXCH02.marvell.com (10.69.176.39) by DC5-EXCH02.marvell.com
 (10.69.176.39) with Microsoft SMTP Server (TLS) id 15.0.1497.42; Sun, 5 Feb
 2023 21:47:00 -0800
Received: from maili.marvell.com (10.69.176.80) by DC5-EXCH02.marvell.com
 (10.69.176.39) with Microsoft SMTP Server id 15.0.1497.42 via Frontend
 Transport; Sun, 5 Feb 2023 21:47:00 -0800
Received: from hyd1soter3.marvell.com (unknown [10.29.37.12])
        by maili.marvell.com (Postfix) with ESMTP id 67EF93F706A;
        Sun,  5 Feb 2023 21:46:54 -0800 (PST)
...
Subject: [net-next PATCH V3 2/4] octeontx2-pf: qos send queues management
Date:   Mon, 6 Feb 2023 11:16:38 +0530
Message-ID: <20230206054640.5854-3-hkelam@marvell.com>
X-Mailer: git-send-email 2.17.1
In-Reply-To: <20230206054640.5854-1-hkelam@marvell.com>
References: <20230206054640.5854-1-hkelam@marvell.com>
MIME-Version: 1.0
Content-Type: text/plain
X-Proofpoint-GUID: e8gRjjpHcGAyLN-rwJn52z9TEoN3bK2o
X-Proofpoint-ORIG-GUID: e8gRjjpHcGAyLN-rwJn52z9TEoN3bK2o
...
---
 ...
 10 files changed, 431 insertions(+), 43 deletions(-)
...
@@ -1048,7 +1061,7 @@ int otx2_config_nix_queues(struct otx2_nic *pfvf)
 	}
...
+		   int stack_pages, int numptrs, int buf_size)
 {
 	struct npa_aq_enq_req *aq;
 	struct otx2_pool *pool;
@@ -1349,7 +1362,7 @@ int otx2_sq_aura_pool_init(struct otx2_nic *pfvf)
 	stack_pages =
...
@@ -1369,7 +1382,7 @@ int otx2_sq_aura_pool_init(struct otx2_nic *pfvf)
 		goto fail;
...
index 3d22cc6a2804..7fe812a62507 100644
