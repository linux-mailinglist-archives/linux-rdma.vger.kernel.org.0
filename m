...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id AF3472C585
	for <lists+linux-rdma@lfdr.de>; Tue, 28 May 2019 13:37:47 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726305AbfE1Lhr (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Tue, 28 May 2019 07:37:47 -0400
Received: from mail.kernel.org ([198.145.29.99]:39502 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726579AbfE1Lhq (ORCPT <rfc822;linux-rdma@vger.kernel.org>);
        Tue, 28 May 2019 07:37:46 -0400
Received: from localhost (unknown [193.47.165.251])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id 3D6FC20989;
        Tue, 28 May 2019 11:37:43 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1559043464;
        bh=+m1YVvQeNyseqMNIStQORLWc340Cd7nWHYQtkvmQMRI=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=jBK3kabFRodW3fI5cWVgztxF6OrE3Z2ze2WYCL6ruFRaOB1QStJNT1TH5NUQFAs6v
         KyI8UlB5XkgsWGaO1UfnlhRIOuJLeUWz0VMY951ZVkhM9QJUizkD2O7crmT2WnnmR8
         8Z8+gYSiCKFobe9eTFzHwMOhYFrFSpn6FgA/++ug=
From:   Leon Romanovsky <leon@kernel.org>
To:     Doug Ledford <dledford@redhat.com>,
        Jason Gunthorpe <jgg@mellanox.com>
Cc:     Leon Romanovsky <leonro@mellanox.com>,
        RDMA mailing list <linux-rdma@vger.kernel.org>
Subject: [PATCH rdma-next v1 2/3] RDMA: Clean destroy CQ in drivers do not return errors
Date:   Tue, 28 May 2019 14:37:28 +0300
Message-Id: <20190528113729.13314-3-leon@kernel.org>
...
index fd7ca578e9f7..8266625425da 100644
...
index 4bfab739ec0d..28a7cf6007c5 100644
...
index d6e8b446fc57..fe3962fc7820 100644
...
index 1fc77b1f2c6d..316a58e02942 100644
...
@@ -3655,7 +3651,7 @@ int hns_roce_v1_destroy_qp(struct ib_qp *ibqp, struct ib_udata *udata)
 	return 0;
 }
...
@@ -3664,7 +3660,6 @@ static int hns_roce_v1_destroy_cq(struct ib_cq *ibcq, struct ib_udata *udata)
 	u32 cqe_cnt_cur;
 	u32 cq_buf_size;
 	int wait_time = 0;
-	int ret = 0;
...
@@ -3686,7 +3681,6 @@ static int hns_roce_v1_destroy_cq(struct ib_cq *ibcq, struct ib_udata *udata)
...
-			ret = -ETIMEDOUT;
 		...
 		wait_time++;
@@ -3703,8 +3697,6 @@ static int hns_roce_v1_destroy_cq(struct ib_cq *ibcq, struct ib_udata *udata)
 	}
...
index 160245d4604c..afdb658be3be 100644
