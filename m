...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 63B4F2B14B8
	for <lists+linux-rdma@lfdr.de>; Fri, 13 Nov 2020 04:30:27 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726041AbgKMDa0 (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Thu, 12 Nov 2020 22:30:26 -0500
Received: from mga14.intel.com ([192.55.52.115]:61033 "EHLO mga14.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726017AbgKMDa0 (ORCPT <rfc822;linux-rdma@vger.kernel.org>);
        Thu, 12 Nov 2020 22:30:26 -0500
IronPort-SDR: 5vjcA7PAPBVHxoU1ETCC+P2kkQqniAhtKC9QfQ7ukQ//NhByogA8lKy03s0vT2oJOoWduzNLxd
 F/Oj9O2wli8w==
X-IronPort-AV: E=McAfee;i="6000,8403,9803"; a="169637260"
X-IronPort-AV: E=Sophos;i="5.77,474,1596524400"; 
   d="scan'208";a="169637260"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga001.jf.intel.com ([10.7.209.18])
  by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 12 Nov 2020 19:30:24 -0800
IronPort-SDR: Tf8qzdSsI/6EE292JLfbDWgkRb7yDL3HCfpivnn+Kni1dHUpDDV2mFnCydAbaCc4JvHRkrZpYs
 orHFsAFxhcwA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.77,474,1596524400"; 
   d="scan'208";a="399624151"
...
x-forefront-antispam-report: CIP:255.255.255.255;CTRY:;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:MW3PR11MB4555.namprd11.prod.outlook.com;PTR:;CAT:NONE;SFS:(4636009)(136003)(346002)(396003)(376002)(366004)(39860400002)(26005)(33656002)(6916009)(66946007)(53546011)(107886003)(478600001)(7696005)(6506007)(186003)(5660300002)(54906003)(86362001)(52536014)(8676002)(8936002)(64756008)(316002)(55016002)(76116006)(4326008)(66556008)(66446008)(66476007)(9686003)(71200400001)(83380400001)(2906002);DIR:OUT;SFP:1102;
...
X-MS-Exchange-CrossTenant-originalarrivaltime: 13 Nov 2020 03:30:04.3623
 (UTC)
...
,
                                       &end))
                        return -EOVERFLOW;
                end =3D ALIGN(end, page_size);
                if (unlikely(end < page_size))
                        return -EOVERFLOW;

The weird part seems to be checking if 'end' is 0, but that should have bee=
n covered
...
>=20
> offset + size =3D=3D end, already computed, in fact move this above the k=
zalloc
>=20
> Jason
