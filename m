...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 45F0B60CA6D
	for <lists+linux-rdma@lfdr.de>; Tue, 25 Oct 2022 12:53:45 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231751AbiJYKxn (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Tue, 25 Oct 2022 06:53:43 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:59576 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232469AbiJYKxn (ORCPT
        <rfc822;linux-rdma@vger.kernel.org>); Tue, 25 Oct 2022 06:53:43 -0400
Received: from szxga01-in.huawei.com (szxga01-in.huawei.com [45.249.212.187])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id E39E6181961
        for <linux-rdma@vger.kernel.org>; Tue, 25 Oct 2022 03:53:41 -0700 (PDT)
Received: from dggemv704-chm.china.huawei.com (unknown [172.30.72.57])
        by szxga01-in.huawei.com (SkyGuard) with ESMTP id 4MxTHC4828zpVsy;
        Tue, 25 Oct 2022 18:50:15 +0800 (CST)
...
Subject: [PATCH 3/5] RDMA/hns: Remove enable rq inline in kernel and add compatibility handling
Date:   Tue, 25 Oct 2022 18:52:42 +0800
Message-ID: <20221025105244.204570-4-xuhaoyue1@hisilicon.com>
...
to a new bit to prevent old kernel space from enabling rq inline.
...
index d472bb1b6f0b..6aac59c54ac7 100644
--- a/drivers/infiniband/hw/hns/hns_roce_qp.c
+++ b/drivers/infiniband/hw/hns/hns_roce_qp.c
@@ -1417,7 +1417,7 @@ int hns_roce_modify_qp(struct ib_qp *ibqp, struct ib_qp_attr *attr,
 		goto out;
