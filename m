...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id F22B32B2252
	for <lists+linux-rdma@lfdr.de>; Fri, 13 Nov 2020 18:28:34 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726070AbgKMR2a (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Fri, 13 Nov 2020 12:28:30 -0500
Received: from mga05.intel.com ([192.55.52.43]:3078 "EHLO mga05.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726066AbgKMR22 (ORCPT <rfc822;linux-rdma@vger.kernel.org>);
        Fri, 13 Nov 2020 12:28:28 -0500
IronPort-SDR: 7yeItXIzFHkzzzhbcq4lK2EnYjdNMnuyxfuGCNhMPKTFPKW70vZObp6biuHGfJUsbYvM7LBH/l
 xekKNld55xFg==
X-IronPort-AV: E=McAfee;i="6000,8403,9804"; a="255215357"
X-IronPort-AV: E=Sophos;i="5.77,476,1596524400"; 
   d="scan'208";a="255215357"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga008.jf.intel.com ([10.7.209.65])
  by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 13 Nov 2020 09:28:28 -0800
IronPort-SDR: CimYDpozihoFZaxPS8IQJPDcpDi2ElDaZkCGBtlMHSIg6C8KOwR5/8d8fytpFnPp8unJQsha2V
 Y+T69QMwjAiQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.77,476,1596524400"; 
   d="scan'208";a="355603987"
...
X-MS-Exchange-CrossTenant-originalarrivaltime: 13 Nov 2020 17:28:22.6374
 (UTC)
...
> >
> > It is still needed. When the dma-buf moves, the callback function of ev=
ery attached importer is invoked, regardless if the importer has
...
> > > > +	struct ib_umem_dmabuf *umem_dmabuf =3D
...
> > > > +	}
> > >
> > > I didn't check carefully, but are you sure this destroy_mkey should b=
e here??
> >
...
> dma_buf_detach() into mlx5, it makes the whole thing a little cleaner, th=
en the umem->private isn't needed any more either.

Putting these calls into mlx5 can remove the 'ops' parameter from the umem_=
get call,
but I don't see how umem->private can be eliminated. In addition, I feel ke=
eping these
two calls in the core provides a better separation between the core and the=
 driver --=20
dma-buf API functions are only called from the core, except for locking/unl=
ocking.

The 'if (mr)' part in the callback can be removed by adding a line
'if (!umem_dmabutf->sgt) return;' before that if that makes a difference.=20
