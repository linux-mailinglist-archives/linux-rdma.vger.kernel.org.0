...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 782F32F5350
	for <lists+linux-rdma@lfdr.de>; Wed, 13 Jan 2021 20:29:49 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728628AbhAMT2f (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Wed, 13 Jan 2021 14:28:35 -0500
Received: from mail.kernel.org ([198.145.29.99]:55898 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1727688AbhAMT2a (ORCPT <rfc822;linux-rdma@vger.kernel.org>);
        Wed, 13 Jan 2021 14:28:30 -0500
Received: by mail.kernel.org (Postfix) with ESMTPSA id 0996A2313E;
        Wed, 13 Jan 2021 19:27:48 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1610566069;
        bh=73O7B1obLekUiXn4ZGdmlUGPp6alM/k/8TDYckFpyIc=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=
...
Subject: [net-next V6 03/14] devlink: Support add and delete devlink port
Date:   Wed, 13 Jan 2021 11:27:19 -0800
Message-Id: <20210113192730.280656-4-saeed@kernel.org>
...
v5->v6:
 ...
 - aligned code for 80 characters limits
 - changed 'should' to 'must' in comments of driver callback
 - simplified comments of driver callbacks
...
index b6ebb516f1b0..bdf54830d975 100644
--- a/include/net/devlink.h
+++ b/include/net/devlink.h
@@ -151,6 +151,17 @@ struct devlink_port {
...
+
 struct devlink_sb_pool_info {
 	...
 	u32 size;
@@ -1361,6 +1372,33 @@ struct devlink_ops {
