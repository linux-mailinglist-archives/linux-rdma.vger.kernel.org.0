...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 4629B1E44BC
	for <lists+linux-rdma@lfdr.de>; Wed, 27 May 2020 15:56:02 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2389023AbgE0Nzl (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Wed, 27 May 2020 09:55:41 -0400
Received: from mail.kernel.org ([198.145.29.99]:51372 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S2388991AbgE0Nzk (ORCPT <rfc822;linux-rdma@vger.kernel.org>);
        Wed, 27 May 2020 09:55:40 -0400
Received: from localhost (unknown [213.57.247.131])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id 00C962078C;
        Wed, 27 May 2020 13:55:38 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1590587739;
        bh=orfoou0qcWEZzYESzhBI6jFstcs1nNv1CYrYd+JvKhQ=;
        h=From:To:Cc:Subject:Date:From;
        b=h2KrBAD2i18mayzGqX3N7XKkoDlr6JP8QEfVq9PGr4xJUXSBY/h8oAtllxXuAUyOL
         NIqE2ZaylfOtle4dOtp16Ev4/QpBU9c0j/bVSQAirsHsMa5n0vRST+q7JaBCIff4/E
         CA+eEJ6j2K8NnATP6HtVxxygC0FlxS+OA3lAvjjc=
From:   Leon Romanovsky <leon@kernel.org>
To:     Doug Ledford <dledford@redhat.com>,
        Jason Gunthorpe <jgg@mellanox.com>
Cc:     linux-rdma@vger.kernel.org, Maor Gottlieb <maorg@mellanox.com>
Subject: [PATCH rdma-next] RDMA/core: Fix double destruction of uobject
Date:   Wed, 27 May 2020 16:55:34 +0300
Message-Id: <20200527135534.482279-1-leon@kernel.org>
...
index de3858515275..38de4942c682 100644
--- a/drivers/infiniband/core/rdma_core.c
+++ b/drivers/infiniband/core/rdma_core.c
@@ -164,9 +164,9 @@ static int uverbs_destroy_uobject(struct ib_uobject *uobj,
 	uobj->context = NULL;
...
+ * caller must pair this with uobj_put_destroy(). This
  ...
  */
@@ -209,6 +209,13 @@ int uobj_destroy(struct ib_uobject *uobj, struct uverbs_attr_bundle *attrs)
...
+	 */
 	...
 	if (ret)
 		goto out_unlock;
@@ -227,7 +234,7 @@ int uobj_destroy(struct ib_uobject *uobj, struct uverbs_attr_bundle *attrs)
 /*
...
@@ -261,8 +268,7 @@ int __uobj_perform_destroy(const struct uverbs_api_object *obj, u32 id,
...
index d6784be27e4b..bf0392ae15eb 100644
