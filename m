mid,cornelisnetworks.com:dkim,cornelisnetworks.com:email,cornelisnetworks.com:from_mime,vger.kernel.org:from_smtp,sea.lore.kernel.org:rdns,sea.lore.kernel.org:helo];
...
---
  Changes since v2:
    - Remove unused dd variable and dd_from_ppd() call in hfi2_check_ah and
      hfi2_notify_new_ah
    - Replace hfi2_uverbs_write_iter() with HFI2_METHOD_CREATE_SDMA_FD ioctl
      that returns an anonymous 'hfi2-sdma' fd. The fd's write_iter calls
      hfi2_do_write_iter() directly, bypassing the ucontext lookup on the hot
      path.
  Changes since v1:
    - Address Leon's feedback (Re: v1 patch 07, Mar 17 2026): hard-code
      rsp.rec_cpu = 0xffff in hfi2_method_ctxt_info().  The driver no
      longer enforces per-process CPU affinity; user space is responsible
      via sched_setaffinity()/taskset.  The rec_cpu field is preserved in
      struct hfi2_ctxt_info_rsp for ABI layout compatibility.
---
 drivers/infiniband/hw/hfi2/exp_rcv.c  |   79 
 drivers/infiniband/hw/hfi2/tid_rdma.c | 5485 +++++++++++++++++++++++++++++++++
 drivers/infiniband/hw/hfi2/uverbs.c   |  646 ++++
 drivers/infiniband/hw/hfi2/uverbs.h   |    2 
 drivers/infiniband/hw/hfi2/verbs.c    |   30 
 include/uapi/rdma/hfi2-abi.h          |  689 ++++
 6 files changed, 6914 insertions(+), 17 deletions(-)
...
new file mode 100644
index 000000000000..6b91ddf9ee2f
--- /dev/null
...
+}
+
+void hfi2_tid_rdma_opfn_init(struct rvt_qp *qp, struct tid_rdma_params *p)
+{
+	struct hfi2_qp_priv *priv = qp->priv;
+
...
+	p->urg = hfi2_is_urg_masked(priv->rcd);
+}
+
+bool hfi2_tid_rdma_conn_req(struct rvt_qp *qp, u64 *data)
+{
+	struct hfi2_qp_priv *priv = qp->priv;
+
...
+}
+
+bool hfi2_tid_rdma_conn_reply(struct rvt_qp *qp, u64 data)
+{
+	struct hfi2_qp_priv *priv = qp->priv;
...
+}
+
+bool hfi2_tid_rdma_conn_resp(struct rvt_qp *qp, u64 *data)
+{
+	bool ret;
+
+	ret = hfi2_tid_rdma_conn_reply(qp, *data);
+	*data = 0;
+	/*
+	 * If hfi2_tid_rdma_conn_reply() returns error, set *data as 0 to indicate
+	 * TID RDMA could not be enabled. This will result in TID RDMA being
+	 * disabled at the requester too.
+	 */
+	if (ret)
+		(void)hfi2_tid_rdma_conn_req(qp, data);
+	return ret;
+}
+
+void hfi2_tid_rdma_conn_error(struct rvt_qp *qp)
+{
+	struct hfi2_qp_priv *priv = qp->priv;
...
+
+/**
+ * hfi2_qp_to_rcd - determine the receive context used by a qp
+ * @qp: the qp
+ *
...
+ */
+struct hfi2_ctxtdata *hfi2_qp_to_rcd(struct rvt_qp *qp)
+{
...
+	int i, ret;
+
+	qpriv->rcd = hfi2_qp_to_rcd(qp);
+
+	spin_lock_init(&qpriv->opfn.lock);
+	INIT_WORK(&qpriv->opfn.opfn_work, hfi2_opfn_send_conn_request);
...
+
+	if (flow->req->qp->pmtu == hfi2_enum_to_mtu(OPA_MTU_4096))
...
+
+/**
+ * __hfi2_trdma_clean_swqe - clean up for large sized QPs
+ * @qp: the queue patch
+ * @wqe: the send wqe
+ */
+void __hfi2_trdma_clean_swqe(struct rvt_qp *qp, struct rvt_swqe *wqe)
+{
...
+	e = hfi2_find_prev_entry(qp, psn, &prev, NULL, &old_req);
+	if (!e ||
...
+
+	if (!hfi2_do_rc_ack(qp, aeth, ipsn, opcode, 0, rcd))
+		goto ack_done;
+
...
+		}
+
+		wqe = hfi2_do_rc_completion(qp, wqe, ibp);
...
+}
+
+void hfi2_do_setup_tid_rdma_wqe(struct rvt_qp *qp, struct rvt_swqe *wqe)
+{
+	struct hfi2_qp_priv *qpriv = (struct hfi2_qp_priv *)qp->priv;
+	struct hfi2_swqe_priv *priv = wqe->priv;
+	struct tid_rdma_params *remote;
...
+
+	/*
+	 * The call to hfi2_do_rc_ack() should be last in the chain of
...
+	 * to it.
+	 */
+	if (!hfi2_do_rc_ack(qp, aeth, psn, opcode, 0, rcd))
+		goto ack_done;
+
...
+		if (req->ack_seg == req->total_segs) {
+			req->state = TID_REQUEST_COMPLETE;
+			wqe = hfi2_do_rc_completion(qp, wqe,
...
+	 * sleep/wakeup flags.)
+	 */
+	hfi2_iowait_set_flag(&priv->s_iowait, IOWAIT_PENDING_TID);
+	return 0;
+}
+
+static int make_tid_rdma_ack(struct rvt_qp *qp, struct ib_other_headers *ohdr,
...
+				priv->s_flags &= ~HFI2_S_TID_BUSY_SET;
+				ps.wait = iowait_get_tid_work(&priv->s_iowait);
+				if (hfi2_iowait_flag_set(&priv->s_iowait,
+						    IOWAIT_PENDING_IB))
+					hfi2_schedule_send(qp);
+			}
+		}
...
+	}
+	if (qp->s_flags & HFI2_S_ANY_WAIT_IO)
+		hfi2_iowait_set_flag(&((struct hfi2_qp_priv *)qp->priv)->s_iowait,
+				IOWAIT_PENDING_TID);
+	return false;
+}
+
...
new file mode 100644
index 000000000000..df3703f2fed0
--- /dev/null
...
index 2250a712875c..cac1fbda942b 100644
...
index 6e5e5cb6247a..e3ea1aadb9ed 100644
--- a/drivers/infiniband/hw/hfi2/verbs.c
+++ b/drivers/infiniband/hw/hfi2/verbs.c
@@ -1744,6 +1744,7 @@ static int get_hw_stats(struct ib_device *ibdev, struct rdma_hw_stats *stats,
...
@@ -1755,12 +1756,12 @@ static const struct ib_device_ops hfi2_dev_ops = {
...
+	.uverbs_abi_ver = HFI2_UVERBS_ABI_VERSION,
 	...
 	.alloc_hw_device_stats = hfi2_alloc_hw_device_stats,
 	.alloc_hw_port_stats = hfi_alloc_hw_port_stats,
@@ -1772,12 +1773,12 @@ static const struct ib_device_ops cport_dev_ops = {
 	/* keep process mad in the driver */
...
+	.uverbs_abi_ver = HFI2_UVERBS_ABI_VERSION,
 	...
 	.alloc_hw_device_stats = hfi2_alloc_hw_device_stats,
 	.alloc_hw_port_stats = hfi_alloc_hw_port_stats,
@@ -1868,7 +1869,7 @@ int hfi2_register_ib_device(struct hfi2_devdata *dd)
 	/*
...
@@ -1901,22 +1902,21 @@ int hfi2_register_ib_device(struct hfi2_devdata *dd)
...
new file mode 100644
index 000000000000..7b7ca198b539
--- /dev/null
