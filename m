...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 9E310592105
	for <lists+linux-rdma@lfdr.de>; Sun, 14 Aug 2022 17:33:01 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S239475AbiHNPc5 (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Sun, 14 Aug 2022 11:32:57 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:39596 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S240258AbiHNPce (ORCPT
        <rfc822;linux-rdma@vger.kernel.org>); Sun, 14 Aug 2022 11:32:34 -0400
Received: from dfw.source.kernel.org (dfw.source.kernel.org [IPv6:2604:1380:4641:c500::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id E1DDD1B7B5;
        Sun, 14 Aug 2022 08:29:58 -0700 (PDT)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by dfw.source.kernel.org (Postfix) with ESMTPS id E1D6160C41;
        Sun, 14 Aug 2022 15:29:57 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 41A8AC433C1;
        Sun, 14 Aug 2022 15:29:56 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1660490997;
        bh=NJ5JFji8AKczbHYMP+URS6Ntns4M6haMIo0PKhyQG34=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=
...
Subject: [PATCH AUTOSEL 5.19 53/64] Revert "RDMA/rxe: Create duplicate mapping tables for FMRs"
Date:   Sun, 14 Aug 2022 11:24:26 -0400
Message-Id: <20220814152437.2374207-53-sashal@kernel.org>
...
index fc3942e04a1f..b02ca3e81dcf 100644
...
index 2e1fa844fabf..16cb06e5ff2d 100644
--- a/drivers/infiniband/sw/rxe/rxe_mw.c
+++ b/drivers/infiniband/sw/rxe/rxe_mw.c
@@ -119,15 +119,15 @@ static int rxe_check_bind_mw(struct rxe_qp *qp, struct rxe_send_wqe *wqe,
...
index ac464e68c923..d83927b9850c 100644
