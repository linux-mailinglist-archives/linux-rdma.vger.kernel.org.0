...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id CA6BC2050BC
	for <lists+linux-rdma@lfdr.de>; Tue, 23 Jun 2020 13:31:11 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1732245AbgFWLbK (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Tue, 23 Jun 2020 07:31:10 -0400
Received: from mail.kernel.org ([198.145.29.99]:42786 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1732447AbgFWLbI (ORCPT <rfc822;linux-rdma@vger.kernel.org>);
        Tue, 23 Jun 2020 07:31:08 -0400
Received: from localhost (unknown [213.57.247.131])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id 4B51120702;
        Tue, 23 Jun 2020 11:31:07 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1592911868;
        bh=NwntB81wG2YVKe/iktj1ZIKVC9UGkDp30KxJb1xJTL4=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=eUbbenM8H+xCkPsBcFH+QF5mz3X2d+fcqSN8rm/nYQBt9vZ6WZiyRJPBifLuAHtoc
         IKVh9hKJ6Y/p9aOaVpksOJsAjPolBcvbDG1fGu1xFvdQQ9fwIVQcngxFYS/XNss5F5
         jXnovvpN5ApyezAroxR0cIi5qMDTT0xaHG91nFWA=
...
Subject: [PATCH rdma-next v3 05/11] RDMA: Add a dedicated CQ resource tracker function
Date:   Tue, 23 Jun 2020 14:30:37 +0300
Message-Id: <20200623113043.1228482-6-leon@kernel.org>
...
index ffdf9787e7f6..9eeac8cb600e 100644
...
index 479fa557993e..b890ff63f24d 100644
--- a/drivers/infiniband/hw/hns/hns_roce_device.h
+++ b/drivers/infiniband/hw/hns/hns_roce_device.h
@@ -1267,6 +1267,6 @@ void hns_roce_handle_device_err(struct hns_roce_dev *hr_dev);
...
index 4f5dfdc53dc5..47516a91cf8a 100644
