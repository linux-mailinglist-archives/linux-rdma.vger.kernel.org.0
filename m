Return-Path: <linux-rdma+bounces-22534-lists+linux-rdma=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-rdma@lfdr.de
Received: from mail.lfdr.de
	by mail.lfdr.de with LMTP
	id 8myaKOX5P2qyawkAu9opvQ
	(envelope-from <linux-rdma+bounces-22534-lists+linux-rdma=lfdr.de@vger.kernel.org>)
	for <lists+linux-rdma@lfdr.de>; Sat, 27 Jun 2026 18:27:17 +0200
X-Original-To: lists+linux-rdma@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [172.234.253.10])
	by mail.lfdr.de (Postfix) with ESMTPS id 7A0D16D244C
	for <lists+linux-rdma@lfdr.de>; Sat, 27 Jun 2026 18:27:16 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=pass header.d=cornelisnetworks.com header.s=selector1 header.b=G8U4w8hg;
	spf=pass (mail.lfdr.de: domain of "linux-rdma+bounces-22534-lists+linux-rdma=lfdr.de@vger.kernel.org" designates 172.234.253.10 as permitted sender) smtp.mailfrom="linux-rdma+bounces-22534-lists+linux-rdma=lfdr.de@vger.kernel.org";
	dmarc=pass (policy=none) header.from=cornelisnetworks.com;
	arc=reject ("cv is fail on i=2")
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id 6B8AE3018088
	for <lists+linux-rdma@lfdr.de>; Sat, 27 Jun 2026 16:27:08 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 852FF2DE70D;
	Sat, 27 Jun 2026 16:27:06 +0000 (UTC)
...
Received: from PH0PR06CU001.outbound.protection.outlook.com (mail-westus3azon11021078.outbound.protection.outlook.com [40.107.208.78])
	...
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id CB38C2EEE7E
	for <linux-rdma@vger.kernel.org>; Sat, 27 Jun 2026 16:26:47 +0000 (UTC)
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1782577625; cv=fail; b=hGodipkriWIX3ESIBad5SRO8GJ7tKhA9D2AeoA2hm7UPXEXNtbCe2glm0uhep4S+n3Kws/js/e82p+Db5W6cF6Y8Hm0eu/mzLWV2rFyZ6vRihyuNNbBbgSQcsKjs57aPTOqQpdCzv60ZlLlJivI2ZguYLa7jkonUxYSW7chBekE=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1782577625; c=relaxed/simple;
	bh=ida3dX4gEHFOy83ebUFrjxJMtQR2j/nWltKv3CFjgPg=;
	h=Subject:From:To:Cc:Date:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=SXpqWE5PrKxY8mJ9JLbRBvSZVN0b9Eh3dFKSpN5nbnIcuYBly7hrkG9gja9uz5ulKfjpWx68OSFUus9M5CwOsYZEA9Sk72X8bxtvP/dZ8KoYgF2KUKYaeqARyjjyp7nGm0oHd9apd6a99TLwKX/f2lhjS2rUmJVXIp72WWltTLA=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=cornelisnetworks.com; spf=pass smtp.mailfrom=cornelisnetworks.com; dkim=pass (2048-bit key) header.d=cornelisnetworks.com header.i=@cornelisnetworks.com header.b=G8U4w8hg; arc=fail smtp.client-ip=40.107.208.78
ARC-Seal: i=1; a=rsa-sha256; s=arcselector10001; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com;
 s=arcselector10001;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-AntiSpam-MessageData-ChunkCount:X-MS-Exchange-AntiSpam-MessageData-0:X-MS-Exchange-AntiSpam-MessageData-1;
 bh=PjTn83rGEXPKzmzUfhj5qnWISxDYkLnJ0/jiKXYOgVw=;
 b=
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=cornelisnetworks.com;
 ...
 bh=PjTn83rGEXPKzmzUfhj5qnWISxDYkLnJ0/jiKXYOgVw=;
 b=
Received: from SA0PR11CA0210.namprd11.prod.outlook.com (2603:10b6:806:1bc::35)
 by DM8PR01MB6984.prod.exchangelabs.com (2603:10b6:8:19::21) with Microsoft
 SMTP Server (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.21.159.18; Sat, 27 Jun 2026 16:26:41 +0000
Received: from SN1PEPF000397AE.namprd05.prod.outlook.com
 (2603:10b6:806:1bc:cafe::4) by SA0PR11CA0210.outlook.office365.com
...
Received: from cn-mailer-00.localdomain (50.148.235.34) by
 ...
 via Frontend Transport; Sat, 27 Jun 2026 16:26:41 +0000
Received: from awdrv-04.localdomain (unknown [10.228.212.218])
	by cn-mailer-00.localdomain (Postfix) with ESMTPS id B2AFD146565;
	Sat, 27 Jun 2026 12:26:40 -0400 (EDT)
Received: from [10.228.212.218] (localhost [IPv6:::1])
	by awdrv-04.localdomain (Postfix) with ESMTP id AAE5D1810D6C7;
	Sat, 27 Jun 2026 12:26:40 -0400 (EDT)
Subject: [PATCH v2 for-next 21/24] RDMA/hfi2: Add the rest of the driver
From: Dennis Dalessandro <dennis.dalessandro@cornelisnetworks.com>
To: jgg@ziepe.ca, leon@kernel.org
Cc: Dean Luick <dean.luick@cornelisnetworks.com>,
 Douglas Miller <doug.miller@cornelisnetworks.com>, linux-rdma@vger.kernel.org
Date: Sat, 27 Jun 2026 12:26:40 -0400
Message-ID: <178257760063.371918.16696994266664990761.stgit@awdrv-04>
...
X-MS-TrafficTypeDiagnostic: SN1PEPF000397AE:EE_|DM8PR01MB6984:EE_
X-MS-Office365-Filtering-Correlation-Id: 28959325-ea3e-41d5-6f6d-08ded468ded8
X-MS-Exchange-AtpMessageProperties: SA
X-MS-Exchange-SenderADCheck: 1
X-MS-Exchange-AntiSpam-Relay: 0
X-Microsoft-Antispam:
	BCL:0;ARA:13230040|23010399003|82310400026|376014|1800799024|36860700016|6133799003|56012099006|5023799004|55112099003|18002099003|22082099003|3023799007;
X-Microsoft-Antispam-Message-Info:
	
X-Forefront-Antispam-Report:
	CIP:50.148.235.34;CTRY:US;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:cn-mailer-00.localdomain;PTR:InfoDomainNonexistent;CAT:NONE;SFS:(13230040)(23010399003)(82310400026)(376014)(1800799024)(36860700016)(6133799003)(56012099006)(5023799004)(55112099003)(18002099003)(22082099003)(3023799007);DIR:OUT;SFP:1102;
X-MS-Exchange-AntiSpam-MessageData-ChunkCount: 1
X-MS-Exchange-AntiSpam-MessageData-0:
	
X-OriginatorOrg: cornelisnetworks.com
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 27 Jun 2026 16:26:41.1961
 (UTC)
X-MS-Exchange-CrossTenant-Network-Message-Id: 28959325-ea3e-41d5-6f6d-08ded468ded8
...
X-MS-Exchange-Transport-CrossTenantHeadersStamped: DM8PR01MB6984
...
X-Spamd-Result: default: False [0.34 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	TO_DN_SOME(0.00)[];
	TAGGED_FROM(0.00)[bounces-22534-lists,linux-rdma=lfdr.de];
	RCVD_TLS_LAST(0.00)[];
	MIME_TRACE(0.00)[0:+];
...
X-Rspamd-Queue-Id: 7A0D16D244C

There are a few other C files left after adding all the major topics; add
them in one go. Also includes the Makefile now that all source files are
present, and removes stale TODO comments from sriov.c.
...
---
 ...
 drivers/infiniband/hw/hfi2/vf2pf_lb.c |   15 
 10 files changed, 6487 insertions(+), 17 deletions(-)
...
index 000000000000..8ba2af9c7dba
--- /dev/null
...
new file mode 100644
index 000000000000..f0aa855efd6c
--- /dev/null
...
+}
+
+static void *_qp_stats_seq_next(struct seq_file *s, void *iter_ptr, loff_t *pos)
+	__must_hold(RCU)
+{
...
+		hfi2_sdma_seqfile_dump_sde(s, &dd->per_sdma[i]);
+	return 0;
+}
+
...
+
+/* read the per-device counters */
+static ssize_t dev_names_read(struct file *file, char __user *buf, size_t count,
+			      loff_t *ppos)
+{
+	char *names;
+	size_t avail;
...
+static ssize_t portnames_read(struct file *file, char __user *buf, size_t count,
+			      loff_t *ppos)
+{
+	char *names;
+	size_t avail;
...
+		return -ENOMEM;
+
+	scratch0 = hfi2_read_csr(dd, ASIC_CFG_SCRATCH);
...
+	hfi2_acquire_hw_mutex(dd);
+
+	scratch0 = hfi2_read_csr(dd, ASIC_CFG_SCRATCH);
+	scratch0 &= ~clear;
+	hfi2_write_csr(dd, ASIC_CFG_SCRATCH, scratch0);
+	/* force write to be visible to other HFI on another OS */
+	(void)hfi2_read_csr(dd, ASIC_CFG_SCRATCH);
+
+	hfi2_release_hw_mutex(dd);
...
+		rval = hfi2_read_8051_data(ppd->dd, start, end - start,
+				      (u64 *)(tmp + start));
+		if (rval)
+			goto done;
+	}
...
+		if (hfi2_read_lcb_csr(ppd, csr_off, (u64 *)&data))
+			break; /* failed */
...
+			break;
+		if (hfi2_write_lcb_csr(ppd, csr_off, data))
+			break; /* failed */
+	}
+	*ppos += total;
+	return total;
...
+		return -ENOMEM;
+
+	ret = hfi2_qsfp_dump(ppd, tmp, PAGE_SIZE);
+	if (ret > 0)
...
+		return PTR_ERR(buff);
+
+	total_written = hfi2_i2c_write(ppd, target, i2c_addr, offset, buff, count);
+	if (total_written < 0) {
+		ret = total_written;
+		goto _free;
+	}
...
+		return -ENOMEM;
+
+	total_read = hfi2_i2c_read(ppd, target, i2c_addr, offset, buff, count);
+	if (total_read < 0) {
+		ret = total_read;
+		goto _free;
+	}
...
+		return PTR_ERR(buff);
+
+	total_written = hfi2_qsfp_write(ppd, target, *ppos, buff, count);
+	if (total_written < 0) {
+		ret = total_written;
+		goto _free;
+	}
...
+	}
+
+	total_read = hfi2_qsfp_read(ppd, target, *ppos, buff, count);
+	if (total_read < 0) {
+		ret = total_read;
+		goto _free;
+	}
...
+	ppd = private2ppd(fp);
+
+	return hfi2_acquire_chip_resource(ppd->dd, i2c_target(target), 0);
+}
+
...
+	ppd = private2ppd(fp);
+
+	hfi2_release_chip_resource(ppd->dd, i2c_target(target));
+
+	return 0;
+}
+
...
+	}
+
+	hfi2_write_csr(dd, ASIC_GPIO_OUT, gpio_val);
+	hfi2_write_csr(dd, ASIC_GPIO_OE, gpio_val);
+
+	return 0;
+}
+
...
+	DEBUGFS_OPS("hfi2_qsfp_dump%d", qsfp_debugfs_dump, NULL),
...
+	loff_t i = *spos;
+
+	hfi2_sdma_seqfile_dump_cpu_list(s, dd, (unsigned long)i);
+	return 0;
+}
+
...
+
+	pr_info("%s: fake active port index %d, lid %d (with hfi2_set_mtu call)\n",
+		__func__, pidx, lid);
+
+	/*
...
+	ib_dispatch_event(&event);
+
+	/* swiped from hfi2_set_link_state - sorta.  hfi2_go_port_active() is new in this
+	 * stack of patches
+	 */
...
+		return -EINVAL;
+
+	rc = hfi2_cport_ping_start(dd, value);
+	if (rc)
+		return rc;
+	return count;
+}
...
+	/* must be element 0*/
+	"KernIntr",  "ErrorIntr", "Tx_Errs",	 "Rcv_Errs",   "H/W_Errs",
+	"NoPIOBufs", "CtxtsOpen", "RcvLen_Errs", "EgrBufFull", "EgrHdrFull"
+};
+
...
new file mode 100644
index 000000000000..cca14f1732c5
--- /dev/null
...
+	int i;
+
+	hfi2_write_csr(dd, ASIC_EEP_ADDR_CMD, CMD_READ_DATA(offset));
+	for (i = 0; i < EP_PAGE_DWORDS; i++)
+		result[i] = (u32)hfi2_read_csr(dd, ASIC_EEP_DATA);
+	hfi2_write_csr(dd, ASIC_EEP_ADDR_CMD, CMD_NOP); /* close open page */
+}
+
+/*
...
+	 */
+	ret = hfi2_acquire_chip_resource(dd, CR_EPROM, EPROM_TIMEOUT);
+	if (ret) {
+		dd_dev_err(dd,
...
+
+	/* set reset */
+	hfi2_write_csr(dd, ASIC_EEP_CTL_STAT, ASIC_EEP_CTL_STAT_EP_RESET_SMASK);
+	/* clear reset, set speed */
+	hfi2_write_csr(dd, ASIC_EEP_CTL_STAT,
+		  EP_SPEED_FULL << ASIC_EEP_CTL_STAT_RATE_SPI_SHIFT);
+
+	/* wake the device with command "release powerdown NoID" */
+	hfi2_write_csr(dd, ASIC_EEP_ADDR_CMD, CMD_RELEASE_POWERDOWN_NOID);
+
+	dd->eprom_available = true;
+	hfi2_release_chip_resource(dd, CR_EPROM);
+done_asic:
+	return ret;
+}
+
...
+ */
+int hfi2_eprom_read_platform_config(struct hfi2_devdata *dd, void **data, u32 *size)
+{
...
new file mode 100644
index 000000000000..e085b8cae020
--- /dev/null
...
+
+#define PCI_EXP_COMP_TIMEOUT_MASK \
+	(PCI_EXP_DEVCTL2_COMP_TMOUT_DIS | PCI_EXP_DEVCTL2_COMP_TIMEOUT)
+
+static int pcie_compl_to = PCI_EXP_COMP_TIMEOUT_RANGE_C |
+			   PCI_EXP_COMP_TIMEOUT_RANGE_B;
+
+/*
...
+		 * Calling hfi2_vf2pf_get_config() provides this information to VFs.
+		 */
+		if (!dd->is_vf) {
...
+	}
+
+	bm->kregbase2 = ioremap(addr + dd->base2_start, dd->params->kreg2_size);
+	if (!bm->kregbase2) {
...
+	snprintf(dd->lbus_info, sizeof(dd->lbus_info), "PCIe,%uMHz,x%u",
...
+	 */
+	if (parent && (dd->pcidev->bus->max_bus_speed == PCIE_SPEED_2_5GT ||
...
+
+/**
+ * hfi2_tune_pcie_caps() - Code to adjust PCIe capabilities.
...
+				dd->pcidev, PCI_EXP_DEVCTL2,
+				PCI_EXP_COMP_TIMEOUT_MASK, pcie_compl_to);
+		}
+	}
+
+	/*
...
+}
+
+static pci_ers_result_t pci_mmio_enabled(struct pci_dev *pdev)
+{
+	u64 rev;
+	struct hfi2_devdata *dd = pci_get_drvdata(pdev);
+	pci_ers_result_t ret = PCI_ERS_RESULT_RECOVERED;
...
+		rev = hfi2_read_csr(dd, CCE_REVISION);
+		if (rev == ~0ULL)
+			ret = PCI_ERS_RESULT_NEED_RESET;
+		dd_dev_info(
+			dd,
...
+	((((u32)(pre)) << PCIE_CFG_REG_PL102_GEN3_EQ_PRE_CURSOR_PSET_SHIFT) | \
...
+		ret = pci_read_config_dword(dd->pcidev, PCIE_CFG_REG_PL105,
+					    &violation);
+		if (ret) {
+			dd_dev_err(dd, "Unable to read from PCI config\n");
+			hit_error = 1;
...
+	      ((u64)hfi2_pcie_serdes_broadcast[dd->hfi2_id]
+		       << ASIC_PCIE_SD_HOST_CMD_SBUS_RCVR_ADDR_SHIFT |
+	       ASIC_PCIE_SD_HOST_CMD_SBR_MODE_SMASK |
+	       ((u64)SBR_DELAY_US & ASIC_PCIE_SD_HOST_CMD_TIMER_MASK)
+		       << ASIC_PCIE_SD_HOST_CMD_TIMER_SHIFT);
+	hfi2_write_csr(dd, ASIC_PCIE_SD_HOST_CMD, reg);
+	/* read back to push the write */
+	hfi2_read_csr(dd, ASIC_PCIE_SD_HOST_CMD);
+}
+
+/*
...
+	u64 lane_bundle;
+
+	pcie_ctrl = hfi2_read_csr(dd, CCE_PCIE_CTRL);
+
+	/*
...
+
+		hfi2_write_csr(dd, CCE_PCIE_CTRL, pcie_ctrl);
+	}
+
...
+	therm = hfi2_read_csr(dd, ASIC_CFG_THERM_POLL_EN);
+	if (therm) {
...
+	ret = hfi2_load_pcie_firmware(dd);
+	if (ret) {
...
+	pci_write_config_dword(
+		dd->pcidev, PCIE_CFG_REG_PL106,
+		((1 << pset) << PCIE_CFG_REG_PL106_GEN3_EQ_PSET_REQ_VEC_SHIFT) |
...
+
+	/*
+	 * step 5e: ASPM is managed by the kernel PCIe core (pcie_aspm=
+	 * cmdline). The driver does not modify ASPM state; the L1 latency
+	 * configuration is handled at the platform level.
+	 */
+
+	/*
...
+	(void)hfi2_read_csr(dd, CCE_DC_CTRL); /* DC reset hold */
+	/* save firmware control across the SBR */
+	fw_ctrl = hfi2_read_csr(dd, MISC_CFG_FW_CTRL);
+
...
+	dd_dev_info(dd, "%s: calling hfi2_restore_pci_variables\n", __func__);
...
+	hfi2_write_csr(dd, MISC_CFG_FW_CTRL, fw_ctrl);
+
+	/*
...
+	 * the status.
+	 */
+	reg = hfi2_read_csr(dd, ASIC_PCIE_SD_HOST_STATUS);
...
+	dd->params->hfi2_setextled(&dd->pport[0], 0);
+
...
+		dd_dev_err(dd, "%s: gasket status 0x%x, expecting 0x%x\n",
...
new file mode 100644
index 000000000000..d6fbcd8cbea1
--- /dev/null
...
+	int i, j, version;
+
+	temp_scratch = hfi2_read_csr(dd, ASIC_CFG_SCRATCH);
...
+		temp_scratch = hfi2_read_csr(dd, ASIC_CFG_SCRATCH + (8 * i));
...
+
+	temp_scratch = hfi2_read_csr(dd, ASIC_CFG_SCRATCH_1);
+
+	temp_dest = temp_scratch & (dd->hfi2_id ? PORT1_PORT_TYPE_SMASK :
+						  PORT0_PORT_TYPE_SMASK);
+	ppd->port_type = temp_dest >> (dd->hfi2_id ? PORT1_PORT_TYPE_SHIFT :
+						     PORT0_PORT_TYPE_SHIFT);
+
+	temp_dest = temp_scratch & (dd->hfi2_id ? PORT1_LOCAL_ATTEN_SMASK :
+						  PORT0_LOCAL_ATTEN_SMASK);
+	ppd->local_atten = temp_dest >> (dd->hfi2_id ? PORT1_LOCAL_ATTEN_SHIFT :
+						       PORT0_LOCAL_ATTEN_SHIFT);
+
+	temp_dest = temp_scratch & (dd->hfi2_id ? PORT1_REMOTE_ATTEN_SMASK :
+						  PORT0_REMOTE_ATTEN_SMASK);
+	ppd->remote_atten = temp_dest >> (dd->hfi2_id ?
+						  PORT1_REMOTE_ATTEN_SHIFT :
+						  PORT0_REMOTE_ATTEN_SHIFT);
+
+	temp_dest = temp_scratch & (dd->hfi2_id ? PORT1_DEFAULT_ATTEN_SMASK :
+						  PORT0_DEFAULT_ATTEN_SMASK);
+	ppd->default_atten = temp_dest >> (dd->hfi2_id ?
+						   PORT1_DEFAULT_ATTEN_SHIFT :
+						   PORT0_DEFAULT_ATTEN_SHIFT);
+
+	temp_scratch = hfi2_read_csr(dd, dd->hfi2_id ? ASIC_CFG_SCRATCH_3 :
+						  ASIC_CFG_SCRATCH_2);
+
...
+		}
+	} else {
+		ret = hfi2_eprom_read_platform_config(
+			dd, (void **)&temp_platform_config, &esize);
+		if (!ret) {
+			/* success */
...
+			       DEFAULT_PLATFORM_CONFIG_NAME, &dd->pcidev->dev);
+	if (ret) {
...
+	 * structure. This allows hfi2_free_platform_config to treat EPROM and
...
+	u32 temp;
+
+	ret = hfi2_get_platform_config_field(ppd, PLATFORM_CONFIG_PORT_TABLE, 0,
+					PORT_TABLE_PORT_TYPE, &temp, 4);
+	if (ret) {
...
+	int ret = 0;
+
+	ret = hfi2_qsfp_write(ppd, ppd->dd->hfi2_id, QSFP_TX_CTRL_BYTE_OFFS,
+			 &tx_ctrl_byte, 1);
...
+	int ret = 0;
+
+	ret = hfi2_get_platform_config_field(ppd, PLATFORM_CONFIG_SYSTEM_TABLE, 0,
+					SYSTEM_TABLE_QSFP_POWER_CLASS_MAX,
+					&power_class_max, 4);
+	if (ret)
+		return ret;
+
+	cable_power_class = hfi2_get_qsfp_power_class(cache[QSFP_MOD_PWR_OFFS]);
+
...
+		power_ctrl_byte &= ~(0x2);
+
+		ret = hfi2_qsfp_write(ppd, ppd->dd->hfi2_id, QSFP_PWR_CTRL_BYTE_OFFS,
+				 &power_ctrl_byte, 1);
+		if (ret != 1)
+			return -EIO;
+
...
+			power_ctrl_byte |= (1 << 2);
+			ret = hfi2_qsfp_write(ppd, ppd->dd->hfi2_id,
...
+}
+
+static void apply_rx_cdr(struct hfi2_pportdata *ppd, u32 rx_preset_index,
+			 u8 *cdr_ctrl_byte)
+{
+	u32 rx_preset;
+	u8 *cache = ppd->qsfp_info.cache;
...
+	}
+
+	hfi2_get_platform_config_field(ppd, PLATFORM_CONFIG_RX_PRESET_TABLE,
+				  rx_preset_index,
+				  RX_PRESET_TABLE_QSFP_RX_CDR_APPLY, &rx_preset,
+				  4);
+
+	if (!rx_preset) {
...
+	rx_preset = (rx_preset | (rx_preset << 1) | (rx_preset << 2) |
+		     (rx_preset << 3));
+
+	if (rx_preset) {
...
+}
+
+static void apply_tx_cdr(struct hfi2_pportdata *ppd, u32 tx_preset_index,
+			 u8 *cdr_ctrl_byte)
+{
+	u32 tx_preset;
+	u8 *cache = ppd->qsfp_info.cache;
...
+	}
+
+	hfi2_get_platform_config_field(ppd, PLATFORM_CONFIG_TX_PRESET_TABLE,
+				  tx_preset_index,
+				  TX_PRESET_TABLE_QSFP_TX_CDR_APPLY, &tx_preset,
+				  4);
+
+	if (!tx_preset) {
...
+
+	/* Expand cdr setting to all 4 lanes */
+	tx_preset = (tx_preset | (tx_preset << 1) | (tx_preset << 2) |
+		     (tx_preset << 3));
+
+	if (tx_preset)
...
+}
+
+static void apply_cdr_settings(struct hfi2_pportdata *ppd, u32 rx_preset_index,
+			       u32 tx_preset_index)
+{
+	u8 *cache = ppd->qsfp_info.cache;
...
+
+	hfi2_qsfp_write(ppd, ppd->dd->hfi2_id, QSFP_CDR_CTRL_BYTE_OFFS,
+		   &cdr_ctrl_byte, 1);
+}
+
...
+	tx_eq &= 0xF0;
+	hfi2_qsfp_write(ppd, ppd->dd->hfi2_id, (256 * 3) + 241, &tx_eq, 1);
+}
+
...
+	hfi2_get_platform_config_field(ppd, PLATFORM_CONFIG_TX_PRESET_TABLE,
+				  tx_preset_index,
+				  TX_PRESET_TABLE_QSFP_TX_EQ_APPLY, &tx_preset,
+				  4);
+	if (!tx_preset) {
...
+	hfi2_qsfp_write(ppd, ppd->dd->hfi2_id, (256 * 3) + 234, &tx_eq, 1);
+	hfi2_qsfp_write(ppd, ppd->dd->hfi2_id, (256 * 3) + 235, &tx_eq, 1);
+}
+
...
+	hfi2_get_platform_config_field(ppd, PLATFORM_CONFIG_RX_PRESET_TABLE,
+				  rx_preset_index,
+				  RX_PRESET_TABLE_QSFP_RX_EMP_APPLY, &rx_preset,
+				  4);
+
+	if (!rx_preset) {
...
+
+	hfi2_qsfp_write(ppd, ppd->dd->hfi2_id, (256 * 3) + 236, &rx_eq, 1);
+	hfi2_qsfp_write(ppd, ppd->dd->hfi2_id, (256 * 3) + 237, &rx_eq, 1);
+}
+
+static void apply_eq_settings(struct hfi2_pportdata *ppd, u32 rx_preset_index,
+			      u32 tx_preset_index)
+{
+	u8 *cache = ppd->qsfp_info.cache;
+
...
+	if (cache[2] & 4) {
+		ppd_dev_info(ppd, "%s: Upper page 03 not present\n", __func__);
+		return;
+	}
+
...
+}
+
+static void apply_rx_amplitude_settings(struct hfi2_pportdata *ppd,
+					u32 rx_preset_index,
+					u32 tx_preset_index)
+{
+	u32 rx_preset;
...
+		ppd_dev_info(ppd, "%s: RX_AMP_APPLY is set to disabled\n",
+			     __func__);
+		return;
+	}
+
+	hfi2_get_platform_config_field(ppd, PLATFORM_CONFIG_RX_PRESET_TABLE,
+				  rx_preset_index,
+				  RX_PRESET_TABLE_QSFP_RX_AMP_APPLY, &rx_preset,
+				  4);
+
+	if (!rx_preset) {
+		ppd_dev_info(ppd, "%s: RX_AMP_APPLY is set to disabled\n",
...
+				  &rx_preset, 4);
+
+	ppd_dev_info(ppd, "%s: Requested RX AMP %x\n", __func__, rx_preset);
+
+	for (i = 0; i < 4; i++) {
...
+	}
+
+	ppd_dev_info(ppd, "%s: Applying RX AMP %x\n", __func__, preferred);
+
+	rx_amp = preferred | (preferred << 4);
+	hfi2_qsfp_write(ppd, ppd->dd->hfi2_id, (256 * 3) + 238, &rx_amp, 1);
+	hfi2_qsfp_write(ppd, ppd->dd->hfi2_id, (256 * 3) + 239, &rx_amp, 1);
+}
+
...
+
+	for (i = 0; i < 4; i++) {
+		ret = hfi2_load_8051_config(ppd->dd, field_id, i, config_data);
+		if (ret != HCMD_SUCCESS) {
...
+	case 0xE:
+		/* active AOC */
+		power_class = hfi2_get_qsfp_power_class(cache[QSFP_MOD_PWR_OFFS]);
...
+}
+
+static void apply_tunings(struct hfi2_pportdata *ppd, u32 tx_preset_index,
...
+	hfi2_read_8051_config(ppd->dd, LINK_TUNING_PARAMETERS, GENERAL_CONFIG,
+			 &config_data);
+	config_data &= ~(0xff << TUNING_METHOD_SHIFT);
+	config_data |= ((u32)tuning_method << TUNING_METHOD_SHIFT);
+	ret = hfi2_load_8051_config(ppd->dd, LINK_TUNING_PARAMETERS, GENERAL_CONFIG,
+			       config_data);
+	if (ret != HCMD_SUCCESS)
...
+		ret = hfi2_read_8051_config(ppd->dd, DC_HOST_COMM_SETTINGS,
+				       GENERAL_CONFIG, &config_data);
+		/* Clear, then set the external device config field */
+		config_data &= ~(u32)0xFF;
+		config_data |= external_device_config;
+		ret = hfi2_load_8051_config(ppd->dd, DC_HOST_COMM_SETTINGS,
+				       GENERAL_CONFIG, config_data);
+		if (ret != HCMD_SUCCESS)
+			ppd_dev_err(ppd,
...
+	hfi2_get_platform_config_field(ppd, PLATFORM_CONFIG_TX_PRESET_TABLE,
+				  tx_preset_index, TX_PRESET_TABLE_PRECUR,
+				  &tx_preset, 4);
+	precur = tx_preset;
+
+	hfi2_get_platform_config_field(ppd, PLATFORM_CONFIG_TX_PRESET_TABLE,
+				  tx_preset_index, TX_PRESET_TABLE_ATTN,
+				  &tx_preset, 4);
+	attn = tx_preset;
+
+	hfi2_get_platform_config_field(ppd, PLATFORM_CONFIG_TX_PRESET_TABLE,
+				  tx_preset_index, TX_PRESET_TABLE_POSTCUR,
+				  &tx_preset, 4);
+	postcur = tx_preset;
+
+	/*
...
+		ret = hfi2_reset_qsfp(ppd);
+		if (ret)
+			return ret;
+		hfi2_refresh_qsfp_cache(ppd, &ppd->qsfp_info);
+	} else {
...
+
+	if (cache[QSFP_EQ_INFO_OFFS] & 0x4) {
+		ret = hfi2_get_platform_config_field(
+			ppd, PLATFORM_CONFIG_PORT_TABLE, 0,
+			PORT_TABLE_TX_PRESET_IDX_ACTIVE_EQ, ptr_tx_preset, 4);
+		if (ret) {
...
+		ret = hfi2_get_platform_config_field(
+			ppd, PLATFORM_CONFIG_PORT_TABLE, 0,
+			PORT_TABLE_TX_PRESET_IDX_ACTIVE_NO_EQ, ptr_tx_preset,
+			4);
+		if (ret) {
+			*ptr_tx_preset = OPA_INVALID_INDEX;
+			return ret;
...
+
+	ret = hfi2_get_platform_config_field(ppd, PLATFORM_CONFIG_PORT_TABLE, 0,
+					PORT_TABLE_RX_PRESET_IDX, ptr_rx_preset,
+					4);
+	if (ret) {
...
+
+	if ((lss & OPA_LINK_SPEED_25G) && (lse & OPA_LINK_SPEED_25G))
+		hfi2_get_platform_config_field(ppd, PLATFORM_CONFIG_PORT_TABLE, 0,
...
+
+	ret = hfi2_set_qsfp_tx(ppd, 1);
+
+	return ret;
+}
+
+static int tune_qsfp(struct hfi2_pportdata *ppd, u32 *ptr_tx_preset,
+		     u32 *ptr_rx_preset, u8 *ptr_tuning_method,
+		     u32 *ptr_total_atten)
+{
...
+	switch ((cache[QSFP_MOD_TECH_OFFS] & 0xF0) >> 4) {
+	case 0xA ... 0xB:
+		ret = hfi2_get_platform_config_field(ppd, PLATFORM_CONFIG_PORT_TABLE,
...
+ * Thus, it depends on its association with hfi2_start_link(...) which checks
...
+
+	/* skip tuning when in hfi2_loopback */
+	if (hfi2_loopback != LOOPBACK_NONE) {
+		ppd->driver_link_ready = 1;
+
+		if (hfi2_qsfp_mod_present(ppd)) {
+			ret = hfi2_acquire_chip_resource(
+				ppd->dd, qsfp_resource(ppd->dd), QSFP_WAIT);
+			if (ret) {
+				ppd_dev_err(
+					ppd,
...
+
+			hfi2_refresh_qsfp_cache(ppd, &ppd->qsfp_info);
+			hfi2_release_chip_resource(ppd->dd, qsfp_resource(ppd->dd));
+		}
+
+		return;
+	}
...
+			 * catch error
+			 */
+			hfi2_get_platform_config_field(ppd,
...
+		apply_tunings(ppd, tx_preset_index, tuning_method, total_atten,
+			      limiting_active);
+
+	if (!ret)
+		ppd->driver_link_ready = 1;
...
new file mode 100644
index 000000000000..bc3c16c31f7a
--- /dev/null
...
+	reg = hfi2_read_csr(dd, target_oe);
+	/*
...
+	else
+		reg |= QSFP_HFI0_I2CDAT;
+	hfi2_write_csr(dd, target_oe, reg);
+	/* do a read to force the write into the chip */
+	(void)hfi2_read_csr(dd, target_oe);
+}
+
...
+	reg = hfi2_read_csr(bus->controlling_dd, target_in);
...
+ */
+int hfi2_i2c_write(struct hfi2_pportdata *ppd, u32 target, int i2c_addr, int offset,
+	      void *bp, int len)
+{
+	int ret;
+
+	if (!hfi2_check_chip_resource(ppd->dd, i2c_target(target), __func__))
+		return -EACCES;
+
...
+ */
+int hfi2_i2c_read(struct hfi2_pportdata *ppd, u32 target, int i2c_addr, int offset,
+	     void *bp, int len)
+{
+	int ret;
+
...
+	int ret;
+
+	ret = hfi2_acquire_chip_resource(dd, resource, QSFP_WAIT);
+	if (ret)
+		return ret;
+	ret = hfi2_qsfp_read(ppd, target, addr, bp, len);
+	hfi2_release_chip_resource(dd, resource);
+
+	return ret;
+}
+
...
+ */
+int hfi2_refresh_qsfp_cache(struct hfi2_pportdata *ppd, struct qsfp_data *cp)
+{
...
+	}
+
+	ret = hfi2_qsfp_read(ppd, target, 0, cache, QSFP_PAGESIZE);
...
+			/* all */
+			ret = hfi2_qsfp_read(ppd, target, 384, cache + 256, 128);
+			if (ret <= 0 || ret != 128) {
+				ppd_dev_info(ppd, "%s failed\n", __func__);
+				goto bail;
+			}
+			ret = hfi2_qsfp_read(ppd, target, 640, cache + 384, 128);
+			if (ret <= 0 || ret != 128) {
+				ppd_dev_info(ppd, "%s failed\n", __func__);
+				goto bail;
+			}
+			ret = hfi2_qsfp_read(ppd, target, 896, cache + 512, 128);
+			if (ret <= 0 || ret != 128) {
+				ppd_dev_info(ppd, "%s failed\n", __func__);
+				goto bail;
+			}
...
+	u64 reg;
+
+	reg = hfi2_read_csr(dd, dd->hfi2_id ? ASIC_QSFP2_IN : ASIC_QSFP1_IN);
...
+		ret = hfi2_one_qsfp_read(ppd, dd->hfi2_id, addr, data + offset, len);
+		if (ret != len) {
+			ret = -EAGAIN;
+			goto set_zeroes;
+		}
...
+				pwr_codes[hfi2_get_qsfp_power_class(power_byte)]);
+
...
index 1c9d82065c60..20d87accc1e7 100644
...
new file mode 100644
index 000000000000..c04bc2f1e6e5
--- /dev/null
...
index 6155cc3eb9fd..3dc3323f8576 100644
