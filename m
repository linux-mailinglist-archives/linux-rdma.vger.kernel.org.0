Return-Path: <linux-rdma+bounces-3965-lists+linux-rdma=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-rdma@lfdr.de
Delivered-To: lists+linux-rdma@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 8319393B98B
	for <lists+linux-rdma@lfdr.de>; Thu, 25 Jul 2024 01:41:18 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 1131B1F2233C
	for <lists+linux-rdma@lfdr.de>; Wed, 24 Jul 2024 23:41:18 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id BCE2C1448D8;
	Wed, 24 Jul 2024 23:40:49 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b="Zb3bcYIF"
X-Original-To: linux-rdma@vger.kernel.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.7])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 77FF01482EE
	for <linux-rdma@vger.kernel.org>; Wed, 24 Jul 2024 23:40:46 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=192.198.163.7
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1721864449; cv=none; b=dDz08rqAvmacFStqfjHKbGKXWYVQvenaO9dHBKi1kE4OG0j/yv5taBs3HR5fw4kMG64/V0Jr8mw0wUCN/ffgPSg91k35NaxceAuBtkf0oScJNcRoS3+R57V23ZwAaimVejQtu1qnCzypVAzu0gzN4iNcTA8hpUlQkeVMfB3jN+c=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1721864449; c=relaxed/simple;
	bh=O6oJ9OlYufXW4bhx3bmOP0qeCdiAljOu1vCsV0GUi3k=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=L1dULUsu+zYU9GerYqoSLYpDKusjAhfULnba72BJi1HF5Z1KEkIYE42Kk3VC4rwlhpKTiaViYuGniNfNdWXl8vQz5mWU3Upi7zkTOZi4QkTroyUtrUHje0f2VJ89yMSBvQ106b8zitziE/jRXj/kmFphU7zmrsQczRSBfBVQrTk=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com; spf=pass smtp.mailfrom=intel.com; dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b=Zb3bcYIF; arc=none smtp.client-ip=192.198.163.7
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  ...
  bh=O6oJ9OlYufXW4bhx3bmOP0qeCdiAljOu1vCsV0GUi3k=;
  b=Zb3bcYIFjZxij9SIMSa2GJ+b8KuabLDPPkmdcMEOqDJjmj8GeVymNW9l
   uzQnhVP15rzn5Ebfx2mI3RvDcLYt1DrCuWy+/lQRIhsstrq4l0zou3jB+
   qJGotbJ72Josg0HiT7VBhyKnx+GAkvTIpt2oDSTl7rwznBFRNvOodXSe7
   4Z8pEO9ZdbaLxE7N5WL+BhAMYvEN02Ra2QtwuU2pjKddWGY0mVRdOdpwq
   EWV1OCDd2KXseyzba81VZ3nZPGAQlQtMhUUGp7YrLEJvRNiy8SZntO53D
   1JC1P4DPof0h2czKbmMYy6aIOclo7RqrS0McVgUVU8XmJmYIC3uSqXb4s
   Q==;
X-CSE-ConnectionGUID: rfaTkOhpTJCI6HyVpU7ANw==
X-CSE-MsgGUID: xK2BXmVJTyON2dPNupBcGw==
X-IronPort-AV: E=McAfee;i="6700,10204,11143"; a="44999776"
X-IronPort-AV: E=Sophos;i="6.09,234,1716274800"; 
   d="scan'208";a="44999776"
Received: from fmviesa006.fm.intel.com ([10.60.135.146])
  by fmvoesa101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 24 Jul 2024 16:40:42 -0700
X-CSE-ConnectionGUID: ntz7ZfBmTuKvQgYZ7AWA1g==
X-CSE-MsgGUID: GU8O9MzBTo6SucT3IDreyA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.09,234,1716274800"; 
   d="scan'208";a="52426062"
...
Subject: [RFC PATCH 14/25] RDMA/irdma: Add GEN3 support for AEQ and CEQ
Date: Wed, 24 Jul 2024 18:39:06 -0500
Message-Id: <20240724233917.704-15-tatyana.e.nikolova@intel.com>
...
+	case IRDMA_VCHNL_OP_QUEUE_VECTOR_UNMAP:
 	...
 	default:
 		return -EOPNOTSUPP;
@@ -314,6 +316,88 @@ int irdma_vchnl_req_get_reg_layout(struct irdma_sc_dev *dev)
 }
...
+
 struct irdma_vchnl_op_buf {
 	u16 op_code;
 	u16 op_ver;
@@ -137,4 +153,7 @@ int irdma_vchnl_req_get_ver(struct irdma_sc_dev *dev, u16 ver_req,
