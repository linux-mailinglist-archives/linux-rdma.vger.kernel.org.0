Return-Path: <linux-rdma+bounces-22526-lists+linux-rdma=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-rdma@lfdr.de
Received: from mail.lfdr.de
	by mail.lfdr.de with LMTP
	id ZkuuL7T5P2qiawkAu9opvQ
	(envelope-from <linux-rdma+bounces-22526-lists+linux-rdma=lfdr.de@vger.kernel.org>)
	for <lists+linux-rdma@lfdr.de>; Sat, 27 Jun 2026 18:26:28 +0200
X-Original-To: lists+linux-rdma@lfdr.de
Received: from sto.lore.kernel.org (sto.lore.kernel.org [IPv6:2600:3c09:e001:a7::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id 4377B6D242B
	for <lists+linux-rdma@lfdr.de>; Sat, 27 Jun 2026 18:26:28 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=pass header.d=cornelisnetworks.com header.s=selector1 header.b=WtuwEuxw;
	spf=pass (mail.lfdr.de: domain of "linux-rdma+bounces-22526-lists+linux-rdma=lfdr.de@vger.kernel.org" designates 2600:3c09:e001:a7::12fc:5321 as permitted sender) smtp.mailfrom="linux-rdma+bounces-22526-lists+linux-rdma=lfdr.de@vger.kernel.org";
	dmarc=pass (policy=none) header.from=cornelisnetworks.com;
	arc=reject ("cv is fail on i=2")
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sto.lore.kernel.org (Postfix) with ESMTP id 68CFD30098AC
	for <lists+linux-rdma@lfdr.de>; Sat, 27 Jun 2026 16:26:27 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id A0C1923AB87;
	Sat, 27 Jun 2026 16:26:23 +0000 (UTC)
...
Received: from CH5PR02CU005.outbound.protection.outlook.com (mail-northcentralusazon11022126.outbound.protection.outlook.com [40.107.200.126])
	...
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 9E1352EC081
	for <linux-rdma@vger.kernel.org>; Sat, 27 Jun 2026 16:26:17 +0000 (UTC)
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1782577583; cv=fail; b=aVdLyZ/oWLvECNF12vB1YBf3AJ2z4bEPcmvz7wFXUTjDsqqgsbTG2zOFio4kwgqHnwiSiIV6sv9jsp+xIkFkosKkBs77j+/eJBxM/DlUogsYfMX6OQ0/Gn2hpEDix+aGdruDHEoztCKpeOHDtT1WFWvaW6TqHpDAnL9bxjgtv1k=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1782577583; c=relaxed/simple;
	bh=062ZsC9sh1LdRg9lFGbMUt1D4ug0OiXVgeudntrk3NI=;
	h=Subject:From:To:Cc:Date:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=XO5WJ4lPJFvY9DGHlqZwz/w5xBjCSdt5AaGPkBP+61Oh0IqB3CBmtAssv1Y8cF4kB3FPOrCtEZAc4uIjaNBqEIoQDq0Y4aNEja/H5YbV/JQo09OVhSXWKZOd4JEYhZ5jK+Jn+YY1J2x3PYylWll+e3n/4hh89PTQ6WS5NgHyPtw=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=cornelisnetworks.com; spf=pass smtp.mailfrom=cornelisnetworks.com; dkim=pass (2048-bit key) header.d=cornelisnetworks.com header.i=@cornelisnetworks.com header.b=WtuwEuxw; arc=fail smtp.client-ip=40.107.200.126
ARC-Seal: i=1; a=rsa-sha256; s=arcselector10001; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com;
 s=arcselector10001;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-AntiSpam-MessageData-ChunkCount:X-MS-Exchange-AntiSpam-MessageData-0:X-MS-Exchange-AntiSpam-MessageData-1;
 bh=J05uLpEgkq1Ql+WMpSrnNj4ZhFV7EXFppLaVeciYCho=;
 b=
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=cornelisnetworks.com;
 ...
 bh=J05uLpEgkq1Ql+WMpSrnNj4ZhFV7EXFppLaVeciYCho=;
 b=
Received: from CH2PR04CA0016.namprd04.prod.outlook.com (2603:10b6:610:52::26)
 by BL1PR01MB7555.prod.exchangelabs.com (2603:10b6:208:386::18) with Microsoft
 SMTP Server (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.21.159.18; Sat, 27 Jun 2026 16:26:11 +0000
Received: from CH2PEPF0000013E.namprd02.prod.outlook.com
 (2603:10b6:610:52:cafe::6a) by CH2PR04CA0016.outlook.office365.com
...
Received: from cn-mailer-00.localdomain (208.255.156.42) by
 ...
 via Frontend Transport; Sat, 27 Jun 2026 16:26:10 +0000
Received: from awdrv-04.localdomain (unknown [10.228.212.218])
	by cn-mailer-00.localdomain (Postfix) with ESMTPS id 53EAF146565;
	Sat, 27 Jun 2026 12:26:10 -0400 (EDT)
Received: from [10.228.212.218] (localhost [IPv6:::1])
	by awdrv-04.localdomain (Postfix) with ESMTP id 4E7C91810D6C7;
	Sat, 27 Jun 2026 12:26:10 -0400 (EDT)
Subject: [PATCH v2 for-next 15/24] RDMA/hfi2: Add SDMA infrastructure
From: Dennis Dalessandro <dennis.dalessandro@cornelisnetworks.com>
To: jgg@ziepe.ca, leon@kernel.org
Cc: Dean Luick <dean.luick@cornelisnetworks.com>,
 Breandan Cunningham <brendan.cunningham@cornelisnetworks.com>,
 Douglas Miller <doug.miller@cornelisnetworks.com>, linux-rdma@vger.kernel.org
Date: Sat, 27 Jun 2026 12:26:10 -0400
Message-ID: <178257757027.371918.18393310192265420741.stgit@awdrv-04>
...
X-MS-TrafficTypeDiagnostic: CH2PEPF0000013E:EE_|BL1PR01MB7555:EE_
X-MS-Office365-Filtering-Correlation-Id: 2b7b9f4f-fd6d-43b8-be2d-08ded468cc90
X-MS-Exchange-AtpMessageProperties: SA
X-MS-Exchange-SenderADCheck: 1
X-MS-Exchange-AntiSpam-Relay: 0
X-Microsoft-Antispam:
	BCL:0;ARA:13230040|36860700016|376014|23010399003|1800799024|82310400026|6133799003|56012099006|55112099003|22082099003|18002099003|3023799007;
X-Microsoft-Antispam-Message-Info:
	
X-Forefront-Antispam-Report:
	CIP:208.255.156.42;CTRY:US;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:cn-mailer-00.localdomain;PTR:InfoDomainNonexistent;CAT:NONE;SFS:(13230040)(36860700016)(376014)(23010399003)(1800799024)(82310400026)(6133799003)(56012099006)(55112099003)(22082099003)(18002099003)(3023799007);DIR:OUT;SFP:1102;
X-MS-Exchange-AntiSpam-MessageData-ChunkCount: 1
X-MS-Exchange-AntiSpam-MessageData-0:
	
X-OriginatorOrg: cornelisnetworks.com
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 27 Jun 2026 16:26:10.5811
 (UTC)
X-MS-Exchange-CrossTenant-Network-Message-Id: 2b7b9f4f-fd6d-43b8-be2d-08ded468cc90
...
X-MS-Exchange-Transport-CrossTenantHeadersStamped: BL1PR01MB7555
...
X-Spamd-Result: default: False [0.34 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	TO_DN_SOME(0.00)[];
	TAGGED_FROM(0.00)[bounces-22526-lists,linux-rdma=lfdr.de];
	RCVD_TLS_LAST(0.00)[];
	MIME_TRACE(0.00)[0:+];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[cornelisnetworks.com:dkim,cornelisnetworks.com:email,cornelisnetworks.com:from_mime,awdrv-04:mid,vger.kernel.org:from_smtp,sto.lore.kernel.org:rdns,sto.lore.kernel.org:helo];
...
---
  Changes since v2:
    - Remove unused data_addr variable and its assignment.
---
 drivers/infiniband/hw/hfi2/iowait.c |  129 +
 drivers/infiniband/hw/hfi2/sdma.c   | 3989 +++++++++++++++++++++++++++++++++++
 2 files changed, 4118 insertions(+)
...
new file mode 100644
index 000000000000..0702500c5c4e
--- /dev/null
...
+					      int eng, u32 offset)
+{
+	return hfi2_get_csr_addr(dd, offset + (dd->params->txe_sdma_stride * eng));
+}
+
+/*
...
+	int blocked;
+
+	status = !!(hfi2_read_csr(dd, dd->params->cce_int_status_reg + reg_off) &
+		    reg_mask);
+	mask = !!(hfi2_read_csr(dd, dd->params->cce_int_mask_reg + reg_off) &
+		  reg_mask);
+	blocked = !!(hfi2_read_csr(dd, dd->params->cce_int_blocked_reg + reg_off) &
+		     reg_mask);
+
...
+		void *kvaddr, struct page *page, unsigned long offset, u16 len)
+{
+	int pad_len, rval;
+	dma_addr_t addr;
+
