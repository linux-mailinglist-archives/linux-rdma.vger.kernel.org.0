Return-Path: <linux-rdma+bounces-23279-lists+linux-rdma=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-rdma@lfdr.de
Received: from mail.lfdr.de
	by mail.lfdr.de with LMTP
	id 9gbKIgWBV2oWTgAAu9opvQ
	(envelope-from <linux-rdma+bounces-23279-lists+linux-rdma=lfdr.de@vger.kernel.org>)
	for <lists+linux-rdma@lfdr.de>; Wed, 15 Jul 2026 14:45:57 +0200
X-Original-To: lists+linux-rdma@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [172.234.253.10])
	by mail.lfdr.de (Postfix) with ESMTPS id E53B575E4F3
	for <lists+linux-rdma@lfdr.de>; Wed, 15 Jul 2026 14:45:56 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=pass header.d=kernel.org header.s=k20260515 header.b=eElLlbTE;
	spf=pass (mail.lfdr.de: domain of "linux-rdma+bounces-23279-lists+linux-rdma=lfdr.de@vger.kernel.org" designates 172.234.253.10 as permitted sender) smtp.mailfrom="linux-rdma+bounces-23279-lists+linux-rdma=lfdr.de@vger.kernel.org";
	dmarc=pass (policy=quarantine) header.from=kernel.org;
	arc=pass ("subspace.kernel.org:s=arc-20240116:i=1")
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id 11223303A93D
	for <lists+linux-rdma@lfdr.de>; Wed, 15 Jul 2026 12:41:53 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 036A2472796;
	Wed, 15 Jul 2026 12:41:52 +0000 (UTC)
...
X-Spamd-Result: default: False [-5.16 / 15.00];
	...
	FROM_HAS_DN(0.00)[];
	FORGED_SENDER(0.00)[david@kernel.org,linux-rdma@vger.kernel.org];
	...
	TAGGED_FROM(0.00)[bounces-23279-lists,linux-rdma=lfdr.de];
