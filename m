Return-Path: <linux-rdma+bounces-3971-lists+linux-rdma=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-rdma@lfdr.de
Delivered-To: lists+linux-rdma@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 6350D93B991
	for <lists+linux-rdma@lfdr.de>; Thu, 25 Jul 2024 01:41:30 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 74B391C22F90
	for <lists+linux-rdma@lfdr.de>; Wed, 24 Jul 2024 23:41:29 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 976C2149C43;
	Wed, 24 Jul 2024 23:40:54 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b="JK4TpDFP"
X-Original-To: linux-rdma@vger.kernel.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.7])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 3F90E1494BC
	for <linux-rdma@vger.kernel.org>; Wed, 24 Jul 2024 23:40:51 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=192.198.163.7
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1721864454; cv=none; b=oIDSwdySJ8WuWNVQA2R7lURQSwJcTPQjKvfEY1FVCFA6luNR3GF0yW67MymKn3zy4ol5IY9M2vBN8Mpi/B4jQufM4pS7vN0hB1MrTEXHnGqz2CGI/O9sfaYzMevV+O23V/6LVaFAIOaA8FhC8+/64OSLViQE2d4ByF2lP9jRkU8=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1721864454; c=relaxed/simple;
	bh=mHsX72t3vDENpJTp2cPRFdvzy+QE7/dwZRiGCfhPmw4=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=pHm4ZwGvl32CARRi1S6/Ep+Lf1lnFSdT+fjRZXJ1zzaj61BBNA3FcySBwOjGc6OQOOGspPO15lOgZ2gcxgCL9FDX3ZaFlFl1sWrDL2jsCDXYoV3fOl1A8SwDsqqHl2fTrMi2E3L1fiCVwB+R/GL4U381IXxqOQIfqUb93t/mJ0I=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com; spf=pass smtp.mailfrom=intel.com; dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b=JK4TpDFP; arc=none smtp.client-ip=192.198.163.7
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=intel.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1721864451; x=1753400451;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=mHsX72t3vDENpJTp2cPRFdvzy+QE7/dwZRiGCfhPmw4=;
  b=JK4TpDFPc/SvG+nW3lDCvAopyyCTW6M52dIP3rOTLIzxKBYCa0H4UtR/
   4QKrlRfKT5u0uV8ZlUWHRBFo4BXZ5pqsLNF5D4JbGeuSF0KHSUQjMXPvM
   eBsnbXWWxV9tObMniy6wbCcP5shglXQP3E4fjGcwXPumo5HS81RPTwPNR
   MWh1mwslYLVFM1AAnTmm9bhNXABvlqNDuL/e7zzmxLLj9ctwk8cVs4QR8
   qGMr8aVBzQ1538caoovYxjla6a6e9wTyI0YtUnPhFBy71Hjl5ZrO8rmMf
   7uDEpOmdU53MJ6HIy18paxTLOmghQ8xEQ3gtY+KAvJmBDRplOAkoOdxMM
   w==;
X-CSE-ConnectionGUID: 9tYErajmQpGWVmqESTU9cQ==
X-CSE-MsgGUID: vNp27V+DQj2bAHmsu64cTg==
X-IronPort-AV: E=McAfee;i="6700,10204,11143"; a="44999795"
X-IronPort-AV: E=Sophos;i="6.09,234,1716274800"; 
   d="scan'208";a="44999795"
Received: from fmviesa006.fm.intel.com ([10.60.135.146])
  by fmvoesa101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 24 Jul 2024 16:40:46 -0700
X-CSE-ConnectionGUID: ax6N/mjISkKmp5NPdY32Eg==
X-CSE-MsgGUID: uq7XGGaMQ1uhyHonXA6SAw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.09,234,1716274800"; 
   d="scan'208";a="52426095"
...
Subject: [RFC PATCH 20/25] RDMA/irdma: Add SRQ support
Date: Wed, 24 Jul 2024 18:39:12 -0500
Message-Id: <20240724233917.704-21-tatyana.e.nikolova@intel.com>
...
@@ -447,6 +448,208 @@ int irdma_sc_qp_init(struct irdma_sc_qp *qp, struct irdma_qp_init_info *info)
 }
...
@@ -2215,6 +2422,14 @@ u8 irdma_get_encoded_wqe_size(u32 wqsize, enum irdma_queue_type queue_type)
 {
 	u8 encoded_size = 0;
...
+	}
 	 ...
 	 */
@@ -5464,13 +5679,12 @@ static int irdma_set_loc_hmc_rsrc_gen_3(struct irdma_sc_dev *dev,
...
@@ -6052,6 +6266,22 @@ static int irdma_exec_cqp_cmd(struct irdma_sc_dev *dev,
...
+		break;
 	default:
 		status = -EOPNOTSUPP;
 		break;
@@ -6209,6 +6439,7 @@ int irdma_sc_dev_init(enum irdma_vers ver, struct irdma_sc_dev *dev,
...
+	IRDMA_OP_SRQ_CREATE			= 51,
+	IRDMA_OP_SRQ_MODIFY			= 52,
+	IRDMA_OP_SRQ_DESTROY			= 53,
 
 	/* Must be last entry*/
-	IRDMA_MAX_CQP_OPS			= 49,
+	IRDMA_MAX_CQP_OPS			= 54,
 };
...
@@ -520,6 +530,7 @@ enum irdma_cqp_op_type {
...
@@ -631,6 +642,24 @@ enum irdma_cqp_op_type {
...
@@ -785,6 +814,11 @@ enum irdma_cqp_op_type {
...
+	struct irdma_sc_srq *srq;
 	...
 	u32 aeqcnt = 0;
@@ -319,7 +320,9 @@ static void irdma_process_aeq(struct irdma_pci_f *rf)
...
@@ -417,6 +420,12 @@ static void irdma_process_aeq(struct irdma_pci_f *rf)
 			}
...
@@ -1839,7 +1848,9 @@ static void irdma_get_used_rsrc(struct irdma_device *iwdev)
...
@@ -2056,7 +2067,8 @@ static void irdma_set_hw_rsrc(struct irdma_pci_f *rf)
...
@@ -2084,12 +2096,14 @@ static u32 irdma_calc_mem_rsrc_size(struct irdma_pci_f *rf)
...
@@ -2117,6 +2131,7 @@ u32 irdma_initialize_hw_rsrc(struct irdma_pci_f *rf)
...
@@ -2136,6 +2151,7 @@ u32 irdma_initialize_hw_rsrc(struct irdma_pci_f *rf)
...
index 2432104..adfc528 100644
--- a/drivers/infiniband/hw/irdma/type.h
+++ b/drivers/infiniband/hw/irdma/type.h
@@ -250,6 +250,7 @@ enum irdma_syn_rst_handling {
...
+	IRDMA_QUEUE_TYPE_SRQ,
 ...
 struct irdma_sc_dev;
@@ -739,6 +740,51 @@ struct irdma_modify_cq_info {
 	bool cq_resize:1;
 };
...
@@ -1045,6 +1091,7 @@ struct irdma_qp_host_ctx_info {
 	};
 	u32 send_cq_num;
 	u32 rcv_cq_num;
+	u32 srq_id;
 	...
 	u16 stats_idx;
 	bool srq_valid:1;
@@ -1344,6 +1391,8 @@ void irdma_sc_qp_setctx_roce(struct irdma_sc_qp *qp, __le64 *qp_ctx,
...
+		      struct irdma_srq_init_info *info);
 ...
 struct cqp_info {
@@ -1587,6 +1636,23 @@ struct cqp_info {
...
+
  ...
  * @qp: hw qp ptr
@@ -318,6 +338,58 @@ int irdma_uk_rdma_write(struct irdma_qp_uk *qp, struct irdma_post_sq_info *info,
 }
...
@@ -1336,6 +1451,42 @@ static void irdma_setup_connection_wqes(struct irdma_qp_uk *qp,
 }
...
index 8fd7eeb..af15529 100644
--- a/drivers/infiniband/hw/irdma/user.h
+++ b/drivers/infiniband/hw/irdma/user.h
@@ -59,7 +59,7 @@ enum irdma_device_caps_const {
...
@@ -147,6 +147,8 @@ enum irdma_qp_caps {
 	IRDMA_PUSH_MODE      = 8,
 };
...
@@ -300,6 +302,39 @@ int irdma_uk_calc_depth_shift_sq(struct irdma_qp_uk_init_info *ukinfo,
...
+
 struct irdma_sq_uk_wr_trk_info {
 	u64 wrid;
 	u32 wr_len;
@@ -344,6 +379,7 @@ struct irdma_qp_uk {
...
@@ -383,6 +419,7 @@ struct irdma_qp_uk_init_info {
 	u8 rq_shift;
 	int abi_ver;
 	bool legacy_mode;
+	struct irdma_srq_uk *srq_uk;
...
@@ -409,5 +447,7 @@ int irdma_get_sqdepth(struct irdma_uk_attrs *uk_attrs, u32 sq_size, u8 shift,
 		      u32 *wqdepth);
...
index 894ced3..2fdcb88 100644
--- a/drivers/infiniband/hw/irdma/utils.c
+++ b/drivers/infiniband/hw/irdma/utils.c
@@ -700,6 +700,9 @@ static int irdma_wait_event(struct irdma_pci_f *rf,
...
@@ -1239,6 +1242,30 @@ void irdma_free_qp_rsrc(struct irdma_qp *iwqp)
 }
...
index 593dbbd..868722b 100644
--- a/drivers/infiniband/hw/irdma/verbs.c
+++ b/drivers/infiniband/hw/irdma/verbs.c
@@ -56,9 +56,9 @@ static int irdma_query_device(struct ib_device *ibdev,
...
@@ -336,6 +336,8 @@ static int irdma_alloc_ucontext(struct ib_ucontext *uctx,
...
@@ -347,6 +349,8 @@ static int irdma_alloc_ucontext(struct ib_ucontext *uctx,
...
@@ -571,7 +575,11 @@ static void irdma_setup_virt_qp(struct irdma_device *iwdev,
...
@@ -940,6 +948,18 @@ static int irdma_create_qp(struct ib_qp *ibqp,
...
+	}
 	...
 	if (err_code)
@@ -1046,6 +1066,8 @@ static int irdma_create_qp(struct ib_qp *ibqp,
 	}
...
@@ -1171,6 +1193,7 @@ static int irdma_query_qp(struct ib_qp *ibqp, struct ib_qp_attr *attr,
...
+	init_attr->srq = iwqp->ibqp.srq;
 	...
 	return 0;
@@ -1834,6 +1857,24 @@ int irdma_modify_qp(struct ib_qp *ibqp, struct ib_qp_attr *attr, int attr_mask,
 }
...
+/**
  ...
  * @rf: RDMA PCI function
  * @iwcq: cq ptr
@@ -1897,6 +1938,22 @@ static int irdma_process_resize_list(struct irdma_cq *iwcq,
 }
...
+/**
  ...
  * @ib_cq: cq pointer
  * @udata: user data
@@ -2079,6 +2136,293 @@ static int irdma_resize_cq(struct ib_cq *ibcq, int entries,
 	return ret;
 }
...
@@ -2526,6 +2870,7 @@ static int irdma_handle_q_mem(struct irdma_device *iwdev,
...
+	struct irdma_srq_mr *srqmr = &iwpbl->srq_mr;
 	...
 	u32 pg_size, total;
@@ -2545,7 +2890,10 @@ static int irdma_handle_q_mem(struct irdma_device *iwdev,
...
+		qpmr->rq_pa = (dma_addr_t)arr[req->sq_pages];
 		if (lvl) {
 			ret = irdma_check_mem_contiguous(arr, req->sq_pages,
 							 pg_size);
@@ -2565,6 +2913,18 @@ static int irdma_handle_q_mem(struct irdma_device *iwdev,
...
@@ -3035,6 +3395,37 @@ static int irdma_reg_user_mr_type_qp(struct irdma_mem_reg_req req,
 	return 0;
 }
...
+
 static int irdma_reg_user_mr_type_cq(struct irdma_mem_reg_req req,
 				     struct ib_udata *udata,
 				     struct irdma_mr *iwmr)
@@ -3121,6 +3512,12 @@ static struct ib_mr *irdma_reg_user_mr(struct ib_pd *pd, u64 start, u64 len,
 			goto error;
...
+		break;
 	case IRDMA_MEMREG_TYPE_CQ:
 		...
 		if (err)
@@ -3436,6 +3833,14 @@ static void irdma_del_memlist(struct irdma_mr *iwmr,
 		}
...
@@ -3655,6 +4060,47 @@ static int irdma_post_send(struct ib_qp *ibqp,
 }
...
+/**
  ...
  * @ibqp: ib qp pointer
  * @ib_wr: work request for receive
@@ -3673,6 +4119,11 @@ static int irdma_post_recv(struct ib_qp *ibqp,
 	iwqp = to_iwqp(ibqp);
...
+
 	...
 	while (ib_wr) {
 		post_recv.num_sges = ib_wr->num_sge;
@@ -4761,6 +5212,18 @@ static enum rdma_link_layer irdma_get_link_layer(struct ib_device *ibdev,
...
@@ -4831,6 +5294,7 @@ static enum rdma_link_layer irdma_get_link_layer(struct ib_device *ibdev,
...
+	INIT_RDMA_OBJ_SIZE(ib_srq, irdma_srq, ibsrq),
 ...
 /**
@@ -4878,6 +5342,10 @@ static void irdma_init_rdma_device(struct irdma_device *iwdev)
