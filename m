Return-Path: <linux-rdma+bounces-22521-lists+linux-rdma=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-rdma@lfdr.de
Received: from mail.lfdr.de
	by mail.lfdr.de with LMTP
	id Uqe/HJz5P2qZawkAu9opvQ
	(envelope-from <linux-rdma+bounces-22521-lists+linux-rdma=lfdr.de@vger.kernel.org>)
	for <lists+linux-rdma@lfdr.de>; Sat, 27 Jun 2026 18:26:04 +0200
X-Original-To: lists+linux-rdma@lfdr.de
Received: from sto.lore.kernel.org (sto.lore.kernel.org [IPv6:2600:3c09:e001:a7::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id D359D6D2412
	for <lists+linux-rdma@lfdr.de>; Sat, 27 Jun 2026 18:26:03 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=pass header.d=cornelisnetworks.com header.s=selector1 header.b=IKsPe8d7;
	spf=pass (mail.lfdr.de: domain of "linux-rdma+bounces-22521-lists+linux-rdma=lfdr.de@vger.kernel.org" designates 2600:3c09:e001:a7::12fc:5321 as permitted sender) smtp.mailfrom="linux-rdma+bounces-22521-lists+linux-rdma=lfdr.de@vger.kernel.org";
	dmarc=pass (policy=none) header.from=cornelisnetworks.com;
	arc=reject ("cv is fail on i=2")
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sto.lore.kernel.org (Postfix) with ESMTP id 7D6F6300B185
	for <lists+linux-rdma@lfdr.de>; Sat, 27 Jun 2026 16:26:02 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 4ABF72EFDA4;
	Sat, 27 Jun 2026 16:25:57 +0000 (UTC)
X-Original-To: linux-rdma@vger.kernel.org
Received: from CY3PR05CU001.outbound.protection.outlook.com (mail-westcentralusazon11023142.outbound.protection.outlook.com [40.93.201.142])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 4B9C923AB87
	for <linux-rdma@vger.kernel.org>; Sat, 27 Jun 2026 16:25:48 +0000 (UTC)
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1782577557; cv=fail; b=eB1IbscKFckHhpQg94/xQKMVRPYmQ0wpvz23q1+tucgZKLKp/svONum3m7cgRj/1GXccGxlXtoZpNQ4P76vmhASZj3ZyNdK0Arlf7U5I02YpH36/E7Ls7aRjWtn9iXwyanC/ERc/lFR1V47fziKOkiKaF7CdqFDj03QJndKDISg=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1782577557; c=relaxed/simple;
	bh=UzTDDiFHC6mU0IpNqZmRhGAuR7a3b2m2VK7Pqc8iaxs=;
	h=Subject:From:To:Cc:Date:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=OcLFgChQ5euGgraZs61JTolQ/HJXzyqc+MPxanNZc1uLKOFPjlZXH+hKACJnWa8MqXwXIjSfugWd4r1lHeRTJ94jYUQPeoz+qqAPQYQlrJ5lh9Q6vVVNe7CiLF3DbQc9XrohvO1A6U6ms+j4YOxK1j+TeaPp3CAcLJTHOyuizx8=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=cornelisnetworks.com; spf=pass smtp.mailfrom=cornelisnetworks.com; dkim=pass (2048-bit key) header.d=cornelisnetworks.com header.i=@cornelisnetworks.com header.b=IKsPe8d7; arc=fail smtp.client-ip=40.93.201.142
ARC-Seal: i=1; a=rsa-sha256; s=arcselector10001; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com;
 s=arcselector10001;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-AntiSpam-MessageData-ChunkCount:X-MS-Exchange-AntiSpam-MessageData-0:X-MS-Exchange-AntiSpam-MessageData-1;
 bh=qCgTIfd6VTBf3EX0a9n1VHuhOWf4WOSWtzMcy2mBsPg=;
 b=
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=cornelisnetworks.com;
 ...
 bh=qCgTIfd6VTBf3EX0a9n1VHuhOWf4WOSWtzMcy2mBsPg=;
 b=
Received: from SJ2PR07CA0013.namprd07.prod.outlook.com (2603:10b6:a03:505::15)
 by SA1PR01MB8639.prod.exchangelabs.com (2603:10b6:806:3a3::16) with Microsoft
 SMTP Server (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.21.159.18; Sat, 27 Jun 2026 16:25:41 +0000
...
Received: from cn-mailer-00.localdomain (50.148.235.34) by
 ...
 via Frontend Transport; Sat, 27 Jun 2026 16:25:40 +0000
Received: from awdrv-04.localdomain (unknown [10.228.212.218])
	by cn-mailer-00.localdomain (Postfix) with ESMTPS id 03569146565;
	Sat, 27 Jun 2026 12:25:40 -0400 (EDT)
Received: from [10.228.212.218] (localhost [IPv6:::1])
	by awdrv-04.localdomain (Postfix) with ESMTP id F25351810D6C7;
	Sat, 27 Jun 2026 12:25:39 -0400 (EDT)
Subject: [PATCH v2 for-next 09/24] RDMA/hfi2: Add initialization and firmware
 support
...
Date: Sat, 27 Jun 2026 12:25:39 -0400
Message-ID: <178257753993.371918.14178456295890399233.stgit@awdrv-04>
...
X-MS-TrafficTypeDiagnostic: SJ1PEPF00002326:EE_|SA1PR01MB8639:EE_
X-MS-Office365-Filtering-Correlation-Id: 645368f0-70aa-46c9-b253-08ded468bade
X-MS-Exchange-AtpMessageProperties: SA
X-MS-Exchange-SenderADCheck: 1
X-MS-Exchange-AntiSpam-Relay: 0
X-Microsoft-Antispam:
	BCL:0;ARA:13230040|82310400026|36860700016|376014|23010399003|1800799024|6133799003|5023799004|22082099003|18092099006|18002099003|56012099006|3023799007|55112099003;
X-Microsoft-Antispam-Message-Info:
	
X-Forefront-Antispam-Report:
	CIP:50.148.235.34;CTRY:US;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:cn-mailer-00.localdomain;PTR:InfoDomainNonexistent;CAT:NONE;SFS:(13230040)(82310400026)(36860700016)(376014)(23010399003)(1800799024)(6133799003)(5023799004)(22082099003)(18092099006)(18002099003)(56012099006)(3023799007)(55112099003);DIR:OUT;SFP:1102;
X-MS-Exchange-AntiSpam-MessageData-ChunkCount: 1
X-MS-Exchange-AntiSpam-MessageData-0:
	
X-OriginatorOrg: cornelisnetworks.com
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 27 Jun 2026 16:25:40.7535
 (UTC)
X-MS-Exchange-CrossTenant-Network-Message-Id: 645368f0-70aa-46c9-b253-08ded468bade
...
X-MS-Exchange-Transport-CrossTenantHeadersStamped: SA1PR01MB8639
...
X-Spamd-Result: default: False [0.34 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	TO_DN_SOME(0.00)[];
	TAGGED_FROM(0.00)[bounces-22521-lists,linux-rdma=lfdr.de];
	RCVD_TLS_LAST(0.00)[];
	MIME_TRACE(0.00)[0:+];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[vger.kernel.org:from_smtp,awdrv-04:mid,cornelisnetworks.com:dkim,cornelisnetworks.com:email,cornelisnetworks.com:from_mime,sto.lore.kernel.org:rdns,sto.lore.kernel.org:helo];
...
X-Rspamd-Queue-Id: D359D6D2412

Add device initialization, firmware loading and management, and the
completion-vector to CPU mapping table used by rdmavt to dispatch CQ
work.
...
---
  Changes since v2:
    - Initialize initfail to 0 to fix potential uninitialized variable warning
    - Fix kernel-doc: @index[in,out] non-standard syntax in allocate_rcd_index
    - Fix kernel-doc: stale @extra param in hfi2_alloc_devdata, replace with @params
    - Fix kernel-doc: add function name line, @cpus param, Return: section to clear_ht_siblings
  Changes since v1:
    - Address Leon's feedback (Re: v1 patch 08, Mar 18 2026): drop
      aspm.h include and aspm_init/exit calls. ASPM is managed at the
      PCIe core layer (pcie_aspm= cmdline).
    - Address Leon's feedback (Re: v1 patch 07, Mar 17 2026): remove
      the CPU-affinity policy code from affinity.c.  Per-process CPU
      affinity is left to user space (sched_setaffinity, taskset);
      IRQ affinity is left to irqbalance and /proc/irq/<n>/smp_affinity.
      Only the kernel-internal completion-vector to CPU mapping table
      is kept; it is now implemented as a thin wrapper around
      cpumask_local_spread() that publishes one CPU per online CPU on
      the device's NUMA node.  The associated module init/exit
      hooks (node_affinity_init/destroy_all) and the per-device init
      hook (hfi2_dev_affinity_init/clean_up) are removed.  The
      hfi2_dev_affinity_clean_up() call is removed from
      postinit_cleanup().
    - Address Arnd Bergmann's feedback (Re: hfi2 v1, Mar 23 2026):
      update start_cport() to use CPORT_OPT_BARE_METAL after the
      cport_options bitfield was replaced with a plain integer flag
      field.
---
 ...
 drivers/infiniband/hw/hfi2/init.c     | 2926 +++++++++++++++++++++++++++++++++
 5 files changed, 5297 insertions(+), 1 deletion(-)
...
index 000000000000..ea869363fce4
--- /dev/null
...
new file mode 100644
index 000000000000..71fbcffe174c
--- /dev/null
...
index 0bf969ca258f..47e5ecfa3ce8 100644
...
new file mode 100644
index 000000000000..97f4708f00b7
--- /dev/null
...
+const u8 hfi2_pcie_pcs_addrs[2][NUM_PCIE_SERDES] = {
...
+const u8 hfi2_pcie_serdes_broadcast[2] = { 0xe2, 0xe3 };
...
+	hfi2_write_csr(dd, DC_DC8051_CFG_RAM_ACCESS_CTRL, reg);
+	/* step 2: enable */
+	hfi2_write_csr(dd, DC_DC8051_CFG_RAM_ACCESS_CTRL,
+		  reg | DC_DC8051_CFG_RAM_ACCESS_CTRL_READ_ENA_SMASK);
+
+	/* wait until ACCESS_COMPLETED is set */
+	count = 0;
+	while ((hfi2_read_csr(dd, DC_DC8051_CFG_RAM_ACCESS_STATUS)
...
+
+	/* gather the data */
+	*result = hfi2_read_csr(dd, DC_DC8051_CFG_RAM_ACCESS_RD_DATA);
+
+	return 0;
+}
+
...
+	hfi2_write_csr(dd, DC_DC8051_CFG_RAM_ACCESS_SETUP, 0);
+
...
+	hfi2_write_csr(dd, DC_DC8051_CFG_RAM_ACCESS_CTRL, 0);
+
...
+	hfi2_write_csr(dd, DC_DC8051_CFG_RAM_ACCESS_SETUP, reg);
+
...
+		}
+		hfi2_write_csr(dd, DC_DC8051_CFG_RAM_ACCESS_WR_DATA, reg);
+
+		/* wait until ACCESS_COMPLETED is set */
+		count = 0;
+		while ((hfi2_read_csr(dd, DC_DC8051_CFG_RAM_ACCESS_STATUS)
...
+			hfi2_write_csr(dd, what + (8 * i), *ptr);
+	} else {
+		/* not aligned */
...
+
+			memcpy(&value, data, 8);
+			hfi2_write_csr(dd, what + (8 * i), value);
+		}
+	}
+}
+
...
+
+	/* start RSA */
+	hfi2_write_csr(dd, MISC_CFG_RSA_CMD, RSA_CMD_START);
+
+	/*
+	 * Look for the result.
+	 *
...
+	 */
+	hfi2_write_csr(dd, MISC_ERR_CLEAR,
...
+	 */
+	reg = hfi2_read_csr(dd, MISC_ERR_STATUS);
+	if (ret) {
...
+{
+	u64 reg = hfi2_read_csr(dd, DC_DC8051_STS_CUR_STATE);
+
...
+	hfi2_write_csr(dd, DC_DC8051_CFG_RST, reg);
+
+	/*
...
+	 */
+	hfi2_write_csr(dd, MISC_CFG_FW_CTRL, MISC_CFG_FW_CTRL_FW_8051_LOADED_SMASK);
+
...
+	 * requests.
+	 */
+	ret = hfi2_wait_fm_ready(dd, TIMEOUT_8051_START);
+	if (ret) { /* timed out */
...
+	}
+
+	hfi2_read_misc_status(dd, &ver_major, &ver_minor, &ver_patch);
...
+{
+	hfi2_write_csr(dd, ASIC_CFG_SBUS_REQUEST,
...
+	u32 result_code = 0;
+
+	hfi2_sbus_request(dd, receiver_addr, data_addr, READ_SBUS_RECEIVER, data_in);
+
+	for (retries = 0; retries < 100; retries++) {
+		usleep_range(1000, 1200); /* arbitrary */
+		reg = hfi2_read_csr(dd, ASIC_STS_SBUS_RESULT);
...
+
+	hfi2_write_csr(dd, MISC_CFG_FW_CTRL, ENABLE_SPICO_SMASK);
+	/* disable SBus spico */
+	if (flags & SPICO_SBUS)
+		hfi2_sbus_request(dd, SBUS_MASTER_BROADCAST, 0x01,
+			     WRITE_SBUS_RECEIVER, 0x00000040);
+
+	/* disable the fabric serdes spicos */
+	if (flags & SPICO_FABRIC)
+		hfi2_sbus_request(dd, fabric_serdes_broadcast[dd->hfi2_id],
...
+		hfi2_sbus_request(dd, ra, 0x07, WRITE_SBUS_RECEIVER, 0x00000011);
+		/* wait 100 refclk cycles @ 156.25MHz => 640ns */
+		udelay(1);
+		/* remove SerDes reset */
+		hfi2_sbus_request(dd, ra, 0x07, WRITE_SBUS_RECEIVER, 0x00000010);
+		/* turn SPICO enable on */
+		hfi2_sbus_request(dd, ra, 0x07, WRITE_SBUS_RECEIVER, 0x00000002);
+	} else {
...
+	hfi2_clear_sbus_fast_mode(dd);
+
+	hfi2_sbus_request(dd, receiver_addr, data_addr, command, data_in);
+	hfi2_write_csr(dd, ASIC_CFG_SBUS_EXECUTE,
...
+			u64 counts = hfi2_read_csr(dd, ASIC_STS_SBUS_COUNTERS);
+			/*
...
+	}
+	count = 0;
+	hfi2_write_csr(dd, ASIC_CFG_SBUS_EXECUTE, 0);
...
+	hfi2_sbus_request(dd, ra, 0x00, WRITE_SBUS_RECEIVER, 0x40000000);
+	/* step 5: download SerDes machine code */
+	for (i = 0; i < fdet->firmware_len; i += 4) {
+		hfi2_sbus_request(dd, ra, 0x0a, WRITE_SBUS_RECEIVER,
+			     *(u32 *)&fdet->firmware_ptr[i]);
+	}
+	/* step 6: IMEM override off */
+	hfi2_sbus_request(dd, ra, 0x00, WRITE_SBUS_RECEIVER, 0x00000000);
+	/* step 7: turn ECC on */
+	hfi2_sbus_request(dd, ra, 0x0b, WRITE_SBUS_RECEIVER, 0x000c0000);
+
...
+	hfi2_sbus_request(dd, ra, 0x08, WRITE_SBUS_RECEIVER, 0x00000000);
+
+	return 0;
+}
+
...
+	hfi2_sbus_request(dd, ra, 0x01, WRITE_SBUS_RECEIVER, 0x000000c0);
+	/* step 3: remove reset, enable off, IMEM_CNTRL_EN on */
+	hfi2_sbus_request(dd, ra, 0x01, WRITE_SBUS_RECEIVER, 0x00000240);
+	/* step 4: set starting IMEM address for burst download */
+	hfi2_sbus_request(dd, ra, 0x03, WRITE_SBUS_RECEIVER, 0x80000000);
+	/* step 5: download the SBus Master machine code */
+	for (i = 0; i < fdet->firmware_len; i += 4) {
+		hfi2_sbus_request(dd, ra, 0x14, WRITE_SBUS_RECEIVER,
+			     *(u32 *)&fdet->firmware_ptr[i]);
+	}
+	/* step 6: set IMEM_CNTL_EN off */
+	hfi2_sbus_request(dd, ra, 0x01, WRITE_SBUS_RECEIVER, 0x00000040);
+	/* step 7: turn ECC on */
+	hfi2_sbus_request(dd, ra, 0x16, WRITE_SBUS_RECEIVER, 0x000c0000);
+
+	/* steps 8-11: run the RSA engine */
...
+	hfi2_sbus_request(dd, ra, 0x01, WRITE_SBUS_RECEIVER, 0x00000140);
+
+	return 0;
+}
+
...
+	hfi2_sbus_request(dd, ra, 0x05, WRITE_SBUS_RECEIVER, 0x00000001);
+	/* step 3: enable XDMEM access */
+	hfi2_sbus_request(dd, ra, 0x01, WRITE_SBUS_RECEIVER, 0x00000d40);
...
+	 */
+	for (i = 0; i < fdet->firmware_len; i += 4) {
+		hfi2_sbus_request(dd, ra, 0x04, WRITE_SBUS_RECEIVER,
+			     *(u32 *)&fdet->firmware_ptr[i]);
+	}
+	/* step 5: disable XDMEM access */
+	hfi2_sbus_request(dd, ra, 0x01, WRITE_SBUS_RECEIVER, 0x00000140);
+	/* step 6: allow SBus Spico to run */
+	hfi2_sbus_request(dd, ra, 0x05, WRITE_SBUS_RECEIVER, 0x00000000);
+
+	/*
...
+		 */
+		hfi2_sbus_request(dd, addrs[count], 0xfd, WRITE_SBUS_RECEIVER,
...
+	u8 user = (u8)hfi2_read_csr(dd, ASIC_CFG_MUTEX);
+
+	if (user == mask) {
+		dd_dev_info(dd,
...
+	while (1) {
+		hfi2_write_csr(dd, ASIC_CFG_MUTEX, mask);
+		user = (u8)hfi2_read_csr(dd, ASIC_CFG_MUTEX);
+		if (user == mask)
+			return 0; /* success */
+		if (time_after(jiffies, timeout))
+			break; /* timed out */
...
+		hfi2_write_csr(dd, ASIC_CFG_MUTEX, 0);
+		try++;
+		goto retry;
+	}
+
...
+		ret = -EBUSY;
+	} else {
+		hfi2_write_csr(dd, ASIC_CFG_SCRATCH, scratch0 | my_bit);
...
+	u64 reg, count = 0;
+
+	reg = hfi2_read_csr(dd, ASIC_STS_SBUS_COUNTERS);
...
+ */
+int hfi2_get_platform_config_field(struct hfi2_pportdata *ppd,
...
+				     hfi2_pcie_serdes_broadcast[dd->hfi2_id],
...
+
+	dd->base_guid = hfi2_read_csr(dd, DC_DC8051_CFG_LOCAL_GUID);
+}
+
...
+	hfi2_sbus_request(dd, SBUS_MASTER_BROADCAST, 0x02, WRITE_SBUS_RECEIVER, 0);
+	hfi2_sbus_request(dd, SBUS_MASTER_BROADCAST, 0x07, WRITE_SBUS_RECEIVER, 0x1);
...
+		hfi2_sbus_request(dd, rcv_addr, 0x03, WRITE_SBUS_RECEIVER, 0);
+		/* wait for interrupt to be processed */
+		usleep_range(10000, 11000);
...
new file mode 100644
index 000000000000..108ee402657e
--- /dev/null
