...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id C34C0211DEE
	for <lists+linux-rdma@lfdr.de>; Thu,  2 Jul 2020 10:18:44 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726862AbgGBISo (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Thu, 2 Jul 2020 04:18:44 -0400
Received: from mail.kernel.org ([198.145.29.99]:46624 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1727071AbgGBISn (ORCPT <rfc822;linux-rdma@vger.kernel.org>);
        Thu, 2 Jul 2020 04:18:43 -0400
Received: from localhost (unknown [213.57.247.131])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id ABCEC20720;
        Thu,  2 Jul 2020 08:18:34 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1593677916;
        bh=gJx5gyhJB0MSQ2Up8VLW4LG4H9aP9zQMj+OhKrKTSA0=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=KkY89g8+t6syJgdx72Vw7lZOZmWuaVpk1n2J9GEZoWvqTu1dMaT7RlWbKXGU9DLhD
         RwUW09YMEiEkKPA0MYj52U7r1C1lDbR4bTowd/e91N/xF08g2Op1Fv0sSN07BN4Hro
         UMzBWQ+M58dwi9VafzaHPRueiTWbycHu4kPlGIs0=
From:   Leon Romanovsky <leon@kernel.org>
To:     Doug Ledford <dledford@redhat.com>,
        Jason Gunthorpe <jgg@mellanox.com>
Cc:     Leon Romanovsky <leonro@mellanox.com>, linux-rdma@vger.kernel.org
Subject: [PATCH rdma-next 4/6] RDMA/mlx5: Separate flow steering logic from main.c
Date:   Thu,  2 Jul 2020 11:18:07 +0300
Message-Id: <20200702081809.423482-5-leon@kernel.org>
...
Move flow steering logic to be in separate file and rename flow.c
to be fs.c because it is better describe the content.

Signed-off-by: Leon Romanovsky <leonro@mellanox.com>
---
 drivers/infiniband/hw/mlx5/Makefile  |    2 +-
 drivers/infiniband/hw/mlx5/devx.c    |   59 +-
 drivers/infiniband/hw/mlx5/devx.h    |   26 +
 drivers/infiniband/hw/mlx5/flow.c    |  765 --------
 drivers/infiniband/hw/mlx5/fs.c      | 2514 ++++++++++++++++++++++++++
 drivers/infiniband/hw/mlx5/fs.h      |   29 +
 drivers/infiniband/hw/mlx5/main.c    | 1721 +-----------------
 drivers/infiniband/hw/mlx5/mlx5_ib.h |   20 +-
 8 files changed, 2579 insertions(+), 2557 deletions(-)
...
index 34eaceb293b4..b4c009bb0db6 100644
...
index 9454a66c12cc..c7dffd799d16 100644
...
new file mode 100644
index 000000000000..0d8abb7c3cdf
--- /dev/null
...
index 389f57e4c261..fc84264939a2 100644
...
-#include <linux/mlx5/fs_helpers.h>
 ...
 #include <rdma/uverbs_std_types.h>
 #include <rdma/mlx5_user_ioctl_verbs.h>
@@ -2579,1685 +2579,6 @@ static void mlx5_ib_dealloc_pd(struct ib_pd *pd, struct ib_udata *udata)
...
@@ -5874,23 +4195,6 @@ static int mlx5_ib_stage_init_init(struct mlx5_ib_dev *dev)
 	return -ENOMEM;
 }
...
@@ -5917,7 +4221,6 @@ static const struct ib_device_ops mlx5_ib_dev_ops = {
...
@@ -5926,8 +4229,6 @@ static const struct ib_device_ops mlx5_ib_dev_ops = {
...
@@ -5972,11 +4273,6 @@ static const struct ib_device_ops mlx5_ib_dev_ops = {
...
@@ -6109,9 +4405,6 @@ static int mlx5_ib_stage_caps_init(struct mlx5_ib_dev *dev)
...
-		ib_set_device_ops(&dev->ib_dev, &mlx5_ib_dev_flow_ipsec_ops);
 	...
 	if (IS_ENABLED(CONFIG_INFINIBAND_USER_ACCESS))
@@ -6440,9 +4733,9 @@ static const struct mlx5_ib_profile pf_profile = {
...
@@ -6503,9 +4796,9 @@ const struct mlx5_ib_profile raw_eth_profile = {
 	STAGE_CREATE(MLX5_IB_STAGE_INIT,
 		     mlx5_ib_stage_init_init,
 		     mlx5_ib_stage_init_cleanup),
-	STAGE_CREATE(MLX5_IB_STAGE_FLOW_DB,
...
index fbf1bc0129be..3196fbe89818 100644
...
+	MLX5_IB_STAGE_FS,
 	...
 	MLX5_IB_STAGE_ROCE,
@@ -1358,14 +1358,6 @@ int mlx5_ib_devx_create(struct mlx5_ib_dev *dev, bool is_user);
...
@@ -1373,16 +1365,6 @@ mlx5_ib_devx_create(struct mlx5_ib_dev *dev,
