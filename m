...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 375D2154172
	for <lists+linux-rdma@lfdr.de>; Thu,  6 Feb 2020 10:57:12 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728303AbgBFJ5L (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Thu, 6 Feb 2020 04:57:11 -0500
Received: from szxga04-in.huawei.com ([45.249.212.190]:10159 "EHLO huawei.com"
        rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org with ESMTP
        id S1727543AbgBFJ5L (ORCPT <rfc822;linux-rdma@vger.kernel.org>);
        Thu, 6 Feb 2020 04:57:11 -0500
Received: from DGGEMS401-HUB.china.huawei.com (unknown [172.30.72.60])
        by Forcepoint Email with ESMTP id 9D470C9149C7E748D3CE;
        Thu,  6 Feb 2020 17:57:06 +0800 (CST)
Received: from localhost.localdomain (10.69.192.56) by
 DGGEMS401-HUB.china.huawei.com (10.3.19.201) with Microsoft SMTP Server id
 14.3.439.0; Thu, 6 Feb 2020 17:56:56 +0800
From:   Yixian Liu <liuyixian@huawei.com>
To:     <dledford@redhat.com>, <jgg@ziepe.ca>, <leon@kernel.org>
CC:     <linux-rdma@vger.kernel.org>, <linuxarm@huawei.com>
Subject: [PATCH v8 for-next 0/2] Add the workqueue framework for flush cqe handler
Date:   Thu, 6 Feb 2020 17:56:43 +0800
Message-ID: <1580983005-13899-1-git-send-email-liuyixian@huawei.com>
...
v8 changes:
1. Use flag instead of counter for initializing flush work accroding
   to Jason's suggestion.
...
Yixian Liu (2):
 ...
 drivers/infiniband/hw/hns/hns_roce_qp.c     |  40 +++++++++++
