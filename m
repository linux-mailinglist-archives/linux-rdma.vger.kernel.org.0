...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id AD2EC3AA53F
	for <lists+linux-rdma@lfdr.de>; Wed, 16 Jun 2021 22:25:51 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233453AbhFPU15 (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Wed, 16 Jun 2021 16:27:57 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:49020 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233452AbhFPU14 (ORCPT
        <rfc822;linux-rdma@vger.kernel.org>); Wed, 16 Jun 2021 16:27:56 -0400
Received: from mail-pf1-x42a.google.com (mail-pf1-x42a.google.com [IPv6:2607:f8b0:4864:20::42a])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 990F8C06175F
        for <linux-rdma@vger.kernel.org>; Wed, 16 Jun 2021 13:25:49 -0700 (PDT)
Received: by mail-pf1-x42a.google.com with SMTP id h12so3163393pfe.2
        for <linux-rdma@vger.kernel.org>; Wed, 16 Jun 2021 13:25:49 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=broadcom.com; s=google;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version;
        bh=XSneTt87PYBqQij8pMclP6IVyVU0XepdPtFkKLJMos0=;
        b=M5gSpIEF5GOfe2YxwYUwUfn1613Ye5FlFL1seRqjswQ7kgEIRGw8e5uw7zCxFeZqyE
         x6pBVVIYtOK6XitBLKyimO+vU0l+glFX+Yc6k+x6uPiwYshBF9lMJourITFFHa+4kb7i
         h/AM/lckAmx9GvTqlpEmLIuIbbom8dIm7aXuQ=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20161025;
        h=x-gm-message-state:from:to:cc:subject:date:message-id:in-reply-to
         :references:mime-version;
        bh=XSneTt87PYBqQij8pMclP6IVyVU0XepdPtFkKLJMos0=;
        b=
X-Gm-Message-State: AOAM532hNo/64/nJbzIhkV6P99U2WGlIfQugYUKAiPdaNywAOA1wbBoz
        Nw0iIL1Nc/p8tqjWHa0GI+pEw2OrlBSzZXai081PW7al0C3gB0JarEgIZa77rfOAKxR3UoNHYwB
        tppoHoEdOnqde+BeQ51WrHVqxND8C5kNQ7eXJXtBOxul0TPdLR4aBGRjzwZxhUaEMcXxuwecMWG
        lLzLyUuQ==
X-Google-Smtp-Source: ABdhPJw3BbknKslvbRZdUqLzyt9MEA60ZPjBLDgtPnl/aviNKXkOs6rMIvLW3Oiqib2Il2oZ8wSClQ==
X-Received: by 2002:a65:624e:: with SMTP id q14mr1363512pgv.103.1623875148181;
        Wed, 16 Jun 2021 13:25:48 -0700 (PDT)
Received: from dev01.dhcp.broadcom.net ([192.19.234.250])
        by smtp.gmail.com with ESMTPSA id s24sm6236561pju.9.2021.06.16.13.25.46
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Wed, 16 Jun 2021 13:25:47 -0700 (PDT)
From:   Devesh Sharma <devesh.sharma@broadcom.com>
To:     linux-rdma@vger.kernel.org
Cc:     Devesh Sharma <devesh.sharma@broadcom.com>
Subject: [PATCH V6 rdma-core 5/5] bnxt_re/lib: Move hardware queue to 16B aligned indices
Date:   Thu, 17 Jun 2021 01:55:24 +0530
Message-Id: <20210616202524.1185195-6-devesh.sharma@broadcom.com>
...
Content-Type: multipart/signed; protocol="application/pkcs7-signature"; micalg=sha-256;
        boundary="0000000000006cc97505c4e7e5f7"
Precedence: bulk
List-ID: <linux-rdma.vger.kernel.org>
X-Mailing-List: linux-rdma@vger.kernel.org

--0000000000006cc97505c4e7e5f7
...
---
 ...
 4 files changed, 293 insertions(+), 122 deletions(-)
...
index bf45381f..000b976c 100644
--- a/providers/bnxt_re/verbs.c
+++ b/providers/bnxt_re/verbs.c
@@ -885,7 +885,77 @@ static int bnxt_re_alloc_init_swque(struct bnxt_re_joint_queue *jqq, int nwr)
 	return 0;
 }
...
+				struct bnxt_re_qp *qp,
 				...
 				uint32_t pg_size)
 {
@@ -893,17 +963,27 @@ static int bnxt_re_alloc_queues(struct bnxt_re_qp *qp,
...
@@ -912,7 +992,7 @@ static int bnxt_re_alloc_queues(struct bnxt_re_qp *qp,
...
@@ -924,7 +1004,7 @@ static int bnxt_re_alloc_queues(struct bnxt_re_qp *qp,
 	/* exclude psns depth*/
 	que->depth -= psn_depth;
...
@@ -947,10 +1027,19 @@ static int bnxt_re_alloc_queues(struct bnxt_re_qp *qp,
...
@@ -991,7 +1080,7 @@ struct ibv_qp *bnxt_re_create_qp(struct ibv_pd *ibvpd,
 	/* alloc queues */
 	qp->cctx = &cntx->cctx;
...
+	if (bnxt_re_alloc_queues(dev, qp, attr, dev->pg_size))
 	...
 	/* Fill ibv_cmd */
 	cap = &qp->cap;
@@ -1095,8 +1184,44 @@ int bnxt_re_destroy_qp(struct ibv_qp *ibvqp)
 	return 0;
 }
...
+					 uint32_t slots)
 {
 	...
 	uint32_t hdrval = 0;
@@ -1117,36 +1242,38 @@ static inline uint8_t bnxt_re_set_hdr_flags(struct bnxt_re_bsqe *hdr,
...
@@ -1164,6 +1291,7 @@ static void bnxt_re_fill_psns(struct bnxt_re_qp *qp, struct bnxt_re_wrid *wrid,
...
@@ -1183,7 +1311,7 @@ static void bnxt_re_fill_psns(struct bnxt_re_qp *qp, struct bnxt_re_wrid *wrid,
...
@@ -1199,16 +1327,19 @@ static void bnxt_re_fill_wrid(struct bnxt_re_wrid *wrid, uint64_t wr_id,
 	wrid->slots = slots;
 }
...
@@ -1218,34 +1349,22 @@ static int bnxt_re_build_send_sqe(struct bnxt_re_qp *qp, void *wqe,
...
@@ -1289,15 +1413,16 @@ static int bnxt_re_build_cns_sqe(struct bnxt_re_qp *qp, void *wqe,
 	return len;
 }
...
+	len = bnxt_re_build_send_sqe(qp, wr, hdr, false, idx);
 	...
 	hdr->lhdr.rva = htole64(wr->wr.atomic.remote_addr);
 	sqe->cmp_dt = htole64(wr->wr.atomic.compare_add);
@@ -1311,13 +1436,16 @@ int bnxt_re_post_send(struct ibv_qp *ibvqp, struct ibv_send_wr *wr,
...
+	uint32_t idx;
 	...
 	while (wr) {
@@ -1335,18 +1463,21 @@ int bnxt_re_post_send(struct ibv_qp *ibvqp, struct ibv_send_wr *wr,
 			goto bad_wr;
 		}
...
@@ -1357,27 +1488,31 @@ int bnxt_re_post_send(struct ibv_qp *ibvqp, struct ibv_send_wr *wr,
...
+			bytes = bnxt_re_build_fna_sqe(qp, hdr, wr, &idx);
 		...
 		default:
 			bytes = -EINVAL;
@@ -1392,10 +1527,11 @@ int bnxt_re_post_send(struct ibv_qp *ibvqp, struct ibv_send_wr *wr,
...
+	len = bnxt_re_build_sge(rq, wr->sg_list, wr->num_sge, false, idx);
 	...
 	/* HW requires wqe size has room for atleast one sge even if none was
 	 * supplied by application
@@ -1441,7 +1574,7 @@ static int bnxt_re_build_rqe(struct bnxt_re_qp *qp, struct ibv_recv_wr *wr,
...
@@ -1452,8 +1585,11 @@ int bnxt_re_post_recv(struct ibv_qp *ibvqp, struct ibv_recv_wr *wr,
 	struct bnxt_re_qp *qp = to_bnxt_re_qp(ibvqp);
...
@@ -1465,17 +1601,24 @@ int bnxt_re_post_recv(struct ibv_qp *ibvqp, struct ibv_recv_wr *wr,
 			return EINVAL;
 		}
...
+		ret = bnxt_re_build_rqe(rq, wr, hdr, wqe_size, &idx, swq_idx);
 		if (ret < 0) {
 			pthread_spin_unlock(&rq->qlock);
 			*bad = wr;
@@ -1483,9 +1626,9 @@ int bnxt_re_post_recv(struct ibv_qp *ibvqp, struct ibv_recv_wr *wr,
 		}
...
@@ -1644,12 +1787,20 @@ static int bnxt_re_build_srqe(struct bnxt_re_srq *srq,
 	struct bnxt_re_wrid *wrid;
 	int wqe_sz, len, next;
 	uint32_t hdrval = 0;
+	int indx;
...

--0000000000006cc97505c4e7e5f7--
