...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 30671380B58
	for <lists+linux-rdma@lfdr.de>; Fri, 14 May 2021 16:15:15 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234261AbhENOQY (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Fri, 14 May 2021 10:16:24 -0400
Received: from mga04.intel.com ([192.55.52.120]:41447 "EHLO mga04.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S232353AbhENOQU (ORCPT <rfc822;linux-rdma@vger.kernel.org>);
        Fri, 14 May 2021 10:16:20 -0400
IronPort-SDR: 7Ib+dE06lXNLooDYlkbc6gwl3UTdMHIXLeURaK9ZwcrSZQym1leHfiNVeZMAgLsz6UF61z1Rrv
 Hm2NjjwEVG0A==
X-IronPort-AV: E=McAfee;i="6200,9189,9984"; a="198227391"
X-IronPort-AV: E=Sophos;i="5.82,300,1613462400"; 
   d="scan'208";a="198227391"
Received: from orsmga004.jf.intel.com ([10.7.209.38])
  by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 14 May 2021 07:15:08 -0700
IronPort-SDR: MF66I2HvhDeiTEOcvuYkOpCEdYBbqxEZ7acD0DZnNy6oDzdyxXsO8SR7+tADawyoxsIjNeyrcH
 YUqji7DOW2Lw==
X-IronPort-AV: E=Sophos;i="5.82,300,1613462400"; 
   d="scan'208";a="542867692"
...
Subject: [PATCH v5 03/22] ice: Implement iidc operations
Date:   Fri, 14 May 2021 09:11:55 -0500
Message-Id: <20210514141214.2120-4-shiraz.saleem@intel.com>
...
index 6d649e5..b9ee449 100644
--- a/drivers/net/ethernet/intel/ice/ice_common.c
+++ b/drivers/net/ethernet/intel/ice/ice_common.c
@@ -3650,6 +3650,54 @@ enum ice_status
 	return status;
 }
...
+
 ...
 /**
@@ -4148,6 +4196,158 @@ enum ice_status
 }
...
index 7a9d2df..48d2cd2 100644
--- a/drivers/net/ethernet/intel/ice/ice_common.h
+++ b/drivers/net/ethernet/intel/ice/ice_common.h
@@ -148,6 +148,15 @@ enum ice_status
...
@@ -1774,13 +1818,22 @@ struct ice_sched_node *
 	if (!vsi_ctx)
 		return ICE_ERR_PARAM;
...
@@ -1795,7 +1848,10 @@ struct ice_sched_node *
 					       new_num_nodes, owner);
 	if (status)
 		return status;
...
@@ -1990,6 +2047,8 @@ static bool ice_sched_is_leaf_node_present(struct ice_sched_node *node)
 		}
 		if (owner == ICE_SCHED_NODE_OWNER_LAN)
