...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 2D1A22CEC69
	for <lists+linux-rdma@lfdr.de>; Fri,  4 Dec 2020 11:44:16 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726733AbgLDKn5 (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Fri, 4 Dec 2020 05:43:57 -0500
Received: from szxga04-in.huawei.com ([45.249.212.190]:8698 "EHLO
        szxga04-in.huawei.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1729623AbgLDKn5 (ORCPT
        <rfc822;linux-rdma@vger.kernel.org>); Fri, 4 Dec 2020 05:43:57 -0500
Received: from DGGEMS412-HUB.china.huawei.com (unknown [172.30.72.59])
        by szxga04-in.huawei.com (SkyGuard) with ESMTP id 4CnTlz5VX7zkkcW;
...
CC:     <leon@kernel.org>, <linux-rdma@vger.kernel.org>,
        <linuxarm@huawei.com>
Subject: [PATCH v2 for-next 09/11] RDMA/hns: Fix incorrect symbol types
Date:   Fri, 4 Dec 2020 18:40:34 +0800
Message-ID: <1607078436-26455-10-git-send-email-liweihang@huawei.com>
...
index c7044f7..af73086 100644
--- a/drivers/infiniband/hw/hns/hns_roce_device.h
+++ b/drivers/infiniband/hw/hns/hns_roce_device.h
@@ -320,7 +320,7 @@ struct hns_roce_hem_table {
 };
...
@@ -340,10 +340,10 @@ struct hns_roce_buf_attr {
...
@@ -354,7 +354,7 @@ struct hns_roce_hem_cfg {
...
@@ -402,7 +402,7 @@ struct hns_roce_wq {
...
+	u32		max_gs;
 	...
 	u32		head;
@@ -468,8 +468,8 @@ struct hns_roce_db {
 	} u;
 	dma_addr_t	dma;
 	void		*virt_addr;
-	int		index;
...
+	unsigned long	order;
 ...
 struct hns_roce_cq {
@@ -517,8 +517,8 @@ struct hns_roce_srq {
 	u64		       *wrid;
...
@@ -756,11 +756,11 @@ struct hns_roce_eq {
...
+	u32				cons_index;
 	...
 	int				over_ignore;
 	int				coalesce;
@@ -768,7 +768,7 @@ struct hns_roce_eq {
 	int				hop_num;
...
+	u32				eq_period;
 	...
 	int				event_type;
 	int				sub_type;
@@ -791,8 +791,8 @@ struct hns_roce_caps {
 	u32		max_sq_inline;
 	u32		max_rq_sg;
 	u32		max_extend_sg;
-	int		num_qps;
...
+	u32		num_cqs;
 	...
 	u32		min_cqes;
 	u32		min_wqes;
@@ -813,7 +813,7 @@ struct hns_roce_caps {
 	int		num_aeq_vectors;
...
@@ -1105,15 +1105,16 @@ static inline struct hns_roce_qp
...
+	unsigned int offset = idx << buf->page_shift;
 	...
 	return buf->trunk_list[offset >> buf->trunk_shift].map +
 			(offset & ((1 << buf->trunk_shift) - 1));
@@ -1188,7 +1189,7 @@ int hns_roce_mtr_create(struct hns_roce_dev *hr_dev, struct hns_roce_mtr *mtr,
...
@@ -1271,10 +1272,10 @@ struct ib_qp *hns_roce_create_qp(struct ib_pd *ib_pd,
...
@@ -1304,7 +1305,7 @@ void hns_roce_cq_completion(struct hns_roce_dev *hr_dev, u32 cqn);
