...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 7A1ED2D3630
	for <lists+linux-rdma@lfdr.de>; Tue,  8 Dec 2020 23:25:10 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1730829AbgLHWYo (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Tue, 8 Dec 2020 17:24:44 -0500
Received: from mga17.intel.com ([192.55.52.151]:1855 "EHLO mga17.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1730706AbgLHWYo (ORCPT <rfc822;linux-rdma@vger.kernel.org>);
        Tue, 8 Dec 2020 17:24:44 -0500
IronPort-SDR: NApTjmAi/Mg7pRw1CSnZ/LIHw66hVqScShsh01380ZON5fDc1m5EpkuoYzCVluNqoaDzPtNqkW
 HHNTBEWm4Xfw==
X-IronPort-AV: E=McAfee;i="6000,8403,9829"; a="153789992"
X-IronPort-AV: E=Sophos;i="5.78,404,1599548400"; 
   d="scan'208";a="153789992"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
  by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 08 Dec 2020 14:23:48 -0800
IronPort-SDR: BhrBTQc1OfmQ0nwj8kD0UPHQ+BXiJ+TcXQneIryUD6lo6WbxJOHLfut1wpkAkHkAuljT2omSiR
 6EF8167Lh3ug==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.78,404,1599548400"; 
   d="scan'208";a="363844594"
...
Subject: [PATCH v14 1/4] RDMA/umem: Support importing dma-buf as user memory region
Date:   Tue,  8 Dec 2020 14:39:12 -0800
Message-Id: <1607467155-92725-2-git-send-email-jianxin.xiong@intel.com>
...
+	struct ib_umem *umem;
+	unsigned long end;
+	struct ib_umem *ret = ERR_PTR(-EINVAL);
+
