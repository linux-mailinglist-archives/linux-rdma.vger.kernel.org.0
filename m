...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 515CF4857EC
	for <lists+linux-rdma@lfdr.de>; Wed,  5 Jan 2022 19:07:17 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S242738AbiAESHP (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Wed, 5 Jan 2022 13:07:15 -0500
...
Received: from mail-ed1-x529.google.com (mail-ed1-x529.google.com [IPv6:2a00:1450:4864:20::529])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 5E016C061245
        for <linux-rdma@vger.kernel.org>; Wed,  5 Jan 2022 10:07:14 -0800 (PST)
Received: by mail-ed1-x529.google.com with SMTP id bm14so165324717edb.5
        for <linux-rdma@vger.kernel.org>; Wed, 05 Jan 2022 10:07:14 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=ionos.com; s=google;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=LLalL0fHgDlbbtlBkFOpWYHyLH4+jL38c4ts4JtaHdk=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=LLalL0fHgDlbbtlBkFOpWYHyLH4+jL38c4ts4JtaHdk=;
        b=
X-Gm-Message-State: AOAM5331b+9j5sGZUdPLWUs4DQURzomW806MPGbwb6uRA0kLataiCGyK
        aJkH58FxqhelUOjpjvj67lXbEs7ccug4nQ==
X-Google-Smtp-Source: ABdhPJw1XfIy0fjPDtKDX9Kboc9eGfRjky1eiACY8d83jOErkWWpL2TDZVhxMP4x6SFvEtqU27hicQ==
X-Received: by 2002:aa7:d2da:: with SMTP id k26mr54783779edr.137.1641406031989;
        Wed, 05 Jan 2022 10:07:11 -0800 (PST)
Received: from jwang-Latitude-5491.fkb.profitbricks.net ([2001:16b8:4592:200:545c:cb34:8a20:aae1])
        by smtp.gmail.com with ESMTPSA id eg12sm15970910edb.25.2022.01.05.10.07.11
...
Subject: [PATCHv3 for-next 2/5] RDMA/rtrs-srv: Rename rtrs_srv_sess to rtrs_srv_path
Date:   Wed,  5 Jan 2022 19:07:05 +0100
Message-Id: <20220105180708.7774-3-jinpu.wang@ionos.com>
...
---
Changes since v2:
    - Fixe missed spots of renaming sess->path in comments/
      error messages
    - Rename sessname->pathname when applicable
    - Rename exist_sessname, post_recv_sess
---
...
index 016e136f0765..f2a9ff08c5e5 100644
