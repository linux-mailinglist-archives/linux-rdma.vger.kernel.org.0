...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 35E0D24FB86
	for <lists+linux-rdma@lfdr.de>; Mon, 24 Aug 2020 12:33:35 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726632AbgHXKde (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Mon, 24 Aug 2020 06:33:34 -0400
Received: from mail.kernel.org ([198.145.29.99]:55676 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1725946AbgHXKdJ (ORCPT <rfc822;linux-rdma@vger.kernel.org>);
        Mon, 24 Aug 2020 06:33:09 -0400
Received: from localhost (unknown [213.57.247.131])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id 49DEC2075B;
        Mon, 24 Aug 2020 10:33:06 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1598265187;
        bh=/MfGNwQv5oRqgCw96Iwbc42aR69i82l8wjzjsYTGcNk=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=yhV7R5Ym+gockCVfJbF4er5zMRPncJRRUx76gHmszBF9ckrkGcEKZmoAyQNWnxxZB
         Zs6YtOWJvIZGVZD0XYA9qjlOkjsOuyxqlVuUZv1V/spqjkeIFncngBTxl642U5/Gj5
         4TCi0nBSQdgJkQhQ5N8XzXq7+mAGRFvuo479gaVs=
...
Subject: [PATCH rdma-next 02/10] RDMA: Restore ability to fail on AH destroy
Date:   Mon, 24 Aug 2020 13:32:39 +0300
Message-Id: <20200824103247.1088464-3-leon@kernel.org>
...
index 06f5e753c821..6c5595210014 100644
--- a/drivers/infiniband/hw/vmw_pvrdma/pvrdma_verbs.c
+++ b/drivers/infiniband/hw/vmw_pvrdma/pvrdma_verbs.c
@@ -549,9 +549,10 @@ int pvrdma_create_ah(struct ib_ah *ibah, struct rdma_ah_init_attr *init_attr,
