...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 620373A88A8
	for <lists+linux-rdma@lfdr.de>; Tue, 15 Jun 2021 20:32:11 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231310AbhFOSeO (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Tue, 15 Jun 2021 14:34:14 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:38958 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231208AbhFOSeO (ORCPT
        <rfc822;linux-rdma@vger.kernel.org>); Tue, 15 Jun 2021 14:34:14 -0400
Received: from mail-pj1-x102e.google.com (mail-pj1-x102e.google.com [IPv6:2607:f8b0:4864:20::102e])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 8F859C061574
        for <linux-rdma@vger.kernel.org>; Tue, 15 Jun 2021 11:32:09 -0700 (PDT)
Received: by mail-pj1-x102e.google.com with SMTP id z3-20020a17090a3983b029016bc232e40bso181174pjb.4
        for <linux-rdma@vger.kernel.org>; Tue, 15 Jun 2021 11:32:09 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=broadcom.com; s=google;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version;
        bh=jufeS3gErMO3/Nw8uDXjThHmzRd47fDdOqOONNq4vXY=;
        b=OsQsBvaT65cT8QY5uSb0P27h6+kUX1sUT013qNU0grzyHEGq1XvYuOjUB1n2hzLIC4
         E6m46hkmnsXJNBOVq6+XT4Rv8ux5hxZQiuCOA2+B4X/RANXIF2A86ZZNACwTou8TC3nW
         +/Lfz/xV6cuM6G4IUfGI0ZqOMGH+UqgHXTt1A=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20161025;
        h=x-gm-message-state:from:to:cc:subject:date:message-id:in-reply-to
         :references:mime-version;
        bh=jufeS3gErMO3/Nw8uDXjThHmzRd47fDdOqOONNq4vXY=;
        b=
X-Gm-Message-State: AOAM531fo+33L4oz5xxS2ktqxh/YtkRRXL6jV5VMWB4rT8hCPajop3oz
        OWI49iEV4pK3YtLhtIrFqLEFBgAu9Gq3HCcLlRLz3jEE2xRfNXBdfqkAON0QYdF5whdWZR6vyZg
        oFcBZIh4JDBm6/OujkY+xq5wSWIgOFMU/jZlfjGo/neNWapqmWMDiFLdxxJ2NiD+hj+1e9E3hoj
        YQ7bQhjA==
X-Google-Smtp-Source: ABdhPJyW6fI/I1cC6aQfvifNXN+fFFDaklVDtYqxdJ66DnI6vWqzBKwhY7g3iYWHNuw3M2uyDVtL1Q==
X-Received: by 2002:a17:90b:3004:: with SMTP id hg4mr6444566pjb.12.1623781928298;
        Tue, 15 Jun 2021 11:32:08 -0700 (PDT)
Received: from dev01.dhcp.broadcom.net ([192.19.234.250])
        by smtp.gmail.com with ESMTPSA id i125sm3803823pfc.7.2021.06.15.11.32.06
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Tue, 15 Jun 2021 11:32:07 -0700 (PDT)
From:   Devesh Sharma <devesh.sharma@broadcom.com>
To:     linux-rdma@vger.kernel.org
Cc:     Devesh Sharma <devesh.sharma@broadcom.com>
Subject: [PATCH V5 rdma-core 5/5] bnxt_re/lib: Move hardware queue to 16B aligned indices
Date:   Wed, 16 Jun 2021 00:01:48 +0530
Message-Id: <20210615183148.1179042-6-devesh.sharma@broadcom.com>
...
Content-Type: multipart/signed; protocol="application/pkcs7-signature"; micalg=sha-256;
        boundary="00000000000014edbb05c4d231be"
Precedence: bulk
List-ID: <linux-rdma.vger.kernel.org>
X-Mailing-List: linux-rdma@vger.kernel.org

--00000000000014edbb05c4d231be
...
index 5d05dd85..2e6131ae 100644
...
index 5bcdef9a..35fb057e 100644
...
index fb097308..d5dcbf51 100644
--- a/providers/bnxt_re/verbs.c
+++ b/providers/bnxt_re/verbs.c
@@ -885,7 +885,76 @@ static int bnxt_re_alloc_init_swque(struct bnxt_re_joint_queue *jqq, int nwr)
 	return 0;
 }
...
+				struct bnxt_re_qp *qp,
 				...
 				uint32_t pg_size)
 {
@@ -893,17 +962,27 @@ static int bnxt_re_alloc_queues(struct bnxt_re_qp *qp,
...
@@ -912,7 +991,7 @@ static int bnxt_re_alloc_queues(struct bnxt_re_qp *qp,
...
@@ -924,7 +1003,7 @@ static int bnxt_re_alloc_queues(struct bnxt_re_qp *qp,
 	/* exclude psns depth*/
 	que->depth -= psn_depth;
...
@@ -947,10 +1026,19 @@ static int bnxt_re_alloc_queues(struct bnxt_re_qp *qp,
...
@@ -991,7 +1079,7 @@ struct ibv_qp *bnxt_re_create_qp(struct ibv_pd *ibvpd,
 	/* alloc queues */
 	qp->cctx = &cntx->cctx;
...
+	if (bnxt_re_alloc_queues(dev, qp, attr, dev->pg_size))
 	...
 	/* Fill ibv_cmd */
 	cap = &qp->cap;
@@ -1095,8 +1183,44 @@ int bnxt_re_destroy_qp(struct ibv_qp *ibvqp)
 	return 0;
 }
...
+					 uint32_t slots)
 {
 	...
 	uint32_t hdrval = 0;
@@ -1117,36 +1241,38 @@ static inline uint8_t bnxt_re_set_hdr_flags(struct bnxt_re_bsqe *hdr,
...
@@ -1164,6 +1290,7 @@ static void bnxt_re_fill_psns(struct bnxt_re_qp *qp, struct bnxt_re_wrid *wrid,
...
@@ -1183,7 +1310,7 @@ static void bnxt_re_fill_psns(struct bnxt_re_qp *qp, struct bnxt_re_wrid *wrid,
...
@@ -1199,16 +1326,19 @@ static void bnxt_re_fill_wrid(struct bnxt_re_wrid *wrid, uint64_t wr_id,
 	wrid->slots = slots;
 }
...
@@ -1218,34 +1348,22 @@ static int bnxt_re_build_send_sqe(struct bnxt_re_qp *qp, void *wqe,
...
@@ -1289,15 +1412,16 @@ static int bnxt_re_build_cns_sqe(struct bnxt_re_qp *qp, void *wqe,
 	return len;
 }
...
+	len = bnxt_re_build_send_sqe(qp, wr, hdr, false, idx);
 	...
 	hdr->lhdr.rva = htole64(wr->wr.atomic.remote_addr);
 	sqe->cmp_dt = htole64(wr->wr.atomic.compare_add);
@@ -1311,13 +1435,16 @@ int bnxt_re_post_send(struct ibv_qp *ibvqp, struct ibv_send_wr *wr,
...
+	uint32_t idx;
 	...
 	while (wr) {
@@ -1335,18 +1462,20 @@ int bnxt_re_post_send(struct ibv_qp *ibvqp, struct ibv_send_wr *wr,
 			goto bad_wr;
 		}
...
@@ -1357,27 +1486,31 @@ int bnxt_re_post_send(struct ibv_qp *ibvqp, struct ibv_send_wr *wr,
...
+			bytes = bnxt_re_build_fna_sqe(qp, hdr, wr, &idx);
 		...
 		default:
 			bytes = -EINVAL;
@@ -1392,10 +1525,11 @@ int bnxt_re_post_send(struct ibv_qp *ibvqp, struct ibv_send_wr *wr,
...
+	len = bnxt_re_build_sge(rq, wr->sg_list, wr->num_sge, false, idx);
 	...
 	/* HW requires wqe size has room for atleast one sge even if none was
 	 * supplied by application
@@ -1441,7 +1572,7 @@ static int bnxt_re_build_rqe(struct bnxt_re_qp *qp, struct ibv_recv_wr *wr,
...
@@ -1452,8 +1583,11 @@ int bnxt_re_post_recv(struct ibv_qp *ibvqp, struct ibv_recv_wr *wr,
 	struct bnxt_re_qp *qp = to_bnxt_re_qp(ibvqp);
...
@@ -1465,17 +1599,24 @@ int bnxt_re_post_recv(struct ibv_qp *ibvqp, struct ibv_recv_wr *wr,
 			return EINVAL;
 		}
...
+		ret = bnxt_re_build_rqe(rq, wr, hdr, wqe_size, &idx, swq_idx);
 		if (ret < 0) {
 			pthread_spin_unlock(&rq->qlock);
 			*bad = wr;
@@ -1483,9 +1624,9 @@ int bnxt_re_post_recv(struct ibv_qp *ibvqp, struct ibv_recv_wr *wr,
 		}
...
@@ -1644,12 +1785,20 @@ static int bnxt_re_build_srqe(struct bnxt_re_srq *srq,
 	struct bnxt_re_wrid *wrid;
 	int wqe_sz, len, next;
 	uint32_t hdrval = 0;
+	int indx;
...

--00000000000014edbb05c4d231be--
