...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id D68B11D06CF
	for <lists+linux-rdma@lfdr.de>; Wed, 13 May 2020 08:02:18 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728712AbgEMGCS (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Wed, 13 May 2020 02:02:18 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:41930 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-FAIL-OK-FAIL)
        by vger.kernel.org with ESMTP id S1726092AbgEMGCR (ORCPT
        <rfc822;linux-rdma@vger.kernel.org>);
        Wed, 13 May 2020 02:02:17 -0400
Received: from mail-ot1-x344.google.com (mail-ot1-x344.google.com [IPv6:2607:f8b0:4864:20::344])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 88107C061A0C
        for <linux-rdma@vger.kernel.org>; Tue, 12 May 2020 23:02:17 -0700 (PDT)
Received: by mail-ot1-x344.google.com with SMTP id z17so12531454oto.4
        for <linux-rdma@vger.kernel.org>; Tue, 12 May 2020 23:02:17 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=qe7DEkVnPnAD93/teZnIUm1SC/00lbP9Vn4InsOAzGs=;
        b=
X-Gm-Message-State: AGi0PuaPkK3WRkulwn23TUW9Ch5ELf+Q1ciKbimRMkkxnM1iP0l9a1No
        b18xoEQso4mqZvWatGs+H6ctkGWlyXDuMenZo0WKtw==
X-Google-Smtp-Source: APiQypJhBGBMbqp2fk0W704/owSaHWeMu8oJjYcB1KHtS1AuK87yeiknqShS1MQw+/I2lHh9U6N8ti2VHpu0rbRKFGM=
X-Received: by 2002:a05:6830:1d0:: with SMTP id r16mr18624229ota.303.1589349736609;
...
References: <20200512085944.222637-1-daniel.vetter@ffwll.ch>
 ...
 <CAKMK7uE+cvUUyiLqySDv0L=saW+fZCmArs3fqokuOV_pL8MGHQ@mail.gmail.com> <84ce83ba-0dc7-756a-c576-81c7319edfa0@amd.com>
...
> > On Tue, May 12, 2020 at 4:24 PM Alex Deucher <alexdeucher@gmail.com> wr=
ote:
> >>
> >> On Tue, May 12, 2020 at 9:45 AM Daniel Vetter <daniel.vetter@ffwll.ch>=
 wrote:
> >>>
> >>> On Tue, May 12, 2020 at 3:29 PM Alex Deucher <alexdeucher@gmail.com> =
wrote:
> >>>>
> >>>> On Tue, May 12, 2020 at 9:17 AM Daniel Vetter <daniel.vetter@ffwll.c=
h> wrote:
> >>>>>
> >>>>> On Tue, May 12, 2020 at 3:12 PM Alex Deucher <alexdeucher@gmail.com=
> wrote:
> >>>>>>
> >>>>>> On Tue, May 12, 2020 at 8:58 AM Daniel Vetter <daniel@ffwll.ch> wr=
ote:
> >>>>>>>
> >>>>>>> On Tue, May 12, 2020 at 08:54:45AM -0400, Alex Deucher wrote:
> >>>>>>>> On Tue, May 12, 2020 at 5:00 AM Daniel Vetter <daniel.vetter@ffw=
ll.ch> wrote:
> >>>>>>>>>
> >>>>>>>>> ...
> >>>>>>>>>
...
> >>>>>>>>>                  if (adev->ip_blocks[i].version->type =3D=3D AM=
D_IP_BLOCK_TYPE_DCE) {
> >>>>>>>>>                          /* XXX handle errors */
> >>>>>>>>> +
> >>>>>>>>> +                       /*
...
> >>>>>> There's no way to avoid that.  On dGPUs at least a full asic reset=
 is
> >>>>>> a full asic reset.  Mostly just skips the modeset and does the min=
imum
> >>>>>> amount necessary to get the display block into a good state for re=
set.
> >>>>>
...
> >>>> without going through the atomic interfaces so everything is back th=
e
...
> already finished - we had no trouble grabbing the locks for the tdr commi=
t.
>
...
> easiest solution seemed to just bypass the entire DRM stack under the hoo=
d.
...
https://patchwork.freedesktop.org/patch/365335/?series=3D77179&rev=3D1
