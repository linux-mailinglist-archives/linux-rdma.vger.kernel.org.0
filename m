Return-Path: <linux-rdma+bounces-17445-lists+linux-rdma=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-rdma@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id qE/lBGZ2p2nyhgAAu9opvQ
	(envelope-from <linux-rdma+bounces-17445-lists+linux-rdma=lfdr.de@vger.kernel.org>)
	for <lists+linux-rdma@lfdr.de>; Wed, 04 Mar 2026 01:01:42 +0100
X-Original-To: lists+linux-rdma@lfdr.de
Received: from tor.lore.kernel.org (tor.lore.kernel.org [172.105.105.114])
	by mail.lfdr.de (Postfix) with ESMTPS id C3CAD1F89BD
	for <lists+linux-rdma@lfdr.de>; Wed, 04 Mar 2026 01:01:41 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by tor.lore.kernel.org (Postfix) with ESMTP id 8339F3081B0D
	for <lists+linux-rdma@lfdr.de>; Wed,  4 Mar 2026 00:00:31 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 4946921771B;
	Wed,  4 Mar 2026 00:00:29 +0000 (UTC)
X-Original-To: linux-rdma@vger.kernel.org
Received: from linux.microsoft.com (linux.microsoft.com [13.77.154.182])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id A52ED191;
	Wed,  4 Mar 2026 00:00:27 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=13.77.154.182
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1772582429; cv=none; b=SPAM0Ahi6swnOYyqBEyfGRbeXUy/5zc0PT9iSxeZQQZq/ID7XWhnxKXfzWVEz3DA/LoS0RzusQzl1deaSYKTHdS41C/3mbvdXnSQpTEc3qc/0gwntSsOUTtmUiEiSOuZsBgnQ/KklLryIK5h+LF+pzB5smI1f7YwE30eED0czSU=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1772582429; c=relaxed/simple;
	bh=eQBOzbpeFBI9GGK0CpbFewvtlmBMUTr8g8DSuMHS92k=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=d6Jtw2/6p554z7O4+3Mof8+1L5vTyrTxgkQAYKICoFWejO0lIAm/WDzNTDsXfzSB22w7CQi55ncHq5IiqQRmQEmx1LNZeDVbPSgNueUPzbLmYILXr2qk9C9pV6EANM0mQ5qf75skCkqudoPYZLuN8NAYzy0M3EGfz3lcEOy5T5M=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=microsoft.com; spf=pass smtp.mailfrom=linux.microsoft.com; arc=none smtp.client-ip=13.77.154.182
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=microsoft.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=linux.microsoft.com
Received: by linux.microsoft.com (Postfix, from userid 1202)
	id 8006C20B6F02; Tue,  3 Mar 2026 16:00:27 -0800 (PST)
DKIM-Filter: OpenDKIM Filter v2.11.0 linux.microsoft.com 8006C20B6F02
...
Subject: [PATCH v2 net-next 1/6] net: mana: Create separate EQs for each vPort
Date: Tue,  3 Mar 2026 16:00:12 -0800
Message-ID: <20260304000017.333312-2-longli@microsoft.com>
...
X-Spamd-Result: default: False [2.04 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-17445-lists,linux-rdma=lfdr.de];
...
index 82f84f7ad37a..0c35d6c3a0a8 100644
--- a/drivers/infiniband/hw/mana/qp.c
+++ b/drivers/infiniband/hw/mana/qp.c
@@ -188,7 +188,7 @@ static int mana_ib_create_qp_rss(struct ib_qp *ibqp, struct ib_pd *pd,
...
@@ -340,7 +340,7 @@ static int mana_ib_create_qp_raw(struct ib_qp *ibqp, struct ib_pd *ibpd,
