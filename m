...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id C95F141D506
	for <lists+linux-rdma@lfdr.de>; Thu, 30 Sep 2021 10:04:44 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1348955AbhI3IGV (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Thu, 30 Sep 2021 04:06:21 -0400
Received: from mail.kernel.org ([198.145.29.99]:32882 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1348965AbhI3IEs (ORCPT <rfc822;linux-rdma@vger.kernel.org>);
        Thu, 30 Sep 2021 04:04:48 -0400
Received: by mail.kernel.org (Postfix) with ESMTPSA id EF0E161875;
        Thu, 30 Sep 2021 08:02:50 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1632988972;
        bh=/b4lFpieSo8LpNoAO47hRBfRFAgKpq3v1kW0c8ag/n8=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=
...
Subject: [PATCH rdma-next v2 03/13] RDMA/counter: Add a descriptor in struct rdma_hw_stats
Date:   Thu, 30 Sep 2021 11:02:19 +0300
Message-Id: <9b8a4074880e1223c1b02a79f63e7949e58a125b.1632988543.git.leonro@nvidia.com>
...
index 26bea51869bf..09354f1257a9 100644
...
+	char *names_out, *p;
 	...
 	n = 0;
@@ -1628,26 +1629,28 @@ static int init_cntr_names(const char *names_in,
 		if (names_in[i] == '\n')
 			n++;
...
@@ -1661,18 +1664,18 @@ static int init_counters(struct ib_device *ibdev)
 		goto out_unlock;
...
@@ -1686,7 +1689,7 @@ static struct rdma_hw_stats *hfi1_alloc_hw_device_stats(struct ib_device *ibdev)
 {
...
@@ -1696,7 +1699,7 @@ static struct rdma_hw_stats *hfi_alloc_hw_port_stats(struct ib_device *ibdev,
 {
 	if (init_counters(ibdev))
 		return NULL;
...
@@ -1921,10 +1924,10 @@ void hfi1_unregister_ib_device(struct hfi1_devdata *dd)
