...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id D1C6E2ADCD1
	for <lists+linux-rdma@lfdr.de>; Tue, 10 Nov 2020 18:24:07 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726307AbgKJRYG (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Tue, 10 Nov 2020 12:24:06 -0500
Received: from mga04.intel.com ([192.55.52.120]:42534 "EHLO mga04.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726179AbgKJRYG (ORCPT <rfc822;linux-rdma@vger.kernel.org>);
        Tue, 10 Nov 2020 12:24:06 -0500
IronPort-SDR: lcwHUcdsZtHnLvwBJAqVVe9jTjfrlZNwhuasGucbuUMzCxG04hgJICg+CNm5K90KoPdrcbfgcS
 7VlpLycEtOtg==
X-IronPort-AV: E=McAfee;i="6000,8403,9801"; a="167430765"
X-IronPort-AV: E=Sophos;i="5.77,466,1596524400"; 
   d="scan'208";a="167430765"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
  by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 10 Nov 2020 09:24:04 -0800
IronPort-SDR: Ixcs+6aGVSQsHKlWekv80vuwLhh5LIFGrHAX6htll+/D5OErRwYfiwcP6CQbudlGy60kPgyA+q
 YQ0t0qt12bfw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.77,466,1596524400"; 
   d="scan'208";a="356237184"
...
X-MS-Exchange-CrossTenant-originalarrivaltime: 10 Nov 2020 17:23:32.0425
 (UTC)
...
com>; Leon Romanovsky <leon@kernel.org>; linux-
> rdma@vger.kernel.org; dri-devel@lists.freedesktop.org; Doug Ledford <dled=
ford@redhat.com>; Vetter, Daniel <daniel.vetter@intel.com>;
> Christian Koenig <christian.koenig@amd.com>
> Subject: Re: [PATCH v8 1/5] RDMA/umem: Support importing dma-buf as user =
memory region
>=20
...
> > > > >
> > > > > In order to check the length, the buffer needs to be mapped. That=
 can be done.
> > > >
...
> > > ht=3Ddma_buf_ops#c.dma_buf_ops
> > >
...
>=20
> The history here is that the X shm extension suffered badly from resizeab=
le storage object exploits of the X server, this is why both dma-buf
