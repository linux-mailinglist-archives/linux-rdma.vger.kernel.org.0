...
index 243210466d88..adfc528a268e 100644
...
+	u32 srq_id;
 	...
 	u16 stats_idx;
 	bool srq_valid:1;
@@ -1344,6 +1391,8 @@ void irdma_sc_cq_resize(struct irdma_sc_cq *cq, struct irdma_modify_cq_info *inf
...
index 38c54e59cc2e..26f3475f6453 100644
...
index 8fd7eebef11d..af15529643e9 100644
...
index 894ced3a8989..2fdcb8872e08 100644
--- a/drivers/infiniband/hw/irdma/utils.c
+++ b/drivers/infiniband/hw/irdma/utils.c
@@ -700,6 +700,9 @@ static const char *const irdma_cqp_cmd_names[IRDMA_MAX_CQP_OPS] = {
...
@@ -1238,6 +1241,30 @@ void irdma_free_qp_rsrc(struct irdma_qp *iwqp)
...
index 4c7fbdce4433..9d08937848bc 100644
...
+	init_attr->srq = iwqp->ibqp.srq;
 	...
 	return 0;
@@ -1833,6 +1856,24 @@ int irdma_modify_qp(struct ib_qp *ibqp, struct ib_qp_attr *attr, int attr_mask,
 	return err;
 }
...
+
  ...
  * @rf: RDMA PCI function
@@ -1896,6 +1937,22 @@ static int irdma_process_resize_list(struct irdma_cq *iwcq,
 	return cnt;
 }
...
@@ -2527,6 +2871,7 @@ static int irdma_handle_q_mem(struct irdma_device *iwdev,
...
+	struct irdma_srq_mr *srqmr = &iwpbl->srq_mr;
 	...
 	u32 pg_size, total;
@@ -2546,7 +2891,10 @@ static int irdma_handle_q_mem(struct irdma_device *iwdev,
...
+		qpmr->rq_pa = (dma_addr_t)arr[req->sq_pages];
 		if (lvl) {
 			ret = irdma_check_mem_contiguous(arr, req->sq_pages,
 							 pg_size);
@@ -2566,6 +2914,18 @@ static int irdma_handle_q_mem(struct irdma_device *iwdev,
...
@@ -3036,6 +3396,37 @@ static int irdma_reg_user_mr_type_qp(struct irdma_mem_reg_req req,
 	return 0;
 }
...
@@ -3437,6 +3834,14 @@ static void irdma_del_memlist(struct irdma_mr *iwmr,
 		}
...
+
  ...
  * @ibqp: ib qp pointer
@@ -3674,6 +4120,11 @@ static int irdma_post_recv(struct ib_qp *ibqp,
 	iwqp = to_iwqp(ibqp);
...
+
 	...
 	while (ib_wr) {
 		post_recv.num_sges = ib_wr->num_sge;
@@ -4762,6 +5213,18 @@ static enum rdma_link_layer irdma_get_link_layer(struct ib_device *ibdev,
...
@@ -4832,6 +5295,7 @@ static const struct ib_device_ops irdma_dev_ops = {
...
+	INIT_RDMA_OBJ_SIZE(ib_srq, irdma_srq, ibsrq),
 ...
 /**
@@ -4879,6 +5343,10 @@ static void irdma_init_rdma_device(struct irdma_device *iwdev)
...
index fcb163c45252..157dfa2d1a05 100644
