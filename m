...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 83D2BDF562
	for <lists+linux-rdma@lfdr.de>; Mon, 21 Oct 2019 20:51:20 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728353AbfJUSu5 (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Mon, 21 Oct 2019 14:50:57 -0400
Received: from us-smtp-delivery-1.mimecast.com ([205.139.110.120]:38357 "EHLO
        us-smtp-1.mimecast.com" rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org
        with ESMTP id S1727211AbfJUSu4 (ORCPT
        <rfc822;linux-rdma@vger.kernel.org>); Mon, 21 Oct 2019 14:50:56 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        s=mimecast20190719; t=1571683852;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=mPaFk24CYIREgTq2xvt4tq69dFoQgxNfUE1dthABq8I=;
        b=Ps7W9wdti6PYiNwvRBXwYCLRDL2t3qbO/LO3b3WFjsRYqNQgXoV8zFpOBeJfahbaozGuwP
        qqqL3mhMzoLcLNeevl80R25FPV6guclOPzjc6OD8dKeFK6biGikRXbflsjfOantd6Ydr6R
        44FRT8x6RqpNfX2wGR0m7sYuJFF56F8=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-2-zdNr4T9QPCywYeovDIs0aw-1; Mon, 21 Oct 2019 14:50:48 -0400
Received: from smtp.corp.redhat.com (int-mx02.intmail.prod.int.phx2.redhat.com [10.5.11.12])
        (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
        (No client certificate requested)
        by mimecast-mx01.redhat.com (Postfix) with ESMTPS id C87341800D79;
        Mon, 21 Oct 2019 18:50:46 +0000 (UTC)
Received: from redhat.com (unknown [10.20.6.178])
        by smtp.corp.redhat.com (Postfix) with ESMTPS id D35636CE45;
        Mon, 21 Oct 2019 18:50:45 +0000 (UTC)
Date:   Mon, 21 Oct 2019 14:50:44 -0400
...
Cc:     John Hubbard <jhubbard@nvidia.com>, Christoph Hellwig <hch@lst.de>,
        ...
        linux-mm@kvack.org
Subject: Re: [PATCH v2 3/3] mm/hmm/test: add self tests for HMM
Message-ID: <20191021185044.GH3177@redhat.com>
References: <20191015204814.30099-1-rcampbell@nvidia.com>
 <20191015204814.30099-4-rcampbell@nvidia.com>
MIME-Version: 1.0
In-Reply-To: <20191015204814.30099-4-rcampbell@nvidia.com>
User-Agent: Mutt/1.12.1 (2019-06-15)
X-Scanned-By: MIMEDefang 2.79 on 10.5.11.12
X-MC-Unique: zdNr4T9QPCywYeovDIs0aw-1
...
On Tue, Oct 15, 2019 at 01:48:14PM -0700, Ralph Campbell wrote:
...
> +=09[HMM_PFN_SPECIAL] =3D 0x20,=09/* actually, read-only zero page */
> +};
> +
> +struct dmirror_pt {
...
> +=09=09return;
> +=09}
> +=09if (entry =3D=3D range->values[HMM_PFN_NONE]) {
> +=09=09*perm =3D HMM_DMIRROR_PROT_NONE;
> +=09=09return;
> +=09}
> +=09if (entry =3D=3D range->values[HMM_PFN_SPECIAL]) {
> +=09=09*perm =3D HMM_DMIRROR_PROT_ZERO;
> +=09=09return;
> +=09}
> +=09if (!(entry & range->flags[HMM_PFN_VALID])) {
> +=09=09*perm =3D HMM_DMIRROR_PROT_NONE;
> +=09=09return;
> +=09}
...
> +=09if (!page)
> +=09=09*perm =3D HMM_DMIRROR_PROT_ZERO;
> +=09else if (entry & range->flags[HMM_PFN_DEVICE_PRIVATE]) {
...
> +=09HMM_DMIRROR_PROT_DEV_PRIVATE_LOCAL      =3D 0x20,
> +=09HMM_DMIRROR_PROT_DEV_PRIVATE_REMOTE     =3D 0x30,
> +};
> +
...
> +=09ASSERT_EQ(m[2], HMM_DMIRROR_PROT_ZERO);
