...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id BDF9F37224
	for <lists+linux-rdma@lfdr.de>; Thu,  6 Jun 2019 12:54:08 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727242AbfFFKyI (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Thu, 6 Jun 2019 06:54:08 -0400
Received: from mail.kernel.org ([198.145.29.99]:54710 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726818AbfFFKyI (ORCPT <rfc822;linux-rdma@vger.kernel.org>);
        Thu, 6 Jun 2019 06:54:08 -0400
Received: from localhost (unknown [193.47.165.251])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id 8169D20872;
        Thu,  6 Jun 2019 10:54:06 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1559818447;
        bh=1dLW/AMXr4CGQ7MFnjp85+/PmgiEe5zV5mG2a+AhQSQ=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=nMBU0Tvo+stZjIrTy4J5NcYUmAflfY5/odeVJK4iKCBcsWFE0jXItUwX844EsuWsu
         PQuT0XPT/fN97qVLl2nTKxgpjBWW52evoEyBIh2RBgYZ4lxF/TTluVLJkcR3jF3Gs3
         yytvmoaSF/ovfrlLU5cntjQzFt/+F96T0HSPsgxw=
...
Subject: [PATCH rdma-next v3 06/17] RDMA/counter: Add "auto" configuration mode support
Date:   Thu,  6 Jun 2019 13:53:34 +0300
Message-Id: <20190606105345.8546-7-leon@kernel.org>
...
index 6cae8bf14997..c5396a16a84a 100644
...
index 4563c838d865..810c3521621a 100644
--- a/drivers/infiniband/core/device.c
+++ b/drivers/infiniband/core/device.c
@@ -2353,6 +2353,8 @@ void ib_set_device_ops(struct ib_device *dev, const struct ib_device_ops *ops)
...
index 4fd5aad890d2..fd7ca578e9f7 100644
...
index 8754873d01c9..823a775dea7b 100644
--- a/include/rdma/ib_verbs.h
+++ b/include/rdma/ib_verbs.h
@@ -1823,6 +1823,9 @@ struct ib_qp {
...
+	struct rdma_counter    *counter;
 ...
 struct ib_dm {
@@ -2597,6 +2600,20 @@ struct ib_device_ops {
 			 u8 pdata_len);
...
index 8dd2619c015d..36fa47136da2 100644
