...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 7ED1A1DAB6A
	for <lists+linux-rdma@lfdr.de>; Wed, 20 May 2020 09:06:32 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726933AbgETHEV (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Wed, 20 May 2020 03:04:21 -0400
Received: from mga06.intel.com ([134.134.136.31]:13816 "EHLO mga06.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726860AbgETHET (ORCPT <rfc822;linux-rdma@vger.kernel.org>);
        Wed, 20 May 2020 03:04:19 -0400
IronPort-SDR: wjK1nv3J/aRp7qDA28vZEei5kU8bASPRrP8GDx0YhRQeGA+/QzvK0i+6UseB/LEKkGRKGXfv+z
 6IZVyNZWbbOQ==
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga003.jf.intel.com ([10.7.209.27])
  by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 20 May 2020 00:04:17 -0700
IronPort-SDR: VwBxpDHhjwLdatdniQrcT9VmQKHqKne00pu413WpwPIK1IR9JhBKclHnAaifcknwOlSnO4R6Ja
 wgPPCAnQg8nQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.73,413,1583222400"; 
   d="scan'208";a="264581213"
...
Subject: [RDMA RFC v6 01/16] RDMA/irdma: Add driver framework definitions
Date:   Wed, 20 May 2020 00:04:00 -0700
Message-Id: <20200520070415.3392210-2-jeffrey.t.kirsher@intel.com>
...
---
 ...
 drivers/infiniband/hw/irdma/main.c     | 570 +++++++++++++++++++++++
...
index 000000000000..005978b181d4
--- /dev/null
...
+	irdma_dbg(dev, "INIT: Gen1 VSI open success ldev=%p\n", ldev);
+
+	return 0;
+
+err_ibreg:
...
new file mode 100644
index 000000000000..d650bb2e26a1
--- /dev/null
...
+
+	dev_warn(idev_to_dev(&rf->sc_dev), "Requesting a a reset\n");
...
new file mode 100644
index 000000000000..46f9d94f834f
--- /dev/null
...
+
+	if (!strcmp(vdev->match_name, IRDMA_I40E_VDEV_NAME))
+		hw_ver = IRDMA_GEN_1;
+	else if (!strcmp(vdev->match_name, IRDMA_ICE_VDEV_NAME))
+		hw_ver = IRDMA_GEN_2;
+
+	return hw_ver;
+}
...
new file mode 100644
index 000000000000..913403dec2e0
--- /dev/null
