...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 54C82290FC5
	for <lists+linux-rdma@lfdr.de>; Sat, 17 Oct 2020 08:00:59 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2436784AbgJQGAw (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Sat, 17 Oct 2020 02:00:52 -0400
Received: from mga17.intel.com ([192.55.52.151]:5405 "EHLO mga17.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S2436875AbgJQGAu (ORCPT <rfc822;linux-rdma@vger.kernel.org>);
        Sat, 17 Oct 2020 02:00:50 -0400
IronPort-SDR: ngGbXr82eohSIuIQsHWDurXMnQ6JKNykZLTawztpMvdqfGF7MpzgtGIE7anXMKB3ArKNy1gVfM
 K0fCIOnbB7FA==
X-IronPort-AV: E=McAfee;i="6000,8403,9776"; a="146585002"
X-IronPort-AV: E=Sophos;i="5.77,384,1596524400"; 
   d="scan'208";a="146585002"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga004.jf.intel.com ([10.7.209.38])
  by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 16 Oct 2020 17:57:31 -0700
IronPort-SDR: ZXfXc0Jm4ZWFqZkN3tDWslvtQ9TrkztK/vN5SLCjHqSFlPD4IpWEkzPvjjFbmrj0/+ceQ/Zhgi
 SRjhn8FACc2A==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.77,384,1596524400"; 
   d="scan'208";a="464877985"
...
X-MS-Exchange-CrossTenant-originalarrivaltime: 17 Oct 2020 00:57:21.4470
 (UTC)
...
>=20
> addr here is offset within the dma buf, but this code does nothing with i=
t.
>=20
The current code assumes 0 offset, and 'addr' is the nominal starting addre=
ss of the
buffer. If this is to be changed to offset, then yes, some more handling is=
 needed
as you mentioned below.

> dma_buf_map_attachment gives a complete SGL for the entire DMA buf, but o=
ffset/length select a subset.
>=20
> You need to edit the sgls to make them properly span the sub-range and fo=
llow the peculiar rules for how SGLs in ib_umem's have to be
> constructed.
>=20
> Who validates that the total dma length of the SGL is exactly equal to le=
ngth? That is really important too.
>=20
> Also, dma_buf_map_attachment() does not do the correct dma mapping for RD=
MA, eg it does not use ib_dma_map(). This is not a problem
...
dma_buf_map_attachment(). They belong to the same family, but take differen=
t
