...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 8AB31E6117
	for <lists+linux-rdma@lfdr.de>; Sun, 27 Oct 2019 07:22:42 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726079AbfJ0GWl (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Sun, 27 Oct 2019 02:22:41 -0400
Received: from mail.kernel.org ([198.145.29.99]:60084 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1725838AbfJ0GWl (ORCPT <rfc822;linux-rdma@vger.kernel.org>);
        Sun, 27 Oct 2019 02:22:41 -0400
Received: from localhost (unknown [77.137.89.37])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id 03F9E21850;
        Sun, 27 Oct 2019 06:22:38 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1572157359;
        bh=tstwK/+AglmGEXh/lKajyq+wOeXAiREOcFOp8/y1+nY=;
        h=From:To:Cc:Subject:Date:From;
        b=B4usiaixU+Zr+MS7gsKlCMwTIMoR20DgPL1r2ZEtW9ctE0Mm+39aQhOx1ixHBzaxd
         3S67IlY29xE2e3BQcMBHiFzrAj2VaVxfMaYXUPRHD7ObssGIkDbiraWYMdE82gSd26
         L1aF+0WFJqA/BfkX/KBYJZYrqUgS4PRZwfPbuiMc=
...
Subject: [PATCH rdma-next v1] IB/mlx5: Test write combining support
Date:   Sun, 27 Oct 2019 08:22:34 +0200
Message-Id: <20191027062234.10993-1-leon@kernel.org>
...
index 20fabb368f61..fd3dd4523a22 100644
...
@@ -6257,6 +6257,7 @@ static const struct ib_device_ops mlx5_ib_dev_ops = {
...
@@ -6700,6 +6701,18 @@ static void mlx5_ib_stage_devx_cleanup(struct mlx5_ib_dev *dev)
 	}
 }
...
index d53739e43a93..d925ce0e46b5 100644
...
+	struct mlx5_sq_bfreg	wc_bfreg;
 	...
 	const struct mlx5_ib_profile	*profile;
@@ -1495,4 +1498,7 @@ static inline bool mlx5_ib_can_use_umr(struct mlx5_ib_dev *dev,
