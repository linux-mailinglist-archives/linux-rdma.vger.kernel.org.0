Return-Path: <linux-rdma+bounces-3959-lists+linux-rdma=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-rdma@lfdr.de
Delivered-To: lists+linux-rdma@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id D847193B985
	for <lists+linux-rdma@lfdr.de>; Thu, 25 Jul 2024 01:41:04 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 083BB1C21898
	for <lists+linux-rdma@lfdr.de>; Wed, 24 Jul 2024 23:41:04 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 30FB5148312;
	Wed, 24 Jul 2024 23:40:45 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b="W6EE87qT"
X-Original-To: linux-rdma@vger.kernel.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.7])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id B2DF71442EA
	for <linux-rdma@vger.kernel.org>; Wed, 24 Jul 2024 23:40:42 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=192.198.163.7
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1721864445; cv=none; b=QXygP+OSNM9LV5UZl//MS9XN8NfbirtK6yqshH+ywMge6iEc+3/VPTTGQj+/Ku6TXJ3D76WbAqWQRfFESt2Z12/jNnt5ZVKEo1naWc9SCLxhSxAu7HvGlTHyMR917s2MUudsOtWBeQ4H46st0+xMjemxIsJTCa7sHEviBd7jrtU=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1721864445; c=relaxed/simple;
	bh=fPW8xkBTw/MMB/j1/5UGqjp4EjwTg+3kU/e/bxbPnuU=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=lttgAJIAegaZW3Xz0MO0+ocVTPp/C+EzPX14778Q/WximH9NefxQeLkeIkR9aSdFK4Zmbeejk8crk95XoEPuhk6qHs42XzqXBT9TqYuQytHyKfSkJV0Veva1HvCwHy2rI/5CsPXx0c16aH9rVkKs0HfMfjir3A80G27a2chiXFA=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com; spf=pass smtp.mailfrom=intel.com; dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b=W6EE87qT; arc=none smtp.client-ip=192.198.163.7
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  ...
  bh=fPW8xkBTw/MMB/j1/5UGqjp4EjwTg+3kU/e/bxbPnuU=;
  b=W6EE87qTG0Hf2kTgBYiXDTMjwPneD5sI6O4DXBtX8cHO2VJubkIgKk8j
   VS7jo+3W/Vui1PvdKqFOO0dSEEgb72IhMK8UEa6Uewhd7UNvF8kX7MaiK
   sDxI04+MHXzpwY1B250ahFIrD375ShgFdAlBWziad1MQSMVXwQIxQ3pY/
   LarSieljabNoP+BPQAFTou7F6NCwC7MVeaoeU8ruI8uBILvJs1HuPZSxH
   KSCiVcBLxzbghwJQ3i6BpGGjYfcWdmH3cfs0YGG4wmj+i9qgQywz2cbwh
   Kuts++eZcpB2A+KdLg+j7ql7sbvlmBuBER+ArITRY6QxRqkSZBPsB5NoY
   Q==;
X-CSE-ConnectionGUID: WQoPrVlrQXuRisDQfJL6oA==
X-CSE-MsgGUID: 0K+TEuACQUqv4ja5Otv7dg==
X-IronPort-AV: E=McAfee;i="6700,10204,11143"; a="44999763"
X-IronPort-AV: E=Sophos;i="6.09,234,1716274800"; 
   d="scan'208";a="44999763"
Received: from fmviesa006.fm.intel.com ([10.60.135.146])
  by fmvoesa101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 24 Jul 2024 16:40:40 -0700
X-CSE-ConnectionGUID: 9B2UcSb7RlqDih/Tcamd5A==
X-CSE-MsgGUID: DCzXv3THSNe059uehgTYVQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.09,234,1716274800"; 
   d="scan'208";a="52426037"
...
Subject: [RFC PATCH 10/25] RDMA/irdma: Refactor GEN2 auxiliary driver
Date: Wed, 24 Jul 2024 18:39:02 -0500
Message-Id: <20240724233917.704-11-tatyana.e.nikolova@intel.com>
...
index 12704ef..89937d4 100644
--- a/drivers/infiniband/hw/irdma/verbs.c
+++ b/drivers/infiniband/hw/irdma/verbs.c
@@ -4529,7 +4529,7 @@ static bool irdma_ah_exists(struct irdma_device *iwdev,
...
@@ -4555,14 +4555,14 @@ static int irdma_destroy_ah(struct ib_ah *ibah, u32 ah_flags)
...
@@ -4599,11 +4599,11 @@ static int irdma_create_user_ah(struct ib_ah *ibah,
...
+			mutex_unlock(&iwdev->rf->ah_tbl_lock);
 		...
 		/* Add new AH to list */
@@ -4615,11 +4615,11 @@ static int irdma_create_user_ah(struct ib_ah *ibah,
