...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 0852F301145
	for <lists+linux-rdma@lfdr.de>; Sat, 23 Jan 2021 00:59:04 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1725972AbhAVX5t (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Fri, 22 Jan 2021 18:57:49 -0500
Received: from mga05.intel.com ([192.55.52.43]:55260 "EHLO mga05.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726440AbhAVXzB (ORCPT <rfc822;linux-rdma@vger.kernel.org>);
        Fri, 22 Jan 2021 18:55:01 -0500
IronPort-SDR: MDHPRn+Ni48hosSw76zohDxQldKz8wNIuogHlK2l+261VPeJFh+kY75+bhp0BpVgXhMwydM4hh
 IZxuxDQbY7ig==
X-IronPort-AV: E=McAfee;i="6000,8403,9872"; a="264346901"
X-IronPort-AV: E=Sophos;i="5.79,368,1602572400"; 
   d="scan'208";a="264346901"
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
  by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 22 Jan 2021 15:50:28 -0800
IronPort-SDR: /5TDjuuaYftUMZgb079/zwAaI17GgDuFsIFGi3/uCJZQ3h7HrER1h704MhhuRbu4Va39uqGln9
 tLsgXNJ9akuQ==
X-IronPort-AV: E=Sophos;i="5.79,368,1602572400"; 
   d="scan'208";a="574869643"
Received: from ssaleem-mobl.amr.corp.intel.com ([10.251.4.95])
  by fmsmga005-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 22 Jan 2021 15:50:26 -0800
...
Subject: [PATCH 16/22] RDMA/irdma: Add RoCEv2 UD OP support
Date:   Fri, 22 Jan 2021 17:48:21 -0600
Message-Id: <20210122234827.1353-17-shiraz.saleem@intel.com>
...
+		irdma_dbg(cqp->dev, "WQE: mg_id out of range\n");
+		return IRDMA_ERR_PARAM;
+	}
+
+	wqe = irdma_sc_cqp_get_next_send_wqe(cqp, scratch);
+	if (!wqe) {
+		irdma_dbg(cqp->dev, "WQE: ring full\n");
+		return IRDMA_ERR_RING_FULL;
+	}
+
