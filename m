...
Subject: [PATCH net-next v2 09/14] net/mlx5: E-switch, Add eswitch helpers for SF vport
Date:   Tue,  8 Dec 2020 23:29:29 -0800
Message-Id: <20201209072934.1272819-10-saeed@kernel.org>
...
index f6c8dae739c2..0d76d80022ce 100644
...
+void mlx5_esw_offloads_rep_unload(struct mlx5_eswitch *esw, u16 vport_num)
 {
 	struct mlx5_eswitch_rep *rep;
 	int rep_type;
@@ -2836,3 +2836,35 @@ u32 mlx5_eswitch_get_vport_metadata_for_match(struct mlx5_eswitch *esw,
