Return-Path: <linux-rdma+bounces-22759-lists+linux-rdma=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-rdma@lfdr.de
Received: from mail.lfdr.de
	by mail.lfdr.de with LMTP
	id xnIfJcurSWoB6AAAu9opvQ
	(envelope-from <linux-rdma+bounces-22759-lists+linux-rdma=lfdr.de@vger.kernel.org>)
	for <lists+linux-rdma@lfdr.de>; Sun, 05 Jul 2026 02:56:43 +0200
X-Original-To: lists+linux-rdma@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [172.234.253.10])
	by mail.lfdr.de (Postfix) with ESMTPS id EA7C9708BA4
	for <lists+linux-rdma@lfdr.de>; Sun, 05 Jul 2026 02:56:42 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=pass header.d=linux.dev header.s=key1 header.b=qpafTel1;
	dmarc=pass (policy=none) header.from=linux.dev;
	spf=pass (mail.lfdr.de: domain of "linux-rdma+bounces-22759-lists+linux-rdma=lfdr.de@vger.kernel.org" designates 172.234.253.10 as permitted sender) smtp.mailfrom="linux-rdma+bounces-22759-lists+linux-rdma=lfdr.de@vger.kernel.org";
	arc=pass ("subspace.kernel.org:s=arc-20240116:i=1")
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id 2A8FF301A939
	for <lists+linux-rdma@lfdr.de>; Sun,  5 Jul 2026 00:56:27 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id F2D791E9B1A;
	Sun,  5 Jul 2026 00:56:25 +0000 (UTC)
X-Original-To: linux-rdma@vger.kernel.org
Received: from out-189.mta1.migadu.com (out-189.mta1.migadu.com [95.215.58.189])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 4B56B19A288
	for <linux-rdma@vger.kernel.org>; Sun,  5 Jul 2026 00:56:23 +0000 (UTC)
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1783212985; cv=none; b=VU4xner4SlC+xSTXLhn3N9obs0XzjJPUzwN9RSyR52zhLh3QLN6lnxS33km/Ab49Ia3VOq3en/lUnLc/id9FGG+Ydq2J3DjkIRRQFlPsQuzJSb79JDtrt6NYhTkUW87bNC5OuUXLgc7yzfYJUr0nO6poaGCC0ZOCBvxUbv8DaHE=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1783212985; c=relaxed/simple;
	bh=pt2BeK4qspZxOThUzG3pWhbdXyCDXgTmzOHpKwA7yaw=;
	h=Message-ID:Date:MIME-Version:Subject:To:Cc:References:From:
	 In-Reply-To:Content-Type; b=ex39Zr6WZf3ikOqHmou60vqZiKdjRarHF4Gq086h2jTHm6uusCZ+FMf+wGrzPtmNOaJRuOnt5CafS6FzsBOKZbWu4BYkCS8Z5EQ2afbKaMr+3+K1n5SjZjfMtntIju69Qd3cPskeAzFN6IEcfsBGslCJNooUnrYqGh1bG67OPIY=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linux.dev; spf=pass smtp.mailfrom=linux.dev; dkim=pass (1024-bit key) header.d=linux.dev header.i=@linux.dev header.b=qpafTel1; arc=none smtp.client-ip=95.215.58.189
Message-ID: <21b7b324-9fd2-402d-8695-5dd061adb957@linux.dev>
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linux.dev; s=key1;
	...
	bh=OtCRwNKcRpv7f3fAbbmgJg9udOf4y+bWylmqLCmpggU=;
	b=qpafTel1DZuckkQ/j4Tw0RYoZoLwFX5O5h4N+QZhMMpOo+kUB9j75kmibdDEWJJ9oRYPTA
	CJtJX4zy6X5Hjd9Wi76iuyax06j6/wOfpAG3NvJBYBSceY2D/EeKSnbrV4DzJhPZK8/6Ur
	kCeUp0ghl16423Zk5Op+TFc8WxPeMGg=
Date: Sat, 4 Jul 2026 17:55:57 -0700
Precedence: bulk
...
To: Yanze Zhang <zhang.yanze@zte.com.cn>, jgg@ziepe.ca, leon@kernel.org,
 julianbraha@gmail.com, huangjunxian6@hisilicon.com,
...
X-Spamd-Result: default: False [-2.16 / 15.00];
	...
	FORGED_RECIPIENTS(0.00)[m:zhang.yanze@zte.com.cn,m:jgg@ziepe.ca,m:leon@kernel.org,m:julianbraha@gmail.com,m:huangjunxian6@hisilicon.com,m:yanjun.zhu@linux.dev,m:linux-kernel@vger.kernel.org,m:linux-rdma@vger.kernel.org,m:wei.quan@zte.com.cn,m:han.junyang@zte.com.cn,m:ran.ming@zte.com.cn,m:han.chengfei@zte.com.cn,s:lists@lfdr.de];
	FREEMAIL_TO(0.00)[zte.com.cn,ziepe.ca,kernel.org,gmail.com,hisilicon.com,linux.dev];
	RCVD_COUNT_THREE(0.00)[3];
	TO_DN_EQ_ADDR_SOME(0.00)[];
	TAGGED_FROM(0.00)[bounces-22759-lists,linux-rdma=lfdr.de];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[linux-foundation.org:email,vger.kernel.org:from_smtp,linux.dev:from_mime,linux.dev:dkim,linux.dev:mid,sea.lore.kernel.org:helo,sea.lore.kernel.org:rdns,zte.com.cn:email]
X-Rspamd-Server: lfdr
X-Rspamd-Queue-Id: EA7C9708BA4

在 2026/7/2 5:22, Yanze Zhang 写道:
...
> 
> Changes in v3:
> - Verified and ensured 8-character indentation throughout; resent with
>    different MUA to rule out formatting corruption (Junxian, v1).
> - Fixed missing handle release in zxdh_remove() as pointed out by Junxian
>    (v1).
> 
> Changes in v2:
> - Removed redundant 'depends on INFINIBAND' from Kconfig (Julian, v1).
> 
...
>   drivers/infiniband/hw/zrdma/zrdma_main.c | 135 ++++++++++++
...
> index 15011f5752a9..5682b5edc7a6 100644
> --- a/MAINTAINERS
> +++ b/MAINTAINERS
> @@ -29828,6 +29828,12 @@ S:	Maintained
...
> index 000000000000..ce1e2606974c
> --- /dev/null
...
> +	tristate "ZTE Ethernet Protocol Driver for RDMA"
	...
	depends on PCI
	depends on ZTE DingHai (ZXDH) Ethernet < --- NIC
	select GENERIC_ALLOCATOR
	select AUXILIARY_BUS
	select CRC32

IMO, the depends and selects like the above should be added in the 
Kconfig. It is just an example.Perhaps you need to add/remove some 
depends or selects based on the above.
...
> new file mode 100644
> index 000000000000..d7296437071f
> --- /dev/null
