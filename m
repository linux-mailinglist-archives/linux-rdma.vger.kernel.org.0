...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 5064280563
	for <lists+linux-rdma@lfdr.de>; Sat,  3 Aug 2019 10:49:37 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2387826AbfHCItf (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Sat, 3 Aug 2019 04:49:35 -0400
Received: from szxga05-in.huawei.com ([45.249.212.191]:3750 "EHLO huawei.com"
        rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org with ESMTP
        id S2387816AbfHCItf (ORCPT <rfc822;linux-rdma@vger.kernel.org>);
        Sat, 3 Aug 2019 04:49:35 -0400
Received: from DGGEMS414-HUB.china.huawei.com (unknown [172.30.72.58])
        by Forcepoint Email with ESMTP id AC92C32B1456F4AE5CCA;
...
CC:     <leon@kernel.org>, <linux-rdma@vger.kernel.org>,
        <linuxarm@huawei.com>
Subject: [PATCH V3 for-next 10/13] RDMA/hns: Remove unnecessary kzalloc
Date:   Sat, 3 Aug 2019 16:45:16 +0800
Message-ID: <1564821919-100676-11-git-send-email-oulijun@huawei.com>
...
index 40fbbde..8076b1e 100644
--- a/drivers/infiniband/hw/hns/hns_roce_hw_v2.c
+++ b/drivers/infiniband/hw/hns/hns_roce_hw_v2.c
@@ -4288,16 +4288,12 @@ static int hns_roce_v2_modify_qp(struct ib_qp *ibqp,
 {
...
@@ -4349,8 +4345,7 @@ static int hns_roce_v2_modify_qp(struct ib_qp *ibqp,
...
+	ret = hns_roce_v2_qp_modify(hr_dev, cur_state, new_state, ctx, hr_qp);
 	if (ret) {
 		...
 		goto out;
@@ -4378,7 +4373,6 @@ static int hns_roce_v2_modify_qp(struct ib_qp *ibqp,
 	}
...
@@ -4429,16 +4423,12 @@ static int hns_roce_v2_query_qp(struct ib_qp *ibqp, struct ib_qp_attr *qp_attr,
 {
 	struct hns_roce_dev *hr_dev = to_hr_dev(ibqp->device);
 	struct hns_roce_qp *hr_qp = to_hr_qp(ibqp);
-	struct hns_roce_v2_qp_context *context;
...
@@ -4450,14 +4440,14 @@ static int hns_roce_v2_query_qp(struct ib_qp *ibqp, struct ib_qp_attr *qp_attr,
 		goto done;
 	}
...
+	state = roce_get_field(context.byte_60_qpst_tempid,
 	...
 	if (tmp_qp_state == -1) {
@@ -4467,7 +4457,7 @@ static int hns_roce_v2_query_qp(struct ib_qp *ibqp, struct ib_qp_attr *qp_attr,
 	}
...
@@ -4475,20 +4465,20 @@ static int hns_roce_v2_query_qp(struct ib_qp *ibqp, struct ib_qp_attr *qp_attr,
...
@@ -4497,43 +4487,43 @@ static int hns_roce_v2_query_qp(struct ib_qp *ibqp, struct ib_qp_attr *qp_attr,
...
@@ -4552,7 +4542,6 @@ static int hns_roce_v2_query_qp(struct ib_qp *ibqp, struct ib_qp_attr *qp_attr,
