...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id CAF442D5BB4
	for <lists+linux-rdma@lfdr.de>; Thu, 10 Dec 2020 14:26:51 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1732970AbgLJN0h (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Thu, 10 Dec 2020 08:26:37 -0500
Received: from szxga04-in.huawei.com ([45.249.212.190]:9150 "EHLO
        szxga04-in.huawei.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S2389231AbgLJN0h (ORCPT
        <rfc822;linux-rdma@vger.kernel.org>); Thu, 10 Dec 2020 08:26:37 -0500
Received: from DGGEMS413-HUB.china.huawei.com (unknown [172.30.72.59])
        by szxga04-in.huawei.com (SkyGuard) with ESMTP id 4CsF4d211Vz15bCq;
...
CC:     <leon@kernel.org>, <linux-rdma@vger.kernel.org>,
        <linuxarm@huawei.com>
Subject: [PATCH v3 for-next 11/11] RDMA/hns: Simplify AEQE process for different types of queue
Date:   Thu, 10 Dec 2020 21:22:52 +0800
Message-ID: <1607606572-11968-12-git-send-email-liweihang@huawei.com>
...
index 546f77d..2ab0c0a 100644
--- a/drivers/infiniband/hw/hns/hns_roce_hw_v2.c
+++ b/drivers/infiniband/hw/hns/hns_roce_hw_v2.c
@@ -5451,8 +5451,6 @@ static void hns_roce_irq_work_handle(struct work_struct *work)
...
@@ -5468,15 +5466,15 @@ static void hns_roce_irq_work_handle(struct work_struct *work)
 		break;
...
@@ -5488,10 +5486,10 @@ static void hns_roce_irq_work_handle(struct work_struct *work)
...
@@ -5507,8 +5505,7 @@ static void hns_roce_irq_work_handle(struct work_struct *work)
 }
...
@@ -5518,10 +5515,9 @@ static void hns_roce_v2_init_irq_work(struct hns_roce_dev *hr_dev,
...
@@ -5573,10 +5569,8 @@ static int hns_roce_v2_aeq_int(struct hns_roce_dev *hr_dev,
...
@@ -5590,15 +5584,9 @@ static int hns_roce_v2_aeq_int(struct hns_roce_dev *hr_dev,
...
+					   HNS_ROCE_V2_AEQE_EVENT_QUEUE_NUM_S);
 		...
 		switch (event_type) {
 		case HNS_ROCE_EVENT_TYPE_PATH_MIG:
@@ -5609,15 +5597,15 @@ static int hns_roce_v2_aeq_int(struct hns_roce_dev *hr_dev,
...
@@ -5626,7 +5614,6 @@ static int hns_roce_v2_aeq_int(struct hns_roce_dev *hr_dev,
...
-		case HNS_ROCE_EVENT_TYPE_CEQ_OVERFLOW:
 		case HNS_ROCE_EVENT_TYPE_FLR:
 			break;
 		default:
@@ -5643,7 +5630,7 @@ static int hns_roce_v2_aeq_int(struct hns_roce_dev *hr_dev,
