Return-Path: <linux-rdma+bounces-22524-lists+linux-rdma=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-rdma@lfdr.de
Received: from mail.lfdr.de
	by mail.lfdr.de with LMTP
	id ien7Ka75P2qfawkAu9opvQ
	(envelope-from <linux-rdma+bounces-22524-lists+linux-rdma=lfdr.de@vger.kernel.org>)
	for <lists+linux-rdma@lfdr.de>; Sat, 27 Jun 2026 18:26:22 +0200
X-Original-To: lists+linux-rdma@lfdr.de
Received: from tor.lore.kernel.org (tor.lore.kernel.org [172.105.105.114])
	by mail.lfdr.de (Postfix) with ESMTPS id C77766D2423
	for <lists+linux-rdma@lfdr.de>; Sat, 27 Jun 2026 18:26:21 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=pass header.d=cornelisnetworks.com header.s=selector1 header.b=mkVau6oG;
	spf=pass (mail.lfdr.de: domain of "linux-rdma+bounces-22524-lists+linux-rdma=lfdr.de@vger.kernel.org" designates 172.105.105.114 as permitted sender) smtp.mailfrom="linux-rdma+bounces-22524-lists+linux-rdma=lfdr.de@vger.kernel.org";
	dmarc=pass (policy=none) header.from=cornelisnetworks.com;
	arc=reject ("cv is fail on i=2")
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by tor.lore.kernel.org (Postfix) with ESMTP id AB864300F962
	for <lists+linux-rdma@lfdr.de>; Sat, 27 Jun 2026 16:26:16 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id A1D442EC081;
	Sat, 27 Jun 2026 16:26:13 +0000 (UTC)
...
Received: from DM1PR04CU001.outbound.protection.outlook.com (mail-centralusazon11020128.outbound.protection.outlook.com [52.101.61.128])
	...
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id B39282E6116
	for <linux-rdma@vger.kernel.org>; Sat, 27 Jun 2026 16:26:06 +0000 (UTC)
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1782577573; cv=fail; b=HXvxueV1xotIsx+jRRO3VNlgzRZtS+cvcjDqiVaQR04Fxbff5CUR2jiTIjaP6TtT7IPr+AeYgwLKeUOwTJKvYGtjb1Nrmt/cjuqklbW6/v/P5H2fTV6YMNAHDqYgF9DE9pDrFiZSBBoOwRJALTLK+W1B5DXgKhiZEmFuRYiltI4=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1782577573; c=relaxed/simple;
	bh=szE8YYQiF9xtg6Soqf2KDhsBxwzMX/6oVELwAkJZNjw=;
	h=Subject:From:To:Cc:Date:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=AtKhHQpgFxJolgJ7XwoBe321saeUcWeO3hsKh2t/DeLdpSHCes3hmSIUlGu98cn2ogA8YF6l44Zw2TPO1zajiC8WnFsj8v+aEsDwW0ulKfVPtwYybuWiWLKpM1VVfH7Kl/DqMKlLkUJWwWj5BD3YXgYCsAqYVc2H/fuGsMf0HJM=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=cornelisnetworks.com; spf=pass smtp.mailfrom=cornelisnetworks.com; dkim=pass (2048-bit key) header.d=cornelisnetworks.com header.i=@cornelisnetworks.com header.b=mkVau6oG; arc=fail smtp.client-ip=52.101.61.128
ARC-Seal: i=1; a=rsa-sha256; s=arcselector10001; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com;
 s=arcselector10001;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-AntiSpam-MessageData-ChunkCount:X-MS-Exchange-AntiSpam-MessageData-0:X-MS-Exchange-AntiSpam-MessageData-1;
 bh=t3REbspSH6wnnRsh9NJUPINQleb1lNBLeHkp7BDyXCY=;
 b=
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=cornelisnetworks.com;
 ...
 bh=t3REbspSH6wnnRsh9NJUPINQleb1lNBLeHkp7BDyXCY=;
 b=
Received: from SJ0PR03CA0252.namprd03.prod.outlook.com (2603:10b6:a03:3a0::17)
 by PH0PR01MB994500.prod.exchangelabs.com (2603:10b6:510:39a::18) with
...
Received: from SJ1PEPF000026C7.namprd04.prod.outlook.com
 (2603:10b6:a03:3a0:cafe::6c) by SJ0PR03CA0252.outlook.office365.com
...
Received: from cn-mailer-00.localdomain (50.148.235.34) by
 ...
 via Frontend Transport; Sat, 27 Jun 2026 16:26:00 +0000
Received: from awdrv-04.localdomain (unknown [10.228.212.218])
	by cn-mailer-00.localdomain (Postfix) with ESMTPS id 38220146565;
	Sat, 27 Jun 2026 12:26:00 -0400 (EDT)
Received: from [10.228.212.218] (localhost [IPv6:::1])
	by awdrv-04.localdomain (Postfix) with ESMTP id 335721810D6C7;
	Sat, 27 Jun 2026 12:26:00 -0400 (EDT)
Subject: [PATCH v2 for-next 13/24] RDMA/hfi2: Add IO related headers
From: Dennis Dalessandro <dennis.dalessandro@cornelisnetworks.com>
To: jgg@ziepe.ca, leon@kernel.org
Cc: Dean Luick <dean.luick@cornelisnetworks.com>,
 Breandan Cunningham <brendan.cunningham@cornelisnetworks.com>,
 Douglas Miller <doug.miller@cornelisnetworks.com>, linux-rdma@vger.kernel.org
Date: Sat, 27 Jun 2026 12:26:00 -0400
Message-ID: <178257756016.371918.1939300067918958932.stgit@awdrv-04>
...
X-MS-TrafficTypeDiagnostic: SJ1PEPF000026C7:EE_|PH0PR01MB994500:EE_
X-MS-Office365-Filtering-Correlation-Id: d216652e-659c-45a9-aa18-08ded468c6e8
X-MS-Exchange-AtpMessageProperties: SA
X-MS-Exchange-SenderADCheck: 1
X-MS-Exchange-AntiSpam-Relay: 0
X-Microsoft-Antispam:
	BCL:0;ARA:13230040|376014|82310400026|36860700016|23010399003|1800799024|6133799003|3023799007|55112099003|22082099003|18002099003|56012099006|5023799004;
X-Microsoft-Antispam-Message-Info:
	
X-Forefront-Antispam-Report:
	CIP:50.148.235.34;CTRY:US;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:cn-mailer-00.localdomain;PTR:InfoDomainNonexistent;CAT:NONE;SFS:(13230040)(376014)(82310400026)(36860700016)(23010399003)(1800799024)(6133799003)(3023799007)(55112099003)(22082099003)(18002099003)(56012099006)(5023799004);DIR:OUT;SFP:1102;
X-MS-Exchange-AntiSpam-MessageData-ChunkCount: 1
X-MS-Exchange-AntiSpam-MessageData-0:
	
X-OriginatorOrg: cornelisnetworks.com
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 27 Jun 2026 16:26:00.9395
 (UTC)
X-MS-Exchange-CrossTenant-Network-Message-Id: d216652e-659c-45a9-aa18-08ded468c6e8
...
X-MS-Exchange-Transport-CrossTenantHeadersStamped: PH0PR01MB994500
...
X-Spamd-Result: default: False [0.34 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	TO_DN_SOME(0.00)[];
	TAGGED_FROM(0.00)[bounces-22524-lists,linux-rdma=lfdr.de];
	RCVD_TLS_LAST(0.00)[];
	MIME_TRACE(0.00)[0:+];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[awdrv-04:mid,vger.kernel.org:from_smtp,cornelisnetworks.com:dkim,cornelisnetworks.com:email,cornelisnetworks.com:from_mime,tor.lore.kernel.org:rdns,tor.lore.kernel.org:helo];
...
---
 ...
 drivers/infiniband/hw/hfi2/verbs.h        |  469 +++++++++++
 drivers/infiniband/hw/hfi2/verbs_txreq.h  |   98 ++
 14 files changed, 3795 insertions(+)
...
index 000000000000..7330992163aa
--- /dev/null
...
new file mode 100644
index 000000000000..ac32ccf5403a
--- /dev/null
...
+void hfi2_iowait_clear_flag(struct iowait *wait, u32 flag);
+
...
new file mode 100644
index 000000000000..7bad304a9383
--- /dev/null
...
new file mode 100644
index 000000000000..d3a12e373fb1
--- /dev/null
...
new file mode 100644
index 000000000000..b4b38edb2698
--- /dev/null
...
new file mode 100644
index 000000000000..b4af59fd2f05
--- /dev/null
...
new file mode 100644
index 000000000000..568676552879
--- /dev/null
...
+}
+
+int hfi2_do_coalesce(struct hfi2_devdata *dd, struct sdma_txreq *tx,
...
+		return hfi2_do_coalesce(dd, tx, SDMA_MAP_PAGE,
...
+{
+	if (unlikely(must_coalesce(tx)))
+		return hfi2_do_coalesce(dd, tx, SDMA_MAP_NONE,
+				   NULL, NULL, 0, 0);
+
...
+
+	if (unlikely(must_coalesce(tx)))
+		return hfi2_do_coalesce(dd, tx, SDMA_MAP_SINGLE,
+				   kvaddr, NULL, 0, len);
+
+	addr = dma_map_single(
+		       &dd->pcidev->dev,
...
+struct iowait_work;
+
+int hfi2_sdma_send_txreq(struct sdma_engine *sde,
+		    struct iowait_work *wait,
+		    struct sdma_txreq *tx,
+		    bool pkts_sent);
+int hfi2_sdma_send_txlist(struct sdma_engine *sde,
+		     struct iowait_work *wait,
...
+};
+
+int hfi2_sdma_map_init(struct hfi2_pportdata *ppd, u8 hfi2_num_vls, u8 *vl_engines);
+
+/* slow path */
...
+void hfi2_sdma_seqfile_dump_cpu_list(struct seq_file *s, struct hfi2_devdata *dd,
+				unsigned long cpuid);
+
...
new file mode 100644
index 000000000000..68c55c727945
--- /dev/null
...
+	if (!wqe->priv)
+		return;
+	__hfi2_trdma_clean_swqe(qp, wqe);
+}
+
...
+		hfi2_do_setup_tid_rdma_wqe(qp, wqe);
+}
+
...
new file mode 100644
index 000000000000..b0185dab74d0
--- /dev/null
...
new file mode 100644
index 000000000000..5b61a951e1d6
--- /dev/null
...
+	bool in_thread;
+	bool pkts_sent;
+	bool hfi2_loopback; /* use hfi2_loopback port for ppd */
+};
+
...
+};
+
+static inline void inc_opstats(u32 tlen, struct hfi2_opcode_stats *stats)
+{
...
+
+void hfi2_rc_hdrerr(struct hfi2_ctxtdata *rcd, struct hfi2_packet *packet,
+		    struct rvt_qp *qp);
+
+u8 hfi2_ah_to_sc(struct ib_device *ibdev, struct rdma_ah_attr *ah_attr);
+
...
+
+extern const enum ib_wc_opcode hfi2_ib_hfi2_wc_opcode[];
+
+extern const u8 hfi2_hdr_len_by_opcode[];
+
+extern const int ib_rvt_state_ops[];
+
+extern __be64 hfi2_ib_hfi2_sys_image_guid; /* in network order */
+
+extern unsigned short hfi2_piothreshold;
+
...
new file mode 100644
index 000000000000..d6b370e088a2
--- /dev/null
