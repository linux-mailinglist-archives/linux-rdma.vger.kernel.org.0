Return-Path: <linux-rdma+bounces-17095-lists+linux-rdma=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-rdma@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id mDA7Lr5LnWmhOQQAu9opvQ
	(envelope-from <linux-rdma+bounces-17095-lists+linux-rdma=lfdr.de@vger.kernel.org>)
	for <lists+linux-rdma@lfdr.de>; Tue, 24 Feb 2026 07:57:02 +0100
X-Original-To: lists+linux-rdma@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [172.234.253.10])
	by mail.lfdr.de (Postfix) with ESMTPS id 560041829D1
	for <lists+linux-rdma@lfdr.de>; Tue, 24 Feb 2026 07:57:02 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id 2C9EC3034B1F
	for <lists+linux-rdma@lfdr.de>; Tue, 24 Feb 2026 06:56:54 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 5372B3093D8;
	Tue, 24 Feb 2026 06:56:52 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=linux.alibaba.com header.i=@linux.alibaba.com header.b="mzJmC5bS"
X-Original-To: linux-rdma@vger.kernel.org
Received: from out199-2.us.a.mail.aliyun.com (out199-2.us.a.mail.aliyun.com [47.90.199.2])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 4D8DE303A0F;
	Tue, 24 Feb 2026 06:56:45 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=47.90.199.2
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1771916212; cv=none; b=Bu2AnUm/RK7ziKnW0NK5vUlTHqeQtNpJI0IOtUDC4EEVtKCahfeHkqPxNl0rV+el+3HErDWSS7jVFli21mcYmjkKIzqxn/Md7bEH3A4qJfg1SU12P1LZaTMTb+WmoRZMz+SqmLtgpz2eDqx8gm+ffJsMRmNJ75cD/GzXhXvXuZQ=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1771916212; c=relaxed/simple;
	bh=G6VodxYEDJJTVtJIZDA/ze7Y8lG/lnGunApcDXEfO0I=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=ZjiJZy4y/k99Ibc7vq88WVjecD1mzfJgPRZuRryqTg5ORYA1MfC3WSz+3zqD5TcAAgOf7eOew3nmaV7mjqkvbQgqbqo8NT91hkHpBExH27Wq85u8liAr+yujAC89ABcMRfr0qssfL97qGF5KHnJfcLPTSyuY6PDd/mbBi5PTnYM=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linux.alibaba.com; spf=pass smtp.mailfrom=linux.alibaba.com; dkim=pass (1024-bit key) header.d=linux.alibaba.com header.i=@linux.alibaba.com header.b=mzJmC5bS; arc=none smtp.client-ip=47.90.199.2
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linux.alibaba.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=linux.alibaba.com
DKIM-Signature:v=1; a=rsa-sha256; c=relaxed/relaxed;
	d=linux.alibaba.com; s=default;
	t=1771916186; h=Date:From:To:Subject:Message-ID:MIME-Version:Content-Type;
	bh=Lx4dBhrqrvG3MFsd9X6PCdB1MPjGTx47ZXklVswma3U=;
	b=mzJmC5bS8jHT+XQo7GWETcRsQ6bEKrzW+BgzHcyOSf0WpnPQPyXZoep4zcU6nX7GCnta5O7N8hWwtuiQkZC2nxv0TvMqEUdI1CDGnrcpHwnZOGGFkZd+tUW9LuDBbnvGx5vKM+plEVdLeKOoR75TBVjaqweMTZrOSiE25HzL05k=
Received: from localhost(mailfrom:alibuda@linux.alibaba.com fp:SMTPD_---0WzigzmF_1771916184 cluster:ay36)
          by smtp.aliyun-inc.com;
          Tue, 24 Feb 2026 14:56:25 +0800
...
Message-ID: <20260224065624.GA67725@j66a10360.sqa.eu95>
References: <20260202094800.30373-1-alibuda@linux.alibaba.com>
 <c054ac11-d3b5-4918-9105-f682db9d3542@linux.ibm.com>
Precedence: bulk
...
In-Reply-To: <c054ac11-d3b5-4918-9105-f682db9d3542@linux.ibm.com>
...
X-Spamd-Result: default: False [-9.16 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-17095-lists,linux-rdma=lfdr.de];
...
X-Rspamd-Queue-Id: 560041829D1
X-Rspamd-Action: no action

On Mon, Feb 23, 2026 at 06:01:38PM +0530, Mahanta Jambigi wrote:
> 
> 
...
Good point. But to support different polling contexts (like IB_POLL_DIRECT)
requires differ handling logic, we can consider this as a future enhancement.
...
Not in this version, because the send ib_cqe is embedded in
smc_wr_tx_pend. However, since I will introduce smc_ib_send_wr in the
next version, I will add the corresponding initialization for it here.
...
No need. ib_drain_qp() handles state checking internally. The
IB_QPS_RESET check here is purely to avoid warning logs from the RDMA
core. Logically, omitting it wouldn't cause any issues at all.
...
I haven't tried dynamic_debug for this. Normally, I use BPF to confirm
if the CQ polling paths are active.
