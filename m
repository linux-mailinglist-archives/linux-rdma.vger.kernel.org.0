...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 5C648407F2B
	for <lists+linux-rdma@lfdr.de>; Sun, 12 Sep 2021 20:15:35 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230106AbhILSQr (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Sun, 12 Sep 2021 14:16:47 -0400
Received: from saphodev.broadcom.com ([192.19.11.229]:34438 "EHLO
        relay.smtp-ext.broadcom.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S233978AbhILSQq (ORCPT
        <rfc822;linux-rdma@vger.kernel.org>);
        Sun, 12 Sep 2021 14:16:46 -0400
Received: from dhcp-10-192-206-197.iig.avagotech.net.net (dhcp-10-123-156-118.dhcp.broadcom.net [10.123.156.118])
        by relay.smtp-ext.broadcom.com (Postfix) with ESMTP id 53EBA80F0;
        Sun, 12 Sep 2021 11:15:30 -0700 (PDT)
DKIM-Filter: OpenDKIM Filter v2.11.0 relay.smtp-ext.broadcom.com 53EBA80F0
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=broadcom.com;
        s=dkimrelay; t=1631470531;
        bh=MbjTiTF5QpwvasN9nu+MAJQOT4yqh5sdsr4FJfrAQkM=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=RQ19CwYrkFMISjAPtUElBdFBmtgDkRV7Cs3dXO5yGu1uEF7VCf+yz2btiazomGzJp
         EuZcRpIavWYqB06ErvRkb6d99TRlVKPBKf64lz8wHkABV84s9yk+jn/SLRIryRiKUO
         AFYwO4LmzE10A4sgz975QO2o6BrW7j4iMXf7R2QY=
From:   Selvin Xavier <selvin.xavier@broadcom.com>
To:     dledford@redhat.com, jgg@nvidia.com
Cc:     linux-rdma@vger.kernel.org,
        Selvin Xavier <selvin.xavier@broadcom.com>
Subject: [PATCH for-next 01/12] RDMA/bnxt_re: Add extended statistics counters
Date:   Sun, 12 Sep 2021 11:15:15 -0700
Message-Id: <1631470526-22228-2-git-send-email-selvin.xavier@broadcom.com>
...
index d4d4959..d0895e6 100644
--- a/drivers/infiniband/hw/bnxt_re/qplib_fp.c
+++ b/drivers/infiniband/hw/bnxt_re/qplib_fp.c
@@ -1049,6 +1049,9 @@ int bnxt_qplib_create_qp(struct bnxt_qplib_res *res, struct bnxt_qplib_qp *qp)
...
@@ -869,3 +870,53 @@ int bnxt_qplib_get_roce_stats(struct bnxt_qplib_rcfw *rcfw,
