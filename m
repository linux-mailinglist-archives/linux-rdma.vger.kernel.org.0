...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 73705164C2
	for <lists+linux-rdma@lfdr.de>; Tue,  7 May 2019 15:39:08 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726509AbfEGNi5 (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Tue, 7 May 2019 09:38:57 -0400
Received: from mail-il-dmz.mellanox.com ([193.47.165.129]:40419 "EHLO
        mellanox.co.il" rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org
        with ESMTP id S1726658AbfEGNi5 (ORCPT
...
Received: from r-vnc08.mtr.labs.mlnx (r-vnc08.mtr.labs.mlnx [10.208.0.121])
        by labmailer.mlnx (8.13.8/8.13.8) with ESMTP id x47DcdFC021865;
...
Subject: [PATCH 12/25] IB/iser: Use IB_WR_REG_MR_INTEGRITY for PI handover
Date:   Tue,  7 May 2019 16:38:26 +0300
Message-Id: <1557236319-9986-13-git-send-email-maxg@mellanox.com>
...
index a7aeaa0c6fbc..8ae77770c962 100644
...
index 2ba70729d7b0..51f1ebf9ed85 100644
--- a/drivers/infiniband/ulp/iser/iser_memory.c
+++ b/drivers/infiniband/ulp/iser/iser_memory.c
@@ -377,17 +377,17 @@ iser_inv_rkey(struct ib_send_wr *inv_wr,
...
@@ -396,33 +396,36 @@ iser_reg_sig_mr(struct iscsi_iser_task *iser_task,
...
-
 ...
 iser_reg_data_sg(struct iscsi_iser_task *task,
 		 struct iser_data_buf *mem,
@@ -516,7 +504,6 @@ int iser_reg_rdma_mem(struct iscsi_iser_task *task,
...
-	struct iser_mem_reg *data_reg;
 	...
 	bool use_dma_key;
 	int err;
@@ -529,32 +516,17 @@ int iser_reg_rdma_mem(struct iscsi_iser_task *task,
 		reg->mem_h = desc;
 	}
...
index 4ff3d98fa6a4..f7502c131b08 100644
