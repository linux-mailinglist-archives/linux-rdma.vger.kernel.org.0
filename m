...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id ABAEF2C34C2
	for <lists+linux-rdma@lfdr.de>; Wed, 25 Nov 2020 00:43:20 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1730270AbgKXXmw (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Tue, 24 Nov 2020 18:42:52 -0500
Received: from mga18.intel.com ([134.134.136.126]:40242 "EHLO mga18.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1728982AbgKXXmw (ORCPT <rfc822;linux-rdma@vger.kernel.org>);
        Tue, 24 Nov 2020 18:42:52 -0500
IronPort-SDR: 1L/SqLxDe3+YUAfOpo8H+NX+BE3MO0eGw7B7BD7Mk8EDGwyVLNMM6of09Jl6N2kCC15Uz7y7g4
 5LLd4YkFa7Bg==
X-IronPort-AV: E=McAfee;i="6000,8403,9815"; a="159801402"
X-IronPort-AV: E=Sophos;i="5.78,367,1599548400"; 
   d="scan'208";a="159801402"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga004.jf.intel.com ([10.7.209.38])
  by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 24 Nov 2020 15:42:51 -0800
IronPort-SDR: ge7G1mLlMrSPGmazNgwJKbhVMZR22Dn7jOsAhjAKLc8jVvYcUrsQxRN2hF8XXNuMf5B7ri7Mgc
 DyzTyO/H9Dlg==
X-IronPort-AV: E=Sophos;i="5.78,367,1599548400"; 
   d="scan'208";a="478695676"
Received: from ssaleem-mobl.amr.corp.intel.com ([10.212.134.32])
  by orsmga004-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 24 Nov 2020 15:42:51 -0800
From:   Shiraz Saleem <shiraz.saleem@intel.com>
To:     dledford@redhat.com, jgg@nvidia.com
Cc:     linux-rdma@vger.kernel.org, stable@kernel.org,
        Shiraz Saleem <shiraz.saleem@intel.com>
Subject: [PATCH 2/2] RDMA/i40iw: Remove push code from i40iw
Date:   Tue, 24 Nov 2020 17:42:24 -0600
Message-Id: <20201124234224.1654-3-shiraz.saleem@intel.com>
...
---
 ...
 9 files changed, 18 insertions(+), 225 deletions(-)
...
index 8bf15c1..584932d 100644
--- a/drivers/infiniband/hw/i40iw/i40iw_main.c
+++ b/drivers/infiniband/hw/i40iw/i40iw_main.c
@@ -1576,7 +1576,6 @@ static enum i40iw_status_code i40iw_setup_init_state(struct i40iw_handler *hdl,
 	if (status)
 		goto exit;
