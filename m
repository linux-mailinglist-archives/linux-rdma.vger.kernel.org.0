...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id A0D62290CDE
	for <lists+linux-rdma@lfdr.de>; Fri, 16 Oct 2020 22:49:58 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2392730AbgJPUt6 (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Fri, 16 Oct 2020 16:49:58 -0400
Received: from mga02.intel.com ([134.134.136.20]:22505 "EHLO mga02.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S2392725AbgJPUt5 (ORCPT <rfc822;linux-rdma@vger.kernel.org>);
        Fri, 16 Oct 2020 16:49:57 -0400
IronPort-SDR: kXh4I61X86kjQLC/Y8cGlHp374234slHu0ALwcXnQcfNX8Mxy8Q00jcWYHBpXiTDM+Rj5pywXI
 VxUZLimdRK9Q==
X-IronPort-AV: E=McAfee;i="6000,8403,9776"; a="153603761"
X-IronPort-AV: E=Sophos;i="5.77,383,1596524400"; 
   d="scan'208";a="153603761"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
  by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 16 Oct 2020 13:49:51 -0700
IronPort-SDR: H4U9zLPEcj390iH7St5ip/mOZiDF5d9dM+u5oCIdlgt5EuoM+488yUfc/TXAQ9KgglOcvr8YlW
 1nsNB2gw8c1Q==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.77,383,1596524400"; 
   d="scan'208";a="522391527"
...
x-forefront-antispam-report: CIP:255.255.255.255;CTRY:;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:MW3PR11MB4555.namprd11.prod.outlook.com;PTR:;CAT:NONE;SFS:(4636009)(136003)(376002)(346002)(39860400002)(366004)(396003)(66556008)(7696005)(86362001)(4326008)(83380400001)(71200400001)(8936002)(186003)(107886003)(6916009)(2906002)(55016002)(6506007)(64756008)(9686003)(53546011)(66476007)(66946007)(66446008)(33656002)(26005)(8676002)(52536014)(76116006)(478600001)(316002)(5660300002)(54906003);DIR:OUT;SFP:1102;
...
X-MS-Exchange-CrossTenant-originalarrivaltime: 16 Oct 2020 20:49:45.1984
 (UTC)
...
> > > > +};
> > >
> > > I'm not really convinced these should be ops, this is usually a bad d=
esign pattern.
> > >
...
I can work along that direction. One change I can see is that the umem_dmab=
uf structure
...
> > This handling is similar to the ODP case. The variables 'ncont' and 'pa=
ge_shift' here are not necessary.
> > They are kept just for the sake of signifying the semantics of the
> > following functions that use them.
>=20
> Well, in this case we can manage it, and the performance boost is high en=
ough we need to. The work on mlx5 to do it is a bit inovlved
> though.
...
> > > is missing here, and this is also missing the related complex teardow=
n logic.
> > >
...
> >
> > On the other hand, it seems that pagefault_dmabuf_mr() is not needed at=
 all.
> > The pagefault is gracefully handled by retrying until the work thread
> > finished programming the NIC.
>=20
> This is a bug of some kind, pagefaults that can't find a mkey in the xarr=
ay should cause completion with error.
>=20
> Jason
