...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 3B8564640B
	for <lists+linux-rdma@lfdr.de>; Fri, 14 Jun 2019 18:28:21 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1725846AbfFNQ2U (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Fri, 14 Jun 2019 12:28:20 -0400
Received: from mga14.intel.com ([192.55.52.115]:48889 "EHLO mga14.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1725801AbfFNQ2U (ORCPT <rfc822;linux-rdma@vger.kernel.org>);
        Fri, 14 Jun 2019 12:28:20 -0400
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
  by fmsmga103.fm.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384; 14 Jun 2019 09:28:19 -0700
X-ExtLoop1: 1
Received: from sedona.ch.intel.com ([10.2.136.157])
  by fmsmga007.fm.intel.com with ESMTP; 14 Jun 2019 09:28:19 -0700
Received: from awfm-01.aw.intel.com (awfm-01.aw.intel.com [10.228.212.213])
        by sedona.ch.intel.com (8.14.3/8.14.3/Standard MailSET/Hub) with ESMTP id x5EGSILZ060693;
        Fri, 14 Jun 2019 09:28:18 -0700
Received: from awfm-01.aw.intel.com (localhost [127.0.0.1])
        by awfm-01.aw.intel.com (8.14.7/8.14.7) with ESMTP id x5EGSGN6044843;
        Fri, 14 Jun 2019 12:28:16 -0400
Subject: [PATCH for-next 3/9] IB/{rdmavt, hfi1,
...
Date:   Fri, 14 Jun 2019 12:28:16 -0400
Message-ID: <20190614162816.44714.81813.stgit@awfm-01.aw.intel.com>
...
@@ -1123,6 +1168,11 @@ struct ib_qp *rvt_create_qp(struct ib_pd *ibpd,
...
+		}
 		...
 		err = alloc_qpn(rdi, &rdi->qp_dev->qpn_table,
 				init_attr->qp_type,
@@ -1226,6 +1276,7 @@ struct ib_qp *rvt_create_qp(struct ib_pd *ibpd,
...
@@ -1670,6 +1721,7 @@ int rvt_destroy_qp(struct ib_qp *ibqp, struct ib_udata *udata)
...
+	free_ud_wq_attr(qp);
 	...
 	kfree(qp);
 	return 0;
@@ -2036,10 +2088,10 @@ static int rvt_post_one_wr(struct rvt_qp *qp,
 	 */
...
@@ -2084,7 +2136,7 @@ static int rvt_post_one_wr(struct rvt_qp *qp,
