...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id CCFD6C2279
	for <lists+linux-rdma@lfdr.de>; Mon, 30 Sep 2019 15:53:08 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1730809AbfI3NxH (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Mon, 30 Sep 2019 09:53:07 -0400
Received: from hr2.samba.org ([144.76.82.148]:21532 "EHLO hr2.samba.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1730378AbfI3NxH (ORCPT <rfc822;linux-rdma@vger.kernel.org>);
        Mon, 30 Sep 2019 09:53:07 -0400
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=samba.org;
         s=42627210; h=Date:Message-ID:From:Cc:To;
        bh=oxd7B5+A9JFKvcA+14/zk0QpEHpnGTsxiFTy+n1+Bas=; b=LYS0gRtGZDAO3B43pYqkii+K0j
        cEOjO/+cc8CMY0bzgkAYK1ySsPkixYkiB6foHsswD3sYjIpOu61GLQwSj6B09L5SgCPslcMt7IX/z
        aRBUKHJaQOY0OKECKNXZg7rZgNvvUtBqQockakuoLWshQCcNld7Fm8Y08Hch+MN0dbnU=;
Received: from [127.0.0.2] (localhost [127.0.0.1])
        by hr2.samba.org with esmtpsa (TLS1.2:ECDHE_ECDSA_CHACHA20_POLY1305:256)
        (Exim)
        id 1iEw6n-000554-P1; Mon, 30 Sep 2019 13:53:01 +0000
...
Subject: Re: [PATCH] rdma/core: add __module_get()/module_put() to
 cma_[de]ref_dev()
Message-ID: <31690de0-eef6-378b-2703-6cd13eb61461@samba.org>
Date:   Mon, 30 Sep 2019 15:52:51 +0200
...
Content-Type: multipart/signed; micalg=pgp-sha512;
 ...
 boundary="m4TYMDacFv68tyIHlyTwSs8kBlmuYbjIt"
...
--m4TYMDacFv68tyIHlyTwSs8kBlmuYbjIt
Content-Type: multipart/mixed; boundary="N3XJX4mPscEQMfGum4f9VpFTyT9dkomTp";
...
--N3XJX4mPscEQMfGum4f9VpFTyT9dkomTp
...
>> Currently there seems to be a problem when an RDMA listener or connect=
ion
...
https://git.samba.org/?p=3Dmetze/linux/smbdirect.git;a=3Dsummary
...

=hPsE
-----END PGP SIGNATURE-----
