...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 79D1848316F
	for <lists+linux-rdma@lfdr.de>; Mon,  3 Jan 2022 14:33:57 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233143AbiACNdz (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Mon, 3 Jan 2022 08:33:55 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:54890 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233127AbiACNdt (ORCPT
        <rfc822;linux-rdma@vger.kernel.org>); Mon, 3 Jan 2022 08:33:49 -0500
Received: from mail-ed1-x531.google.com (mail-ed1-x531.google.com [IPv6:2a00:1450:4864:20::531])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 68EB9C06179C
        for <linux-rdma@vger.kernel.org>; Mon,  3 Jan 2022 05:33:48 -0800 (PST)
Received: by mail-ed1-x531.google.com with SMTP id w16so136047387edc.11
        for <linux-rdma@vger.kernel.org>; Mon, 03 Jan 2022 05:33:48 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=ionos.com; s=google;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=Oxk0R1LXD4qru1qBJ9B3tJXRLQAuozv+pn6t+qo7D6g=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=Oxk0R1LXD4qru1qBJ9B3tJXRLQAuozv+pn6t+qo7D6g=;
        b=
X-Gm-Message-State: AOAM5312Kk9i7cNv3birWtkMk96wMNmwriEjXKXON6FjoR1nBYW4OsuY
        RBKd7DXbsxA0zcgurhpyF+w19NX89EV4ZA==
X-Google-Smtp-Source: ABdhPJyBUb0fBB32tJVDjgeFs1RJvitCRfAWIxMfb0+I7JNkxM5LtAatcaxv6FR/gDyDv2GZgshoOA==
X-Received: by 2002:a05:6402:184c:: with SMTP id v12mr43770586edy.154.1641216825394;
...
Received: from jwang-Latitude-5491.fkb.profitbricks.net ([2001:16b8:456d:f000:5d30:da54:5b3e:3042])
        by smtp.gmail.com with ESMTPSA id ne2sm10702408ejc.108.2022.01.03.05.33.44
...
Subject: [PATCHv2 for-next 3/5] RDMA/rtrs-clt: Rename rtrs_clt_sess to rtrs_clt_path
Date:   Mon,  3 Jan 2022 14:33:37 +0100
Message-Id: <20220103133339.9483-4-jinpu.wang@ionos.com>
...
rtrs_clt_sess is used for paths and not sessions on
the client side. This creates confusion so let's
rename it to rtrs_clt_path. Also, rename related
variables and functions.

Coccinelle is used to do the transformations for most
of the occurrences and remaining ones were handled
manually.
...
---
 ...
 drivers/infiniband/ulp/rtrs/rtrs-clt.c       | 993 ++++++++++---------
 drivers/infiniband/ulp/rtrs/rtrs-clt.h       |  20 +-
 drivers/infiniband/ulp/rtrs/rtrs.h           |   4 +-
 5 files changed, 583 insertions(+), 565 deletions(-)

diff --git a/drivers/infiniband/ulp/rtrs/rtrs-clt-stats.c b/drivers/infiniband/ulp/rtrs/rtrs-clt-stats.c
index 608069b7c303..385a19846c24 100644
...
index 0e69180c3771..834f6d30487c 100644
...
index e767692ec221..72b1fed365d1 100644
...
+		if (xchg_sessions(ppcpu_path, clt_path, next))
 			/*
...
index 57579b2c91d1..899ea6e36462 100644
...
index e28a53ff4b0b..d5d037660cea 100644
