...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 0956833D7D2
	for <lists+linux-rdma@lfdr.de>; Tue, 16 Mar 2021 16:41:19 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234264AbhCPPkq (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Tue, 16 Mar 2021 11:40:46 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:38504 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234198AbhCPPkc (ORCPT
        <rfc822;linux-rdma@vger.kernel.org>); Tue, 16 Mar 2021 11:40:32 -0400
Received: from mail-ot1-x334.google.com (mail-ot1-x334.google.com [IPv6:2607:f8b0:4864:20::334])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id F2FA9C06174A
        for <linux-rdma@vger.kernel.org>; Tue, 16 Mar 2021 08:40:31 -0700 (PDT)
Received: by mail-ot1-x334.google.com with SMTP id t16so8807086ott.3
        for <linux-rdma@vger.kernel.org>; Tue, 16 Mar 2021 08:40:31 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=subject:to:cc:references:from:message-id:date:user-agent
         :mime-version:in-reply-to:content-language:content-transfer-encoding;
        bh=IjpZAi2nrSXAjLkiGSRCbRW+B56/NICKRMFAbQSKtok=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=IjpZAi2nrSXAjLkiGSRCbRW+B56/NICKRMFAbQSKtok=;
        b=
X-Gm-Message-State: AOAM530Cy25/hNE3P1zpEDIsk20nGX4eYN3kSyF4Z6RU0yOhzu2EpNC7
        VtY9n9kvcoHAfhbIMIjU024=
X-Google-Smtp-Source: ABdhPJzkSduFEHojzl9WWtJ2p5ufjrhiuBeNNBLow/tcDrB7H3UCkt6b7te5QZQ7mRJvCZGr5ddmNw==
X-Received: by 2002:a9d:39ca:: with SMTP id y68mr4206946otb.84.1615909230943;
        Tue, 16 Mar 2021 08:40:30 -0700 (PDT)
Received: from ?IPv6:2603:8081:140c:1a00:860d:4b17:b3b4:cd4a? (2603-8081-140c-1a00-860d-4b17-b3b4-cd4a.res6.spectrum.com. [2603:8081:140c:1a00:860d:4b17:b3b4:cd4a])
        by smtp.gmail.com with ESMTPSA id x23sm5618789ood.28.2021.03.16.08.40.30
...
References: <20210314222612.44728-1-rpearson@hpe.com>
 <CAD=hENeNa0=21OOK_dCq9ykBYuLY1PWdvBewECBU9aUY2AS4Lg@mail.gmail.com>
From:   Bob Pearson <rpearsonhpe@gmail.com>
Message-ID: <e2a0dbf0-72d2-a79f-4f26-9f2430a74aec@gmail.com>
Date:   Tue, 16 Mar 2021 10:40:29 -0500
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:78.0) Gecko/20100101
 Thunderbird/78.7.1
MIME-Version: 1.0
In-Reply-To: <CAD=hENeNa0=21OOK_dCq9ykBYuLY1PWdvBewECBU9aUY2AS4Lg@mail.gmail.com>
...
On 3/16/21 2:18 AM, Zhu Yanjun wrote:
...
> Zhu Yanjun
> 
Almost all the lines here are just changing mem to mr (and MEM to MR).
There is no way to do it in pieces without breaking the driver.
There are a comparatively small number of changes splitting out mw
which are mostly limited to changing the name from mem to mw. And one or two
other lines. Since mw isn't actually used yet there isn't much code.
This patch is part of getting ready for adding mw support.
The way to check this is to verify by inspection that (except as mentioned above)
each line just replaces mem by mr and then grep for mem or MEM in the tree to make
sure they are all done. (There are a few other mem's like umem and memcpy.)
