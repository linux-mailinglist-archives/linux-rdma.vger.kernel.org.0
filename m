Return-Path: <linux-rdma+bounces-4541-lists+linux-rdma=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-rdma@lfdr.de
Delivered-To: lists+linux-rdma@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 0814E95DAE8
	for <lists+linux-rdma@lfdr.de>; Sat, 24 Aug 2024 05:22:21 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 02D501F22AED
	for <lists+linux-rdma@lfdr.de>; Sat, 24 Aug 2024 03:22:20 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id B97FC28683;
	Sat, 24 Aug 2024 03:20:50 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b="dqINFr0M"
X-Original-To: linux-rdma@vger.kernel.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.16])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 13271481A3;
...
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	...
	bh=EUrxlqk0QFrRlNEYKqcqwgvK+ouJmsmHw7DXMAHzBds=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=oi8MaNyrxBlI5k76lgkj7f8NdOOo69I0cgBkmc+bMeRx0zoZU9sebrCv51KzZBF4wEu+ybmdiX/+Xpq7Qqcs5R8jJUfGn2BdQGTloBB/ID8mxrXWHYzXlQSrPY0NBxCk5BjIOB9uTw9jfr2Bb94D7H6A6iwM1vfU+iapH9ddVsQ=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com; spf=pass smtp.mailfrom=intel.com; dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b=dqINFr0M; arc=none smtp.client-ip=192.198.163.16
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=intel.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1724469647; x=1756005647;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=EUrxlqk0QFrRlNEYKqcqwgvK+ouJmsmHw7DXMAHzBds=;
  b=dqINFr0MptLPRyXN2+8nkxc0R5JAtn36x1KihU5FqV6AWXz9rrHzPJFH
   cHhcL5V1l2E7RfKyVRWtpd5dggoulXSnDWpuN2z1rfL1jmwVy7SPdEbiW
   8aRkcA880nTGgLzUr3kGoVRq3VUmWfeXgkGXe/3Iq+S7oJAvhFhoxndo0
   /IfrS9G/4a8NVauFEzFOC/HzWLxspyDJgQUbSuvHNgJMG8ub+IZebNiOQ
   JIBbr5ediUojt73p4kWtso8hUQ3g1iD60ONR7iylasKZb0yxJ5jT4u8/v
   gxINHxh7aqEY+oXWyBtGJJk6Re8Tzd6xz4y6yUggGefsyUqbv7ml3zsXI
   Q==;
X-CSE-ConnectionGUID: I90aCFzHRqGZDRG0r1LKSg==
X-CSE-MsgGUID: ZMx2QZxKRIiQBpU/y81lZQ==
X-IronPort-AV: E=McAfee;i="6700,10204,11173"; a="13187797"
X-IronPort-AV: E=Sophos;i="6.10,172,1719903600"; 
   d="scan'208";a="13187797"
Received: from orviesa001.jf.intel.com ([10.64.159.141])
  by fmvoesa110.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 23 Aug 2024 20:20:44 -0700
X-CSE-ConnectionGUID: 1wKB9RvTRu+MVi4jMOLGRQ==
X-CSE-MsgGUID: DXmKjdP4TXCZtOMCTzNs+g==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.10,172,1719903600"; 
   d="scan'208";a="99492103"
...
Subject: [RFC v2 11/25] RDMA/irdma: Add GEN3 core driver support
Date: Fri, 23 Aug 2024 22:19:10 -0500
Message-Id: <20240824031924.421-12-tatyana.e.nikolova@intel.com>
...
index 6aed6169c07d..9d7b151a6b95 100644
...
@@ -2829,7 +2832,8 @@ irdma_sc_parse_fpm_commit_buf(struct irdma_sc_dev *dev, __le64 *buf,
 				   IRDMA_HMC_IW_QP);
...
@@ -2864,15 +2868,17 @@ irdma_sc_parse_fpm_commit_buf(struct irdma_sc_dev *dev, __le64 *buf,
 					   IRDMA_HMC_IW_HDR);
...
@@ -4335,6 +4368,26 @@ int irdma_sc_init_iw_hmc(struct irdma_sc_dev *dev, u8 hmc_fn_id)
 	return ret_code;
 }
...
+	}
 	if (sd > 0xFFFFFFFF) {
 		...
 		sd = 0xFFFFFFFF - 1;
@@ -4785,6 +4851,272 @@ static void cfg_fpm_value_gen_2(struct irdma_sc_dev *dev,
...
+
  ...
  * @dev: sc device struct
@@ -4792,16 +5124,15 @@ static void cfg_fpm_value_gen_2(struct irdma_sc_dev *dev,
  */
...
index 2cb4b96db721..7825896c445c 100644
...
index ad50b77282f8..288131466a19 100644
...
new file mode 100644
index 000000000000..70b1ed3723a4
--- /dev/null
...
index 20d2e7393e3d..769170445f88 100644
...
index 59b34afa867b..cfcb5d938d76 100644
...
index 380e4a47aede..8fd7eebef11d 100644
...
new file mode 100644
index 000000000000..2abfc3961f3e
--- /dev/null
