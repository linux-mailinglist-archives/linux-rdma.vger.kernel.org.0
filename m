...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id EE811218B0C
	for <lists+linux-rdma@lfdr.de>; Wed,  8 Jul 2020 17:19:52 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1730064AbgGHPTv (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Wed, 8 Jul 2020 11:19:51 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:58094 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1730052AbgGHPTv (ORCPT
        <rfc822;linux-rdma@vger.kernel.org>); Wed, 8 Jul 2020 11:19:51 -0400
Received: from mail-wm1-x344.google.com (mail-wm1-x344.google.com [IPv6:2a00:1450:4864:20::344])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 2354BC061A0B;
        Wed,  8 Jul 2020 08:19:51 -0700 (PDT)
Received: by mail-wm1-x344.google.com with SMTP id l2so3657548wmf.0;
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=8yDYs5kf0VFRFsstSduiE28HS82Bac8JtWtCly+D0gs=;
        b=
X-Gm-Message-State: AOAM530YlSCR1f/QLnb8k1LsyEVCaEX9aNXWl+3WwW6nACfGkttmWvPk
        hmfm4r6yqkxmi0K2q+BdT4LZVSIO9NKadGMIC13H924e
...
On Wed, Jul 8, 2020 at 11:13 AM Daniel Vetter <daniel.vetter@ffwll.ch> wrot=
e:
>
...
> - amdgpu needs a full rework of display reset (but apparently in the work=
s)

I think the display deadlock issues should be fixed in:
https://cgit.freedesktop.org/drm/drm/commit/?id=3Dcdaae8371aa9d4ea1648a299b=
1a75946b9556944
...
> > >    isn't nested the same way under all circumstances, so ABBA deadloc=
ks
...
> > >    side in lockdep, but this forces all normal spinlocks nested withi=
n
> > >    dma_fence_begin/end_signalling to be spinlocks. That bollocks.
> > >
> > >    The approach now is to simple check in_atomic(), and for these cas=
es
...
wn.net%2FArticles%2F709849%2F&amp;data=3D02%7C01%7Cchristian.koenig%40amd.c=
om%7Cff1a9dd17c544534eeb808d822b21ba2%7C3dd8961fe4884e608e11a82d994e183d%7C=
0%7C0%7C637297495649621566&amp;sdata=3DpbDwf%2BAG1UZ5bLZeep7VeGVQMnlQhX0TKG=
1d6Ok8GfQ%3D&amp;reserved=3D0
> > >
...
> > >
> > >           This code (CONFIG_LOCKDEP_CROSSRELEASE=3Dy and CONFIG_LOCKD=
EP_COMPLETIONS=3Dy),
> > >           while it found a number of old bugs initially, was also cau=
sing too many
> > >           false positives that caused people to disable lockdep - whi=
ch is arguably
...
> > >    starts, like fresh syscall or fresh work callback. This would agai=
n
> > >    cause false positives without explicit annotations, since for
> > >    dma_fence the critical sections only starts when we publish a fenc=
e.
> > >
> > > - Furthermore there can be cases where a thread never does a
> > >    dma_fence_signal, but is still critical for reaching completion of
> > >    fences. One example would be a scheduler kthread which picks up jo=
bs
...
> > >    manually annotate it. cross-release aimed to solve this by chainin=
g
> > >    cross-release dependencies, but the dependency from scheduler thre=
ad
...
> > > and end of critical sections, cross-relese dependency tracking doesn'=
t
...
> > > +
> > > +/**
> > > + * dma_fence_end_signalling - end a critical DMA fence signalling se=
ction
> > > + *
> > > + * Closes a critical section annotation opened by dma_fence_begin_si=
gnalling().
> > > + */
...
> > > @@ -210,6 +369,8 @@ dma_fence_wait_timeout(struct dma_fence *fence, b=
ool intr, signed long timeout)
> > >
> > >       might_sleep();
> > >
