...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id A297C1DAD75
	for <lists+linux-rdma@lfdr.de>; Wed, 20 May 2020 10:29:53 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726820AbgETI3x (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Wed, 20 May 2020 04:29:53 -0400
Received: from mail.kernel.org ([198.145.29.99]:49596 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726224AbgETI3w (ORCPT <rfc822;linux-rdma@vger.kernel.org>);
        Wed, 20 May 2020 04:29:52 -0400
Received: from localhost (unknown [213.57.247.131])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id CBF13206C3;
        Wed, 20 May 2020 08:29:50 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1589963391;
        bh=+HkR//HWmT15z+sDrQww5Fv8N5gv57s5TIYC93qy4qg=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=Tu/ZgPY/8CuOYqdiXesrj0OYMO0DnQo0DwDTJ/eX9CDufAKs2KqIns3UQKclK/MLp
         6zKUcdiIbSOLYrREE25eeCcQm8dIKrQ5rCbcTQN3/DUVtdWFN6a/FwQhfBc/Aeg7W+
         HlHLxnbbTQDVTIlfuxTsbL9HNzYsfutROjLJLihU=
...
Subject: [PATCH rdma-next 6/8] RDMA/mlx5: Convert modify QP to use MLX5_SET macros
Date:   Wed, 20 May 2020 11:29:17 +0300
Message-Id: <20200520082919.440939-7-leon@kernel.org>
...
index f29e0cc94f81..7d974d9c03d3 100644
--- a/drivers/infiniband/hw/mlx5/qp.c
+++ b/drivers/infiniband/hw/mlx5/qp.c
@@ -3032,14 +3032,13 @@ int mlx5_ib_destroy_qp(struct ib_qp *qp, struct ib_udata *udata)
 	return 0;
 }
...
@@ -3054,8 +3053,8 @@ static int to_mlx5_access_flags(struct mlx5_ib_qp *qp,
 	if (!dest_rd_atomic)
...
@@ -3063,15 +3062,11 @@ static int to_mlx5_access_flags(struct mlx5_ib_qp *qp,
 		if (atomic_mode < 0)
 			return -EOPNOTSUPP;
...
@@ -3151,26 +3146,22 @@ static int modify_raw_packet_tx_affinity(struct mlx5_core_dev *dev,
 	return err;
 }
...
+			 const struct ib_qp_attr *attr, bool alt)
 {
 	...
 	int err;
@@ -3179,8 +3170,8 @@ static int mlx5_set_path(struct mlx5_ib_dev *dev, struct mlx5_ib_qp *qp,
...
+			 alt ? attr->alt_pkey_index : attr->pkey_index);
 	...
 	if (ah_flags & IB_AH_GRH) {
 		if (grh->sgid_index >=
@@ -3196,7 +3187,8 @@ static int mlx5_set_path(struct mlx5_ib_dev *dev, struct mlx5_ib_qp *qp,
 		if (!(ah_flags & IB_AH_GRH))
 			return -EINVAL;
...
@@ -3206,38 +3198,38 @@ static int mlx5_set_path(struct mlx5_ib_dev *dev, struct mlx5_ib_qp *qp,
...
@@ -3763,9 +3755,9 @@ static int __mlx5_ib_modify_qp(struct ib_qp *ibqp,
...
+	void *qpc, *pri_path, *alt_path;
 	...
 	u32 set_id = 0;
 	int mlx5_st;
@@ -3777,25 +3769,25 @@ static int __mlx5_ib_modify_qp(struct ib_qp *ibqp,
 	if (mlx5_st < 0)
 		return -EINVAL;
...
@@ -3803,19 +3795,20 @@ static int __mlx5_ib_modify_qp(struct ib_qp *ibqp,
...
@@ -3823,40 +3816,45 @@ static int __mlx5_ib_modify_qp(struct ib_qp *ibqp,
 			err = -EINVAL;
 			goto out;
 		}
...
+					    IB_QP_TIMEOUT,
 		...
 		if (err)
 			goto out;
@@ -3865,53 +3863,47 @@ static int __mlx5_ib_modify_qp(struct ib_qp *ibqp,
...
@@ -3925,15 +3917,14 @@ static int __mlx5_ib_modify_qp(struct ib_qp *ibqp,
...
@@ -3991,7 +3982,7 @@ static int __mlx5_ib_modify_qp(struct ib_qp *ibqp,
...
+		err = mlx5_core_qp_modify(dev, op, optpar, qpc, &base->mqp);
 	...
 	if (err)
@@ -4038,7 +4029,7 @@ static int __mlx5_ib_modify_qp(struct ib_qp *ibqp,
 	}
