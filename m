...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 9B8C91B5A3A
	for <lists+linux-rdma@lfdr.de>; Thu, 23 Apr 2020 13:16:10 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727906AbgDWLQJ (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Thu, 23 Apr 2020 07:16:09 -0400
Received: from szxga07-in.huawei.com ([45.249.212.35]:49716 "EHLO huawei.com"
        rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org with ESMTP
        id S1727862AbgDWLQI (ORCPT <rfc822;linux-rdma@vger.kernel.org>);
        Thu, 23 Apr 2020 07:16:08 -0400
Received: from DGGEMS407-HUB.china.huawei.com (unknown [172.30.72.59])
        by Forcepoint Email with ESMTP id A04C8436892238645A61;
...
CC:     <leon@kernel.org>, <linux-rdma@vger.kernel.org>,
        <linuxarm@huawei.com>
Subject: [PATCH for-next 4/5] RDMA/hns: Move SRQ code to the reasonable place
Date:   Thu, 23 Apr 2020 19:15:49 +0800
Message-ID: <1587640550-16777-5-git-send-email-liweihang@huawei.com>
...
---
 drivers/infiniband/hw/hns/hns_roce_hw_v2.c | 793 ++++++++++++++---------------
 1 file changed, 396 insertions(+), 397 deletions(-)

diff --git a/drivers/infiniband/hw/hns/hns_roce_hw_v2.c b/drivers/infiniband/hw/hns/hns_roce_hw_v2.c
index 97b8cb3..0b79daf 100644
...
@@ -5588,294 +5875,6 @@ static void hns_roce_v2_cleanup_eq_table(struct hns_roce_dev *hr_dev)
