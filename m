Return-Path: <linux-rdma+bounces-22523-lists+linux-rdma=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-rdma@lfdr.de
Received: from mail.lfdr.de
	by mail.lfdr.de with LMTP
	id YR3UNKj5P2qcawkAu9opvQ
	(envelope-from <linux-rdma+bounces-22523-lists+linux-rdma=lfdr.de@vger.kernel.org>)
	for <lists+linux-rdma@lfdr.de>; Sat, 27 Jun 2026 18:26:16 +0200
X-Original-To: lists+linux-rdma@lfdr.de
Received: from sto.lore.kernel.org (sto.lore.kernel.org [172.232.135.74])
	by mail.lfdr.de (Postfix) with ESMTPS id 436416D241E
	for <lists+linux-rdma@lfdr.de>; Sat, 27 Jun 2026 18:26:16 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=pass header.d=cornelisnetworks.com header.s=selector1 header.b=iQTaTeZ1;
	spf=pass (mail.lfdr.de: domain of "linux-rdma+bounces-22523-lists+linux-rdma=lfdr.de@vger.kernel.org" designates 172.232.135.74 as permitted sender) smtp.mailfrom="linux-rdma+bounces-22523-lists+linux-rdma=lfdr.de@vger.kernel.org";
	dmarc=pass (policy=none) header.from=cornelisnetworks.com;
	arc=reject ("cv is fail on i=2")
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sto.lore.kernel.org (Postfix) with ESMTP id 8E2A730058CD
	for <lists+linux-rdma@lfdr.de>; Sat, 27 Jun 2026 16:26:15 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id CF2312EEE7E;
	Sat, 27 Jun 2026 16:26:11 +0000 (UTC)
...
Received: from SN4PR2101CU001.outbound.protection.outlook.com (mail-southcentralusazon11022126.outbound.protection.outlook.com [40.93.195.126])
	...
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id BF1CA1B808
	for <linux-rdma@vger.kernel.org>; Sat, 27 Jun 2026 16:26:02 +0000 (UTC)
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1782577571; cv=fail; b=oVB8163g7Zg7Krxa0nx5NoPIXsg2gEFewBy93DhqQM/ik7bZL8dECr65b7173YIkkmMSI/ltWxeamXFpz/NOKpNsE+lyjHbi43iCBssUvzszgDQDLBGKIzb4rKcS5yUAJTHOciKrzY9vCBBDbDVR7k+3QuJwCYSynTjdcYPycEM=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1782577571; c=relaxed/simple;
	bh=LFkMWhsLERbg5weB+FMwsgrGyx1fhq5ZRwmn/s44QpU=;
	h=Subject:From:To:Cc:Date:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=PUMrUwlwZOVLNK+Z2tgep35PqkLeYm6cWomuTB/x+hMC6s08908ROdpwpxIPWI6Xx/PjM3IbfRyBeeZS5yBg9lswb/21Sa6QhurqCelPVGq0jrmYFAbZNHVKrm0/8VJjDn5hXBNwb1ZYfelwz0qyOsqauspSSE7ZWA2I+xuNARk=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=cornelisnetworks.com; spf=pass smtp.mailfrom=cornelisnetworks.com; dkim=pass (2048-bit key) header.d=cornelisnetworks.com header.i=@cornelisnetworks.com header.b=iQTaTeZ1; arc=fail smtp.client-ip=40.93.195.126
ARC-Seal: i=1; a=rsa-sha256; s=arcselector10001; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com;
 s=arcselector10001;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-AntiSpam-MessageData-ChunkCount:X-MS-Exchange-AntiSpam-MessageData-0:X-MS-Exchange-AntiSpam-MessageData-1;
 bh=ksn1tfEi5lFMaXQiaHlho7uV9BCsURvYgMV2YZZbXtM=;
 b=
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=cornelisnetworks.com;
 ...
 bh=ksn1tfEi5lFMaXQiaHlho7uV9BCsURvYgMV2YZZbXtM=;
 b=
Received: from CH0PR13CA0038.namprd13.prod.outlook.com (2603:10b6:610:b2::13)
 by SJ0PR01MB6270.prod.exchangelabs.com (2603:10b6:a03:2a2::14) with Microsoft
 SMTP Server (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.21.159.18; Sat, 27 Jun 2026 16:25:56 +0000
Received: from DS3PEPF0000C37A.namprd04.prod.outlook.com
 (2603:10b6:610:b2:cafe::34) by CH0PR13CA0038.outlook.office365.com
...
Received: from cn-mailer-00.localdomain (50.148.235.34) by
 ...
 Server (version=TLS1_3, cipher=TLS_AES_256_GCM_SHA384) id 15.21.181.6 via
 Frontend Transport; Sat, 27 Jun 2026 16:25:55 +0000
Received: from awdrv-04.localdomain (unknown [10.228.212.218])
	by cn-mailer-00.localdomain (Postfix) with ESMTPS id 29963146565;
	Sat, 27 Jun 2026 12:25:55 -0400 (EDT)
Received: from [10.228.212.218] (localhost [IPv6:::1])
	by awdrv-04.localdomain (Postfix) with ESMTP id 252771810D6C7;
	Sat, 27 Jun 2026 12:25:55 -0400 (EDT)
Subject: [PATCH v2 for-next 12/24] RDMA/hfi2: Implement MAD handling
From: Dennis Dalessandro <dennis.dalessandro@cornelisnetworks.com>
To: jgg@ziepe.ca, leon@kernel.org
Cc: Dean Luick <dean.luick@cornelisnetworks.com>,
 Douglas Miller <doug.miller@cornelisnetworks.com>, linux-rdma@vger.kernel.org
Date: Sat, 27 Jun 2026 12:25:55 -0400
Message-ID: <178257755509.371918.5267352339352457618.stgit@awdrv-04>
...
X-MS-TrafficTypeDiagnostic: DS3PEPF0000C37A:EE_|SJ0PR01MB6270:EE_
X-MS-Office365-Filtering-Correlation-Id: e08bdb89-30b2-4162-1d7a-08ded468c3a8
X-MS-Exchange-AtpMessageProperties: SA
X-MS-Exchange-SenderADCheck: 1
X-MS-Exchange-AntiSpam-Relay: 0
X-Microsoft-Antispam:
	BCL:0;ARA:13230040|82310400026|376014|23010399003|1800799024|36860700016|6133799003|56012099006|5023799004|55112099003|18002099003|22082099003|3023799007;
X-Microsoft-Antispam-Message-Info:
	
X-Forefront-Antispam-Report:
	CIP:50.148.235.34;CTRY:US;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:cn-mailer-00.localdomain;PTR:InfoDomainNonexistent;CAT:NONE;SFS:(13230040)(82310400026)(376014)(23010399003)(1800799024)(36860700016)(6133799003)(56012099006)(5023799004)(55112099003)(18002099003)(22082099003)(3023799007);DIR:OUT;SFP:1102;
X-MS-Exchange-AntiSpam-MessageData-ChunkCount: 1
X-MS-Exchange-AntiSpam-MessageData-0:
	
X-OriginatorOrg: cornelisnetworks.com
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 27 Jun 2026 16:25:55.5826
 (UTC)
X-MS-Exchange-CrossTenant-Network-Message-Id: e08bdb89-30b2-4162-1d7a-08ded468c3a8
...
X-Spamd-Result: default: False [0.34 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	TO_DN_SOME(0.00)[];
	TAGGED_FROM(0.00)[bounces-22523-lists,linux-rdma=lfdr.de];
	RCVD_TLS_LAST(0.00)[];
	MIME_TRACE(0.00)[0:+];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[vger.kernel.org:from_smtp,cornelisnetworks.com:dkim,cornelisnetworks.com:email,cornelisnetworks.com:from_mime,awdrv-04:mid,sto.lore.kernel.org:rdns,sto.lore.kernel.org:helo,wc.sl:url];
...
---
 ...
 1 file changed, 6503 insertions(+)
...
index 000000000000..e87a6d53b58f
--- /dev/null
...
+
+	pi->port_states.portphysstate_portstate = (hfi2_driver_pstate(ppd) << 4) |
+						  state;
+
...
+		mtu = hfi2_mtu_to_enum(ppd->vld[i].mtu, HFI2_DEFAULT_ACTIVE_MTU);
+		if ((i % 2) == 0)
...
+			hfi2_set_link_down_reason(ppd, OPA_LINKDOWN_REASON_FM_BOUNCE,
...
+		else
+			mtu = hfi2_enum_to_mtu(pi->neigh_mtu.pvlx_to_mtu[i / 2] &
+					  0xF);
+		if (mtu == 0xffff) {
+			ppd_dev_warn(
+				ppd,
...
+		ppd->offline_disabled_reason;
+
+	psi->port_states.portphysstate_portstate = (hfi2_driver_pstate(ppd) << 4) |
+						   (lstate & 0xf);
...
+		return 0;
+	if (vl < C_VL_COUNT)
+		port_vl_xmit_wait_curr = hfi2_read_port_cntr(ppd, C_TX_WAIT_VL, vl);
+	else
...
+	rsp->port_rcv_data =
+		cpu_to_be64(hfi2_read_dev_cntr(dd, C_DC_RCV_FLITS, CNTR_INVALID_VL));
+	rsp->port_xmit_pkts =
+		cpu_to_be64(hfi2_read_dev_cntr(dd, C_DC_XMIT_PKTS, CNTR_INVALID_VL));
+	rsp->port_rcv_pkts =
+		cpu_to_be64(hfi2_read_dev_cntr(dd, C_DC_RCV_PKTS, CNTR_INVALID_VL));
...
+	rsp->port_rcv_fecn =
+		cpu_to_be64(hfi2_read_dev_cntr(dd, C_DC_RCV_FCN, CNTR_INVALID_VL));
+	rsp->port_rcv_becn =
+		cpu_to_be64(hfi2_read_dev_cntr(dd, C_DC_RCV_BCN, CNTR_INVALID_VL));
...
+		cpu_to_be64(hfi2_read_dev_cntr(dd, C_DC_RX_REPLAY, CNTR_INVALID_VL));
+	tmp = hfi2_read_dev_cntr(dd, C_DC_SEQ_CRC_CNT, CNTR_INVALID_VL);
+	tmp2 = tmp +
+	       hfi2_read_dev_cntr(dd, C_DC_REINIT_FROM_PEER_CNT, CNTR_INVALID_VL);
...
+	}
+	rsp->port_rcv_errors =
+		cpu_to_be64(hfi2_read_dev_cntr(dd, C_DC_RCV_ERR, CNTR_INVALID_VL));
+	rsp->excessive_buffer_overruns =
+		cpu_to_be64(hfi2_read_port_cntr(ppd, C_RCV_OVF, CNTR_INVALID_VL));
...
+			hfi2_read_dev_cntr(dd, C_DC_RX_PKT_VL, idx_from_vl(vl)));
+
+		rsp->vls[vfi].port_vl_xmit_data = cpu_to_be64(
+			hfi2_read_port_cntr(ppd, C_TX_FLIT_VL, idx_from_vl(vl)));
+
...
+			hfi2_read_dev_cntr(dd, C_DC_RCV_FCN_VL, idx_from_vl(vl)));
+
+		rsp->vls[vfi].port_vl_rcv_becn = cpu_to_be64(
+			hfi2_read_dev_cntr(dd, C_DC_RCV_BCN_VL, idx_from_vl(vl)));
+
...
+	error_counter_summary +=
+		(hfi2_read_dev_cntr(dd, C_DC_RX_REPLAY, CNTR_INVALID_VL) >> res_lli);
+	/* link error recovery must b right-shifted by the ler resolution */
+	tmp = hfi2_read_dev_cntr(dd, C_DC_SEQ_CRC_CNT, CNTR_INVALID_VL);
+	tmp += hfi2_read_dev_cntr(dd, C_DC_REINIT_FROM_PEER_CNT, CNTR_INVALID_VL);
...
+			hfi2_read_dev_cntr(dd, C_DC_RX_FLIT_VL, idx_from_vl(vl)));
+
+		rsp->vls[vfi].port_vl_xmit_pkts = cpu_to_be64(
+			hfi2_read_port_cntr(ppd, C_TX_PKT_VL, idx_from_vl(vl)));
+
...
+		hfi2_write_port_cntr(ppd, C_SW_RCV_CSTR_ERR, CNTR_INVALID_VL, 0);
+
...
+		hfi2_write_port_cntr(ppd, C_SW_XMIT_CSTR_ERR, CNTR_INVALID_VL, 0);
+
...
+		hfi2_write_dev_cntr(dd, C_DC_REINIT_FROM_PEER_CNT, CNTR_INVALID_VL,
+			       0);
+	}
+
...
+	for_each_set_bit(vl, &vl_select_mask, BITS_PER_LONG) {
+		if (counter_select & CS_PORT_XMIT_DATA)
+			hfi2_write_port_cntr(ppd, C_TX_FLIT_VL, idx_from_vl(vl), 0);
+
+		if (counter_select & CS_PORT_RCV_DATA)
+			hfi2_write_dev_cntr(dd, C_DC_RX_FLIT_VL, idx_from_vl(vl), 0);
+
+		if (counter_select & CS_PORT_XMIT_PKTS)
+			hfi2_write_port_cntr(ppd, C_TX_PKT_VL, idx_from_vl(vl), 0);
+
+		if (counter_select & CS_PORT_RCV_PKTS)
+			hfi2_write_dev_cntr(dd, C_DC_RX_PKT_VL, idx_from_vl(vl), 0);
+
+		if (counter_select & CS_PORT_XMIT_WAIT) {
+			hfi2_write_port_cntr(ppd, C_TX_WAIT_VL, idx_from_vl(vl), 0);
...
+		if (counter_select & CS_PORT_RCV_FECN)
+			hfi2_write_dev_cntr(dd, C_DC_RCV_FCN_VL, idx_from_vl(vl), 0);
+
+		if (counter_select & CS_PORT_RCV_BECN)
+			hfi2_write_dev_cntr(dd, C_DC_RCV_BCN_VL, idx_from_vl(vl), 0);
+
+		/* port_vl_xmit_time_cong is 0 for HFIs */
+		/* port_vl_xmit_wasted_bw ??? */
+		/* port_vl_xmit_wait_data - TXE (table 13-9 HFI spec) ??? */
+		if (counter_select & CS_PORT_RCV_BUBBLE)
+			hfi2_write_dev_cntr(dd, C_DC_RCV_BBL_VL, idx_from_vl(vl), 0);
+
+		/* if (counter_select & CS_PORT_MARK_FECN)
+		 *     hfi2_write_csr(dd, DCC_PRF_PORT_VL_MARK_FECN_CNT + offset, 0);
+		 */
+		if (counter_select & C_SW_XMIT_DSCD_VL)
+			hfi2_write_port_cntr(ppd, C_SW_XMIT_DSCD_VL, idx_from_vl(vl),
+					0);
+	}
+
+	if (resp_len)
...
+	((struct ib_header *)buf)->u.oth.u.ud.deth[1] = cpu_to_be32(2);
+
+	ret = hfi2_cport_send_req(dd, CH_OP_MAD_9B, sb, buf, size, &rsp, &rsp_len,
+			     to);
+	kfree(buf);
+	if (ret)
+		goto out;
...
+	 */
+	return hfi2_cport_process_mad(ibdev, mad_flags, port, in_wc, in_grh, in_mad,
