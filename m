...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 9073F2D4904
	for <lists+linux-rdma@lfdr.de>; Wed,  9 Dec 2020 19:30:23 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1733021AbgLIS3u (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Wed, 9 Dec 2020 13:29:50 -0500
Received: from mga17.intel.com ([192.55.52.151]:8604 "EHLO mga17.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1733106AbgLIS3t (ORCPT <rfc822;linux-rdma@vger.kernel.org>);
        Wed, 9 Dec 2020 13:29:49 -0500
IronPort-SDR: yu7mRfGRuQ5AH/JdMuGNtYcw9yo6FrCwIKOE2wWh+h5ucqSUE9xGC7Lf7TeAFS4AF7/QHSa+AO
 y/gWADQal2PA==
X-IronPort-AV: E=McAfee;i="6000,8403,9830"; a="153933178"
X-IronPort-AV: E=Sophos;i="5.78,405,1599548400"; 
   d="scan'208";a="153933178"
Received: from orsmga005.jf.intel.com ([10.7.209.41])
  by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 09 Dec 2020 10:29:06 -0800
IronPort-SDR: TWx5ye2Zq7uR4opl7lhARy1VJb5ifcjuvvJDWA5ak30dH0klUkzOS4W/c5jRa1O8x3GjHsUk4e
 k4/s/Wl60VqA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.78,405,1599548400"; 
   d="scan'208";a="552733480"
...
x-forefront-antispam-report: CIP:255.255.255.255;CTRY:;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:MW3PR11MB4555.namprd11.prod.outlook.com;PTR:;CAT:NONE;SFS:(4636009)(136003)(366004)(376002)(346002)(107886003)(9686003)(66446008)(64756008)(83380400001)(52536014)(86362001)(8676002)(4326008)(6506007)(33656002)(71200400001)(26005)(7696005)(66556008)(2906002)(5660300002)(8936002)(55016002)(186003)(53546011)(508600001)(6916009)(76116006)(66946007)(66476007)(54906003);DIR:OUT;SFP:1102;
...
X-MS-Exchange-CrossTenant-originalarrivaltime: 09 Dec 2020 18:29:00.9980
 (UTC)
...
> Subject: Re: [PATCH v14 4/4] RDMA/mlx5: Support dma-buf based userspace m=
emory region
>=20
> On Tue, Dec 08, 2020 at 02:39:15PM -0800, Jianxin Xiong wrote:
> > Implement the new driver method 'reg_user_mr_dmabuf'.  Utilize the
> > core functions to import dma-buf based memory region and update the map=
pings.
> >
...
>=20
> dma_resv_lock(umem_dmabuf->attach->dmabuf->resv, NULL); err =3D ib_umem_d=
mabuf_map_pages(umem_dmabuf);
> if (err) {
>       dma_resv_unlock(umem_dmabuf->attach->dmabuf->resv);
>       return err;
> }
