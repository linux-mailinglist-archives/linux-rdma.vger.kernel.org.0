...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 214BC5F2F1C
	for <lists+linux-rdma@lfdr.de>; Mon,  3 Oct 2022 12:52:52 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229759AbiJCKwt (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Mon, 3 Oct 2022 06:52:49 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:54796 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229864AbiJCKwd (ORCPT
        <rfc822;linux-rdma@vger.kernel.org>); Mon, 3 Oct 2022 06:52:33 -0400
Received: from mail-ej1-x631.google.com (mail-ej1-x631.google.com [IPv6:2a00:1450:4864:20::631])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 204645467C
        for <linux-rdma@vger.kernel.org>; Mon,  3 Oct 2022 03:52:23 -0700 (PDT)
Received: by mail-ej1-x631.google.com with SMTP id nb11so21253493ejc.5
        for <linux-rdma@vger.kernel.org>; Mon, 03 Oct 2022 03:52:23 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=resnulli-us.20210112.gappssmtp.com; s=20210112;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:from:to:cc:subject:date;
        bh=76BxYhW7XbjRSqXX6ubfdBTspkWYX6oWFgQLqqtkkVE=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=content-transfer-encoding:mime-version:references:in-reply-to
         ...
         :subject:date;
        bh=76BxYhW7XbjRSqXX6ubfdBTspkWYX6oWFgQLqqtkkVE=;
        b=
X-Gm-Message-State: ACrzQf1dTsElyqT7UybbU2Qmt+erWK7/NxQoOZOhNTOvZ1OEr6Nx1rd1
        pZqGeipYfQbWOFUUQPw1pMOZKg==
X-Google-Smtp-Source: AMsMyM7yGzMvk7CNRGUnmEVlKuLp757jJNuLedrmo7t5BTyzXIcRxHmW+AGcvjQo4V7fHxTYTY+5EA==
X-Received: by 2002:a17:907:1607:b0:788:799e:dc97 with SMTP id hb7-20020a170907160700b00788799edc97mr9397565ejc.747.1664794342050;
        Mon, 03 Oct 2022 03:52:22 -0700 (PDT)
Received: from localhost ([86.61.181.4])
        by smtp.gmail.com with ESMTPSA id x11-20020aa7d38b000000b00456e6e64047sm7123217edq.94.2022.10.03.03.52.20
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Mon, 03 Oct 2022 03:52:21 -0700 (PDT)
From:   Jiri Pirko <jiri@resnulli.us>
To:     netdev@vger.kernel.org
Cc:     davem@davemloft.net, kuba@kernel.org, pabeni@redhat.com,
        edumazet@google.com, tariqt@nvidia.com, moshe@nvidia.com,
        saeedm@nvidia.com, linux-rdma@vger.kernel.org
Subject: [patch net-next v2 12/13] net: remove unused ndo_get_devlink_port
Date:   Mon,  3 Oct 2022 12:52:03 +0200
Message-Id: <20221003105204.3315337-13-jiri@resnulli.us>
...
index 48987c4120e4..b08b4a81cd20 100644
--- a/drivers/net/ethernet/mellanox/mlx5/core/en_main.c
+++ b/drivers/net/ethernet/mellanox/mlx5/core/en_main.c
@@ -4833,7 +4833,6 @@ const struct net_device_ops mlx5e_netdev_ops = {
...
index bdb6a855ee98..856f40695d4a 100644
...
index bbb93be49063..637174e4219d 100644
