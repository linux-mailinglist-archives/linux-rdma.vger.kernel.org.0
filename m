...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 8C0D217F1D5
	for <lists+linux-rdma@lfdr.de>; Tue, 10 Mar 2020 09:23:04 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726220AbgCJIXD (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Tue, 10 Mar 2020 04:23:03 -0400
Received: from mail.kernel.org ([198.145.29.99]:44658 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1725919AbgCJIXD (ORCPT <rfc822;linux-rdma@vger.kernel.org>);
        Tue, 10 Mar 2020 04:23:03 -0400
Received: from localhost (unknown [193.47.165.251])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id 1E80224677;
        Tue, 10 Mar 2020 08:23:00 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1583828581;
        bh=hRsMMAB29RvBHLYslMpn/7ScjiUihzvnSB+X06BKYvQ=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=CHZZmmiz5bmG5ycGjIQWGcceIVXgX8dUl75LQauD22iIm42fD8FFvxORbzNJYQoQr
         HjiXa3En0FruvtH3QotawV2v/bLVTYTmqsEHomx0CVgt6T263sU9Be/nlfY+HvAMAT
         i+iR14F3tDw/8dt40vT3Ubq6onFkMpNaaoDClQLs=
From:   Leon Romanovsky <leon@kernel.org>
To:     Doug Ledford <dledford@redhat.com>,
        Jason Gunthorpe <jgg@mellanox.com>
Cc:     linux-rdma@vger.kernel.org
Subject: [PATCH rdma-next v1 06/12] RDMA/mlx5: Simplify how the MR cache bucket is located
Date:   Tue, 10 Mar 2020 10:22:32 +0200
Message-Id: <20200310082238.239865-7-leon@kernel.org>
...
index f70e6928f088..58369d38d627 100644
--- a/drivers/infiniband/hw/mlx5/mlx5_ib.h
+++ b/drivers/infiniband/hw/mlx5/mlx5_ib.h
@@ -622,8 +622,8 @@ struct mlx5_ib_mr {
 	struct ib_umem	       *umem;
...
@@ -1281,7 +1281,8 @@ int mlx5_ib_get_cqe_size(struct ib_cq *ibcq);
