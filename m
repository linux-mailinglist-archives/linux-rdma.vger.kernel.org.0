...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 4824124FBCF
	for <lists+linux-rdma@lfdr.de>; Mon, 24 Aug 2020 12:45:11 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726632AbgHXKpJ (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Mon, 24 Aug 2020 06:45:09 -0400
Received: from mail.kernel.org ([198.145.29.99]:35788 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726704AbgHXKpB (ORCPT <rfc822;linux-rdma@vger.kernel.org>);
        Mon, 24 Aug 2020 06:45:01 -0400
Received: from localhost (unknown [213.57.247.131])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id 1AF9B20738;
        Mon, 24 Aug 2020 10:44:59 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1598265900;
        bh=4TOjmkSOO9mE3zB4jOoOXgAKsKOAz2gbWDqzhQ2bOx4=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=EKrR7E0R9fLFuiCvsqnNtvW6OrwJYI072eTCxb0bZQNDGwPSZ8CATnGV5s5w7wOIj
         fTlShFBN5Ijt1G4kSGNy2VuOAtWv2csphBtAPympbgEOeGK3Dwww7fi885ELNcOS4u
         cKK0c0Vhgsl/07dbIKaXwSr5z64NHP5CvgPM9Rnc=
From:   Leon Romanovsky <leon@kernel.org>
To:     Doug Ledford <dledford@redhat.com>,
        Jason Gunthorpe <jgg@nvidia.com>
Cc:     Leon Romanovsky <leonro@mellanox.com>,
        Gal Pressman <galpress@amazon.com>, linux-rdma@vger.kernel.org
Subject: [PATCH rdma-next 08/14] RDMA/core: Allow drivers to disable restrack DB
Date:   Mon, 24 Aug 2020 13:44:09 +0300
Message-Id: <20200824104415.1090901-9-leon@kernel.org>
...
index 6d5dd6cd7315..52a1bd6ee45d 100644
...
+
 	...
 	if (WARN_ON(!dev))
 		return;
@@ -329,8 +336,9 @@ void rdma_restrack_del(struct rdma_restrack_entry *res)
...
index 74d3f4c39dc5..490dd87a9a6d 100644
