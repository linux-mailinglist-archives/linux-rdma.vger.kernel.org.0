...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 93E59702853
	for <lists+linux-rdma@lfdr.de>; Mon, 15 May 2023 11:22:50 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S238172AbjEOJWs (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Mon, 15 May 2023 05:22:48 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:56454 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S237674AbjEOJWU (ORCPT
        <rfc822;linux-rdma@vger.kernel.org>); Mon, 15 May 2023 05:22:20 -0400
Received: from mail-pf1-x42d.google.com (mail-pf1-x42d.google.com [IPv6:2607:f8b0:4864:20::42d])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 50C061BEF
        for <linux-rdma@vger.kernel.org>; Mon, 15 May 2023 02:18:42 -0700 (PDT)
Received: by mail-pf1-x42d.google.com with SMTP id d2e1a72fcca58-643557840e4so13540191b3a.2
        for <linux-rdma@vger.kernel.org>; Mon, 15 May 2023 02:18:42 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=broadcom.com; s=google; t=1684142322; x=1686734322;
        h=references:in-reply-to:message-id:date:subject:cc:to:from:from:to
         :cc:subject:date:message-id:reply-to;
        bh=0q9jSKQf9y3n1pk1XRVyLJRkZ1MjTuMNhcF3kbkwrN4=;
        b=GuEu1GMXvSRXCp+cBW2ew8OwEkEJGOBCHJLnIw6LQ7d+VufLGmHWvz4NgQ4RvUrNe8
         oue1woEjrZCVPpLTKQqJPNEKsFMgPcAiqNp5X0DPYOqpMgL+d1S4YbirhWp8/bIGh3lf
         HhZ/r0MR1/e0wCkIPoqI/YP8HyzPWN3ZV/G4s=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20221208; t=1684142322; x=1686734322;
        h=references:in-reply-to:message-id:date:subject:cc:to:from
         :x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=0q9jSKQf9y3n1pk1XRVyLJRkZ1MjTuMNhcF3kbkwrN4=;
        b=
X-Gm-Message-State: AC+VfDyHbmD/29R7gMf6JjCEA22xWdj2NytKlJrTr1pmGfh50Up0K9i3
        F1G+LBNxAcwxzN9bziBHozt37O4KEP05MyuNqXs=
X-Google-Smtp-Source: ACHHUZ7jQQrCsJB4D92xtUfaxODB+yHSG4fyoHtdi2gHMJbR1O8L15IPh+SddS+9UukBXSFJVrhz7A==
X-Received: by 2002:a05:6a20:1583:b0:105:f368:dfc4 with SMTP id h3-20020a056a20158300b00105f368dfc4mr4249661pzj.2.1684142321638;
        Mon, 15 May 2023 02:18:41 -0700 (PDT)
Received: from dhcp-10-192-206-197.iig.avagotech.net.net ([192.19.234.250])
        by smtp.gmail.com with ESMTPSA id q7-20020a654947000000b00520f316ebe3sm10402169pgs.62.2023.05.15.02.18.39
...
Subject: [PATCH v3 for-next 5/6] RDMA/bnxt_re: Reorg the bar mapping
Date:   Mon, 15 May 2023 02:06:49 -0700
Message-Id: <1684141610-17588-6-git-send-email-selvin.xavier@broadcom.com>
...
Content-Type: multipart/signed; protocol="application/pkcs7-signature"; micalg=sha-256;
        boundary="000000000000dbe7c305fbb7f0f6"
...
index f139d4c..8e1dc22 100644
--- a/drivers/infiniband/hw/bnxt_re/qplib_fp.c
+++ b/drivers/infiniband/hw/bnxt_re/qplib_fp.c
@@ -659,7 +659,7 @@ int bnxt_qplib_create_srq(struct bnxt_qplib_res *res,
...
+	srq->dbinfo.priv_db = res->dpi_tbl.priv_db;
 	...
 	srq->arm_req = false;
@@ -2103,7 +2103,7 @@ int bnxt_qplib_create_cq(struct bnxt_qplib_res *res, struct bnxt_qplib_cq *cq)
...

zdUFVygJ
--000000000000dbe7c305fbb7f0f6--
