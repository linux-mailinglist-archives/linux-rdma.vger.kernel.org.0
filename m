...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 83DDC2CB805
	for <lists+linux-rdma@lfdr.de>; Wed,  2 Dec 2020 10:03:29 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2387941AbgLBJC2 (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Wed, 2 Dec 2020 04:02:28 -0500
Received: from szxga07-in.huawei.com ([45.249.212.35]:8913 "EHLO
        szxga07-in.huawei.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S2387923AbgLBJC1 (ORCPT
        <rfc822;linux-rdma@vger.kernel.org>); Wed, 2 Dec 2020 04:02:27 -0500
Received: from DGGEMS407-HUB.china.huawei.com (unknown [172.30.72.60])
        by szxga07-in.huawei.com (SkyGuard) with ESMTP id 4CmCc91ngSz77C0;
        Wed,  2 Dec 2020 17:00:41 +0800 (CST)
Received: from localhost.localdomain (10.67.165.24) by
 DGGEMS407-HUB.china.huawei.com (10.3.19.207) with Microsoft SMTP Server id
 14.3.487.0; Wed, 2 Dec 2020 17:00:56 +0800
From:   Weihang Li <liweihang@huawei.com>
To:     <dledford@redhat.com>, <jgg@ziepe.ca>
CC:     <leon@kernel.org>, <linux-rdma@vger.kernel.org>,
        <linuxarm@huawei.com>
Subject: [PATCH for-next 09/11] RDMA/hns: Fix incorrect symbol types
Date:   Wed, 2 Dec 2020 16:59:11 +0800
Message-ID: <1606899553-54592-10-git-send-email-liweihang@huawei.com>
...
index 1981501..51d8499 100644
--- a/drivers/infiniband/hw/hns/hns_roce_device.h
+++ b/drivers/infiniband/hw/hns/hns_roce_device.h
@@ -322,7 +322,7 @@ struct hns_roce_hem_table {
 };
...
@@ -342,10 +342,10 @@ struct hns_roce_buf_attr {
...
@@ -356,7 +356,7 @@ struct hns_roce_hem_cfg {
...
+	u32		max_gs;
 	...
 	u32		head;
@@ -470,8 +470,8 @@ struct hns_roce_db {
 	} u;
 	dma_addr_t	dma;
 	void		*virt_addr;
-	int		index;
...
+	unsigned long	order;
 ...
 struct hns_roce_cq {
@@ -519,8 +519,8 @@ struct hns_roce_srq {
 	u64		       *wrid;
...
@@ -758,11 +758,11 @@ struct hns_roce_eq {
...
+	u32				cons_index;
 	...
 	int				over_ignore;
 	int				coalesce;
@@ -770,7 +770,7 @@ struct hns_roce_eq {
 	int				hop_num;
...
+	u32				eq_period;
 	...
 	int				event_type;
 	int				sub_type;
@@ -793,8 +793,8 @@ struct hns_roce_caps {
 	u32		max_sq_inline;
 	u32		max_rq_sg;
 	u32		max_extend_sg;
-	int		num_qps;
...
+	u32		reserved_qps;
 	...
 	int		num_cqc_timer;
 	int		num_srqs;
@@ -806,7 +806,7 @@ struct hns_roce_caps {
 	u32		max_srq_desc_sz;
...
+	u32		num_cqs;
 	...
 	u32		min_cqes;
 	u32		min_wqes;
@@ -815,7 +815,7 @@ struct hns_roce_caps {
 	int		num_aeq_vectors;
...
@@ -1107,15 +1107,16 @@ static inline struct hns_roce_qp
...
+	unsigned int offset = idx << buf->page_shift;
 	...
 	return buf->trunk_list[offset >> buf->trunk_shift].map +
 			(offset & ((1 << buf->trunk_shift) - 1));
@@ -1182,7 +1183,7 @@ int hns_roce_mtr_create(struct hns_roce_dev *hr_dev, struct hns_roce_mtr *mtr,
...
@@ -1265,10 +1266,10 @@ struct ib_qp *hns_roce_create_qp(struct ib_pd *ib_pd,
...
@@ -1298,7 +1299,7 @@ void hns_roce_cq_completion(struct hns_roce_dev *hr_dev, u32 cqn);
...
index 8281616..c2030ab 100644
--- a/drivers/infiniband/hw/hns/hns_roce_hw_v2.c
+++ b/drivers/infiniband/hw/hns/hns_roce_hw_v2.c
@@ -657,7 +657,7 @@ static int hns_roce_v2_post_send(struct ib_qp *ibqp,
...
@@ -835,7 +835,7 @@ static void *get_srq_wqe(struct hns_roce_srq *srq, int n)
...
@@ -876,12 +876,12 @@ static int hns_roce_v2_post_srq_recv(struct ib_srq *ibsrq,
...
@@ -1126,7 +1126,7 @@ static void hns_roce_cmq_init_regs(struct hns_roce_dev *hr_dev, bool ring_type)
...
@@ -1134,7 +1134,7 @@ static void hns_roce_cmq_init_regs(struct hns_roce_dev *hr_dev, bool ring_type)
...
@@ -1920,8 +1920,8 @@ static void set_default_caps(struct hns_roce_dev *hr_dev)
 	}
 }
...
@@ -2400,10 +2400,10 @@ static int hns_roce_init_link_table(struct hns_roce_dev *hr_dev,
 	u32 buf_chk_sz;
 	dma_addr_t t;
 	int func_num = 1;
-	int pg_num_a;
...
+	u32 size;
 	...
 	switch (type) {
@@ -2599,7 +2599,7 @@ static int hns_roce_query_mbox_status(struct hns_roce_dev *hr_dev)
...
@@ -2670,7 +2670,7 @@ static int hns_roce_v2_post_mbox(struct hns_roce_dev *hr_dev, u64 in_param,
 }
...
+				unsigned int timeout)
 {
 	struct device *dev = hr_dev->dev;
 	unsigned long end;
@@ -3068,7 +3068,7 @@ static void *get_cqe_v2(struct hns_roce_cq *hr_cq, int n)
...
@@ -3415,7 +3415,7 @@ static int hns_roce_v2_poll_one(struct hns_roce_cq *hr_cq,
 	int is_send;
 	u16 wqe_ctr;
 	u32 opcode;
-	int qpn;
...
index 5c43089..00544f2 100644
--- a/drivers/infiniband/hw/hns/hns_roce_mr.c
+++ b/drivers/infiniband/hw/hns/hns_roce_mr.c
@@ -509,7 +509,7 @@ int hns_roce_map_mr_sg(struct ib_mr *ibmr, struct scatterlist *sg, int sg_nents,
...
@@ -828,12 +828,12 @@ static int mtr_get_pages(struct hns_roce_dev *hr_dev, struct hns_roce_mtr *mtr,
 }
...
@@ -870,13 +870,12 @@ int hns_roce_mtr_find(struct hns_roce_dev *hr_dev, struct hns_roce_mtr *mtr,
...
index b59f3e0..77b8a6e 100644
--- a/drivers/infiniband/hw/hns/hns_roce_qp.c
+++ b/drivers/infiniband/hw/hns/hns_roce_qp.c
@@ -1323,22 +1323,22 @@ static inline void *get_wqe(struct hns_roce_qp *hr_qp, int offset)
