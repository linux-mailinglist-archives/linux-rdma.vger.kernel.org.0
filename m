Return-Path: <linux-rdma+bounces-16269-lists+linux-rdma=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-rdma@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id oE1HKqDifGmpPAIAu9opvQ
	(envelope-from <linux-rdma+bounces-16269-lists+linux-rdma=lfdr.de@vger.kernel.org>)
	for <lists+linux-rdma@lfdr.de>; Fri, 30 Jan 2026 17:56:00 +0100
X-Original-To: lists+linux-rdma@lfdr.de
Received: from sin.lore.kernel.org (sin.lore.kernel.org [IPv6:2600:3c15:e001:75::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id 8CB95BCB5B
	for <lists+linux-rdma@lfdr.de>; Fri, 30 Jan 2026 17:55:59 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sin.lore.kernel.org (Postfix) with ESMTP id D8418300B292
	for <lists+linux-rdma@lfdr.de>; Fri, 30 Jan 2026 16:55:19 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id B29AF356A3B;
	Fri, 30 Jan 2026 16:54:53 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="DvYBH6UH"
X-Original-To: linux-rdma@vger.kernel.org
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id EFE0435BDB1
	for <linux-rdma@vger.kernel.org>; Fri, 30 Jan 2026 16:54:49 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.133.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1769792093; cv=none; b=i7wAmUSDf+8RknnTfhhORZdjjij544scCpPV6MTU8dHOO1JbDUay64kK4jpr71V53qVeKRoPSVqPq2I6Dp5xxuFnw8g5EB/UNy7dRXqdta6ulqQ1+FlYWv7aUfoDgpS/DzyxgWbuXWsL1B2l2dAUHcZiM9cu42AkWlSH2VsRZ3Q=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1769792093; c=relaxed/simple;
	bh=Tz26+iviOmObM5wvehUDVbtFVup/rDTzGsJ5Scteofg=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=M9m9KKrF3FAoxRoSKBA8mAtq9qFBz0n0roIFqF/TYpxF4vrZflvIENBzWuRSClK+3WLdHnLXkdZsEo6gFImDD4DFf/6XzWaNZyYThtUFG1qSp8B6WN9Bc7Z4QWAl4ODPUSbCPw4Msdu4uf3h6I1zvxkDEAbgfQI6PQNxfUWor6I=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=DvYBH6UH; arc=none smtp.client-ip=170.10.133.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1769792089;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=0MTVI+PXLyTxVzBO+pYM7uoUoIjNDNNTwd47snz1ctU=;
	b=DvYBH6UHKWvVoNy7I/XQntpWU7tuylKzqtmrXsdrzdbZ2bLW72bq6anAWegDB4MPpusAXR
	YlwHzNe1WfiL11Lywc7Yx3QVGBBzbSsISaCPr5737/HsAwaQz+6amC46G+Vzkk+wUqVDdw
	uJTu9bbCMt8Sz78Hqfv1P/DwbAAcbNk=
Received: from mx-prod-mc-08.mail-002.prod.us-west-2.aws.redhat.com
 (ec2-35-165-154-97.us-west-2.compute.amazonaws.com [35.165.154.97]) by
 relay.mimecast.com with ESMTP with STARTTLS (version=TLSv1.3,
 cipher=TLS_AES_256_GCM_SHA384) id us-mta-368-4Xbwgd1CMM6hj6nBgNCKYg-1; Fri,
 30 Jan 2026 11:54:46 -0500
X-MC-Unique: 4Xbwgd1CMM6hj6nBgNCKYg-1
X-Mimecast-MFC-AGG-ID: 4Xbwgd1CMM6hj6nBgNCKYg_1769792083
Received: from mx-prod-int-08.mail-002.prod.us-west-2.aws.redhat.com (mx-prod-int-08.mail-002.prod.us-west-2.aws.redhat.com [10.30.177.111])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by mx-prod-mc-08.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTPS id C23E7180045C;
	Fri, 30 Jan 2026 16:54:43 +0000 (UTC)
Received: from p16v.redhat.com (unknown [10.45.226.27])
	by mx-prod-int-08.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTP id 78E5B1800109;
	Fri, 30 Jan 2026 16:54:37 +0000 (UTC)
...
Subject: [PATCH net-next v3 9/9] ice: dpll: Support E825-C SyncE and dynamic pin discovery
Date: Fri, 30 Jan 2026 17:53:38 +0100
Message-ID: <20260130165338.101860-10-ivecera@redhat.com>
...
X-Spamd-Result: default: False [0.84 / 15.00];
	...
	MIME_TRACE(0.00)[0:+];
	TAGGED_FROM(0.00)[bounces-16269-lists,linux-rdma=lfdr.de];
...
1. Discovery Mechanism: The driver parses the 'dpll-pins' and
   'dpll-pin-names' firmware properties to identify the external DPLL
   pins (parents) corresponding to its RCLK outputs ("rclk0", "rclk1").
   It uses fwnode_dpll_pin_find() to locate these parent pins in the DPLL
   core.
...
index 17d92ba65128a..15eef34d9f53c 100644
--- a/drivers/net/ethernet/intel/ice/ice_lib.c
+++ b/drivers/net/ethernet/intel/ice/ice_lib.c
@@ -3987,6 +3987,9 @@ void ice_init_feature_support(struct ice_pf *pf)
 		break;
 	}
