...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 0A909256D47
	for <lists+linux-rdma@lfdr.de>; Sun, 30 Aug 2020 12:15:05 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728762AbgH3KPD (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Sun, 30 Aug 2020 06:15:03 -0400
Received: from mail.kernel.org ([198.145.29.99]:49448 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1728766AbgH3KO7 (ORCPT <rfc822;linux-rdma@vger.kernel.org>);
        Sun, 30 Aug 2020 06:14:59 -0400
Received: from localhost (unknown [213.57.247.131])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id A82C12071B;
        Sun, 30 Aug 2020 10:14:58 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1598782499;
        bh=AZO7R3OpxmNDDrUIzRlV03WiowTy0IaafRqYCLaXb+0=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=C3AYZ6oUNsCWRbdLRm0gDtYH/W7Rcti9GZ6MGS7pj9Omg/idx4Nyp6PKpyNd0+BD6
         aJD2J8VoMJyPLTGEzEPdlQeYM8QjXIqrGoWFHfTNjSnRO7B2L52tQo/RW3+CRaxzXt
         VLvJ9gLAdxQPkthCYU1X+2o4HECva3rYnP6C3urA=
From:   Leon Romanovsky <leon@kernel.org>
To:     Doug Ledford <dledford@redhat.com>,
        Jason Gunthorpe <jgg@nvidia.com>
Cc:     Leon Romanovsky <leonro@mellanox.com>, linux-rdma@vger.kernel.org
Subject: [PATCH rdma-next v1 06/13] RDMA/cma: Be strict with attaching to CMA device
Date:   Sun, 30 Aug 2020 13:14:29 +0300
Message-Id: <20200830101436.108487-7-leon@kernel.org>
...
index 16444d74ad64..6f9d06ed444d 100644
...
+		goto out;
 ...
 out:
 	mutex_unlock(&lock);
@@ -4728,69 +4747,6 @@ static struct notifier_block cma_nb = {
...
@@ -4853,6 +4809,81 @@ static void cma_process_remove(struct cma_device *cma_dev)
