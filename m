...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 8384D274F9C
	for <lists+linux-rdma@lfdr.de>; Wed, 23 Sep 2020 05:40:24 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726703AbgIWDkX (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Tue, 22 Sep 2020 23:40:23 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:46596 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726448AbgIWDkX (ORCPT
        <rfc822;linux-rdma@vger.kernel.org>); Tue, 22 Sep 2020 23:40:23 -0400
Received: from mail-oi1-x242.google.com (mail-oi1-x242.google.com [IPv6:2607:f8b0:4864:20::242])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id EB4E0C061755
        for <linux-rdma@vger.kernel.org>; Tue, 22 Sep 2020 20:40:22 -0700 (PDT)
Received: by mail-oi1-x242.google.com with SMTP id 185so23488899oie.11
        for <linux-rdma@vger.kernel.org>; Tue, 22 Sep 2020 20:40:22 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=mime-version:references:in-reply-to:from:date:message-id:subject:to
         :cc;
        bh=xy2rnWpFda2mcoQAcM7ZVxos71pAB3XBqBKTz1AfSso=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=xy2rnWpFda2mcoQAcM7ZVxos71pAB3XBqBKTz1AfSso=;
        b=
X-Gm-Message-State: AOAM530k66v6/V+7yB413H6XaYzotOBrqXa9SX1VrooTJFnj37cu6yAo
        VJptZejecm+DwPvnujnpcEFYscuzqSCZZPFl8fM=
X-Google-Smtp-Source: ABdhPJyNRB+p56lRwNNmaWDxsUbDma/FxF3PKc0HfYPrPSenfGODT8JAVPoNKe08yE16kkS2usjHl07ZCMsN8yjTjNc=
X-Received: by 2002:aca:da8b:: with SMTP id r133mr4532537oig.163.1600832422053;
 Tue, 22 Sep 2020 20:40:22 -0700 (PDT)
MIME-Version: 1.0
References: <20200921200356.8627-1-rpearson@hpe.com> <20200921200356.8627-6-rpearson@hpe.com>
 <56fdbeff-6965-2c8d-3dee-0630934b213a@gmail.com> <ab5e7568-b2d7-d25d-543a-e19885310785@gmail.com>
In-Reply-To: <ab5e7568-b2d7-d25d-543a-e19885310785@gmail.com>
From:   Zhu Yanjun <zyjzyj2000@gmail.com>
Date:   Wed, 23 Sep 2020 11:40:09 +0800
Message-ID: <CAD=hENcTRf5L7OxYKcJHQCpkeGNPWJ1yXaj1sbQsiBj5CpgQJg@mail.gmail.com>
Subject: Re: [PATCH for-next v6 05/12] rdma_rxe: Add bind_mw and invalidate_mw verbs
...
On Wed, Sep 23, 2020 at 10:51 AM Bob Pearson <rpearsonhpe@gmail.com> wrote:
>
> On 9/22/20 9:25 PM, Zhu Yanjun wrote:
...
> >>   drivers/infiniband/sw/rxe/rxe_req.c    | 126 ++++++++---
...
> >> index 65f2e4a94956..1ee6270d3f2a 100644
...
> >> @@ -117,6 +119,10 @@ int rxe_dealloc_mw(struct ib_mw *ibmw);
...
> >> index 4c53badfa4e9..3f7c9b84f99b 100644
> >> --- a/drivers/infiniband/sw/rxe/rxe_mr.c
> >> +++ b/drivers/infiniband/sw/rxe/rxe_mr.c
> >> @@ -538,12 +538,23 @@ struct rxe_mr *lookup_mr(struct rxe_pd *pd, int access, u32 key,
> >>       return mr;
> >>   }
> >>   +int rxe_invalidate_mr(struct rxe_qp *qp, struct rxe_mr *mr)
> >> +{
> >
> > In this function, where is the qp used?
> >
...
> >> index 682f30bb3495..1944d2bbc43b 100644
...
> >
> >
> > here, is ret necessary? is qp necessary?
> >
> >
> >> +        rxe_drop_ref(mr);
> >> +    }
...
> >> index 885b5bf6dc2e..4d688a50d301 100644
...
> >
>
> Currently there are a bunch of places where the mr code is weak in checking the rules.
> Because the focus of this project was to implement memory windows and not fix all the mr
> issues I made minimal functional changes to the mr code. In this particular case
> I just set the mr state to free as before these patches. However, I am working now on cleaning
> up and extending the mr implementation and I expect this to require both qp and a return value since
> the invalidate_mr code can absolutely fail.

Thanks a lot for your explanations. IMO, you should also add the above
to the comments of this function. Or else others will also have the
same suspects about this function.
