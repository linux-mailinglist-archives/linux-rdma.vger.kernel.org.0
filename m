...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id C2135164BF
	for <lists+linux-rdma@lfdr.de>; Tue,  7 May 2019 15:39:06 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726648AbfEGNiz (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Tue, 7 May 2019 09:38:55 -0400
Received: from mail-il-dmz.mellanox.com ([193.47.165.129]:40381 "EHLO
        mellanox.co.il" rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org
        with ESMTP id S1726509AbfEGNiy (ORCPT
        <rfc822;linux-rdma@vger.kernel.org>); Tue, 7 May 2019 09:38:54 -0400
Received: from Internal Mail-Server by MTLPINE2 (envelope-from maxg@mellanox.com)
        with ESMTPS (AES256-SHA encrypted); 7 May 2019 16:38:40 +0300
Received: from r-vnc08.mtr.labs.mlnx (r-vnc08.mtr.labs.mlnx [10.208.0.121])
        by labmailer.mlnx (8.13.8/8.13.8) with ESMTP id x47DcdFA021865;
...
Subject: [PATCH 10/25] RDMA/mlx5: Introduce and implement new IB_WR_REG_MR_INTEGRITY work request
Date:   Tue,  7 May 2019 16:38:24 +0300
Message-Id: <1557236319-9986-11-git-send-email-maxg@mellanox.com>
...
index a44d5b32492c..3fb0019c2aca 100644
--- a/drivers/infiniband/hw/mlx5/qp.c
+++ b/drivers/infiniband/hw/mlx5/qp.c
@@ -4091,7 +4091,7 @@ static __be64 sig_mkey_mask(void)
...
@@ -4222,7 +4222,7 @@ static void set_reg_mkey_seg(struct mlx5_mkey_seg *seg,
...
@@ -4273,7 +4273,7 @@ static void set_reg_data_seg(struct mlx5_wqe_data_seg *dseg,
 			     struct mlx5_ib_mr *mr,
...
@@ -4466,23 +4466,52 @@ static int mlx5_set_bsf(struct ib_mr *sig_mr,
 	return 0;
 }
...
@@ -4516,8 +4545,6 @@ static int set_sig_data_segment(const struct ib_sig_handover_wr *wr,
...
@@ -4595,6 +4622,56 @@ static void set_sig_umr_segment(struct mlx5_wqe_umr_ctrl_seg *umr,
...
+}
 ...
 static int set_sig_umr_wr(const struct ib_send_wr *send_wr,
 			  struct mlx5_ib_qp *qp, void **seg, int *size,
@@ -4638,7 +4715,8 @@ static int set_sig_umr_wr(const struct ib_send_wr *send_wr,
 	*size += sizeof(struct mlx5_mkey_seg) / 16;
 	handle_post_send_edge(&qp->sq, seg, *size, cur_edge);
...
@@ -4680,7 +4758,7 @@ static int set_reg_wr(struct mlx5_ib_qp *qp,
 {
...
@@ -4822,8 +4900,11 @@ static int _mlx5_ib_post_send(struct ib_qp *ibqp, const struct ib_send_wr *wr,
...
+	struct ib_sig_attrs *sig_attrs;
 	...
 	struct mlx5_bf *bf;
 	void *cur_edge;
@@ -4877,7 +4958,8 @@ static int _mlx5_ib_post_send(struct ib_qp *ibqp, const struct ib_send_wr *wr,
 			goto out;
 		}
...
@@ -4935,6 +5017,102 @@ static int _mlx5_ib_post_send(struct ib_qp *ibqp, const struct ib_send_wr *wr,
 				num_sge = 0;
 				break;
...
index 0343c81d4c5f..6c0da790173e 100644
...
index ee18ff26dc1a..8e15d8d3f9f4 100644
--- a/include/rdma/ib_verbs.h
+++ b/include/rdma/ib_verbs.h
@@ -1213,6 +1213,7 @@ enum ib_wr_opcode {
