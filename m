...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 80DA26394CC
	for <lists+linux-rdma@lfdr.de>; Sat, 26 Nov 2022 10:03:59 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229475AbiKZJDz (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Sat, 26 Nov 2022 04:03:55 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:33558 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229450AbiKZJDy (ORCPT
        <rfc822;linux-rdma@vger.kernel.org>); Sat, 26 Nov 2022 04:03:54 -0500
Received: from out30-43.freemail.mail.aliyun.com (out30-43.freemail.mail.aliyun.com [115.124.30.43])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 317BD2A42C;
        Sat, 26 Nov 2022 01:03:51 -0800 (PST)
X-Alimail-AntiSpam: AC=PASS;BC=-1|-1;BR=01201311R161e4;CH=green;DM=||false|;DS=||;FP=0|-1|-1|-1|0|-1|-1|-1;HT=ay29a033018045192;MF=alibuda@linux.alibaba.com;NM=1;PH=DS;RN=8;SR=0;TI=SMTPD_---0VViBjRC_1669453422;
Received: from j66a10360.sqa.eu95.tbsite.net(mailfrom:alibuda@linux.alibaba.com fp:SMTPD_---0VViBjRC_1669453422)
          by smtp.aliyun-inc.com;
          Sat, 26 Nov 2022 17:03:48 +0800
From:   "D.Wythe" <alibuda@linux.alibaba.com>
To:     kgraul@linux.ibm.com, wenjia@linux.ibm.com, jaka@linux.ibm.com
Cc:     kuba@kernel.org, davem@davemloft.net, netdev@vger.kernel.org,
        linux-s390@vger.kernel.org, linux-rdma@vger.kernel.org
Subject: [PATCH net-next v6 0/7] optimize the parallelism of SMC-R connections
Date:   Sat, 26 Nov 2022 17:03:35 +0800
Message-Id: <1669453422-38152-1-git-send-email-alibuda@linux.alibaba.com>
...
2. Merge patch 'fix SMC_CLC_DECL_ERR_REGRMB without smc_server_lgr_pending' with
patch 'remove locks smc_client_lgr_pending and smc_server_lgr_pending'
3. Format code styles, including alignment and reverse christmas tree style.
...
D. Wythe (7):
 ...
 net/smc/af_smc.c   |  75 ++++----
 net/smc/smc_core.c | 525 ++++++++++++++++++++++++++++++++++++++++++++++++-----
 net/smc/smc_core.h |  53 +++++-
 net/smc/smc_llc.c  | 297 ++++++++++++++++++++++--------
 net/smc/smc_llc.h  |   6 +
 net/smc/smc_wr.c   |  10 -
 net/smc/smc_wr.h   |  10 +
 7 files changed, 806 insertions(+), 170 deletions(-)
