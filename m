Return-Path: <linux-rdma+bounces-22527-lists+linux-rdma=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-rdma@lfdr.de
Received: from mail.lfdr.de
	by mail.lfdr.de with LMTP
	id FCF0Lbz5P2qjawkAu9opvQ
	(envelope-from <linux-rdma+bounces-22527-lists+linux-rdma=lfdr.de@vger.kernel.org>)
	for <lists+linux-rdma@lfdr.de>; Sat, 27 Jun 2026 18:26:36 +0200
X-Original-To: lists+linux-rdma@lfdr.de
Received: from tor.lore.kernel.org (tor.lore.kernel.org [IPv6:2600:3c04:e001:36c::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id C68DB6D242E
	for <lists+linux-rdma@lfdr.de>; Sat, 27 Jun 2026 18:26:35 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=pass header.d=cornelisnetworks.com header.s=selector1 header.b=bkSfBAJD;
	spf=pass (mail.lfdr.de: domain of "linux-rdma+bounces-22527-lists+linux-rdma=lfdr.de@vger.kernel.org" designates 2600:3c04:e001:36c::12fc:5321 as permitted sender) smtp.mailfrom="linux-rdma+bounces-22527-lists+linux-rdma=lfdr.de@vger.kernel.org";
	dmarc=pass (policy=none) header.from=cornelisnetworks.com;
	arc=reject ("cv is fail on i=2")
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by tor.lore.kernel.org (Postfix) with ESMTP id 6F5403019FEC
	for <lists+linux-rdma@lfdr.de>; Sat, 27 Jun 2026 16:26:28 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 045262EBB9E;
	Sat, 27 Jun 2026 16:26:28 +0000 (UTC)
...
Received: from SJ2PR03CU001.outbound.protection.outlook.com (mail-westusazon11022074.outbound.protection.outlook.com [52.101.43.74])
	...
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 0401C2EEE91
	for <linux-rdma@vger.kernel.org>; Sat, 27 Jun 2026 16:26:20 +0000 (UTC)
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1782577587; cv=fail; b=JyndvryPoz3/TF+w2z8PpDCUkYx0V0TRdhtMHnHQswMxBLT5wtck0Yuipn3IDTlIwcvKL2Jj9XZcWSViG/d8tqRuUSfg+rKc0K04hDOlEvoroK40jONuiBs4BB9yTW6PT52bH5GTJMrP+GDrL9mTwxD0UMl6VarQ/CVDPNcfuPI=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1782577587; c=relaxed/simple;
	bh=p0qTP2UgDCBgneYenSajn4Qe3RYkAOl8oxDBMlIJ0VY=;
	h=Subject:From:To:Cc:Date:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=qe+XmKXlvTsG6gFS7Z6QKNs2ciiqE9YLLvyQJy3On9Cw6hCJmKe+jhJzSMOyeAdds0hRnwLT9pUxw+TcsXogiA5CrPcubBH6TDXOBde+FFLcQYVCE75n4KQMklPlrGd/9M7xEhj9N5LALTCiczDIy+vFAI9VwSKrAECtwq5PClU=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=cornelisnetworks.com; spf=pass smtp.mailfrom=cornelisnetworks.com; dkim=pass (2048-bit key) header.d=cornelisnetworks.com header.i=@cornelisnetworks.com header.b=bkSfBAJD; arc=fail smtp.client-ip=52.101.43.74
ARC-Seal: i=1; a=rsa-sha256; s=arcselector10001; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com;
 s=arcselector10001;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-AntiSpam-MessageData-ChunkCount:X-MS-Exchange-AntiSpam-MessageData-0:X-MS-Exchange-AntiSpam-MessageData-1;
 bh=aLftJ1wZeOX/CPhz6iLptG2ts6JWV/DDmo6Fsz8Pd6o=;
 b=
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=cornelisnetworks.com;
 ...
 bh=aLftJ1wZeOX/CPhz6iLptG2ts6JWV/DDmo6Fsz8Pd6o=;
 b=
Received: from CH0PR08CA0004.namprd08.prod.outlook.com (2603:10b6:610:33::9)
 by LV9PR01MB994200.prod.exchangelabs.com (2603:10b6:408:377::18) with
 Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id 15.21.139.18; Sat, 27 Jun
 2026 16:26:16 +0000
Received: from CH2PEPF00000142.namprd02.prod.outlook.com
 (2603:10b6:610:33:cafe::a0) by CH0PR08CA0004.outlook.office365.com
...
Received: from cn-mailer-00.localdomain (208.255.156.42) by
 ...
 via Frontend Transport; Sat, 27 Jun 2026 16:26:15 +0000
Received: from awdrv-04.localdomain (unknown [10.228.212.218])
	by cn-mailer-00.localdomain (Postfix) with ESMTPS id 6330C146565;
	Sat, 27 Jun 2026 12:26:15 -0400 (EDT)
Received: from [10.228.212.218] (localhost [IPv6:::1])
	by awdrv-04.localdomain (Postfix) with ESMTP id 5DC701810D6C7;
	Sat, 27 Jun 2026 12:26:15 -0400 (EDT)
Subject: [PATCH v2 for-next 16/24] RDMA/hfi2: Implement data moving
 infrastructure
...
Date: Sat, 27 Jun 2026 12:26:15 -0400
Message-ID: <178257757533.371918.17031218552475130441.stgit@awdrv-04>
...
X-MS-TrafficTypeDiagnostic: CH2PEPF00000142:EE_|LV9PR01MB994200:EE_
X-MS-Office365-Filtering-Correlation-Id: ff93d98f-fa91-47d4-89b1-08ded468cf93
X-MS-Exchange-AtpMessageProperties: SA
X-MS-Exchange-SenderADCheck: 1
X-MS-Exchange-AntiSpam-Relay: 0
X-Microsoft-Antispam:
	BCL:0;ARA:13230040|23010399003|1800799024|376014|36860700016|82310400026|6133799003|18002099003|22082099003|3023799007|56012099006|5023799004|55112099003;
X-Microsoft-Antispam-Message-Info:
	
X-Forefront-Antispam-Report:
	CIP:208.255.156.42;CTRY:US;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:cn-mailer-00.localdomain;PTR:InfoDomainNonexistent;CAT:NONE;SFS:(13230040)(23010399003)(1800799024)(376014)(36860700016)(82310400026)(6133799003)(18002099003)(22082099003)(3023799007)(56012099006)(5023799004)(55112099003);DIR:OUT;SFP:1102;
X-MS-Exchange-AntiSpam-MessageData-ChunkCount: 1
X-MS-Exchange-AntiSpam-MessageData-0:
	
X-OriginatorOrg: cornelisnetworks.com
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 27 Jun 2026 16:26:15.6558
 (UTC)
X-MS-Exchange-CrossTenant-Network-Message-Id: ff93d98f-fa91-47d4-89b1-08ded468cf93
...
X-MS-Exchange-Transport-CrossTenantHeadersStamped: LV9PR01MB994200
...
X-Spamd-Result: default: False [0.34 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	TO_DN_SOME(0.00)[];
	TAGGED_FROM(0.00)[bounces-22527-lists,linux-rdma=lfdr.de];
	RCVD_TLS_LAST(0.00)[];
	MIME_TRACE(0.00)[0:+];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[vger.kernel.org:from_smtp,cornelisnetworks.com:dkim,cornelisnetworks.com:email,cornelisnetworks.com:from_mime,tor.lore.kernel.org:rdns,tor.lore.kernel.org:helo,awdrv-04:mid,kdeth.sh:url,kdeth.om:url,evict_data.target:url];
...
---
  Changes since v2:
    - Fix kernel-doc: add function name line, @param tags, and Return: sections to
      hfi2_user_sdma_add_ref and hfi2_user_sdma_mru_ref
    - Fix kernel-doc: add function name line and @node param to hfi2_user_exp_rcv_invalidate
  Changes since v1:
    - Address Leon's feedback (Re: v1 patch 08, Mar 18 2026): drop
      aspm.h include and aspm_disable_all/enable_all calls in
      file_ops.c. ASPM is managed at the PCIe core layer
      (pcie_aspm= cmdline).
    - Address Leon's feedback (Re: v1 patch 07, Mar 17 2026): drop
      hfi2_get_proc_affinity() / hfi2_put_proc_affinity() calls and
      the rec_cpu_num field in struct hfi2_filedata.  Allocate user
      context memory on the device's NUMA node (dd->node) instead of
      a CPU-derived NUMA node.  Per-process CPU affinity is left to
      user space (sched_setaffinity, taskset).  Drop the now-unused
      static helper any_user_allocated_contexts() that previously
      gated ASPM enable/disable.
---
 drivers/infiniband/hw/hfi2/file_ops.c     | 1255 ++++++++++++++++++++++
 ...
 7 files changed, 5132 insertions(+)
...
index 000000000000..32490d5958de
--- /dev/null
...
new file mode 100644
index 000000000000..949f12e6406a
--- /dev/null
...
new file mode 100644
index 000000000000..aa7023a8d99e
--- /dev/null
...
new file mode 100644
index 000000000000..8d0f065047cc
--- /dev/null
...
+
+	ret = hfi2_tid_user_buf_init(expected_count, vaddr, length, notify, &sys_bufops,
...
+{
+	return hfi2_register_tid_ops(HFI2_MEMINFO_TYPE_SYSTEM, &sys_bufops, &sys_nodeops);
+}
+
+void hfi2_deregister_system_tid_ops(void)
+{
+	hfi2_deregister_tid_ops(HFI2_MEMINFO_TYPE_SYSTEM);
+}
diff --git a/drivers/infiniband/hw/hfi2/user_exp_rcv.c b/drivers/infiniband/hw/hfi2/user_exp_rcv.c
new file mode 100644
index 000000000000..1f1d91132d58
--- /dev/null
...
+}
+
+int hfi2_tid_user_buf_init(u16 pset_size, unsigned long vaddr, unsigned long length,
...
new file mode 100644
index 000000000000..3c781327e7d4
--- /dev/null
...
new file mode 100644
index 000000000000..4ac6ff91b6e5
--- /dev/null
