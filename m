...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 54EA91DAB73
	for <lists+linux-rdma@lfdr.de>; Wed, 20 May 2020 09:06:37 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726999AbgETHEa (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Wed, 20 May 2020 03:04:30 -0400
Received: from mga12.intel.com ([192.55.52.136]:50891 "EHLO mga12.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726861AbgETHE3 (ORCPT <rfc822;linux-rdma@vger.kernel.org>);
        Wed, 20 May 2020 03:04:29 -0400
IronPort-SDR: b/VHa6RDWsJlwsk4b3wBrPhWg6dFzBVMqf8uYsOb6T8mmWahXXM1yUokhllCm6M7+ilktsD+S/
 BVWbOGsrmkzQ==
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga003.jf.intel.com ([10.7.209.27])
  by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 20 May 2020 00:04:17 -0700
IronPort-SDR: 16e35T3zhOovTMWAczIhMr5p1NqmZr8XBjOCzsxSzPEzifi8wJlnnUBDTHiFtItBEAFQ0XXuYO
 Ukz1YLv1ooVA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.73,413,1583222400"; 
   d="scan'208";a="264581216"
...
Subject: [RDMA RFC v6 02/16] RDMA/irdma: Implement device initialization definitions
Date:   Wed, 20 May 2020 00:04:01 -0700
Message-Id: <20200520070415.3392210-3-jeffrey.t.kirsher@intel.com>
...
---
 ...
 5 files changed, 3219 insertions(+)
...
index 000000000000..ae5deabff784
--- /dev/null
...
+
+		aeqcnt++;
+		irdma_dbg(dev, "AEQ: ae_id = 0x%x bool qp=%d qp_id = %d\n",
...
+	status = irdma_handle_cqp_op(iwdev->rf, cqp_request);
+	if (status) {
+		irdma_dbg(dev, "ERR: CQP-OP Manage Qhash Entry fail");
+		if (cm_node && !wait)
+			irdma_rem_ref_cm_node(cm_node);
+	}
+
...
+	status = irdma_handle_cqp_op(rf, cqp_request);
+	if (status) {
+		irdma_dbg(&rf->sc_dev, "ERR: CQP-OP Flush WQE's fail");
+		complete(&iwqp->sq_drained);
+		complete(&iwqp->rq_drained);
+		qp->qp_uk.sq_flush_complete = true;
+		qp->qp_uk.rq_flush_complete = true;
...
new file mode 100644
index 000000000000..9834785cf6d7
--- /dev/null
...
new file mode 100644
index 000000000000..eeebb5927f54
--- /dev/null
...
new file mode 100644
index 000000000000..0b3d9eeee407
--- /dev/null
...
new file mode 100644
index 000000000000..58078cca66f8
--- /dev/null
