...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 9C8E03722B
	for <lists+linux-rdma@lfdr.de>; Thu,  6 Jun 2019 12:54:32 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727456AbfFFKyc (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Thu, 6 Jun 2019 06:54:32 -0400
Received: from mail.kernel.org ([198.145.29.99]:55022 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1727451AbfFFKyb (ORCPT <rfc822;linux-rdma@vger.kernel.org>);
        Thu, 6 Jun 2019 06:54:31 -0400
Received: from localhost (unknown [193.47.165.251])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id 6DDD220872;
        Thu,  6 Jun 2019 10:54:30 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1559818471;
        bh=5xDD640FDjr2BcSuuh3pRym0Z0fV9WCHofCXe/gMP3k=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=bDwP6ZuxHuYmGTZZTA629rKq6F8eknTaWm0zuO/Mty11kl2b8R9Y7rae9AoE7fTM+
         vecxyR14nZNCcmMqHvRXX4ndQFiDcKTB9iKRheu8sr90pgoV+fDpSPIjrAav7iIj/z
         kL9XKAaxnRw53C+fWLiBbjt4dRuW/da0V32KUdxQ=
...
Subject: [PATCH rdma-next v3 13/17] RDMA/core: Get sum value of all counters when perform a sysfs stat read
Date:   Thu,  6 Jun 2019 13:53:41 +0300
Message-Id: <20190606105345.8546-14-leon@kernel.org>
...
---
 drivers/infiniband/core/counters.c | 83 +++++++++++++++++++++++++++++-
 drivers/infiniband/core/sysfs.c    | 10 ++--
 include/rdma/rdma_counter.h        |  2 +
 3 files changed, 91 insertions(+), 4 deletions(-)

diff --git a/drivers/infiniband/core/counters.c b/drivers/infiniband/core/counters.c
index 6acbb7fad9d5..22eba729c647 100644
--- a/drivers/infiniband/core/counters.c
+++ b/drivers/infiniband/core/counters.c
@@ -143,6 +143,20 @@ static int __rdma_counter_bind_qp(struct rdma_counter *counter,
 	return ret;
 }
...
@@ -281,8 +295,10 @@ int rdma_counter_unbind_qp(struct ib_qp *qp, bool force)
 		return ret;
...
+
 ...
 {
 	struct rdma_port_counter *port_counter;
@@ -314,9 +370,34 @@ void rdma_counter_init(struct ib_device *dev)
 		port_counter = &dev->port_data[port].port_counter;
...
index ea142debfa11..9168c3a208cc 100644
