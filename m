...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id A4CC72FC41
	for <lists+linux-rdma@lfdr.de>; Thu, 30 May 2019 15:25:45 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726640AbfE3NZo (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Thu, 30 May 2019 09:25:44 -0400
Received: from mail-il-dmz.mellanox.com ([193.47.165.129]:34967 "EHLO
        mellanox.co.il" rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org
        with ESMTP id S1726658AbfE3NZo (ORCPT
        <rfc822;linux-rdma@vger.kernel.org>); Thu, 30 May 2019 09:25:44 -0400
Received: from Internal Mail-Server by MTLPINE2 (envelope-from maxg@mellanox.com)
        with ESMTPS (AES256-SHA encrypted); 30 May 2019 16:25:33 +0300
Received: from r-vnc08.mtr.labs.mlnx (r-vnc08.mtr.labs.mlnx [10.208.0.121])
        by labmailer.mlnx (8.13.8/8.13.8) with ESMTP id x4UDPVZb007883;
...
Subject: [PATCH 09/20] RDMA/mlx5: Update set_sig_data_segment attribute for new signature API
Date:   Thu, 30 May 2019 16:25:20 +0300
Message-Id: <1559222731-16715-10-git-send-email-maxg@mellanox.com>
...
index 10b9f79e2c4d..65d82e40871c 100644
--- a/drivers/infiniband/hw/mlx5/qp.c
+++ b/drivers/infiniband/hw/mlx5/qp.c
@@ -4648,17 +4648,15 @@ static int set_sig_data_segment(const struct ib_sig_handover_wr *wr,
 }
...
@@ -4715,7 +4713,8 @@ static int set_sig_umr_wr(const struct ib_send_wr *send_wr,
