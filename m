...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 12ED637A5AC
	for <lists+linux-rdma@lfdr.de>; Tue, 11 May 2021 13:22:57 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231382AbhEKLYB (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Tue, 11 May 2021 07:24:01 -0400
Received: from szxga05-in.huawei.com ([45.249.212.191]:2629 "EHLO
        szxga05-in.huawei.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231360AbhEKLYB (ORCPT
        <rfc822;linux-rdma@vger.kernel.org>); Tue, 11 May 2021 07:24:01 -0400
Received: from DGGEMS408-HUB.china.huawei.com (unknown [172.30.72.58])
        by szxga05-in.huawei.com (SkyGuard) with ESMTP id 4Ffb6S3PxgzPx12;
...
Subject: [PATCH v2 for-next 6/7] RDMA/hns: Add method to detach WQE buffer
Date:   Tue, 11 May 2021 19:22:40 +0800
Message-ID: <1620732161-27180-7-git-send-email-liweihang@huawei.com>
...
+
 	...
 	buf_id = cfg->buf_id;
 	/* Already attached */
@@ -780,20 +792,140 @@ static int attach_dca_mem(struct hns_roce_dev *hr_dev,
 	return 0;
 }
...
@@ -972,12 +1104,38 @@ DECLARE_UVERBS_NAMED_METHOD(
...
@@ -54,5 +58,6 @@ void hns_roce_unregister_udca(struct hns_roce_dev *hr_dev,
...
index d0d66fd..26485cd 100644
--- a/drivers/infiniband/hw/hns/hns_roce_qp.c
+++ b/drivers/infiniband/hw/hns/hns_roce_qp.c
@@ -782,7 +782,7 @@ static int alloc_wqe_buf(struct hns_roce_dev *hr_dev, struct hns_roce_qp *hr_qp,
 	if (ret) {
...
+			hns_roce_disable_dca(hr_dev, hr_qp, udata);
 	...
 	return ret;
@@ -794,7 +794,7 @@ static void free_wqe_buf(struct hns_roce_dev *hr_dev, struct hns_roce_qp *hr_qp,
