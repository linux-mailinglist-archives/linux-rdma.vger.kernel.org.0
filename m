...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 1F8A473B7EA
	for <lists+linux-rdma@lfdr.de>; Fri, 23 Jun 2023 14:45:24 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231578AbjFWMpT (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Fri, 23 Jun 2023 08:45:19 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:34380 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231622AbjFWMpQ (ORCPT
        <rfc822;linux-rdma@vger.kernel.org>); Fri, 23 Jun 2023 08:45:16 -0400
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 483FE26AE;
        Fri, 23 Jun 2023 05:44:39 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1687524279; x=1719060279;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=F05rO7MefYTQWag7EZWP6bdJMD4WHQ7Lp2RQ4VIIc84=;
  b=guxBKSWvCYzg+bhCf7k+cbQ7HAlNrgM5m/qw2n3qi1nWuvJEZH+534hc
   jm4KfDGaCjVGx8ABnLQj9fIUJF1KQvO2LUEsC66zqytofj25xFVPrQtKu
   lgUS7/SbAx6h+kd8d5dRYPTWtxHYrWDEy5wZeL7PNNS/aAGkc7f0XtEsZ
   XAIdYjZ3M4Nb14B7OpIsZ/f23+MfGPAdncCC/PmblwxYARGMmVnMfZyd5
   yzil9GI311KiHRvkgAEqPrf3p/+XU8SKePRtvP32E5C11oJ+tO9LF09OF
   uypzY4m2eadycPKPd8Vjca247FEMWR/q3QyqFrf1fjUxUq33b0ugjofHI
   A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10750"; a="341096796"
X-IronPort-AV: E=Sophos;i="6.01,152,1684825200"; 
   d="scan'208";a="341096796"
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
  by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 23 Jun 2023 05:41:40 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10750"; a="785321211"
X-IronPort-AV: E=Sophos;i="6.01,152,1684825200"; 
   d="scan'208";a="785321211"
Received: from amlin-018-114.igk.intel.com ([10.102.18.114])
  by fmsmga004.fm.intel.com with ESMTP; 23 Jun 2023 05:41:29 -0700
...
Subject: [RFC PATCH v9 07/10] ice: add admin commands to access cgu configuration
Date:   Fri, 23 Jun 2023 14:38:17 +0200
Message-Id: <20230623123820.42850-8-arkadiusz.kubalewski@intel.com>
...
---
 ...
 8 files changed, 1402 insertions(+), 5 deletions(-)

diff --git a/drivers/net/ethernet/intel/ice/ice.h b/drivers/net/ethernet/intel/ice/ice.h
index 4ba3d99439a0..add5c11ca2f2 100644
...
index eb2dc0983776..c306e4ac9f1b 100644
...
@@ -4917,6 +4993,392 @@ ice_dis_vsi_rdma_qset(struct ice_port_info *pi, u16 count, u32 *qset_teid,
 	return status;
 }
...
index 81961a7d6598..88ff8fa58356 100644
...
index a38614d21ea8..3f5d0d827637 100644
...
+
  ...
  * @hw: pointer to the hw struct
@@ -3381,3 +3465,332 @@ int ice_get_phy_tx_tstamp_ready(struct ice_hw *hw, u8 block, u64 *tstamp_ready)
