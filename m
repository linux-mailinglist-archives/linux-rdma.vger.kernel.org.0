...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id A5DC7744F3F
	for <lists+linux-rdma@lfdr.de>; Sun,  2 Jul 2023 19:45:27 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229701AbjGBRpZ (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Sun, 2 Jul 2023 13:45:25 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:42742 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229992AbjGBRpM (ORCPT
        <rfc822;linux-rdma@vger.kernel.org>); Sun, 2 Jul 2023 13:45:12 -0400
Received: from mail-ot1-x32c.google.com (mail-ot1-x32c.google.com [IPv6:2607:f8b0:4864:20::32c])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 7166D183
        for <linux-rdma@vger.kernel.org>; Sun,  2 Jul 2023 10:45:09 -0700 (PDT)
Received: by mail-ot1-x32c.google.com with SMTP id 46e09a7af769-6b71ee710edso2887872a34.2
        for <linux-rdma@vger.kernel.org>; Sun, 02 Jul 2023 10:45:09 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20221208; t=1688319909; x=1690911909;
        h=content-transfer-encoding:in-reply-to:from:references:to
         :content-language:subject:user-agent:mime-version:date:message-id
         :from:to:cc:subject:date:message-id:reply-to;
        bh=WJ7u0Dqh36FbleUN9xbFRWkSlyrJur6C9+sq+MaE1V4=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20221208; t=1688319909; x=1690911909;
        h=content-transfer-encoding:in-reply-to:from:references:to
         :content-language:subject:user-agent:mime-version:date:message-id
         :x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=WJ7u0Dqh36FbleUN9xbFRWkSlyrJur6C9+sq+MaE1V4=;
        b=
X-Gm-Message-State: AC+VfDxERAzDi3RQDqH9Y9Mp7Lvq1rF9DaN4Ewrz4AXeRypoZRHjyTao
        8OtDnfXbRdlYENAQl8PyZAs=
X-Google-Smtp-Source: ACHHUZ5RMYk128vR30TXk7wD9vxIq/KGj7eIdsTh00ruhOPEN7H+8OfwaJspJFO/D6/oD81cWNfgGA==
X-Received: by 2002:a05:6830:1d54:b0:6b7:494b:a503 with SMTP id p20-20020a0568301d5400b006b7494ba503mr7599962oth.18.1688319908557;
        Sun, 02 Jul 2023 10:45:08 -0700 (PDT)
Received: from ?IPV6:2603:8081:140c:1a00:ff3f:6f4:ecbd:5b43? (2603-8081-140c-1a00-ff3f-06f4-ecbd-5b43.res6.spectrum.com. [2603:8081:140c:1a00:ff3f:6f4:ecbd:5b43])
        by smtp.gmail.com with ESMTPSA id b16-20020a9d7550000000b006b45be2fdc2sm7149370otl.65.2023.07.02.10.45.07
        (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
        Sun, 02 Jul 2023 10:45:08 -0700 (PDT)
Message-ID: <23a8d7cb-0aa2-686b-ce01-2c9cc6be9a42@gmail.com>
Date:   Sun, 2 Jul 2023 12:45:07 -0500
MIME-Version: 1.0
...
References: <20230630163827.95373-1-rpearsonhpe@gmail.com>
 ...
 <9519b3cd-ad46-3bb4-4bba-3df04644215e@gmail.com>
 <fa2de2dd-b4bd-1818-41d4-71f127c8573a@linux.dev>
From:   Bob Pearson <rpearsonhpe@gmail.com>
In-Reply-To: <fa2de2dd-b4bd-1818-41d4-71f127c8573a@linux.dev>
...
On 7/1/23 21:00, Zhu Yanjun wrote:
> 
...
> 
> 1. Just change the timeout value from 0.2seconds to 10 seconds, does it solve the problem? If yes,  Just changing the timeout value can fix the problem.
> 
> So I think it can be a commit.
> 
> 2. Based on the first commit,  because rdma-core mostly ignores return codes from ib_destroy_qp I changed the rxe_cleanup function to a void.
> 
>  This required changing the calls in rxe-verbs.c to not check the return code,  a trivial change. This can be the 2nd commit?
> 
> 3. Finally since I can't return an error I just wait in a loop calling wait_for_completion_timeout(). This can be the 3rd commit?
> 
> Just my 2 cents.
> 
...
Thanks, Good suggestions. I'll fix it.
