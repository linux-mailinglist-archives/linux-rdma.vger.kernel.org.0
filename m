...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 60CC02A975
	for <lists+linux-rdma@lfdr.de>; Sun, 26 May 2019 13:42:38 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727681AbfEZLmg (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Sun, 26 May 2019 07:42:36 -0400
Received: from mx0b-001b2d01.pphosted.com ([148.163.158.5]:58662 "EHLO
        mx0a-001b2d01.pphosted.com" rhost-flags-OK-OK-OK-FAIL)
        by vger.kernel.org with ESMTP id S1727730AbfEZLmf (ORCPT
        <rfc822;linux-rdma@vger.kernel.org>);
        Sun, 26 May 2019 07:42:35 -0400
Received: from pps.filterd (m0098420.ppops.net [127.0.0.1])
        by mx0b-001b2d01.pphosted.com (8.16.0.27/8.16.0.27) with SMTP id x4QBgYmV195392
        for <linux-rdma@vger.kernel.org>; Sun, 26 May 2019 07:42:34 -0400
Received: from e06smtp07.uk.ibm.com (e06smtp07.uk.ibm.com [195.75.94.103])
        by mx0b-001b2d01.pphosted.com with ESMTP id 2sqk7ut1ny-1
...
Received: from b06wcsmtp001.portsmouth.uk.ibm.com (b06wcsmtp001.portsmouth.uk.ibm.com [9.149.105.160])
        by b06cxnps3074.portsmouth.uk.ibm.com (8.14.9/8.14.9/NCO v10.0) with ESMTP id x4QBgRW261604036
        (version=TLSv1/SSLv3 cipher=DHE-RSA-AES256-GCM-SHA384 bits=256 verify=OK);
        Sun, 26 May 2019 11:42:27 GMT
Received: from b06wcsmtp001.portsmouth.uk.ibm.com (unknown [127.0.0.1])
        by IMSVA (Postfix) with ESMTP id 1F993A4054;
        Sun, 26 May 2019 11:42:27 +0000 (GMT)
Received: from b06wcsmtp001.portsmouth.uk.ibm.com (unknown [127.0.0.1])
        by IMSVA (Postfix) with ESMTP id EA055A405B;
...
Subject: [PATCH for-next v1 06/12] SIW application buffer management
Date:   Sun, 26 May 2019 13:41:50 +0200
X-Mailer: git-send-email 2.17.2
In-Reply-To: <20190526114156.6827-1-bmt@zurich.ibm.com>
References: <20190526114156.6827-1-bmt@zurich.ibm.com>
X-TM-AS-GCONF: 00
x-cbid: 19052611-0028-0000-0000-000003718F07
X-IBM-AV-DETECTION: SAVI=unused REMOTE=unused XFE=unused
x-cbparentid: 19052611-0029-0000-0000-000024314893
Message-Id: <20190526114156.6827-7-bmt@zurich.ibm.com>
...
new file mode 100644
index 000000000000..22316ca929a6
--- /dev/null
...
+#define _SIW_MEM_H
+
+extern struct siw_umem *siw_umem_get(u64 start, u64 len, bool writable);
+extern void siw_umem_release(struct siw_umem *umem, bool dirty);
+extern struct siw_pbl *siw_pbl_alloc(u32 num_buf);
+extern u64 siw_pbl_get_buffer(struct siw_pbl *pbl, u64 off, int *len, int *idx);
+extern struct siw_mem *siw_mem_id2obj(struct siw_device *sdev, int stag_index);
+extern int siw_mem_add(struct siw_device *sdev, struct siw_mem *m);
+extern int siw_invalidate_stag(struct ib_pd *pd, u32 stag);
+extern int siw_check_mem(struct ib_pd *pd, struct siw_mem *mem, u64 addr,
+			 enum ib_access_flags perms, int len);
+extern int siw_check_sge(struct ib_pd *pd, struct siw_sge *sge,
+			 struct siw_mem *mem[], enum ib_access_flags perms,
+			 u32 off, int len);
+extern void siw_wqe_put_mem(struct siw_wqe *wqe, enum siw_opcode op);
+extern int siw_mr_add_mem(struct siw_mr *mr, struct ib_pd *pd, void *mem_obj,
+			  u64 start, u64 len, int rights);
+extern void siw_mr_drop_mem(struct siw_mr *mr);
