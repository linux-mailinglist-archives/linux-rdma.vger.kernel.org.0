...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id A5E107A212D
	for <lists+linux-rdma@lfdr.de>; Fri, 15 Sep 2023 16:38:21 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235780AbjIOOiX (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Fri, 15 Sep 2023 10:38:23 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:35532 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235785AbjIOOiX (ORCPT
        <rfc822;linux-rdma@vger.kernel.org>); Fri, 15 Sep 2023 10:38:23 -0400
Received: from mail-oa1-x2b.google.com (mail-oa1-x2b.google.com [IPv6:2001:4860:4864:20::2b])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 84C681BC7
        for <linux-rdma@vger.kernel.org>; Fri, 15 Sep 2023 07:38:14 -0700 (PDT)
Received: by mail-oa1-x2b.google.com with SMTP id 586e51a60fabf-1c50438636fso1175398fac.1
        for <linux-rdma@vger.kernel.org>; Fri, 15 Sep 2023 07:38:14 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1694788693; x=1695393493; darn=vger.kernel.org;
        h=content-transfer-encoding:in-reply-to:from:content-language
         :references:cc:to:subject:user-agent:mime-version:date:message-id
         :from:to:cc:subject:date:message-id:reply-to;
        bh=LhoS6p5dwkiFfKqIz5L9qqPKoqzRjaNy4GkKAmjhGT4=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1694788693; x=1695393493;
        h=content-transfer-encoding:in-reply-to:from:content-language
         :references:cc:to:subject:user-agent:mime-version:date:message-id
         :x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=LhoS6p5dwkiFfKqIz5L9qqPKoqzRjaNy4GkKAmjhGT4=;
        b=
X-Gm-Message-State: AOJu0Yw8cUOdxvbFhqKsYHcatatF+ysgFNnhF50BHQo0QCKiy+ZpdbHZ
        MtQ85GZ/T1+A3nLKHj8fYM8=
X-Google-Smtp-Source: AGHT+IGKdMZPP225dredtm1eGcjCOzSchflqwvu8dHkAU6C6v9i/bNIWh2ccbPi48J5X7wxfHZikpw==
X-Received: by 2002:a05:6871:c117:b0:1d6:8e92:1e55 with SMTP id yq23-20020a056871c11700b001d68e921e55mr188190oab.50.1694788692789;
        Fri, 15 Sep 2023 07:38:12 -0700 (PDT)
Received: from ?IPV6:2603:8081:1405:679b:4c45:e3b5:53a:a819? (2603-8081-1405-679b-4c45-e3b5-053a-a819.res6.spectrum.com. [2603:8081:1405:679b:4c45:e3b5:53a:a819])
        by smtp.gmail.com with ESMTPSA id bg15-20020a056871940f00b0019f188355a8sm1925282oac.17.2023.09.15.07.38.11
        (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
        Fri, 15 Sep 2023 07:38:12 -0700 (PDT)
Message-ID: <52ce3314-0e25-8e25-44c0-1c6702da9372@gmail.com>
Date:   Fri, 15 Sep 2023 09:38:10 -0500
MIME-Version: 1.0
...
In-Reply-To: <74f6a2a3-b556-c716-62d0-58fd0d493fab@fujitsu.com>
...
> 
> 
> On 15/09/2023 08:45, Zhu Yanjun wrote:
>>
>> 在 2023/9/15 0:40, Bob Pearson 写道:
>>> Earlier patches removed newlines from some debug macros and
>>> added newlines to instances of these marcros but not all.
> 
> Is the 'Earlier patches' here referring to the one I sent earlier "[PATCH v2 1/2] RDMA/rxe: Improve newline in printing messages"
> that one hasn't been merged and have to be rebased.
> 
> 
>   This
...
> 
> Compare to your changes, your patch is smaller than mine(rebased to 6.6-rc1). And your patch
> modified the print words as well that doesn't obey your patch subject.
> 
...
> drivers/infiniband/sw/rxe/rxe.h:41:#define rxe_dbg(fmt, ...) pr_debug("%s: " fmt, __func__, ##__VA_ARGS__)
> drivers/infiniband/sw/rxe/rxe.h:61:#define rxe_err(fmt, ...) pr_err_ratelimited("%s: " fmt, __func__, \
> drivers/infiniband/sw/rxe/rxe.h:82:#define rxe_info(fmt, ...) pr_info_ratelimited("%s: " fmt, __func__, \
> 
> My earlier patch want to make all rxe_{dbg,info,err}() and rxe_{dbg,info,err}_xxx() be consistent(no newline macros built-in).

I may have missed your second patch. I was looking at the code in 6.6.0-rc1 and guessed that it was upstream.
If the two patches are equivalent then yours is fine. I'm just looking to get things clean and consistent.

Bob
> if i'm still missing something, feel free to let me know.
> 
> Thanks
> Zhijian
> 
