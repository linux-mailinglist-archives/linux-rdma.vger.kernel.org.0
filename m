...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id EA1953DAE9D
	for <lists+linux-rdma@lfdr.de>; Fri, 30 Jul 2021 00:01:21 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233967AbhG2WBY (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Thu, 29 Jul 2021 18:01:24 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:58202 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234122AbhG2WBX (ORCPT
        <rfc822;linux-rdma@vger.kernel.org>); Thu, 29 Jul 2021 18:01:23 -0400
Received: from mail-oi1-x22b.google.com (mail-oi1-x22b.google.com [IPv6:2607:f8b0:4864:20::22b])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 61917C061765
        for <linux-rdma@vger.kernel.org>; Thu, 29 Jul 2021 15:01:19 -0700 (PDT)
Received: by mail-oi1-x22b.google.com with SMTP id z26so10371392oih.10
        for <linux-rdma@vger.kernel.org>; Thu, 29 Jul 2021 15:01:19 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=aN/wEzaHe+h3WLj+UqBKYAzv8ZqjJXmqnRErBoEKruQ=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=aN/wEzaHe+h3WLj+UqBKYAzv8ZqjJXmqnRErBoEKruQ=;
        b=
X-Gm-Message-State: AOAM533RXr8uLqAqikAtBmof4zYeMAzxqeSyVr6WCglMzbh8u6Khpd9l
        t7h4SQ23s/JJdlG/0nLnHxw=
X-Google-Smtp-Source: ABdhPJxqvRUZKC4x/sgRIr6gCLNpv++oG4LsvZpGP4Vhu0Rb7H25uWKCQfs2D/JQLFp+nyzFoGTutA==
X-Received: by 2002:a05:6808:1301:: with SMTP id y1mr2254347oiv.156.1627596078740;
        Thu, 29 Jul 2021 15:01:18 -0700 (PDT)
Received: from localhost (2603-8081-140c-1a00-80ca-c9ae-640f-0f9a.res6.spectrum.com. [2603:8081:140c:1a00:80ca:c9ae:640f:f9a])
        by smtp.gmail.com with ESMTPSA id f3sm810408otc.49.2021.07.29.15.01.18
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Thu, 29 Jul 2021 15:01:18 -0700 (PDT)
From:   Bob Pearson <rpearsonhpe@gmail.com>
To:     jgg@nvidia.com, zyjzyj2000@gmail.com, linux-rdma@vger.kernel.org
Cc:     Bob Pearson <rpearsonhpe@gmail.com>
Subject: [PATCH for-next v2 3/3] RDMA/rxe: Add memory barriers to kernel queues
Date:   Thu, 29 Jul 2021 17:00:40 -0500
Message-Id: <20210729220039.18549-4-rpearsonhpe@gmail.com>
...
index f7b1a1f64c13..31148478f704 100644
...
@@ -640,27 +629,17 @@ static int post_one_send(struct rxe_qp *qp, const struct ib_send_wr *ibwr,
...
@@ -852,18 +831,12 @@ static int rxe_poll_cq(struct ib_cq *ibcq, int num_entries, struct ib_wc *wc)
...
@@ -875,10 +848,7 @@ static int rxe_peek_cq(struct ib_cq *ibcq, int wc_cnt)
...
@@ -894,10 +864,7 @@ static int rxe_req_notify_cq(struct ib_cq *ibcq, enum ib_cq_notify_flags flags)
