...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id D543B14E096
	for <lists+linux-rdma@lfdr.de>; Thu, 30 Jan 2020 19:13:21 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728472AbgA3SNU (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Thu, 30 Jan 2020 13:13:20 -0500
Received: from mail-wm1-f66.google.com ([209.85.128.66]:37698 "EHLO
        mail-wm1-f66.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1728458AbgA3SNU (ORCPT
        <rfc822;linux-rdma@vger.kernel.org>); Thu, 30 Jan 2020 13:13:20 -0500
Received: by mail-wm1-f66.google.com with SMTP id f129so5448526wmf.2
        for <linux-rdma@vger.kernel.org>; Thu, 30 Jan 2020 10:13:16 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=broadcom.com; s=google;
        h=from:to:cc:subject:date:message-id:in-reply-to:references;
        bh=5XU57aBejClV+765x5nS9oighNtQOmPfWvaIuBX5M+Y=;
        b=WO7NOqupAaegAZlCv7VYuQM8u9R2QeMyZCEu6bqfYCHVP0seGZ72oyYizRH22aiTG2
         D7veal2PxL8ugC7x5OaWX1bLhwYmqbZFGFeAN/Zng/Y/UCrk4P32sLGQ1xy2ZKTANSe+
         8BnjCdXHLfOEcPwTJDdrTfV4O5H0q+VK9Ys3I=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20161025;
        h=x-gm-message-state:from:to:cc:subject:date:message-id:in-reply-to
         :references;
        bh=5XU57aBejClV+765x5nS9oighNtQOmPfWvaIuBX5M+Y=;
        b=
X-Gm-Message-State: APjAAAXsm415LbYfoswdUzEVDPJ1Q8UQzxHWMbUzyNggGuvalm2mVevy
        1Vm6BPXmvApqO7anB90MdQATKt12kqjCqPtDR5raVA/0rhmB/ltbNro+2lRzifecCriEC3mkCOW
        3W6vBlMh4lCOaew9hs0sc2vXFTRWq+hCrtdrzjLYryYj4fxYr0Ota9ICYGaVkXwxYkfT+viOERU
        8iRho=
X-Google-Smtp-Source: APXvYqxRsupbpvA+MJrzSeS6zkNSiav+vjvWNwOrCVnGyrqW5TqP2VRGCYO+sbEewSpuBRuQAOMw+g==
X-Received: by 2002:a7b:ce18:: with SMTP id m24mr6891659wmc.123.1580407995056;
        Thu, 30 Jan 2020 10:13:15 -0800 (PST)
Received: from neo00-el73.dhcp.broadcom.net ([192.19.234.250])
        by smtp.gmail.com with ESMTPSA id d14sm8695060wru.9.2020.01.30.10.13.12
        (version=TLS1_2 cipher=ECDHE-RSA-AES128-GCM-SHA256 bits=128/128);
        Thu, 30 Jan 2020 10:13:14 -0800 (PST)
From:   Devesh Sharma <devesh.sharma@broadcom.com>
To:     linux-rdma@vger.kernel.org
Cc:     jgg@mellanox.com, dledford@redhat.com
Subject: [PATCH V2 for-next 1/8] RDMA/bnxt_re: Refactor queue pair creation code
Date:   Thu, 30 Jan 2020 13:12:55 -0500
Message-Id: <1580407982-882-2-git-send-email-devesh.sharma@broadcom.com>
...
@@ -967,8 +995,6 @@ static int bnxt_re_init_user_qp(struct bnxt_re_dev *rdev, struct bnxt_re_pd *pd,
 	if (rc)
 		goto fail;
...
-
 	...
 	mutex_lock(&rdev->qp_lock);
@@ -981,205 +1007,377 @@ static int bnxt_re_init_user_qp(struct bnxt_re_dev *rdev, struct bnxt_re_pd *pd,
 	return NULL;
 }
...
@@ -1751,7 +1950,7 @@ int bnxt_re_modify_qp(struct ib_qp *ib_qp, struct ib_qp_attr *qp_attr,
...
@@ -1995,9 +2194,12 @@ static int bnxt_re_build_qp1_shadow_qp_recv(struct bnxt_re_qp *qp,
...
@@ -2012,7 +2214,7 @@ static int bnxt_re_build_qp1_shadow_qp_recv(struct bnxt_re_qp *qp,
...
@@ -2832,12 +3034,13 @@ static bool bnxt_re_is_loopback_packet(struct bnxt_re_dev *rdev,
 	return rc;
 }
...
@@ -2860,19 +3063,19 @@ static int bnxt_re_process_raw_qp_pkt_rx(struct bnxt_re_qp *qp1_qp,
 	swr = &udwr.wr;
 	tbl_idx = cqe->wr_id;
...
@@ -2926,7 +3129,7 @@ static int bnxt_re_process_raw_qp_pkt_rx(struct bnxt_re_qp *qp1_qp,
 	rwr.wr_id = tbl_idx;
 	rwr.next = NULL;
...
@@ -2938,13 +3141,13 @@ static int bnxt_re_process_raw_qp_pkt_rx(struct bnxt_re_qp *qp1_qp,
 	swr->wr_id = tbl_idx;
...
@@ -2998,12 +3201,12 @@ static void bnxt_re_process_res_rc_wc(struct ib_wc *wc,
...
+	struct bnxt_re_qp *gsi_qp = NULL;
 	...
 	struct bnxt_re_sqp_entries *sqp_entry = NULL;
 	int nw_type;
@@ -3013,13 +3216,13 @@ static void bnxt_re_process_res_shadow_qp_wc(struct bnxt_re_qp *qp,
...
@@ -3098,7 +3301,7 @@ static int send_phantom_wqe(struct bnxt_re_qp *qp)
...
@@ -3162,8 +3365,9 @@ int bnxt_re_poll_cq(struct ib_cq *ib_cq, int num_entries, struct ib_wc *wc)
...
+				    qp->qplib_qp.id == sh_qp->qplib_qp.id) {
 					 ...
 					 */
@@ -3189,7 +3393,7 @@ int bnxt_re_poll_cq(struct ib_cq *ib_cq, int num_entries, struct ib_wc *wc)
 				 * stored in the table
 				 */
 				tbl_idx = cqe->wr_id;
...
+				sqp_entry = &cq->rdev->gsi_ctx.sqp_tbl[tbl_idx];
 				...
 				break;
@@ -3197,8 +3401,9 @@ int bnxt_re_poll_cq(struct ib_cq *ib_cq, int num_entries, struct ib_wc *wc)
