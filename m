...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id EBC3D20FBFF
	for <lists+linux-rdma@lfdr.de>; Tue, 30 Jun 2020 20:46:22 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726154AbgF3SqV (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Tue, 30 Jun 2020 14:46:21 -0400
Received: from mga05.intel.com ([192.55.52.43]:56426 "EHLO mga05.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726213AbgF3SqV (ORCPT <rfc822;linux-rdma@vger.kernel.org>);
        Tue, 30 Jun 2020 14:46:21 -0400
IronPort-SDR: wHCH6xWLfWlAMnUMbKanOV6FiF+cutmNl0RIZlc2UyxPEul1jeCaS1pPqmNp+IfBbEUfyeZFWZ
 Tq5DupU6N7rA==
X-IronPort-AV: E=McAfee;i="6000,8403,9668"; a="231221677"
X-IronPort-AV: E=Sophos;i="5.75,298,1589266800"; 
   d="scan'208";a="231221677"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga003.jf.intel.com ([10.7.209.27])
  by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 30 Jun 2020 11:46:20 -0700
IronPort-SDR: TDAqqfRoomjQd2s5lRmUMMprSjZaiIqtHBhp4bag9MzQELWBCpY2dQMCJ4BCRHFjmZyH8Ob2cR
 8P9rHb/7RYHA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.75,298,1589266800"; 
   d="scan'208";a="277516248"
...
x-forefront-antispam-report: CIP:255.255.255.255;CTRY:;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:MW3PR11MB4555.namprd11.prod.outlook.com;PTR:;CAT:NONE;SFTY:;SFS:(4636009)(366004)(396003)(346002)(136003)(39860400002)(376002)(5660300002)(478600001)(53546011)(83380400001)(316002)(7696005)(66446008)(2906002)(66556008)(66476007)(64756008)(6506007)(4326008)(55016002)(8676002)(76116006)(8936002)(66946007)(9686003)(71200400001)(54906003)(186003)(86362001)(52536014)(26005)(6916009)(33656002);DIR:OUT;SFP:1102;
...
X-MS-Exchange-CrossTenant-originalarrivaltime: 30 Jun 2020 18:46:17.2520
 (UTC)
...
> > > > handle page fault. For RDMA, that means the NIC must support on-dem=
and paging.
> > >
...
>=20
> Sort of, but only within the same device, RDMA or anything else generic c=
an't reach inside a DEVICE_PRIVATE and extract anything useful.
...
At the RDMA side, we mainly want to check if the changes are acceptable. Fo=
r example,
the part about adding 'fd' to the device ops and the ioctl interface. All t=
he previous
comments are very helpful for us to refine the patch so that we can be read=
y when
GPU side support becomes available.

>=20
> The need for the dynamic mapping support for even the current DMA Buf hac=
ky P2P users is really too bad. Can you get any GPU driver to
...
> > > > aforementioned issues as well as GPU-NIC peer-to-peer access soluti=
ons in general.
> > >
> > > These seem like DMA buf problems, not RDMA problems, why are you
> > > asking these questions with a RDMA patch set? The usual DMA buf peopl=
e are not even Cc'd here.
> >
...
> > MAINTAINERS file. I agree more people could be invited to the discussio=
n.
> > Just added Christian Koenig to the cc-list.
>=20
> Would be good to have added the drm lists too

Thanks, cc'd dri-devel here, and will also do the same for the previous par=
t of the thread.

>=20
> > If the umem_description you mentioned is for information used to
> > create the umem (e.g. a structure for all the parameters), then this wo=
uld work better.
>=20
