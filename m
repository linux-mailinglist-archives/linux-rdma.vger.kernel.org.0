...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id D82FB2C32AE
	for <lists+linux-rdma@lfdr.de>; Tue, 24 Nov 2020 22:25:30 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1731546AbgKXVY7 (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Tue, 24 Nov 2020 16:24:59 -0500
...
IronPort-SDR: zodyrmznovU96GDx4Z2oPJQJtKmZ9Swb1eFgeDuWCy+FcWx4DKsFnyEcTbgMNR20vTU+8QXhTb
 VCb3dSKzVYBw==
X-IronPort-AV: E=McAfee;i="6000,8403,9815"; a="172117605"
X-IronPort-AV: E=Sophos;i="5.78,367,1599548400"; 
   d="scan'208";a="172117605"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga006.jf.intel.com ([10.7.209.51])
  by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 24 Nov 2020 13:24:56 -0800
IronPort-SDR: /GTku4lbLScLLHVaJBBBDdWyrqZy9tSiuMFhu7xx3n8nY1fJFI6e1P8EX1MutL3KwJPq7aQDDY
 kftD2ShekNzg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.78,367,1599548400"; 
   d="scan'208";a="332701578"
...
Subject: [PATCH rdma-core v2 2/6] verbs: Support dma-buf based memory region
Date:   Tue, 24 Nov 2020 13:38:50 -0800
Message-Id: <1606253934-67181-3-git-send-email-jianxin.xiong@intel.com>
