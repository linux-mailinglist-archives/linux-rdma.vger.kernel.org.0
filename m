...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 3523F1CF5CF
	for <lists+linux-rdma@lfdr.de>; Tue, 12 May 2020 15:29:42 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729524AbgELN3k (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Tue, 12 May 2020 09:29:40 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:57120 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1729436AbgELN3k (ORCPT
        <rfc822;linux-rdma@vger.kernel.org>); Tue, 12 May 2020 09:29:40 -0400
Received: from mail-wr1-x442.google.com (mail-wr1-x442.google.com [IPv6:2a00:1450:4864:20::442])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id D9A78C061A0C;
        Tue, 12 May 2020 06:29:39 -0700 (PDT)
Received: by mail-wr1-x442.google.com with SMTP id l11so9478698wru.0;
        Tue, 12 May 2020 06:29:39 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=TRLUSL9kFv9sdcI3tfJukr0+AJwjO1OGVzax5jMfx1o=;
        b=
X-Gm-Message-State: AGi0PuaLdG1x6LmxVAPnJFTDA6vCKEOJ8DoS5tf/I52KLE+H6I2+6a6z
        E7gin4A4z1RJcMoZGRN2sj29ZLc1jf8AH8UPlP0=
...
On Tue, May 12, 2020 at 9:17 AM Daniel Vetter <daniel.vetter@ffwll.ch> wrot=
e:
>
> On Tue, May 12, 2020 at 3:12 PM Alex Deucher <alexdeucher@gmail.com> wrot=
e:
> >
...
> > > > On Tue, May 12, 2020 at 5:00 AM Daniel Vetter <daniel.vetter@ffwll.=
ch> wrote:
> > > > >
> > > > > ...
> > > > >
...
> > > > > [  132.584091] WARNING: possible circular locking dependency dete=
cted
> > > > > [  132.584775] 5.7.0-rc3+ #346 Tainted: G        W
> > > > > [  132.585461] --------------------------------------------------=
----
> > > > > [  132.586184] kworker/2:3/865 is trying to acquire lock:
> > > > > [  132.586857] ffffc90000677c70 (crtc_ww_class_acquire){+.+.}-{0:=
0}, at: drm_atomic_helper_suspend+0x38/0x120 [drm_kms_helper]
> > > > > [  132.587569]
...
> > > > >
> > > > > [  132.592009]
> > > > >                the existing dependency chain (in reverse order) i=
s:
> > > > > [  132.593507]
> > > > >                -> #2 (dma_fence_map){++++}-{0:0}:
> > > > > [  132.595019]        dma_fence_begin_signalling+0x50/0x60
> > > > > [  132.595767]        drm_atomic_helper_commit+0xa1/0x180 [drm_km=
s_helper]
> > > > > [  132.596567]        drm_client_modeset_commit_atomic+0x1ea/0x25=
0 [drm]
> > > > > [  132.597420]        drm_client_modeset_commit_locked+0x55/0x190=
 [drm]
> > > > > [  132.598178]        drm_client_modeset_commit+0x24/0x40 [drm]
> > > > > [  132.598948]        drm_fb_helper_restore_fbdev_mode_unlocked+0=
x4b/0xa0 [drm_kms_helper]
> > > > > [  132.599738]        drm_fb_helper_set_par+0x30/0x40 [drm_kms_he=
lper]
...
> > > > > [  132.605369]        __drm_fb_helper_initial_config_and_unlock+0=
x36e/0x520 [drm_kms_helper]
> > > > > [  132.606187]        amdgpu_fbdev_init+0xb3/0xf0 [amdgpu]
> > > > > [  132.607032]        amdgpu_device_init.cold+0xe90/0x1677 [amdgp=
u]
...
> > > > > [  132.627098]        amdgpu_device_init.cold+0xbd1/0x1677 [amdgp=
u]
...
> > > > > [  132.647071]        drm_atomic_helper_suspend+0x38/0x120 [drm_k=
ms_helper]
...
> > > > > [  132.650300]        amdgpu_device_gpu_recover.cold+0x4e6/0xe64 =
[amdgpu]
...
> > > > > [  132.663574]                                lock(crtc_ww_class_=
mutex);
...
> > > > > [  132.669462]  #1: ffffc90000677e58 ((work_completion)(&(&sched-=
>work_tdr)->work)){+.+.}-{0:0}, at: process_one_work+0x1bc/0x580
> > > > > [  132.670242]  #2: ffffffff82318c80 (dma_fence_map){++++}-{0:0},=
 at: drm_sched_job_timedout+0x25/0xf0 [gpu_sched]
> > > > > [  132.671039]  #3: ffff8887b84a1748 (&adev->lock_reset){+.+.}-{3=
:3}, at: amdgpu_device_gpu_recover.cold+0x59e/0xe64 [amdgpu]
> > > > > [  132.671902]
> > > > >                stack backtrace:
> > > > > [  132.673515] CPU: 2 PID: 865 Comm: kworker/2:3 Tainted: G      =
  W         5.7.0-rc3+ #346
> > > > > [  132.674347] Hardware name: System manufacturer System Product =
Name/PRIME X370-PRO, BIOS 4011 04/19/2018
> > > > > [  132.675194] Workqueue: events drm_sched_job_timedout [gpu_sche=
d]
...
> > > > > [  132.681163]  ? drm_atomic_helper_suspend+0x38/0x120 [drm_kms_h=
elper]
...
> > > > > [  132.685466]  ? drm_atomic_helper_suspend+0x38/0x120 [drm_kms_h=
elper]
> > > > > [  132.686335]  drm_atomic_helper_suspend+0x38/0x120 [drm_kms_hel=
per]
...
> > > > > [  132.690893]  amdgpu_device_gpu_recover.cold+0x4e6/0xe64 [amdgp=
u]
...
> > > > > @@ -2415,6 +2415,14 @@ static int amdgpu_device_ip_suspend_phase1=
(struct amdgpu_device *adev)
> > > > >                 /* displays are handled separately */
> > > > >                 if (adev->ip_blocks[i].version->type =3D=3D AMD_I=
P_BLOCK_TYPE_DCE) {
> > > > >                         /* XXX handle errors */
> > > > > +
> > > > > +                       /*
> > > > > +                        * This is dm_suspend, which calls modese=
t locks, and
> > > > > +                        * that a pretty good inversion against d=
ma_fence_signal
> > > > > +                        * which gpu recovery is supposed to guar=
antee.
> > > > > +                        *
...
> > >
> > > Spoilers? Solid way is to sidesteck the entire thing by avoiding to r=
eset
> > > the display block entirely. Fixing the locking while still resetting =
the
