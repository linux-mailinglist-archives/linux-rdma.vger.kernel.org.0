...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 87C7027EF62
	for <lists+linux-rdma@lfdr.de>; Wed, 30 Sep 2020 18:38:42 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1725837AbgI3Qik (ORCPT <rfc822;lists+linux-rdma@lfdr.de>);
        Wed, 30 Sep 2020 12:38:40 -0400
Received: from mail.kernel.org ([198.145.29.99]:39074 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1731240AbgI3Qik (ORCPT <rfc822;linux-rdma@vger.kernel.org>);
        Wed, 30 Sep 2020 12:38:40 -0400
Received: from localhost (unknown [213.57.247.131])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id 7CA6720789;
        Wed, 30 Sep 2020 16:38:37 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1601483918;
        bh=+DJxP1KsFVbOaZNQxm4Uyx82tExOvwES4Fl9fEfE/lI=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=qolaclIohAAzdEnxa4tgZExmi8GAr5sriGDD8PCG2ppYfil55KZjJaLB0Z+jM1bEO
         OD9aV4SzR2nlDwrAv1gbxocf3Ye5TEEF7opx3RPVilhoWNBmczDntqfN8ejfP1eg3S
         XDuuALDqI53E4udAjmYE5cf585tzypazYGbr3WyU=
From:   Leon Romanovsky <leon@kernel.org>
To:     Doug Ledford <dledford@redhat.com>,
        Jason Gunthorpe <jgg@nvidia.com>
Cc:     Yishai Hadas <yishaih@nvidia.com>, linux-rdma@vger.kernel.org,
        Christoph Hellwig <hch@infradead.org>
Subject: [PATCH rdma-next v3 1/4] IB/core: Improve ODP to use hmm_range_fault()
Date:   Wed, 30 Sep 2020 19:38:25 +0300
Message-Id: <20200930163828.1336747-2-leon@kernel.org>
...
---
 ...
 drivers/infiniband/core/umem_odp.c | 280 ++++++++++++-----------------
 drivers/infiniband/hw/mlx5/odp.c   |  24 +--
 include/rdma/ib_umem_odp.h         |  21 +--
 4 files changed, 129 insertions(+), 197 deletions(-)
...
index cc6b4befde7c..b7dc9ccb2cc9 100644
...
+		* non-invalidating trasition, like read-only to writable.
+		* Resync the flags.
+		*/
