Return-Path: <linux-rdma+bounces-4533-lists+linux-rdma=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-rdma@lfdr.de
Delivered-To: lists+linux-rdma@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 188E895DAD7
	for <lists+linux-rdma@lfdr.de>; Sat, 24 Aug 2024 05:21:10 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 1FF9B1C21596
	for <lists+linux-rdma@lfdr.de>; Sat, 24 Aug 2024 03:21:09 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id E424A29406;
	Sat, 24 Aug 2024 03:20:43 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b="WSX3Zszt"
X-Original-To: linux-rdma@vger.kernel.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.16])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 0E99E1863E;
	Sat, 24 Aug 2024 03:20:39 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=192.198.163.16
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1724469643; cv=none; b=BBVs1v7sD28XsGTQne9C4GZwEDSzAMukH/f6syu24elV7NAlcNgYdFzMvyhpZF5lpl27MLEa/qOvFonEnuDIt6txZllPJXEokTGW4e/L7dUtiBplvuP/+5SizDZ9JkSYla8pDqietYGIYe1oKvusoZxBonbxwswcc3JYitWYHe4=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1724469643; c=relaxed/simple;
	bh=wPwVlIkeaNhIghdGFpKGeGjOljbdvssdGI68xzURduc=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=qOSBsNsbEZd0nV6eflHjCgqzuDCNHDc5up3/PdZekKJ2MQMrq1xTvBikpXetphZbGsR3O3gVafBbJZC0zYPPp4hpOa/bKJPYzQy9lUbzVfDTAucjbwgpRXXZ17sF3dRR0tYS89MTRXo/1EmQ2yfVtNQBcn3WXWmSCAfjYMLgx60=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com; spf=pass smtp.mailfrom=intel.com; dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b=WSX3Zszt; arc=none smtp.client-ip=192.198.163.16
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  ...
  bh=wPwVlIkeaNhIghdGFpKGeGjOljbdvssdGI68xzURduc=;
  b=WSX3ZsztdD6Vd7jL6LaeT3aSxTUCGRhMdrWVYa/WJdyFb8hUwktVux/Z
   NET3qtlpWSrDFoDOyQmnalU8j5r++dJ0Y4UwFIgI5jD2Ho6Mlg61DzQ44
   zqrUtPr9TFf7J1QApEr/6CYsWX3jXPe5qztGDZFlueXJBSjR9eJ22G5/9
   joBHO8t40S4H7xxYxj92UYMepPy2tITdyOdhQQk41jX7eMSh+wJq1lPtk
   xIGLdKCH/NA7sJizOHjFLhX6XUpl2pFy7iZp4rzl0EoKvWszV8kYpVRZb
   ScEO7ZNKpwKxMjrmPeDP7mZeFppp3PNAhH9ViSwGAnmEV3H42xs47oS9v
   g==;
X-CSE-ConnectionGUID: 1k1nIMkKTB61pki1AWSIBQ==
X-CSE-MsgGUID: HJZg6uv+Qcm5GePwQbh1XA==
X-IronPort-AV: E=McAfee;i="6700,10204,11173"; a="13187767"
X-IronPort-AV: E=Sophos;i="6.10,172,1719903600"; 
   d="scan'208";a="13187767"
Received: from orviesa001.jf.intel.com ([10.64.159.141])
  by fmvoesa110.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 23 Aug 2024 20:20:38 -0700
X-CSE-ConnectionGUID: ElRZJAekT/mjdSwHIymLcQ==
X-CSE-MsgGUID: U/5BeVl9Skuk13e8d8Lpmw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.10,172,1719903600"; 
   d="scan'208";a="99492071"
...
Subject: [RFC v2 01/25] iidc/ice/irdma: Update IDC to support multiple consumers
Date: Fri, 23 Aug 2024 22:19:00 -0500
Message-Id: <20240824031924.421-2-tatyana.e.nikolova@intel.com>
...
To support RDMA for E2000 product, the idpf driver will require to use
IDC interface with the irdma auxiliary driver, thus becoming a second
...
different pf sturct, implenent a universal struct that all core drivers
can export to the auxiliary driver through the probe call.

The iidc.h header file will be divided into two files.  The first,
idc_rdma.h, will host all of the generic header info that will be need
...
---
 ...
 14 files changed, 512 insertions(+), 284 deletions(-)
...
index e1e3d3ae72b7..b41134b7ea5f 100644
...
index 810a901d7afd..57faed00cd0f 100644
--- a/drivers/net/ethernet/intel/ice/devlink/devlink.c
+++ b/drivers/net/ethernet/intel/ice/devlink/devlink.c
@@ -1284,8 +1284,14 @@ ice_devlink_enable_roce_get(struct devlink *devlink, u32 id,
...
@@ -1295,19 +1301,24 @@ static int ice_devlink_enable_roce_set(struct devlink *devlink, u32 id,
...
@@ -1318,11 +1329,16 @@ ice_devlink_enable_roce_validate(struct devlink *devlink, u32 id,
 				 struct netlink_ext_ack *extack)
 {
 	struct ice_pf *pf = devlink_priv(devlink);
+	struct idc_rdma_core_dev_info *cdev;
...
@@ -1336,7 +1352,8 @@ ice_devlink_enable_iw_get(struct devlink *devlink, u32 id,
 {
 	struct ice_pf *pf = devlink_priv(devlink);
...
@@ -1346,19 +1363,23 @@ static int ice_devlink_enable_iw_set(struct devlink *devlink, u32 id,
 				     struct netlink_ext_ack *extack)
 {
 	struct ice_pf *pf = devlink_priv(devlink);
+	struct idc_rdma_core_dev_info *cdev;
...
@@ -1373,7 +1394,7 @@ ice_devlink_enable_iw_validate(struct devlink *devlink, u32 id,
 	if (!test_bit(ICE_FLAG_RDMA_ENA, pf->flags))
 		return -EOPNOTSUPP;
...
index caaa10157909..9070452b3b33 100644
--- a/drivers/net/ethernet/intel/ice/ice.h
+++ b/drivers/net/ethernet/intel/ice/ice.h
@@ -405,7 +405,6 @@ struct ice_vsi {
...
index a94e7072b570..c85d86c0c9c5 100644
--- a/drivers/net/ethernet/intel/ice/ice_dcb_lib.c
+++ b/drivers/net/ethernet/intel/ice/ice_dcb_lib.c
@@ -352,7 +352,7 @@ int ice_pf_dcb_cfg(struct ice_pf *pf, struct ice_dcbx_cfg *new_cfg, bool locked)
...
@@ -404,7 +404,7 @@ int ice_pf_dcb_cfg(struct ice_pf *pf, struct ice_dcbx_cfg *new_cfg, bool locked)
 		goto free_cfg;
 	}
...
@@ -739,7 +739,9 @@ static int ice_dcb_noncontig_cfg(struct ice_pf *pf)
...
@@ -782,13 +784,17 @@ void ice_pf_dcb_recfg(struct ice_pf *pf, bool locked)
...
@@ -943,6 +949,36 @@ ice_tx_prepare_vlan_flags_dcb(struct ice_tx_ring *tx_ring,
 	}
 }
...
index 8c990c976132..ee5e88b7cb89 100644
--- a/drivers/net/ethernet/intel/ice/ice_ethtool.c
+++ b/drivers/net/ethernet/intel/ice/ice_ethtool.c
@@ -3992,11 +3992,11 @@ static int ice_set_channels(struct net_device *dev, struct ethtool_channels *ch)
 		return -EINVAL;
 	}
...
+		if (pf->cdev_info->adev->dev.driver) {
 			...
 			ret = -EBUSY;
 			goto adev_unlock;
@@ -4015,7 +4015,7 @@ static int ice_set_channels(struct net_device *dev, struct ethtool_channels *ch)
...
index 145b27f2a4ce..3454b91afcaa 100644
...
@@ -32,44 +33,52 @@ static struct iidc_auxiliary_drv *ice_get_auxiliary_drv(struct ice_pf *pf)
  * @pf: pointer to PF struct
  * @event: event struct
  */
...
@@ -100,27 +109,28 @@ int ice_add_rdma_qset(struct ice_pf *pf, struct iidc_rdma_qset_params *qset)
...
@@ -130,57 +140,56 @@ int ice_del_rdma_qset(struct ice_pf *pf, struct iidc_rdma_qset_params *qset)
 	q_id = qset->qs_handle;
 	teid = qset->teid;
...
+	pf = pci_get_drvdata(cdev->pdev);
 	...
 	if (!vsi)
 		return -EINVAL;
@@ -198,35 +207,6 @@ int ice_rdma_update_vsi_filter(struct ice_pf *pf, u16 vsi_id, bool enable)
...
@@ -234,22 +214,26 @@ EXPORT_SYMBOL_GPL(ice_get_qos_params);
  */
...
+			entry = &cdev->msix_entries[i];
 			...
 			if (map.index < 0)
 				break;
@@ -267,32 +251,49 @@ static int ice_alloc_rdma_qvectors(struct ice_pf *pf)
  */
...
@@ -302,7 +303,8 @@ static void ice_adev_release(struct device *dev)
  */
...
@@ -312,17 +314,22 @@ int ice_plug_aux_dev(struct ice_pf *pf)
 	if (!ice_is_rdma_ena(pf))
 		return 0;
...
+		     "roce" : "iwarp";
 	...
 	if (ret) {
@@ -337,7 +344,7 @@ int ice_plug_aux_dev(struct ice_pf *pf)
 	}
...
+	cdev->adev = adev;
 	...
 	return 0;
@@ -351,8 +358,8 @@ void ice_unplug_aux_dev(struct ice_pf *pf)
 	struct auxiliary_device *adev;
...
+	pf->cdev_info->adev = NULL;
 	...
 	if (adev) {
@@ -361,6 +368,30 @@ void ice_unplug_aux_dev(struct ice_pf *pf)
 	}
 }
...
+
  ...
  * @pf: ptr to ice_pf
@@ -368,6 +399,8 @@ void ice_unplug_aux_dev(struct ice_pf *pf)
...
+	struct idc_rdma_core_dev_info *cdev;
 	...
 	if (!ice_is_rdma_ena(pf)) {
@@ -375,20 +408,46 @@ int ice_init_rdma(struct ice_pf *pf)
 		return 0;
 	}
...
@@ -397,8 +456,14 @@ int ice_init_rdma(struct ice_pf *pf)
 err_plug_aux_dev:
...
index 3de020020bc4..ed2b0a6be8d0 100644
--- a/drivers/net/ethernet/intel/ice/ice_main.c
+++ b/drivers/net/ethernet/intel/ice/ice_main.c
@@ -2380,11 +2380,11 @@ static void ice_service_task(struct work_struct *work)
 	}
...
+			set_bit(IDC_RDMA_EVENT_CRIT_ERR, event->type);
 			...
 			ice_send_event_to_aux(pf, event);
@@ -2403,11 +2403,11 @@ static void ice_service_task(struct work_struct *work)
 		ice_plug_aux_dev(pf);
...
@@ -9258,6 +9258,7 @@ ice_setup_tc(struct net_device *netdev, enum tc_setup_type type,
 {
...
@@ -9273,11 +9274,12 @@ ice_setup_tc(struct net_device *netdev, enum tc_setup_type type,
 			return -EOPNOTSUPP;
 		}
...
+			if (cdev->adev->dev.driver) {
 				...
 				err = -EBUSY;
 				goto adev_unlock;
@@ -9291,7 +9293,7 @@ ice_setup_tc(struct net_device *netdev, enum tc_setup_type type,
...
new file mode 100644
index 000000000000..2e30b04a8a75
--- /dev/null
