Return-Path: <linux-rdma+bounces-3960-lists+linux-rdma=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-rdma@lfdr.de
Delivered-To: lists+linux-rdma@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id E816A93B986
	for <lists+linux-rdma@lfdr.de>; Thu, 25 Jul 2024 01:41:06 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 17E131C234B3
	for <lists+linux-rdma@lfdr.de>; Wed, 24 Jul 2024 23:41:06 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 857F1148848;
	Wed, 24 Jul 2024 23:40:46 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b="eLG4Z6at"
X-Original-To: linux-rdma@vger.kernel.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.7])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 4D253143888
	for <linux-rdma@vger.kernel.org>; Wed, 24 Jul 2024 23:40:44 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=192.198.163.7
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1721864446; cv=none; b=R7XRLur/hBdJASgLgKciHIXeObPdEUaAMpiJWc5OHhe1OzKwZP2N09FJjPTsXhGRzTQUwGVBJsJkwL5fH9WAz2PQ00ErCLZlyTzc7X+9jrEs7+qHGtpjEYlAgSCOVQoU28iRxZaJeK6E3Ofrku7i37GrAFmgxAy5FZNhVkqOlw4=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1721864446; c=relaxed/simple;
	bh=iyi2+P3FSSeAZmxpMJxHMQs4jCGujOfYqtpPDRhm+3k=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=Hzzb1yIADnJnffL2TfyWPFKTwKECiNI/m+3tzLhmjCXRh9+GIhG42CeMxknXDeUd26mdSLqtPJLJ4vvl4oF8uRtSIlQajEmuag7dDM8hfYiTH1mYhzx4N8QJ67S8RTMBbyLtD+MZcmhDT2UH7SoMBC8EBgyxBGmqiiDv8Zywlqc=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com; spf=pass smtp.mailfrom=intel.com; dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b=eLG4Z6at; arc=none smtp.client-ip=192.198.163.7
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=intel.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1721864444; x=1753400444;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=iyi2+P3FSSeAZmxpMJxHMQs4jCGujOfYqtpPDRhm+3k=;
  b=eLG4Z6at6qUsUm2dqq2/DvpHNxTL+f59X+zKahBtxSFto+DQP+yHuzxV
   ttQ0JzkdwwKsCG8nX8xqEY0UnVQG0j+21jWdCm9+67XSo8uPOgWA9McoV
   ZzrqJIUK6D2/dZkJRu3kKzEESsCbKPZyJWCRctWKwpvREtRYRSKIi3hHJ
   jVEhm+ScKsSnFSFzGQGsPBD8whGXmsx3h33frQvX1s4p3nfgraz/Oxqng
   Ow+fHAqy6lfD3bTfJBTGMvuZ7No378dg9oPPjGMigyHhEFtBI1bf+uwtG
   RswWzGWtch7eCKlnUHzdWQBcodCAIsBEVwpG1+Zot3UAe2uJjhjvqPY20
   A==;
X-CSE-ConnectionGUID: 43f8LOcXSW+TXtUDurYUEA==
X-CSE-MsgGUID: hWmUnCxCSSerFTyBPZel2Q==
X-IronPort-AV: E=McAfee;i="6700,10204,11143"; a="44999769"
X-IronPort-AV: E=Sophos;i="6.09,234,1716274800"; 
   d="scan'208";a="44999769"
Received: from fmviesa006.fm.intel.com ([10.60.135.146])
  by fmvoesa101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 24 Jul 2024 16:40:41 -0700
X-CSE-ConnectionGUID: Ssoxhwx+T/Ct4oOzfDAY4A==
X-CSE-MsgGUID: +Y5x/iK5R8CkB43ZMORK3g==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.09,234,1716274800"; 
   d="scan'208";a="52426054"
...
Subject: [RFC PATCH 12/25] RDMA/irdma: Discover and set up GEN3 hardware register layout
Date: Wed, 24 Jul 2024 18:39:04 -0500
Message-Id: <20240724233917.704-13-tatyana.e.nikolova@intel.com>
...
index 9d7b151..34875cb 100644
--- a/drivers/infiniband/hw/irdma/ctrl.c
+++ b/drivers/infiniband/hw/irdma/ctrl.c
@@ -5677,6 +5677,9 @@ static inline void irdma_sc_init_hw(struct irdma_sc_dev *dev)
 	case IRDMA_GEN_2:
 		icrdma_init_hw(dev);
 		break;
+	case IRDMA_GEN_3:
...
@@ -5744,18 +5747,26 @@ int irdma_sc_dev_init(enum irdma_vers ver, struct irdma_sc_dev *dev,
...
@@ -136,6 +183,137 @@ static int irdma_vchnl_req_send_sync(struct irdma_sc_dev *dev,
 }
...
+
 struct irdma_vchnl_req {
 	...
 	void *parm;
@@ -93,4 +136,5 @@ int irdma_vchnl_req_get_ver(struct irdma_sc_dev *dev, u16 ver_req,
